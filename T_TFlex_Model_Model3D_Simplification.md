...
# Simplification - класс  
  
---  
  
Операция удаления лишних геометрических элементов упрощения геометрии

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSimplification
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Simplification](M_TFlex_Model_Model3D_Simplification__ctor.md) | Конструктор для создания операции удаления лишних геометрических элементов упрощения геометрии |
