...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CoordinateNode3D](M_TFlex_Model_Model3D_CoordinateNode3D__ctor.md) | Конструктор для создания узла по координатам |
...
|  | [X](P_TFlex_Model_Model3D_CoordinateNode3D_X.md) | X - координата узла |
|  | [Y](P_TFlex_Model_Model3D_CoordinateNode3D_Y.md) | Y - координата узла |
|  | [Z](P_TFlex_Model_Model3D_CoordinateNode3D_Z.md) | Z - координата узла |
