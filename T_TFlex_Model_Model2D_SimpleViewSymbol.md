...
# SimpleViewSymbol - класс  
  
---  
  
Класс обозначения вида

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DViewSymbol](T_TFlex_Model_Model2D_ViewSymbol.md) TFlex.Model.Model2DSimpleViewSymbol
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SimpleViewSymbol](M_TFlex_Model_Model2D_SimpleViewSymbol__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [BottomLineOffset](P_TFlex_Model_Model2D_SimpleViewSymbol_BottomLineOffset.md) | Смещение нижней строки |
|  | [BottomNote](P_TFlex_Model_Model2D_SimpleViewSymbol_BottomNote.md) | Строка текста под линией |
...
|  | [Node](P_TFlex_Model_Model2D_SimpleViewSymbol_Node.md) | Узел привязки |
...
|  | [OutlineLineWidth](P_TFlex_Model_Model2D_SimpleViewSymbol_OutlineLineWidth.md) | Толщина линий |
...
|  | [Point](P_TFlex_Model_Model2D_SimpleViewSymbol_Point.md) | Координаты точки привязки |
...
|  | [ShowLine](P_TFlex_Model_Model2D_SimpleViewSymbol_ShowLine.md) | Показывать линию подчёркивания |
|  | [TopLineOffset](P_TFlex_Model_Model2D_SimpleViewSymbol_TopLineOffset.md) | Смещение верхней строки |
|  | [TopNote](P_TFlex_Model_Model2D_SimpleViewSymbol_TopNote.md) | Строка текста над линией |
...
|  | [SetAbsolutePosition](M_TFlex_Model_Model2D_SimpleViewSymbol_SetAbsolutePosition.md) | Установка привязки в абсолютных коордиеннатах |
...
|  | [SetNode](M_TFlex_Model_Model2D_SimpleViewSymbol_SetNode.md) | Установка привязки к узлу |
