...
# ObjectTransformManipulatorEnableTranslateXZ - свойство  
...
```csharp
public bool EnableTranslateXZ { get; set; }
```
```vb
Public Property EnableTranslateXZ As Boolean
	Get
	Set
```
```cpp
public:
property bool EnableTranslateXZ {
	bool get ();
	void set (bool value);
}
```
