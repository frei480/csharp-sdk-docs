...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AreaPath](M_TFlex_Model_Model3D_AreaPath__ctor.md) | Конструктор для создания пути по одноконтурной штриховке и рабочей поверхности |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Area](P_TFlex_Model_Model3D_AreaPath_Area.md) | Штриховка, задающая форму пути |
...
|  | [OnHatch](P_TFlex_Model_Model3D_AreaPath_OnHatch.md) | 2D узел, задающий перемещение узла контура в 3D узел |
...
|  | [Target](P_TFlex_Model_Model3D_AreaPath_Target.md) | 3D узел для привязки плоскости контура |
...
|  | [WorkSurface](P_TFlex_Model_Model3D_AreaPath_WorkSurface.md) | Рабочая поверхность, задающая положение пути |
