...
# ExpanderControl - класс  
    
Элемент, отображающий разворачиваемую группу

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) [TFlex.DialogsGroupControl](T_TFlex_Dialogs_GroupControl.md) TFlex.DialogsExpanderControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExpanderControl](M_TFlex_Dialogs_ExpanderControl__ctor.md) | Инициализирует новый экземпляр класса ExpanderControl |
|  | [ExpanderControl(String)](M_TFlex_Dialogs_ExpanderControl__ctor_1.md) | Инициализирует новый экземпляр класса ExpanderControl |
...
|  | [HeaderText](P_TFlex_Dialogs_ExpanderControl_HeaderText.md) | Текст заголовка |
...
|  | [IsExpanded](P_TFlex_Dialogs_ExpanderControl_IsExpanded.md) | Развернут или нет контрол |
...
|  | [Orientation](P_TFlex_Dialogs_GroupControl_Orientation.md) | Устанавливает ориентацию группы(Унаследован от [GroupControl](T_TFlex_Dialogs_GroupControl.md)) |
...
|  | [Collapsed](E_TFlex_Dialogs_ExpanderControl_Collapsed.md) | Событие сворачивания |
...
|  | [Expanded](E_TFlex_Dialogs_ExpanderControl_Expanded.md) | Событие разворота |
