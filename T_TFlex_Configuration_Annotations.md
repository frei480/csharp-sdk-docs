...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationAnnotations
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Annotations](M_TFlex_Configuration_Annotations__ctor.md) | Инициализирует новый экземпляр класса Annotations |
|  | [Annotations(IntPtr, Boolean)](M_TFlex_Configuration_Annotations__ctor_1.md) | Инициализирует новый экземпляр класса Annotations |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AutoViewAngle](P_TFlex_Configuration_Annotations_AutoViewAngle.md) |  |
|  | [AutoViewNaming](P_TFlex_Configuration_Annotations_AutoViewNaming.md) |  |
|  | [AutoViewNamingReverseOrder](P_TFlex_Configuration_Annotations_AutoViewNamingReverseOrder.md) |  |
|  | [AutoViewScale](P_TFlex_Configuration_Annotations_AutoViewScale.md) |  |
|  | [FastText](P_TFlex_Configuration_Annotations_FastText.md) |  |
|  | [Standard](P_TFlex_Configuration_Annotations_Standard.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Annotations_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Annotations_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Annotations_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
