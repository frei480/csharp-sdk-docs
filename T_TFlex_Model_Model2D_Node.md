...
Базовый класс 2D узла

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DNode Подробнее
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AbsX](P_TFlex_Model_Model2D_Node_AbsX.md) | Координата X в системе координат модели (без учёта масштаба страницы) |
|  | [AbsY](P_TFlex_Model_Model2D_Node_AbsY.md) | Координата Y в системе координат модели (без учёта масштаба страницы) |
...
|  | [Color](P_TFlex_Model_Model2D_Node_Color.md) | Цвет объекта |
|  | [Coordinates](P_TFlex_Model_Model2D_Node_Coordinates.md) | Координаты узла в системе координат модели (без учёта масштаба страницы) |
...
|  | [GroupType](P_TFlex_Model_Model2D_Node_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_Node_Layer.md) | Слой, на котором размещается объект |
|  | [Level](P_TFlex_Model_Model2D_Node_Level.md) | Уровень объекта |
...
|  | [Page](P_TFlex_Model_Model2D_Node_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [SubType](P_TFlex_Model_Model2D_Node_SubType.md) | Подтип способа построения узла |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DNode [TFlex.Model.Model2DBetweenNode](T_TFlex_Model_Model2D_BetweenNode.md) [TFlex.Model.Model2DCopyNode](T_TFlex_Model_Model2D_CopyNode.md) [TFlex.Model.Model2DFragmentNode](T_TFlex_Model_Model2D_FragmentNode.md) [TFlex.Model.Model2DFreeNode](T_TFlex_Model_Model2D_FreeNode.md) [TFlex.Model.Model2DIntersectionNode](T_TFlex_Model_Model2D_IntersectionNode.md) [TFlex.Model.Model2DNamedFragmentNode](T_TFlex_Model_Model2D_NamedFragmentNode.md) [TFlex.Model.Model2DObjectNode](T_TFlex_Model_Model2D_ObjectNode.md) [TFlex.Model.Model2DProjectionNode](T_TFlex_Model_Model2D_ProjectionNode.md) [TFlex.Model.Model2DRelativeNode](T_TFlex_Model_Model2D_RelativeNode.md)