...
```csharp
public static ICollection<Section3D> GetSections(
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Section3D](T_TFlex_Model_Model3D_Section3D.md)
