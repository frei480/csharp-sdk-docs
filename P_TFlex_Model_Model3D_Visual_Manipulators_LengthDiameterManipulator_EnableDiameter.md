...
# LengthDiameterManipulatorEnableDiameter - свойство  
...
```csharp
public bool EnableDiameter { get; set; }
```
```vb
Public Property EnableDiameter As Boolean
	Get
	Set
```
```cpp
public:
property bool EnableDiameter {
	bool get ();
	void set (bool value);
}
```
