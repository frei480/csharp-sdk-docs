...
Линия изображения - ось двух других линий изображения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DAxisOutline
...
|  | [AxisOutline(Document, Outline, Outline, Outline, Outline)](M_TFlex_Model_Model2D_AxisOutline__ctor_1.md) | Конструктор |
...
|  | [Limit1Outline](P_TFlex_Model_Model2D_AxisOutline_Limit1Outline.md) | Первая ограничивающая линия изображения |
|  | [Limit2Outline](P_TFlex_Model_Model2D_AxisOutline_Limit2Outline.md) | Вторая ограничивающая линия изображения |
...
|  | [Source1Outline](P_TFlex_Model_Model2D_AxisOutline_Source1Outline.md) | Первая исходная линия изображения |
|  | [Source2Outline](P_TFlex_Model_Model2D_AxisOutline_Source2Outline.md) | Вторая исходная линия изображения |
...
|  | [SubType](P_TFlex_Model_Model2D_AxisOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
