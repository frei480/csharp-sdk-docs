...
# InputControlBase - класс  
  
---  
  
Базовый класс для элементов ввода значений

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsInputControlBase [TFlex.DialogsCompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md) [TFlex.DialogsNumericInputControl](T_TFlex_Dialogs_NumericInputControl.md)
...
|  | [Buttons](P_TFlex_Dialogs_InputControlBase_Buttons.md) | Доступ к дополнительным кнопкам |
...
|  | [CurrentValueListIndex](P_TFlex_Dialogs_InputControlBase_CurrentValueListIndex.md) | Индекс текущего элемента списка (для итерации колёсиком мыши) |
...
|  | [FocusLostBehavior](P_TFlex_Dialogs_InputControlBase_FocusLostBehavior.md) | Поведение при потере фокуса |
...
|  | [IsAutocomplete](P_TFlex_Dialogs_InputControlBase_IsAutocomplete.md) | Флаг индикатор того, что у контрола включено автодополнение |
|  | [IsDirty](P_TFlex_Dialogs_InputControlBase_IsDirty.md) | Получить флаг IsDirty |
...
|  | [IsManyValues](P_TFlex_Dialogs_InputControlBase_IsManyValues.md) | Флаг индикатор того, что контрол отображает сразу несколько значений |
...
|  | [IsUserValue](P_TFlex_Dialogs_InputControlBase_IsUserValue.md) | Возвращает True, если текущее значение получено от пользователя |
|  | [IsValid](P_TFlex_Dialogs_InputControlBase_IsValid.md) | Управление состоянием корректности ввода |
...
|  | [ManyValuesText](P_TFlex_Dialogs_InputControlBase_ManyValuesText.md) | Текст, показываемый пользователю в режиме IsManyValues |
...
|  | [OriginalValueIsFromUser](P_TFlex_Dialogs_InputControlBase_OriginalValueIsFromUser.md) | Возвращает True, если стабильное значение получено от пользователя (а не задано программно) |
...
|  | [SelectionLength](P_TFlex_Dialogs_InputControlBase_SelectionLength.md) | Длина селекции |
|  | [SelectionStart](P_TFlex_Dialogs_InputControlBase_SelectionStart.md) | Позиция начала селекции |
|  | [Tag](P_TFlex_Dialogs_BaseControl_Tag.md) | Пользовательские данные(Унаследован от [BaseControl](T_TFlex_Dialogs_BaseControl.md)) |
|  | [Text](P_TFlex_Dialogs_InputControlBase_Text.md) | Получить текст |
|  | [ValueList](P_TFlex_Dialogs_InputControlBase_ValueList.md) | Доступ к списку значений |
|  | [ValueListMode](P_TFlex_Dialogs_InputControlBase_ValueListMode.md) | Режим списка значений |
...
|  | [ApplyChanges](M_TFlex_Dialogs_InputControlBase_ApplyChanges.md) | Применить изменения пользователя |
|  | [ClearOriginalValueIsFromUser](M_TFlex_Dialogs_InputControlBase_ClearOriginalValueIsFromUser.md) | Сбрасывает значение флага OriginalValueIsFromUser |
|  | [DeselectAll](M_TFlex_Dialogs_InputControlBase_DeselectAll.md) | Сбросить селекцию текста |
...
|  | [EndUserEdit](M_TFlex_Dialogs_InputControlBase_EndUserEdit.md) | Завершить редактирование |
...
|  | [RevertChanges](M_TFlex_Dialogs_InputControlBase_RevertChanges.md) | Отменить изменения пользователя |
|  | [Select](M_TFlex_Dialogs_InputControlBase_Select.md) | Выделить указанный текст |
|  | [SelectAll](M_TFlex_Dialogs_InputControlBase_SelectAll.md) | Выделить весь текст |
...
|  | [AutocompleteFilling](E_TFlex_Dialogs_InputControlBase_AutocompleteFilling.md) |  |
|  | [ChangesApplied](E_TFlex_Dialogs_InputControlBase_ChangesApplied.md) | Событие применения изменений |
|  | [ChangesReverted](E_TFlex_Dialogs_InputControlBase_ChangesReverted.md) | События отмены изменений |
