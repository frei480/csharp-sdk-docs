...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSizeInt
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SizeInt](M_TFlex_Configuration_SizeInt__ctor.md) | Инициализирует новый экземпляр класса SizeInt |
|  | [SizeInt(IntPtr, Boolean)](M_TFlex_Configuration_SizeInt__ctor_1.md) | Инициализирует новый экземпляр класса SizeInt |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [X](P_TFlex_Configuration_SizeInt_X.md) |  |
|  | [Y](P_TFlex_Configuration_SizeInt_Y.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_SizeInt_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_SizeInt_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_SizeInt_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
...
|  | [ToString](M_TFlex_Configuration_SizeInt_ToString.md) | (Переопределяет [ObjectToString](https://learn.microsoft.com/dotnet/api/system.object.tostring)) |
