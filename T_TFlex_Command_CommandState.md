...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.CommandFilterOwner](T_TFlex_Command_FilterOwner.md) TFlex.CommandCommandState
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CommandState](M_TFlex_Command_CommandState__ctor.md) | Инициализирует новый экземпляр класса CommandState |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Automenu](P_TFlex_Command_CommandState_Automenu.md) |  |
|  | [Command](P_TFlex_Command_CommandState_Command.md) |  |
|  | [Filter](P_TFlex_Command_CommandState_Filter.md) |  |
|  | [PropertiesWindow](P_TFlex_Command_CommandState_PropertiesWindow.md) |  |
...
|  | [OnExit](M_TFlex_Command_CommandState_OnExit.md) |  |
|  | [OnInitialize](M_TFlex_Command_CommandState_OnInitialize.md) |  |
|  | [OnKeyPressed](M_TFlex_Command_CommandState_OnKeyPressed.md) |  |
|  | [OnKeyUp](M_TFlex_Command_CommandState_OnKeyUp.md) |  |
|  | [OnMouseMove](M_TFlex_Command_CommandState_OnMouseMove.md) |  |
|  | [OnSelect](M_TFlex_Command_CommandState_OnSelect.md) |  |
...
|  | [OnShowCursor](M_TFlex_Command_CommandState_OnShowCursor.md) |  |
