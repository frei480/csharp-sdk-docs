...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SurfaceSetDevelopmentProfile](M_TFlex_Model_Model3D_SurfaceSetDevelopmentProfile__ctor.md) | Конструктор для создания развёртки набора граней |
...
|  | [DeleteRedundant](P_TFlex_Model_Model3D_SurfaceSetDevelopmentProfile_DeleteRedundant.md) | Параметр "удалять лишние рёбра" |
|  | [DevelopmentFaces](P_TFlex_Model_Model3D_SurfaceSetDevelopmentProfile_DevelopmentFaces.md) | Набор разворачиваемых граней |
...
|  | [FixedEdges](P_TFlex_Model_Model3D_SurfaceSetDevelopmentProfile_FixedEdges.md) | Набор неразрывных рёбер |
...
|  | [PointOnFace](P_TFlex_Model_Model3D_SurfaceSetDevelopmentProfile_PointOnFace.md) | Точка на наборе граней |
