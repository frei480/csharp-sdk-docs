...
Тип [TermGroup](T_TFlex_Model_Data_Filters_TermGroup.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [AsGroup](P_TFlex_Model_Data_Filters_TermGroup_AsGroup.md) | Приводит текущий объект к типу [TermGroup](T_TFlex_Model_Data_Filters_TermGroup.md)(Переопределяет [TermGroupItemAsGroup](P_TFlex_Model_Data_Filters_TermGroupItem_AsGroup.md)) |
