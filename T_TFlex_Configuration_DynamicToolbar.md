...
# DynamicToolbar - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationDynamicToolbar
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [DynamicToolbar](M_TFlex_Configuration_DynamicToolbar__ctor.md) | Инициализирует новый экземпляр класса DynamicToolbar |
|  | [DynamicToolbar(IntPtr, Boolean)](M_TFlex_Configuration_DynamicToolbar__ctor_1.md) | Инициализирует новый экземпляр класса DynamicToolbar |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [DontHide](P_TFlex_Configuration_DynamicToolbar_DontHide.md) |  |
|  | [HotDistance](P_TFlex_Configuration_DynamicToolbar_HotDistance.md) |  |
|  | [UseDynamicToolbar](P_TFlex_Configuration_DynamicToolbar_UseDynamicToolbar.md) |  |
|  | [UseTransparency](P_TFlex_Configuration_DynamicToolbar_UseTransparency.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_DynamicToolbar_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_DynamicToolbar_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_DynamicToolbar_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
