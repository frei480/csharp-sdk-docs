...
# OnFaceOffsetPoint - свойства  
    
Тип [OnFaceOffsetPoint](T_TFlex_Model_Model3D_OnFaceOffsetPoint.md) предоставляет следующие члены.
...
|  | [Face](P_TFlex_Model_Model3D_OnFaceOffsetPoint_Face.md) | Получить грань, на которой строится точка |
|  | [FirstAdjacent](P_TFlex_Model_Model3D_OnFaceOffsetPoint_FirstAdjacent.md) | Получить первую границу, от которого строится смещение |
...
|  | [SecondAdjacent](P_TFlex_Model_Model3D_OnFaceOffsetPoint_SecondAdjacent.md) | Получить вторую границу, от которой строится смещение |
...
[OnFaceOffsetPoint - ](T_TFlex_Model_Model3D_OnFaceOffsetPoint.md)
