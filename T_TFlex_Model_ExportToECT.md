...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExportToECT](M_TFlex_Model_ExportToECT__ctor.md) | Инициализирует новый экземпляр класса ExportToECT |
...
|  | [Archive](P_TFlex_Model_ExportToECT_Archive.md) | Запаковать в архив |
|  | [CacheObjects](P_TFlex_Model_ExportToECT_CacheObjects.md) | Кэширование объектов |
...
|  | [Export](M_TFlex_Model_ExportToECT_Export.md) | Функция экспорта документа(Переопределяет [ExportToFacetExport(String)](M_TFlex_Model_ExportToFacet_Export.md)) |
