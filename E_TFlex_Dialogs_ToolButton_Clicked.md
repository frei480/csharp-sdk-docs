...
```csharp
public event EventHandler<BaseEventArgs> Clicked
```
```vb
Public Event Clicked As EventHandler(Of BaseEventArgs)
```
```cpp
public:
 event EventHandler<BaseEventArgs^>^ Clicked {
