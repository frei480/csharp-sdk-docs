...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ThreePlanesPoint](M_TFlex_Model_Model3D_ThreePlanesPoint__ctor.md) | Конструктор для создания узла на пересечении трёх плоскостей |
...
|  | [Plane1](P_TFlex_Model_Model3D_ThreePlanesPoint_Plane1.md) | Первая плоскость |
|  | [Plane2](P_TFlex_Model_Model3D_ThreePlanesPoint_Plane2.md) | Вторая плоскость |
|  | [Plane3](P_TFlex_Model_Model3D_ThreePlanesPoint_Plane3.md) | Третья плоскость |
