...
```csharp
public static Unit SquareMeterCelciusDegreeSecondPerCalorie { get; }
```
```vb
Public Shared ReadOnly Property SquareMeterCelciusDegreeSecondPerCalorie As Unit
	Get
```
```cpp
public:
static property Unit^ SquareMeterCelciusDegreeSecondPerCalorie {
	Unit^ get ();
}
```
