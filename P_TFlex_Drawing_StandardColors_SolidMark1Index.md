...
# StandardColorsSolidMark1Index - свойство  
...
```csharp
public static int SolidMark1Index { get; }
```
```vb
Public Shared ReadOnly Property SolidMark1Index As Integer
	Get
```
```cpp
public:
static property int SolidMark1Index {
	int get ();
}
```
