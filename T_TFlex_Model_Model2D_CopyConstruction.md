...
# CopyConstruction - класс  
    
Класс линии построения, полученной ассоциативным копированием

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DCopyConstruction
...
|  | [GeometryType](P_TFlex_Model_Model2D_CopyConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [Source](P_TFlex_Model_Model2D_CopyConstruction_Source.md) | Исходная линия построения |
|  | [SourceCopyOperation](P_TFlex_Model_Model2D_CopyConstruction_SourceCopyOperation.md) | Исходный объект-копия |
|  | [SubType](P_TFlex_Model_Model2D_CopyConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
|  | [Transformation](P_TFlex_Model_Model2D_CopyConstruction_Transformation.md) | Преобразование |
...
Объект данного класса не может быть создан приложением. он может создаваться только автоматически системой при создании операции копирования или массива
