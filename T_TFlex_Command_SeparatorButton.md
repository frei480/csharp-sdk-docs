...
# SeparatorButton - класс  
  
---  
  
Разделитель кнопок в автоменю

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.CommandButton](T_TFlex_Command_Button.md) TFlex.CommandSeparatorButton
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SeparatorButton](M_TFlex_Command_SeparatorButton__ctor.md) | Конструктор |
