...
# BaseControlDeactivated - событие  
...
```csharp
public event EventHandler<BaseEventArgs> Deactivated
```
```vb
Public Event Deactivated As EventHandler(Of BaseEventArgs)
```
```cpp
public:
 event EventHandler<BaseEventArgs^>^ Deactivated {
