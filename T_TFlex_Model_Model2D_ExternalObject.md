...
# ExternalObject - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DExternalObject
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExternalObject(IntPtr)](M_TFlex_Model_Model2D_ExternalObject__ctor.md) | Инициализирует новый экземпляр класса ExternalObject |
|  | [ExternalObject(ProxyObject2D, Document, Plugin)](M_TFlex_Model_Model2D_ExternalObject__ctor_1.md) | Инициализирует новый экземпляр класса ExternalObject |
...
|  | [Color](P_TFlex_Model_Model2D_ExternalObject_Color.md) | Цвет |
|  | [ConstObject](P_TFlex_Model_Model2D_ExternalObject_ConstObject.md) |  |
...
|  | [GroupType](P_TFlex_Model_Model2D_ExternalObject_GroupType.md) | (Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_ExternalObject_Layer.md) | Слой |
|  | [Level](P_TFlex_Model_Model2D_ExternalObject_Level.md) | Уровень |
...
|  | [Page](P_TFlex_Model_Model2D_ExternalObject_Page.md) | Страница(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [PluginGuid](P_TFlex_Model_Model2D_ExternalObject_PluginGuid.md) |  |
|  | [Priority](P_TFlex_Model_Model2D_ExternalObject_Priority.md) | Приоритет |
|  | [TypeID](P_TFlex_Model_Model2D_ExternalObject_TypeID.md) |  |
...
|  | [VolatileObject](P_TFlex_Model_Model2D_ExternalObject_VolatileObject.md) |  |
...
|  | [ResetPlugin](M_TFlex_Model_Model2D_ExternalObject_ResetPlugin.md) | Перезадать приложение, определяющее промежуточный (прокси-) объект |
