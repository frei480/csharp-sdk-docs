...
|  | [SubType](P_TFlex_Model_Model3D_ProjectedLinearDimension_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [SetLeaderNote](M_TFlex_Model_Model3D_ProjectedLinearDimension_SetLeaderNote.md) | Установка привязок размера к узлам, либо по относительным смещениям |
|  | [SetOffsets](M_TFlex_Model_Model3D_ProjectedLinearDimension_SetOffsets.md) | Установка привязок размера к узлам, либо по относительным смещениям |
