...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CompoundStringControl](M_TFlex_Dialogs_CompoundStringControl__ctor.md) | Инициализирует новый экземпляр класса CompoundStringControl |
|  | [CompoundStringControl(String)](M_TFlex_Dialogs_CompoundStringControl__ctor_1.md) | Инициализирует новый экземпляр класса CompoundStringControl |
...
|  | [ExplodedString](P_TFlex_Dialogs_CompoundStringControl_ExplodedString.md) | Раскрытая строка (строка, в которую подставлены значения переменных) для текущего значения Text |
...
|  | [IsExplodeOn](P_TFlex_Dialogs_CompoundStringControl_IsExplodeOn.md) | "Раскрытие" строки влючено |
...
|  | [Text](P_TFlex_Dialogs_CompoundStringControl_Text.md) | Значение |
|  | [TextVariableOn](P_TFlex_Dialogs_CompoundStringControl_TextVariableOn.md) | Поддержка ввода выражений строковых переменных |
...
|  | [ExplodedStringChanged](E_TFlex_Dialogs_CompoundStringControl_ExplodedStringChanged.md) |  |
...
|  | [TextChanged](E_TFlex_Dialogs_CompoundStringControl_TextChanged.md) |  |
