...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.CircuitsLinkBase](T_TFlex_Model_Circuits_LinkBase.md) TFlex.Model.CircuitsMultiLink [TFlex.Model.CircuitsMultiLinksGroup](T_TFlex_Model_Circuits_MultiLinksGroup.md)
...
|  | [BreakNumerationType](P_TFlex_Model_Circuits_MultiLink_BreakNumerationType.md) |  |
|  | [BreakPageFormat](P_TFlex_Model_Circuits_MultiLink_BreakPageFormat.md) |  |
|  | [CanDraw](P_TFlex_Model_Circuits_LinkBase_CanDraw.md) | Управление отрисовкой(Унаследован от [LinkBase](T_TFlex_Model_Circuits_LinkBase.md)) |
...
|  | [GroupType](P_TFlex_Model_Circuits_MultiLink_GroupType.md) | (Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Page](P_TFlex_Model_Model2D_Object2D_Page.md) | Страница, на которой размещается объект(Унаследован от [Object2D](T_TFlex_Model_Model2D_Object2D.md)) |
...
|  | [TextOffset](P_TFlex_Model_Circuits_MultiLink_TextOffset.md) | (Переопределяет [LinkBaseTextOffset](P_TFlex_Model_Circuits_LinkBase_TextOffset.md)) |
|  | [TurnCaptions](P_TFlex_Model_Circuits_MultiLink_TurnCaptions.md) |  |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddDesignation(String, String, DesignationType)](M_TFlex_Model_Circuits_MultiLink_AddDesignation.md) | (Переопределяет [LinkBaseAddDesignation(String, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_AddDesignation.md)) |
|  | [AddDesignation(String, String, DesignationType, String)](M_TFlex_Model_Circuits_MultiLink_AddDesignation_1.md) | (Переопределяет [LinkBaseAddDesignation(String, String, DesignationType, String)](M_TFlex_Model_Circuits_LinkBase_AddDesignation_1.md)) |
|  | [AddDesignation(String, FixingVector, Double, String, DesignationType)](M_TFlex_Model_Circuits_MultiLink_AddDesignation_2.md) | (Переопределяет [LinkBaseAddDesignation(String, FixingVector, Double, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_AddDesignation_2.md)) |
|  | [AddLink](M_TFlex_Model_Circuits_MultiLink_AddLink.md) |  |
|  | [AddWireConnectionInfo](M_TFlex_Model_Circuits_MultiLink_AddWireConnectionInfo.md) | (Переопределяет [LinkBaseAddWireConnectionInfo(Element, ModelObject, ModelObject)](M_TFlex_Model_Circuits_LinkBase_AddWireConnectionInfo.md)) |
|  | [AttachBus](M_TFlex_Model_Circuits_MultiLink_AttachBus.md) |  |
...
|  | [CreateFromBuses](M_TFlex_Model_Circuits_MultiLink_CreateFromBuses.md) |  |
...
|  | [GetAllLinkedObjects](M_TFlex_Model_Circuits_MultiLink_GetAllLinkedObjects.md) | (Переопределяет [LinkBaseGetAllLinkedObjects](M_TFlex_Model_Circuits_LinkBase_GetAllLinkedObjects.md)) |
|  | [GetAllWireConnectionInfos](M_TFlex_Model_Circuits_MultiLink_GetAllWireConnectionInfos.md) | (Переопределяет [LinkBaseGetAllWireConnectionInfos(Boolean)](M_TFlex_Model_Circuits_LinkBase_GetAllWireConnectionInfos.md)) |
...
|  | [GetDesignations](M_TFlex_Model_Circuits_MultiLink_GetDesignations.md) | (Переопределяет [LinkBaseGetDesignations(DesignationType)](M_TFlex_Model_Circuits_LinkBase_GetDesignations.md)) |
...
|  | [GetFontOptions](M_TFlex_Model_Circuits_MultiLink_GetFontOptions.md) | (Переопределяет [LinkBaseGetFontOptions](M_TFlex_Model_Circuits_LinkBase_GetFontOptions.md)) |
|  | [GetGroups](M_TFlex_Model_Circuits_MultiLink_GetGroups.md) | (Переопределяет [LinkBaseGetGroups](M_TFlex_Model_Circuits_LinkBase_GetGroups.md)) |
...
|  | [GetLinkPoint](M_TFlex_Model_Circuits_MultiLink_GetLinkPoint.md) | (Переопределяет [LinkBaseGetLinkPoint(FixingVector)](M_TFlex_Model_Circuits_LinkBase_GetLinkPoint.md)) |
|  | [GetLinks](M_TFlex_Model_Circuits_MultiLink_GetLinks.md) |  |
...
|  | [GetPathBoundRect](M_TFlex_Model_Circuits_MultiLink_GetPathBoundRect.md) | (Переопределяет [LinkBaseGetPathBoundRect(FixingVector, FixingVector)](M_TFlex_Model_Circuits_LinkBase_GetPathBoundRect.md)) |
...
|  | [GetTexts(Boolean, DesignationType)](M_TFlex_Model_Circuits_MultiLink_GetTexts.md) | (Переопределяет [LinkBaseGetTexts(Boolean, DesignationType)](M_TFlex_Model_Circuits_LinkBase_GetTexts.md)) |
|  | [GetTexts(Boolean, FixingVector, DesignationType)](M_TFlex_Model_Circuits_MultiLink_GetTexts_1.md) | (Переопределяет [LinkBaseGetTexts(Boolean, FixingVector, DesignationType)](M_TFlex_Model_Circuits_LinkBase_GetTexts_1.md)) |
|  | [GetType](https://learn.microsoft.com/dotnet/api/system.object.gettype) | Gets the [Type](https://learn.microsoft.com/dotnet/api/system.type) of the current instance.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetWireConnectionInfo(Element, Boolean)](M_TFlex_Model_Circuits_MultiLink_GetWireConnectionInfo_1.md) | (Переопределяет [LinkBaseGetWireConnectionInfo(Element, Boolean)](M_TFlex_Model_Circuits_LinkBase_GetWireConnectionInfo_1.md)) |
|  | [GetWireConnectionInfo(Int32, Boolean)](M_TFlex_Model_Circuits_MultiLink_GetWireConnectionInfo.md) | (Переопределяет [LinkBaseGetWireConnectionInfo(Int32, Boolean)](M_TFlex_Model_Circuits_LinkBase_GetWireConnectionInfo.md)) |
|  | [HasDesignation(DesignationType)](M_TFlex_Model_Circuits_MultiLink_HasDesignation.md) | (Переопределяет [LinkBaseHasDesignation(DesignationType)](M_TFlex_Model_Circuits_LinkBase_HasDesignation.md)) |
|  | [HasDesignation(FixingVector, DesignationType)](M_TFlex_Model_Circuits_MultiLink_HasDesignation_1.md) | (Переопределяет [LinkBaseHasDesignation(FixingVector, DesignationType)](M_TFlex_Model_Circuits_LinkBase_HasDesignation_1.md)) |
|  | [HasDesignations](M_TFlex_Model_Circuits_MultiLink_HasDesignations.md) | (Переопределяет [LinkBaseHasDesignations(DesignationType)](M_TFlex_Model_Circuits_LinkBase_HasDesignations.md)) |
...
|  | [IsConnectionExist](M_TFlex_Model_Circuits_MultiLink_IsConnectionExist.md) |  |
...
|  | [MarkPath(Graphics, Point, Point)](M_TFlex_Model_Circuits_MultiLink_MarkPath.md) | (Переопределяет [LinkBaseMarkPath(Graphics, Point, Point)](M_TFlex_Model_Circuits_LinkBase_MarkPath.md)) |
|  | [MarkPath(Graphics, FixingVector, FixingVector)](M_TFlex_Model_Circuits_MultiLink_MarkPath_1.md) | (Переопределяет [LinkBaseMarkPath(Graphics, FixingVector, FixingVector)](M_TFlex_Model_Circuits_LinkBase_MarkPath_1.md)) |
...
|  | [RebaseDesignation](M_TFlex_Model_Circuits_MultiLink_RebaseDesignation.md) | (Переопределяет [LinkBaseRebaseDesignation(FixingVector, FixingVector, DesignationType, HashSetIntPtr)](M_TFlex_Model_Circuits_LinkBase_RebaseDesignation.md)) |
...
|  | [Remove](M_TFlex_Model_Circuits_MultiLink_Remove.md) | (Переопределяет [LinkBaseRemove(FixingVector)](M_TFlex_Model_Circuits_LinkBase_Remove.md)) |
|  | [RemoveChainDesignations](M_TFlex_Model_Circuits_MultiLink_RemoveChainDesignations.md) | (Переопределяет [LinkBaseRemoveChainDesignations](M_TFlex_Model_Circuits_LinkBase_RemoveChainDesignations.md)) |
|  | [RemoveDesignation(DesignationType)](M_TFlex_Model_Circuits_MultiLink_RemoveDesignation.md) | (Переопределяет [LinkBaseRemoveDesignation(DesignationType)](M_TFlex_Model_Circuits_LinkBase_RemoveDesignation.md)) |
|  | [RemoveDesignation(FixingVector, DesignationType)](M_TFlex_Model_Circuits_MultiLink_RemoveDesignation_1.md) | (Переопределяет [LinkBaseRemoveDesignation(FixingVector, DesignationType)](M_TFlex_Model_Circuits_LinkBase_RemoveDesignation_1.md)) |
|  | [RemoveDesignations](M_TFlex_Model_Circuits_MultiLink_RemoveDesignations.md) | (Переопределяет [LinkBaseRemoveDesignations(DesignationType)](M_TFlex_Model_Circuits_LinkBase_RemoveDesignations.md)) |
|  | [RemoveLink](M_TFlex_Model_Circuits_MultiLink_RemoveLink.md) |  |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [ReplaceDesignation(String, String, String)](M_TFlex_Model_Circuits_MultiLink_ReplaceDesignation.md) | (Переопределяет [LinkBaseReplaceDesignation(String, String, String)](M_TFlex_Model_Circuits_LinkBase_ReplaceDesignation.md)) |
|  | [ReplaceDesignation(String, String, String, String)](M_TFlex_Model_Circuits_MultiLink_ReplaceDesignation_1.md) | (Переопределяет [LinkBaseReplaceDesignation(String, String, String, String)](M_TFlex_Model_Circuits_LinkBase_ReplaceDesignation_1.md)) |
|  | [SetDesignation(String, String, DesignationType)](M_TFlex_Model_Circuits_MultiLink_SetDesignation.md) | (Переопределяет [LinkBaseSetDesignation(String, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_SetDesignation.md)) |
|  | [SetDesignation(String, MultilineText, String)](M_TFlex_Model_Circuits_MultiLink_SetDesignation_2.md) | (Переопределяет [LinkBaseSetDesignation(String, MultilineText, String)](M_TFlex_Model_Circuits_LinkBase_SetDesignation_2.md)) |
|  | [SetDesignation(String, FixingVector, Double, String, DesignationType)](M_TFlex_Model_Circuits_MultiLink_SetDesignation_1.md) | (Переопределяет [LinkBaseSetDesignation(String, FixingVector, Double, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_SetDesignation_1.md)) |
...
|  | [SetFontOptions](M_TFlex_Model_Circuits_MultiLink_SetFontOptions.md) | (Переопределяет [LinkBaseSetFontOptions(FontOptions)](M_TFlex_Model_Circuits_LinkBase_SetFontOptions.md)) |
...
|  | [SetTextHorizontalAlignment](M_TFlex_Model_Circuits_MultiLink_SetTextHorizontalAlignment.md) | (Переопределяет [LinkBaseSetTextHorizontalAlignment(TextHorizontalAlignment)](M_TFlex_Model_Circuits_LinkBase_SetTextHorizontalAlignment.md)) |
|  | [SetTextVerticalAlignment](M_TFlex_Model_Circuits_MultiLink_SetTextVerticalAlignment.md) | (Переопределяет [LinkBaseSetTextVerticalAlignment(TextVerticalAlignment)](M_TFlex_Model_Circuits_LinkBase_SetTextVerticalAlignment.md)) |
|  | [ShowDesignations](M_TFlex_Model_Circuits_MultiLink_ShowDesignations.md) | (Переопределяет [LinkBaseShowDesignations(DesignationType, Boolean)](M_TFlex_Model_Circuits_LinkBase_ShowDesignations.md)) |
