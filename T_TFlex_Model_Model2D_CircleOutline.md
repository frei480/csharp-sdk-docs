...
Линия изображения - окружность с центром в узле с заданным радиусом

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DCircleOutline
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CircleOutline](M_TFlex_Model_Model2D_CircleOutline__ctor.md) | Конструктор |
...
|  | [CenterNode](P_TFlex_Model_Model2D_CircleOutline_CenterNode.md) | Центр окружности |
...
|  | [Radius](P_TFlex_Model_Model2D_CircleOutline_Radius.md) | Радиус окружности |
...
|  | [SubType](P_TFlex_Model_Model2D_CircleOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
