...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSeparation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Separation](M_TFlex_Model_Model3D_Separation__ctor.md) | Конструктор для операции "Разделение" |
...
|  | [GroupType](P_TFlex_Model_Model3D_Separation_GroupType.md) | (Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Source](P_TFlex_Model_Model3D_Separation_Source.md) | Разделяемая операция |
