...
parameterSystemName [String](https://learn.microsoft.com/dotnet/api/system.string)
...
[Item - перегрузка](Overload_TFlex_Model_Structure_ElementType_Item.md)
