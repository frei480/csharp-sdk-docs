...
|  | Имя | Описание |
| --- | --- | --- |
|  | [DirectionalLight](M_TFlex_Model_Model3D_DirectionalLight__ctor.md) | Конструктор для направленного источника света |
...
|  | [Direction](P_TFlex_Model_Model3D_DirectionalLight_Direction.md) | **Устарело.** Точка задающая направление источника света |
