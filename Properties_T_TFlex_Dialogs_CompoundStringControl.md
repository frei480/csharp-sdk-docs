...
# CompoundStringControl - свойства  
  
---  
  
Тип [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md) предоставляет следующие члены.
...
[CompoundStringControl - ](T_TFlex_Dialogs_CompoundStringControl.md)
