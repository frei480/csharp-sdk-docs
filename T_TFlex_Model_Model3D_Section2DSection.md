...
# Section2DSection - класс  
    
Сечение по обозначению вида

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DSection3D](T_TFlex_Model_Model3D_Section3D.md) [TFlex.Model.Model3DModel2DSection](T_TFlex_Model_Model3D_Model2DSection.md) TFlex.Model.Model3DSection2DSection

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class Section2DSection : Model2DSection
```
```vb
Public Class Section2DSection
	Inherits Model2DSection
```
```cpp
public ref class Section2DSection : public Model2DSection
```


Тип Section2DSection предоставляет следующие члены.
...
|  | [Section2DSection(Document, Page)](M_TFlex_Model_Model3D_Section2DSection__ctor_1.md) | Конструктор для создания сечения по обозначению вида |
...
|  | [Geometry](P_TFlex_Model_Model3D_Section3D_Geometry.md) | Получить геометрические данные сечения(Унаследован от [Section3D](T_TFlex_Model_Model3D_Section3D.md)) |
|  | [GroupType](P_TFlex_Model_Model3D_Section3D_GroupType.md) | Тип объекта(Унаследован от [Section3D](T_TFlex_Model_Model3D_Section3D.md)) |
...
|  | [Orientation](P_TFlex_Model_Model3D_Section3D_Orientation.md) | Направление сечения(Унаследован от [Section3D](T_TFlex_Model_Model3D_Section3D.md)) |
|  | [Page](P_TFlex_Model_Model3D_Section3D_Page.md) | Страница(Унаследован от [Section3D](T_TFlex_Model_Model3D_Section3D.md)) |
...
|  | [Projection](P_TFlex_Model_Model3D_Model2DSection_Projection.md) | Проекция(Унаследован от [Model2DSection](T_TFlex_Model_Model3D_Model2DSection.md)) |
|  | [Section2D](P_TFlex_Model_Model3D_Section2DSection_Section2D.md) | Обозначение вида |
|  | [ShowOn3D](P_TFlex_Model_Model3D_Section3D_ShowOn3D.md) | Признак рисования сечения в 3D сцене(Унаследован от [Section3D](T_TFlex_Model_Model3D_Section3D.md)) |
...
|  | [UseColorFromBody](P_TFlex_Model_Model3D_Section3D_UseColorFromBody.md) | Признак использования цвета с тела(Унаследован от [Section3D](T_TFlex_Model_Model3D_Section3D.md)) |
...
|  | [Workplane](P_TFlex_Model_Model3D_Model2DSection_Workplane.md) | Рабочая плоскость(Унаследован от [Model2DSection](T_TFlex_Model_Model3D_Model2DSection.md)) |
