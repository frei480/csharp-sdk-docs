...
|  | [Curve](P_TFlex_Model_Model3D_Geometry_ModelEdge_Curve.md) | Получить кривую, на которой лежит ребро |
...
|  | [Faces](P_TFlex_Model_Model3D_Geometry_ModelEdge_Faces.md) | Множество смежных граней |
|  | [Geometry](P_TFlex_Model_Model3D_Geometry_ModelEdge_Geometry.md) | Получить геометрические данные ребра |
...
|  | [Interval](P_TFlex_Model_Model3D_Geometry_ModelEdge_Interval.md) | Получить интервал кривой на котором лежит ребро |
|  | [Loops](P_TFlex_Model_Model3D_Geometry_ModelEdge_Loops.md) | Множество смежных циклов |
...
|  | [Sense](P_TFlex_Model_Model3D_Geometry_ModelEdge_Sense.md) | Получить признак совпадения ориентации кривой и ребра |
...
|  | [Vertices](P_TFlex_Model_Model3D_Geometry_ModelEdge_Vertices.md) | Множество вершин, смежных ребру |
...
|  | [GetPolyline(Double, Double, Double)](M_TFlex_Model_Model3D_Geometry_ModelEdge_GetPolyline_1.md) | Полилиния |
