...
# ReferencePath - свойства  
    
Тип [ReferencePath](T_TFlex_Model_Model3D_ReferencePath.md) предоставляет следующие члены.
...
|  | [OriginalLayerName](P_TFlex_Model_Model3D_ReferencePath_OriginalLayerName.md) | Имя слоя, на котором объект лежит в документе фрагмента |
|  | [OriginalName](P_TFlex_Model_Model3D_ReferencePath_OriginalName.md) | Имя объекта в документе фрагмента |
|  | [Owner](P_TFlex_Model_Model3D_ReferencePath_Owner.md) | Владелец ссылочного объекта |
...
[ReferencePath - ](T_TFlex_Model_Model3D_ReferencePath.md)
