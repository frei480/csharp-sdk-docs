...
# LinearSizeManipulator - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.Visual.ManipulatorsManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_Manipulator.md) TFlex.Model.Model3D.Visual.ManipulatorsLinearSizeManipulator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LinearSizeManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator__ctor.md) | Инициализирует новый экземпляр класса LinearSizeManipulator |
...
|  | [GetCommitedLinearSize](M_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator_GetCommitedLinearSize.md) | Получить фиксированное значение линейного размера в модельных единицах |
...
|  | [GetPendingLinearSize](M_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator_GetPendingLinearSize.md) | Получить динамическое значение линейного размера в модельных единицах |
...
|  | [ResetLinearSize](M_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator_ResetLinearSize.md) | Перезадать линейный размер в модельных единицах |
|  | [SetAxis](M_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator_SetAxis.md) | Задать ось |
...
|  | [LinearSizeCommited](E_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator_LinearSizeCommited.md) |  |
|  | [LinearSizeEnqueued](E_TFlex_Model_Model3D_Visual_Manipulators_LinearSizeManipulator_LinearSizeEnqueued.md) |  |
