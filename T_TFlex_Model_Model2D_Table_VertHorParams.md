...
# TableVertHorParams - структура  
    
Значение, задаваемое по вертикали и по горизонтали

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model2DTableVertHorParams
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Horizontal](F_TFlex_Model_Model2D_Table_VertHorParams_Horizontal.md) | Горизонтальное значение |
|  | [Vertical](F_TFlex_Model_Model2D_Table_VertHorParams_Vertical.md) | Вертикальное значение |
