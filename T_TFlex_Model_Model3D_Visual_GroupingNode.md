...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.VisualSceneNode](T_TFlex_Model_Model3D_Visual_SceneNode.md) [TFlex.Model.Model3D.VisualGroup](T_TFlex_Model_Model3D_Visual_Group.md) TFlex.Model.Model3D.VisualGroupingNode
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [GroupingNode](M_TFlex_Model_Model3D_Visual_GroupingNode__ctor.md) | Конструктор |
...
При использовании этого класса эффект атрибутов и трансформаций сохраняется при выходе из группы. 
