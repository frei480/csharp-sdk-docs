...
|  | [GroupType](P_TFlex_Model_Model3D_WorkSurface_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Page](P_TFlex_Model_Model3D_WorkSurface_Page.md) | Страница |
...
|  | [ShowOn3D](P_TFlex_Model_Model3D_WorkSurface_ShowOn3D.md) | Признак рисования рабочей плоскости в 3D сцене |
