...
|  | Имя | Описание |
| --- | --- | --- |
|  | [MoveCopy](M_TFlex_Model_Model2D_MoveCopy__ctor.md) | Стандартный конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model2D_MoveCopy_Angle.md) | Угол поворота |
...
|  | [CopyType](P_TFlex_Model_Model2D_MoveCopy_CopyType.md) | Подтип объекта-копии(Переопределяет [CopyOperationCopyType](P_TFlex_Model_Model2D_CopyOperation_CopyType.md)) |
...
|  | [EndNode](P_TFlex_Model_Model2D_MoveCopy_EndNode.md) | Конечный узел, определяющий перемещение |
|  | [EndX](P_TFlex_Model_Model2D_MoveCopy_EndX.md) | X-координата конечной точки |
|  | [EndY](P_TFlex_Model_Model2D_MoveCopy_EndY.md) | Y-координата конечной точки |
...
|  | [Scale](P_TFlex_Model_Model2D_MoveCopy_Scale.md) | Масштаб |
...
|  | [StartNode](P_TFlex_Model_Model2D_MoveCopy_StartNode.md) | Начальный узел, определяющий перемещение |
|  | [StartX](P_TFlex_Model_Model2D_MoveCopy_StartX.md) | X-координата начальной точки |
|  | [StartY](P_TFlex_Model_Model2D_MoveCopy_StartY.md) | Y-координата начальной точки |
