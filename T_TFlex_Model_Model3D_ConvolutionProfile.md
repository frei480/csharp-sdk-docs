...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ConvolutionProfile](M_TFlex_Model_Model3D_ConvolutionProfile__ctor.md) | Конструктор для создания свёртки плоского профиля на поверхность |
...
|  | [ConvertToSpline](P_TFlex_Model_Model3D_Profile_ConvertToSpline.md) | Получить параметры для преобразования составных контуров профиля в сплайны(Унаследован от [Profile](T_TFlex_Model_Model3D_Profile.md)) |
|  | [ConvolutionSurface](P_TFlex_Model_Model3D_ConvolutionProfile_ConvolutionSurface.md) | Набор граней, образующих поверхность, на которую выполняется свёртка |
|  | [DirectionPointOnPlane](P_TFlex_Model_Model3D_ConvolutionProfile_DirectionPointOnPlane.md) | Вторая точка в плоскости сворачиваемго контура |
|  | [DirectionPointOnSurface](P_TFlex_Model_Model3D_ConvolutionProfile_DirectionPointOnSurface.md) | Вторая точка на поверхности |
...
|  | [Geometry](P_TFlex_Model_Model3D_Profile_Geometry.md) | Получить геометрические данные профиля(Унаследован от [Profile](T_TFlex_Model_Model3D_Profile.md)) |
|  | [GroupType](P_TFlex_Model_Model3D_Profile_GroupType.md) | Тип объекта(Унаследован от [Profile](T_TFlex_Model_Model3D_Profile.md)) |
...
|  | [Orientation](P_TFlex_Model_Model3D_ConvolutionProfile_Orientation.md) | Ориентация направления свёртки |
...
|  | [PlanarContour](P_TFlex_Model_Model3D_ConvolutionProfile_PlanarContour.md) | Сворачиваемый плоский контур |
|  | [StartPointOnPlane](P_TFlex_Model_Model3D_ConvolutionProfile_StartPointOnPlane.md) | Первая точка в плоскости сворачиваемго контура |
|  | [StartPointOnSurface](P_TFlex_Model_Model3D_ConvolutionProfile_StartPointOnSurface.md) | Первая точка на поверхности |
|  | [Thickness](P_TFlex_Model_Model3D_Profile_Thickness.md) | Получить свойства толщины(Унаследован от [Profile](T_TFlex_Model_Model3D_Profile.md)) |
...
|  | [Transparency](P_TFlex_Model_Model3D_Profile_Transparency.md) | Прозрачность(Унаследован от [Profile](T_TFlex_Model_Model3D_Profile.md)) |
