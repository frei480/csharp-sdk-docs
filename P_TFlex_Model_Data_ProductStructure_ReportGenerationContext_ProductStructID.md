...
# ReportGenerationContextProductStructID - свойство  
...
```csharp
public ulong ProductStructID { get; set; }
```
```vb
Public Property ProductStructID As ULong
	Get
	Set
```
```cpp
public:
property unsigned long long ProductStructID {
