...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSheetList
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SheetList](M_TFlex_Configuration_SheetList__ctor.md) | Инициализирует новый экземпляр класса SheetList |
|  | [SheetList(IntPtr, Boolean)](M_TFlex_Configuration_SheetList__ctor_1.md) | Инициализирует новый экземпляр класса SheetList |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Height](P_TFlex_Configuration_SheetList_Height.md) |  |
|  | [Name](P_TFlex_Configuration_SheetList_Name.md) |  |
|  | [Std](P_TFlex_Configuration_SheetList_Std.md) |  |
|  | [Width](P_TFlex_Configuration_SheetList_Width.md) |  |
|  | [Zones](P_TFlex_Configuration_SheetList_Zones.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_SheetList_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_SheetList_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_SheetList_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
