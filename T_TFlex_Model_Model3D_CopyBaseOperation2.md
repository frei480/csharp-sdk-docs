...
```csharp
public class CopyBaseOperation2 : Operation
```
```vb
Public Class CopyBaseOperation2
	Inherits Operation
```
```cpp
public ref class CopyBaseOperation2 : public Operation
```


Тип CopyBaseOperation2 предоставляет следующие члены.
...
|  | [Constructions](P_TFlex_Model_Model3D_CopyBaseOperation2_Constructions.md) | Коллекция копируемых элементов построения |
...
|  | [CopyMode](P_TFlex_Model_Model3D_CopyBaseOperation2_CopyMode.md) | Тип копирования |
...
|  | [Edges](P_TFlex_Model_Model3D_CopyBaseOperation2_Edges.md) | Коллекция рёбер, используемых для выбора копируемых граней |
...
|  | [Faces](P_TFlex_Model_Model3D_CopyBaseOperation2_Faces.md) | Коллекция копируемых граней |
...
|  | [IncludeInBom](P_TFlex_Model_Model3D_CopyBaseOperation2_IncludeInBom.md) | Включать в спецификацию |
...
|  | [Loops](P_TFlex_Model_Model3D_CopyBaseOperation2_Loops.md) | Коллекция циклов, используемых для выбора копируемых граней |
...
|  | [ObjectsType](P_TFlex_Model_Model3D_CopyBaseOperation2_ObjectsType.md) | Тип копируемых элементов |
|  | [Operations](P_TFlex_Model_Model3D_CopyBaseOperation2_Operations.md) | Коллекция копируемых операций |
...
|  | [IsModeAvailable](M_TFlex_Model_Model3D_CopyBaseOperation2_IsModeAvailable.md) | Определить, доступен ли указанный режим копирования для данной операции |
