...
# Fragment3DUpdateBillOfMaterialsOnAutoSave - свойство  
  **Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool UpdateBillOfMaterialsOnAutoSave { get; set; }
```
```vb
Public Property UpdateBillOfMaterialsOnAutoSave As Boolean
	Get
	Set
```
```cpp
public:
property bool UpdateBillOfMaterialsOnAutoSave {
	bool get ();
	void set (bool value);
}
```
