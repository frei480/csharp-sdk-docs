...
# ViewRulerContextMenuCommandEventArgs - класс  
  
---  
  
Класс, содержащий данные о событии - вызвана локальная команда из контекстного меню линейки вида

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemEventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) [TFlexPluginEventArgs](T_TFlex_PluginEventArgs.md) [TFlexDocumentEventArgs](T_TFlex_DocumentEventArgs.md) TFlexViewRulerContextMenuCommandEventArgs
...
|  | [Command](P_TFlex_ViewRulerContextMenuCommandEventArgs_Command.md) | Идентификатор команды |
