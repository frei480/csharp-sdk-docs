...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model2DBomGroup
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ID](P_TFlex_Model_Model2D_BomGroup_ID.md) | Идентификатор |
|  | [Name](P_TFlex_Model_Model2D_BomGroup_Name.md) | Наименование раздела |
|  | [ParentID](P_TFlex_Model_Model2D_BomGroup_ParentID.md) | Идентификатор родительского раздела |
