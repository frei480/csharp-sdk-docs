...
# SheetMetalFeature - класс  
  
---  
  
Операция "Выштамповка"

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSheetMetalFeature
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SheetMetalFeature](M_TFlex_Model_Model3D_SheetMetalFeature__ctor.md) | Конструктор для операции "Выштамповка" |
...
|  | [Contour](P_TFlex_Model_Model3D_SheetMetalFeature_Contour.md) | Контур |
...
|  | [FileName](P_TFlex_Model_Model3D_SheetMetalFeature_FileName.md) | Имя файла штамповки |
...
|  | [GroupType](P_TFlex_Model_Model3D_SheetMetalFeature_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [PathName](P_TFlex_Model_Model3D_SheetMetalFeature_PathName.md) | Получить путь к файлу |
