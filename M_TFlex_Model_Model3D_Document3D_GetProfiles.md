...
# Document3DGetProfiles - метод  
    
Контейнер 3D профилей
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Profile](T_TFlex_Model_Model3D_Profile.md)
