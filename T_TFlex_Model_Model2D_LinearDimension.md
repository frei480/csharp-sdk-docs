...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LinearDimension](M_TFlex_Model_Model2D_LinearDimension__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model2D_LinearDimensionBase_Accuracy.md) | Точность(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltAccuracy](P_TFlex_Model_Model2D_LinearDimensionBase_AltAccuracy.md) | Точность для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltLocation](P_TFlex_Model_Model2D_LinearDimensionBase_AltLocation.md) | Расположение альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltMinDigits](P_TFlex_Model_Model2D_LinearDimensionBase_AltMinDigits.md) | Минимальное количество знаков после запятой для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltScaleFactor](P_TFlex_Model_Model2D_LinearDimensionBase_AltScaleFactor.md) | Величина дополнительного масштабирования альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltScaleFactorType](P_TFlex_Model_Model2D_LinearDimensionBase_AltScaleFactorType.md) | Тип дополнительного масштабирования альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltSeparator](P_TFlex_Model_Model2D_LinearDimensionBase_AltSeparator.md) | Тип разделителя для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTextAfter](P_TFlex_Model_Model2D_LinearDimensionBase_AltTextAfter.md) | Текст после числа альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTextBefore](P_TFlex_Model_Model2D_LinearDimensionBase_AltTextBefore.md) | Текст перед числом альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTextParameters](P_TFlex_Model_Model2D_LinearDimensionBase_AltTextParameters.md) | Параметры для отображения в тексте альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTolerLetters](P_TFlex_Model_Model2D_LinearDimensionBase_AltTolerLetters.md) | Поле допуска с квалитетом для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTolerLowerDev](P_TFlex_Model_Model2D_LinearDimensionBase_AltTolerLowerDev.md) | Величина нижнего отклонения допуска для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTolerType](P_TFlex_Model_Model2D_LinearDimensionBase_AltTolerType.md) | Тип задания допуска для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltTolerUpperDev](P_TFlex_Model_Model2D_LinearDimensionBase_AltTolerUpperDev.md) | Величина верхнего отклонения допуска для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [AltUnits](P_TFlex_Model_Model2D_LinearDimensionBase_AltUnits.md) | Единицы измерения для альтернативного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [Dual](P_TFlex_Model_Model2D_LinearDimensionBase_Dual.md) | Режим отображения двойного размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [EndArrowSize](P_TFlex_Model_Model2D_LinearDimensionBase_EndArrowSize.md) | Размер конечной стрелки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [EndArrowType](P_TFlex_Model_Model2D_LinearDimensionBase_EndArrowType.md) | Тип конечной стрелки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [ExtOffset](P_TFlex_Model_Model2D_LinearDimensionBase_ExtOffset.md) | Величина смещения выносных линий(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [FitLetters](P_TFlex_Model_Model2D_LinearDimensionBase_FitLetters.md) | Поле посадки с квалитетом(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [FitLowerDev](P_TFlex_Model_Model2D_LinearDimensionBase_FitLowerDev.md) | Величина нижнего отклонения посадки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [FitUpperDev](P_TFlex_Model_Model2D_LinearDimensionBase_FitUpperDev.md) | Величина верхнего отклонения посадки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [FitView](P_TFlex_Model_Model2D_LinearDimensionBase_FitView.md) | Вид посадки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [Leader](P_TFlex_Model_Model2D_LinearDimensionBase_Leader.md) | Параметр отображения размера с выносной полкой(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [LinearDimType](P_TFlex_Model_Model2D_LinearDimension_LinearDimType.md) | Подтип размера |
|  | [LinesType](P_TFlex_Model_Model2D_LinearDimensionBase_LinesType.md) | Режим отображения размерных и выносных линий(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [LinkedEnd](P_TFlex_Model_Model2D_LinearDimension_LinkedEnd.md) | Конечный объект привязки размера |
|  | [LinkedStart](P_TFlex_Model_Model2D_LinearDimension_LinkedStart.md) | Начальный объект привязки размера |
...
|  | [MinDigits](P_TFlex_Model_Model2D_LinearDimensionBase_MinDigits.md) | Минимальное число знаков после запятой(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [OutsideArrows](P_TFlex_Model_Model2D_LinearDimensionBase_OutsideArrows.md) | Состояние флага отображения стрелок с внешней стороны(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [PlaceFit](P_TFlex_Model_Model2D_LinearDimensionBase_PlaceFit.md) | Параметр отображения посадки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [PrefixSymbol](P_TFlex_Model_Model2D_LinearDimensionBase_PrefixSymbol.md) | Символ перед размерным числом(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [ScaleFactor](P_TFlex_Model_Model2D_LinearDimensionBase_ScaleFactor.md) | Величина дополнительного масштабирования размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [ScaleFactorType](P_TFlex_Model_Model2D_LinearDimensionBase_ScaleFactorType.md) | Тип дополнительного масштабирования размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [Standard](P_TFlex_Model_Model2D_LinearDimensionBase_Standard.md) | Тип стандарта размера(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [StartArrowSize](P_TFlex_Model_Model2D_LinearDimensionBase_StartArrowSize.md) | Размер начальной стрелки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [StartArrowType](P_TFlex_Model_Model2D_LinearDimensionBase_StartArrowType.md) | Тип начальной стрелки(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [StringsOffset](P_TFlex_Model_Model2D_LinearDimensionBase_StringsOffset.md) | Величина смещения строк от размерной линии(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [SubType](P_TFlex_Model_Model2D_LinearDimension_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [TolerAutomatic](P_TFlex_Model_Model2D_LinearDimensionBase_TolerAutomatic.md) | Параметр автоматического расчёта допуска(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [TolerLetters](P_TFlex_Model_Model2D_LinearDimensionBase_TolerLetters.md) | Поле допуска с квалитетом(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [TolerLowerDev](P_TFlex_Model_Model2D_LinearDimensionBase_TolerLowerDev.md) | Величина нижнего отклонения допуска(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [TolerSize](P_TFlex_Model_Model2D_LinearDimensionBase_TolerSize.md) | Тип отображения допуска(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [TolerUpperDev](P_TFlex_Model_Model2D_LinearDimensionBase_TolerUpperDev.md) | Величина верхнего отклонения допуска(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
|  | [Units](P_TFlex_Model_Model2D_LinearDimensionBase_Units.md) | Единицы измерения(Унаследован от [LinearDimensionBase](T_TFlex_Model_Model2D_LinearDimensionBase.md)) |
...
|  | [ForceCenter](M_TFlex_Model_Model2D_LinearDimension_ForceCenter.md) | Принудительное центрирование размера |
...
|  | [Link](M_TFlex_Model_Model2D_LinearDimension_Link.md) | Привязать размер к объектам |
...
|  | [SetArcLength](M_TFlex_Model_Model2D_LinearDimension_SetArcLength.md) | Установка параметров размера - длины дуги |
|  | [SetConstructionAndNode](M_TFlex_Model_Model2D_LinearDimension_SetConstructionAndNode.md) | Установка параметров размера между линией построения и узлом |
|  | [SetConstructionAndOutline](M_TFlex_Model_Model2D_LinearDimension_SetConstructionAndOutline.md) | Установка параметров размера между линией построения и линией изображения |
...
|  | [SetLeaderNote](M_TFlex_Model_Model2D_LinearDimension_SetLeaderNote.md) | Установка привязок размера к узлам, либо по относительным смещениям |
|  | [SetOffsets](M_TFlex_Model_Model2D_LinearDimension_SetOffsets.md) | Установка привязок размера к узлам, либо по относительным смещениям |
|  | [SetOutlineAndNode](M_TFlex_Model_Model2D_LinearDimension_SetOutlineAndNode.md) | Установка параметров размера между линией изображения и узлом |
...
|  | [SetSegment](M_TFlex_Model_Model2D_LinearDimension_SetSegment.md) | Установка параметров размера на отрезке |
|  | [SetTwoConstructions](M_TFlex_Model_Model2D_LinearDimension_SetTwoConstructions.md) | Установка параметров размера между двумя линиями построения |
|  | [SetTwoNodes](M_TFlex_Model_Model2D_LinearDimension_SetTwoNodes.md) | Установка параметров размера между двумя узлами |
|  | [SetTwoNodesAndLine](M_TFlex_Model_Model2D_LinearDimension_SetTwoNodesAndLine.md) | Установка параметров размера между двумя узлами, перпендикулярно линии |
|  | [SetTwoOutlines](M_TFlex_Model_Model2D_LinearDimension_SetTwoOutlines.md) | Установка параметров размера между двумя линиями изображения |
