...
# ChainsAndSignals - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationChainsAndSignals
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ChainsAndSignals](M_TFlex_Configuration_ChainsAndSignals__ctor.md) | Инициализирует новый экземпляр класса ChainsAndSignals |
|  | [ChainsAndSignals(IntPtr, Boolean)](M_TFlex_Configuration_ChainsAndSignals__ctor_1.md) | Инициализирует новый экземпляр класса ChainsAndSignals |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [InheritChainsWhenInsertComponent](P_TFlex_Configuration_ChainsAndSignals_InheritChainsWhenInsertComponent.md) |  |
|  | [SolvingConflictsWhenConnectLines](P_TFlex_Configuration_ChainsAndSignals_SolvingConflictsWhenConnectLines.md) |  |
|  | [UniqueChainForNewSocketConnection](P_TFlex_Configuration_ChainsAndSignals_UniqueChainForNewSocketConnection.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_ChainsAndSignals_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_ChainsAndSignals_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_ChainsAndSignals_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
