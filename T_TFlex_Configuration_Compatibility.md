...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationCompatibility
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Compatibility](M_TFlex_Configuration_Compatibility__ctor.md) | Инициализирует новый экземпляр класса Compatibility |
|  | [Compatibility(IntPtr, Boolean)](M_TFlex_Configuration_Compatibility__ctor_1.md) | Инициализирует новый экземпляр класса Compatibility |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [SyncFragmentsWithDOCs](P_TFlex_Configuration_Compatibility_SyncFragmentsWithDOCs.md) |  |
|  | [UseVariablesInDbSearch](P_TFlex_Configuration_Compatibility_UseVariablesInDbSearch.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Compatibility_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Compatibility_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Compatibility_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
