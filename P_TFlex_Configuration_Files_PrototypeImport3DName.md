...
# FilesPrototypeImport3DName - свойство  
  
---  
**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public string PrototypeImport3DName { get; set; }
```
```vb
Public Property PrototypeImport3DName As String
	Get
	Set
```
```cpp
public:
property String^ PrototypeImport3DName {
	String^ get ();
