...
# ModelCylinderSurface - свойства  
  
---  
  
Тип [ModelCylinderSurface](T_TFlex_Model_Model3D_Geometry_ModelCylinderSurface.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Axis](P_TFlex_Model_Model3D_Geometry_ModelCylinderSurface_Axis.md) | Получить ось симметрии |
...
|  | [Radius](P_TFlex_Model_Model3D_Geometry_ModelCylinderSurface_Radius.md) | Получить радиус основания |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Geometry_ModelCylinderSurface_ReferenceDirection.md) | Получить полуось основания, от которой откладывается угол |
...
[ModelCylinderSurface - ](T_TFlex_Model_Model3D_Geometry_ModelCylinderSurface.md)
