...
# RotationManipulator - класс  
  
---  
  
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.Visual.ManipulatorsManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_Manipulator.md) TFlex.Model.Model3D.Visual.ManipulatorsRotationManipulator
...
```
```cpp
public ref class RotationManipulator : public Manipulator
```


Тип RotationManipulator предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [RotationManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator__ctor.md) | Инициализирует новый экземпляр класса RotationManipulator |
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_Dispose.md) | Освобождает неуправляемые ресурсы, используемые объектом RotationManipulator, а при необходимости освобождает также управляемые ресурсы(Переопределяет [ManipulatorDispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_Manipulator_Dispose_1.md)) |
...
|  | [GetCommitedAngle](M_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_GetCommitedAngle.md) | Получить фиксированное значение угла в градусах |
...
|  | [GetPendingAngle](M_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_GetPendingAngle.md) | Получить динамическое значение угла в градусах |
...
|  | [ResetAngle](M_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_ResetAngle.md) | Перезадать значение угла в градусах |
...
|  | [SetAxis](M_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_SetAxis.md) | Задать ось |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AngleCommited](E_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_AngleCommited.md) |  |
|  | [AngleEnqueued](E_TFlex_Model_Model3D_Visual_Manipulators_RotationManipulator_AngleEnqueued.md) |  |
