...
|  | Имя | Описание |
| --- | --- | --- |
|  | [NodeArrayOperation(Document)](M_TFlex_Model_Model3D_NodeArrayOperation__ctor.md) | Конструктор для операции "Массив по точкам" |
|  | [NodeArrayOperation(Document, ArrayOperationType)](M_TFlex_Model_Model3D_NodeArrayOperation__ctor_1.md) | Конструктор для операции "Массив по точкам" |
...
|  | [GroupType](P_TFlex_Model_Model3D_NodeArrayOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [SourcePoint](P_TFlex_Model_Model3D_NodeArrayOperation_SourcePoint.md) | Исходная точка |
...
|  | [TargetPointCount](P_TFlex_Model_Model3D_NodeArrayOperation_TargetPointCount.md) | Получить количество целевых точек массива |
|  | [TargetPoints](P_TFlex_Model_Model3D_NodeArrayOperation_TargetPoints.md) | Получить перечисление базовых элементов для построения массива |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddTargetPoint](M_TFlex_Model_Model3D_NodeArrayOperation_AddTargetPoint.md) | Добавить целевую точку для построения массива |
...
|  | [GetTargetPoint](M_TFlex_Model_Model3D_NodeArrayOperation_GetTargetPoint.md) | Получить целевую точку массива по номеру |
...
|  | [RemoveTargetPoint](M_TFlex_Model_Model3D_NodeArrayOperation_RemoveTargetPoint.md) | Удалить целевую точку по индексу |
