...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LoftEndProfileCondition](M_TFlex_Model_Model3D_Loft_EndProfileCondition__ctor.md) | Инициализирует новый экземпляр класса LoftEndProfileCondition |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Type](P_TFlex_Model_Model3D_Loft_EndProfileCondition_Type.md) | Получить тип граничного условия |
