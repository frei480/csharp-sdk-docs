...
# FilesPrototype3DAssemblyName - свойство  
  
---  
**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public string Prototype3DAssemblyName { get; set; }
```
```vb
Public Property Prototype3DAssemblyName As String
	Get
	Set
```
```cpp
public:
property String^ Prototype3DAssemblyName {
	String^ get ();
