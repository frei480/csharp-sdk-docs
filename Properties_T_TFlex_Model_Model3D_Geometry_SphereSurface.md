...
# SphereSurface - свойства  
    
Тип [SphereSurface](T_TFlex_Model_Model3D_Geometry_SphereSurface.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Center](P_TFlex_Model_Model3D_Geometry_SphereSurface_Center.md) | Центр сферы |
|  | [Normal](P_TFlex_Model_Model3D_Geometry_SphereSurface_Normal.md) | Нормаль к плоскости в которой откладываются углы |
...
|  | [Radius](P_TFlex_Model_Model3D_Geometry_SphereSurface_Radius.md) | Радиус сферы |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Geometry_SphereSurface_ReferenceDirection.md) | Полуось основания, от которой откладываются углы |
