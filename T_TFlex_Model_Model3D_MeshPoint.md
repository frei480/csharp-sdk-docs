...
|  | [Coords](P_TFlex_Model_Model3D_MeshPoint_Coords.md) | Получить координаты точки |
...
|  | [Geometry](P_TFlex_Model_Model3D_Node3D_Geometry.md) | Получить геометрические данные точки(Унаследован от [Node3D](T_TFlex_Model_Model3D_Node3D.md)) |
|  | [GroupType](P_TFlex_Model_Model3D_MeshPoint_GroupType.md) | Тип объекта(Переопределяет [Node3DGroupType](P_TFlex_Model_Model3D_Node3D_GroupType.md)) |
|  | [HandleForSelection](P_TFlex_Model_Model3D_MeshPoint_HandleForSelection.md) | Для внутреннего использования(Переопределяет ModelObject.HandleForSelection) |
...
|  | [Plane1](P_TFlex_Model_Model3D_MeshPoint_Plane1.md) | Первая плоскость(Переопределяет [ThreePlanesPointPlane1](P_TFlex_Model_Model3D_ThreePlanesPoint_Plane1.md)) |
|  | [Plane2](P_TFlex_Model_Model3D_MeshPoint_Plane2.md) | Вторая плоскость(Переопределяет [ThreePlanesPointPlane2](P_TFlex_Model_Model3D_ThreePlanesPoint_Plane2.md)) |
|  | [Plane3](P_TFlex_Model_Model3D_MeshPoint_Plane3.md) | Третья плоскость(Переопределяет [ThreePlanesPointPlane3](P_TFlex_Model_Model3D_ThreePlanesPoint_Plane3.md)) |
...
|  | [Create(DictionaryWorkplane, Workplane)](M_TFlex_Model_Model3D_MeshPoint_Create_1.md) |  |
...
|  | [IsTemporaryObject](M_TFlex_Model_Model3D_MeshPoint_IsTemporaryObject.md) | (Переопределяет [ModelObjectIsTemporaryObject](M_TFlex_Model_ModelObject_IsTemporaryObject.md)) |
...
Это временный объект. Узел нельзя явно создать и использовать как родителя для других объектов. Он возвращается при селекции на сетке точек пересечения рабочих плоскостей
