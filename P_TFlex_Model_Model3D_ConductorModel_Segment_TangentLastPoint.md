...
# SegmentTangentLastPoint - свойство  
...
```csharp
public Parameter TangentLastPoint { get; set; }
```
```vb
Public Property TangentLastPoint As Parameter
	Get
	Set
```
```cpp
public:
property Parameter^ TangentLastPoint {
	Parameter^ get ();
