...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Data](P_TFlex_Model_Model3D_Geometry_ModelSplineSurface_Data.md) | Получить описание сплайновой поверхности |
...
|  | [Splinewise](P_TFlex_Model_Model3D_Geometry_ModelSplineSurface_Splinewise.md) | Получить описание интерполяционной сплайновой поверхности по набору точек, через которые проходит сплайновая поверхность, по параметрам поверхности в этих точках и условиям на концах |
...
|  | [Piecewise](M_TFlex_Model_Model3D_Geometry_ModelSplineSurface_Piecewise.md) | Получить описание сплайновой поверхности по набору сегментов |
