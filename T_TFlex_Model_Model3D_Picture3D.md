...
|  | [Picture3D(FileLink)](M_TFlex_Model_Model3D_Picture3D__ctor_1.md) | Конструктор с именем файла картинки |
...
|  | [FileLink](P_TFlex_Model_Model3D_Picture3D_FileLink.md) | Ссылка на файл картинки |
|  | [FileName](P_TFlex_Model_Model3D_Picture3D_FileName.md) | Имя файла 3D изображения |
|  | [Fixing](P_TFlex_Model_Model3D_Picture3D_Fixing.md) | Получить способ привязки 3D изображения |
|  | [GroupType](P_TFlex_Model_Model3D_Picture3D_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [PathName](P_TFlex_Model_Model3D_Picture3D_PathName.md) | Получить путь к файлу 3D изображения |
|  | [SourceLCSName](P_TFlex_Model_Model3D_Picture3D_SourceLCSName.md) | Получить имя системы координат созданной в документе фрагмента, используемой для привязки 3D изображения |
|  | [TargetLCS](P_TFlex_Model_Model3D_Picture3D_TargetLCS.md) | Получить целевую систему координат созданную в документе сборки, используемую для привязки 3D изображения |
...
|  | [Workplane](P_TFlex_Model_Model3D_Picture3D_Workplane.md) | Получить рабочую плоскость, используемую для привязки 3D изображения |
...
|  | [FixByPictureLCS](M_TFlex_Model_Model3D_Picture3D_FixByPictureLCS.md) | Привязать 3D изображение по системе координат созданной в документе фрагмента в систему координат сборки |
|  | [FixByWorkplane](M_TFlex_Model_Model3D_Picture3D_FixByWorkplane.md) | Привязать 3D изображение по расположению соответствующего 2D фрагмента на Рабочей плоскости |
