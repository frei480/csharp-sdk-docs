...
# SimpleDrawingProjection - класс  
    
Класс стандартных видов проекций 

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DProjection](T_TFlex_Model_Model3D_Projection.md) TFlex.Model.Model3DSimpleDrawingProjection [TFlex.Model.Model3DArrowProjection](T_TFlex_Model_Model3D_ArrowProjection.md) [TFlex.Model.Model3DLocalSectionProjection](T_TFlex_Model_Model3D_LocalSectionProjection.md) [TFlex.Model.Model3DNonStandardProjection](T_TFlex_Model_Model3D_NonStandardProjection.md) [TFlex.Model.Model3DProjectionWithSection](T_TFlex_Model_Model3D_ProjectionWithSection.md)

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class SimpleDrawingProjection : Projection
```
```vb
Public Class SimpleDrawingProjection
	Inherits Projection
```
```cpp
public ref class SimpleDrawingProjection : public Projection
```


Тип SimpleDrawingProjection предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [SimpleDrawingProjection(Document)](M_TFlex_Model_Model3D_SimpleDrawingProjection__ctor.md) | Конструктор для создания новой проекции |
|  | [SimpleDrawingProjection(Document, Page)](M_TFlex_Model_Model3D_SimpleDrawingProjection__ctor_1.md) | Конструктор для создания новой проекции |
...
|  | [AxisCreate](P_TFlex_Model_Model3D_SimpleDrawingProjection_AxisCreate.md) | Признак режима создания осей |
|  | [AxisLineColor](P_TFlex_Model_Model3D_SimpleDrawingProjection_AxisLineColor.md) | Цвет осевых линий |
|  | [AxisLineName](P_TFlex_Model_Model3D_SimpleDrawingProjection_AxisLineName.md) | Имя типа осевых линий |
|  | [AxisLineScale](P_TFlex_Model_Model3D_SimpleDrawingProjection_AxisLineScale.md) | Масштаб осевых линий |
|  | [AxisLineWidth](P_TFlex_Model_Model3D_SimpleDrawingProjection_AxisLineWidth.md) | Толщина осевых линий |
...
|  | [ConvertPolylinesToSplines](P_TFlex_Model_Model3D_SimpleDrawingProjection_ConvertPolylinesToSplines.md) | Признак режима конвертации полилиний в сплайны |
|  | [CreateHidden](P_TFlex_Model_Model3D_SimpleDrawingProjection_CreateHidden.md) | Признак режима создания изображений с невидимыми линиями |
|  | [CreateSection](P_TFlex_Model_Model3D_SimpleDrawingProjection_CreateSection.md) | Признак режима создания изображений с линиями сечений |
|  | [CreateTangentEdges](P_TFlex_Model_Model3D_SimpleDrawingProjection_CreateTangentEdges.md) | Режим создания изображений с показом гладких сопряжений |
|  | [CreateThreads](P_TFlex_Model_Model3D_SimpleDrawingProjection_CreateThreads.md) | Признак режима создания изображений резьб |
...
|  | [Explode](P_TFlex_Model_Model3D_SimpleDrawingProjection_Explode.md) | Признак режима разборки |
...
|  | [HiddenLineColor](P_TFlex_Model_Model3D_SimpleDrawingProjection_HiddenLineColor.md) | Цвет невидимых линий |
|  | [HiddenLineWidth](P_TFlex_Model_Model3D_SimpleDrawingProjection_HiddenLineWidth.md) | Толщина невидимых линий |
...
|  | [Monochrome](P_TFlex_Model_Model3D_SimpleDrawingProjection_Monochrome.md) | Признак использования одного цвета на всей проекции |
...
|  | [OverlapBodies](P_TFlex_Model_Model3D_SimpleDrawingProjection_OverlapBodies.md) | Режим учёта перекрытия тел при проецировании |
...
|  | [Perspective](P_TFlex_Model_Model3D_SimpleDrawingProjection_Perspective.md) | Перспективная проекция |
|  | [ProjectionClass](P_TFlex_Model_Model3D_SimpleDrawingProjection_ProjectionClass.md) | Тип проекции |
|  | [ProjectPrecision](P_TFlex_Model_Model3D_SimpleDrawingProjection_ProjectPrecision.md) | Получить значение точности проецирования |
|  | [RecognizeCircles](P_TFlex_Model_Model3D_SimpleDrawingProjection_RecognizeCircles.md) | Признак режима распознавания дуг окружностей |
|  | [RecognizeLines](P_TFlex_Model_Model3D_SimpleDrawingProjection_RecognizeLines.md) | Признак режима распознавания отрезков |
|  | [RegenerationMode](P_TFlex_Model_Model3D_SimpleDrawingProjection_RegenerationMode.md) | Режим регенерации проекции |
...
|  | [SmoothLineColor](P_TFlex_Model_Model3D_SimpleDrawingProjection_SmoothLineColor.md) | Цвет линий гладких сопряжений |
|  | [SmoothLineName](P_TFlex_Model_Model3D_SimpleDrawingProjection_SmoothLineName.md) | Имя типа видимых линий гладких сопряжений |
|  | [SmoothLineScale](P_TFlex_Model_Model3D_SimpleDrawingProjection_SmoothLineScale.md) | Масштаб линий гладких сопряжений |
|  | [SmoothLineWidth](P_TFlex_Model_Model3D_SimpleDrawingProjection_SmoothLineWidth.md) | Толщина линий гладких сопряжений |
...
|  | [ThreadLineColor](P_TFlex_Model_Model3D_SimpleDrawingProjection_ThreadLineColor.md) | Цвет линий резьбы |
|  | [ThreadLineName](P_TFlex_Model_Model3D_SimpleDrawingProjection_ThreadLineName.md) | Имя типа линий резьбы |
|  | [ThreadLineScale](P_TFlex_Model_Model3D_SimpleDrawingProjection_ThreadLineScale.md) | Масштаб линий резьбы |
|  | [ThreadLineWidth](P_TFlex_Model_Model3D_SimpleDrawingProjection_ThreadLineWidth.md) | Толщина линий резьбы |
...
|  | [VisibleLineColor](P_TFlex_Model_Model3D_SimpleDrawingProjection_VisibleLineColor.md) | Цвет видимых линий |
|  | [VisibleLineName](P_TFlex_Model_Model3D_SimpleDrawingProjection_VisibleLineName.md) | Имя типа видимых линий |
|  | [VisibleLineScale](P_TFlex_Model_Model3D_SimpleDrawingProjection_VisibleLineScale.md) | Масштаб видимых линий |
|  | [VisibleLineWidth](P_TFlex_Model_Model3D_SimpleDrawingProjection_VisibleLineWidth.md) | Толщина видимых линий |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddBody](M_TFlex_Model_Model3D_SimpleDrawingProjection_AddBody.md) | Добавить операцию как тело для проецирования |
...
|  | [AddOperation](M_TFlex_Model_Model3D_SimpleDrawingProjection_AddOperation.md) | Добавить операцию для проецирования |
...
|  | [CreateLegacy](M_TFlex_Model_Model3D_SimpleDrawingProjection_CreateLegacy.md) |  |
...
|  | [GetEdgeMode](M_TFlex_Model_Model3D_SimpleDrawingProjection_GetEdgeMode.md) | Опрос режима отрисовки рёбер в растровых проекциях |
...
|  | [GetOutlineMode](M_TFlex_Model_Model3D_SimpleDrawingProjection_GetOutlineMode.md) | Опрос режима отрисовки очерка в растровых проекциях |
...
|  | [RemoveAllOperations](M_TFlex_Model_Model3D_SimpleDrawingProjection_RemoveAllOperations.md) | Сбросить все проецируемые операции |
