...
# ThreeFaceBlendGenerator - методы  
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_ThreeFaceBlendGenerator_Dispose.md) | (Переопределяет [BaseGeneratorDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Dispose_1.md)) |
