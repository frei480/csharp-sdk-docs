...
Класс перспективной камеры

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DCamera](T_TFlex_Model_Model3D_Camera.md) TFlex.Model.Model3DPerspectiveCamera
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PerspectiveCamera](M_TFlex_Model_Model3D_PerspectiveCamera__ctor.md) | Конструктор для перспективной камеры |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Active](P_TFlex_Model_Model3D_Camera_Active.md) | Активна ли камера(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AutoClip](P_TFlex_Model_Model3D_Camera_AutoClip.md) | **Устарело.** Включен или нет режим автоматической обрезки(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_Camera_GroupType.md) | (Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [HeightAngle](P_TFlex_Model_Model3D_PerspectiveCamera_HeightAngle.md) | Высотный угол камеры |
...
|  | [NearDistance](P_TFlex_Model_Model3D_Camera_NearDistance.md) | **Устарело.** Растояние до ближней плоскости отсечения(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
...
|  | [OffsetX](P_TFlex_Model_Model3D_Camera_OffsetX.md) | **Устарело.** Смещение по оси X(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [OffsetY](P_TFlex_Model_Model3D_Camera_OffsetY.md) | **Устарело.** Смещение по оси Y(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [OffsetZ](P_TFlex_Model_Model3D_Camera_OffsetZ.md) | **Устарело.** Смещение по оси Z(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [OriginLCS](P_TFlex_Model_Model3D_Camera_OriginLCS.md) | **Устарело.** Система координат камеры(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
...
|  | [RotateOrder](P_TFlex_Model_Model3D_Camera_RotateOrder.md) | **Устарело.** Порядок применения поворотов(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [RotateX](P_TFlex_Model_Model3D_Camera_RotateX.md) | **Устарело.** Поворот вокруг оси X(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [RotateY](P_TFlex_Model_Model3D_Camera_RotateY.md) | **Устарело.** Поворот вокруг оси Y(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
|  | [RotateZ](P_TFlex_Model_Model3D_Camera_RotateZ.md) | **Устарело.** Поворот вокруг оси Z(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
...
|  | [Walk](P_TFlex_Model_Model3D_Camera_Walk.md) | **Устарело.** Находится ли камера в режиме прогулки(Унаследован от [Camera](T_TFlex_Model_Model3D_Camera.md)) |
