...
# AggregateMultilineTextExtensionAddMultilineText - метод  
    
Аггрегировать новый многострочный текст

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public static int AddMultilineText(
...
A_0 [ModelObject](T_TFlex_Model_ModelObject.md)
    

#### Возвращаемое значение

[Int32](https://learn.microsoft.com/dotnet/api/system.int32)Индекс нового многострочного текста
