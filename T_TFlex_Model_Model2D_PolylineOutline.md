...
# PolylineOutline - класс  
    
Линия изображения заданная геометрией

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DPolylineOutline
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PolylineOutline](M_TFlex_Model_Model2D_PolylineOutline__ctor.md) | Конструктор, задающий узлы, между которыми пройдет линия, и линию построения |
...
|  | [GeometryType](P_TFlex_Model_Model2D_PolylineOutline_GeometryType.md) | Тип геометрии линии изображения(Переопределяет [OutlineGeometryType](P_TFlex_Model_Model2D_Outline_GeometryType.md)) |
