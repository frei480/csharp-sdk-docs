...
Операция перемещения граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFaceTransform
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FaceTransform](M_TFlex_Model_Model3D_FaceTransform__ctor.md) | Конструктор для создания операция "Разбиение граней" |
...
|  | [Faces](P_TFlex_Model_Model3D_FaceTransform_Faces.md) | Перемещаемые грани |
|  | [FacesTransformation](P_TFlex_Model_Model3D_FaceTransform_FacesTransformation.md) | Трансформация |
...
|  | [GroupType](P_TFlex_Model_Model3D_FaceTransform_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Transformation](P_TFlex_Model_Model3D_FaceTransform_Transformation.md) | **Устарело.** Трансформация |
