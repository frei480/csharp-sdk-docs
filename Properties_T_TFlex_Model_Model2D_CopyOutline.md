...
# CopyOutline - свойства  
    
Тип [CopyOutline](T_TFlex_Model_Model2D_CopyOutline.md) предоставляет следующие члены.
...
[CopyOutline - ](T_TFlex_Model_Model2D_CopyOutline.md)
