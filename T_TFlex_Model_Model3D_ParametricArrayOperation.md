...
# ParametricArrayOperation - класс  
  
---  
  
Параметрический массив

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DParametricArrayOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ParametricArrayOperation](M_TFlex_Model_Model3D_ParametricArrayOperation__ctor.md) | Конструктор для операции "Параметрический массив" |
...
|  | [GeneratrixOperation](P_TFlex_Model_Model3D_ParametricArrayOperation_GeneratrixOperation.md) | Образующая операция |
...
|  | [GroupType](P_TFlex_Model_Model3D_ParametricArrayOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Parametric](P_TFlex_Model_Model3D_ParametricArrayOperation_Parametric.md) | Общие свойства параметрических объектов |
|  | [ParamType](P_TFlex_Model_Model3D_ParametricArrayOperation_ParamType.md) | Cпособ задания параметризации |
...
В текущей версии можно копировать только операции
