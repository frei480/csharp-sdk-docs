...
|  | [SplineCurve(SplineData)](M_TFlex_Model_Model3D_Geometry_SplineCurve__ctor_1.md) | Создание сплайна по набору контрольных точек, весов и последовательности узлов параметризации |
|  | [SplineCurve(SplinewiseData)](M_TFlex_Model_Model3D_Geometry_SplineCurve__ctor_2.md) | Создание интерполяционного сплайна по набору точек, через которые проходит сплайн, по параметрам кривой в этих точках и условиям на концах |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Data](P_TFlex_Model_Model3D_Geometry_SplineCurve_Data.md) | Описание сплайна |
...
|  | [Splinewise](P_TFlex_Model_Model3D_Geometry_SplineCurve_Splinewise.md) | Описание интерполяционного сплайна по набору точек, через которые проходит сплайн, по параметрам кривой в этих точках и условиям на концах |
...
|  | [Piecewise](M_TFlex_Model_Model3D_Geometry_SplineCurve_Piecewise.md) | Описание сплайна по набору сегментов |
...
|  | [SetPiecewise](M_TFlex_Model_Model3D_Geometry_SplineCurve_SetPiecewise.md) | Установить описание сплайна по набору сегментов |
