...
# StandardColorsFaceEdgeMark2 - свойство  
  
---  
  
Цвет пометки рёбер грани 2

**Пространство имён:** [TFlex.Drawing](N_TFlex_Drawing.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public static Color FaceEdgeMark2 { get; }
```
```vb
Public Shared ReadOnly Property FaceEdgeMark2 As Color
	Get
```
```cpp
public:
static property Color FaceEdgeMark2 {
	Color get ();
}
```
