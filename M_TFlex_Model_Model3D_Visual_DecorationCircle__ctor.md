...
# DecorationCircle(String, FloatVector, FloatVector, Double) - конструктор  
...
center [FloatVector](T_TFlex_Model_Model3D_FloatVector.md)
    Центр окружности
axis [FloatVector](T_TFlex_Model_Model3D_FloatVector.md)
    Направление оси
...
[DecorationCircle - перегрузка](Overload_TFlex_Model_Model3D_Visual_DecorationCircle__ctor.md)
