...
# FileLinkParameter - класс  
  
---  
  
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationBaseParameter](T_TFlex_Configuration_BaseParameter.md) TFlex.ConfigurationFileLinkParameter
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Link](P_TFlex_Configuration_FileLinkParameter_Link.md) |  |
