...
# EllipseConstructionSetCenterAndNodeAndRadius - метод  
  
---  
  
Эллипс с центром в узле, проходящий через узел, с заданным радиусом

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public void SetCenterAndNodeAndRadius(
	Node centerNode,
	Node srcNode,
	Parameter radius
)
```
```vb
Public Sub SetCenterAndNodeAndRadius ( 
	centerNode As Node,
	srcNode As Node,
	radius As Parameter
)
...
```cpp
public:
void SetCenterAndNodeAndRadius(
	Node^ centerNode, 
	Node^ srcNode, 
	Parameter^ radius
)
