...
# RichTextInsertFragment(FileLink, RichTextInsertObjectOptions) - метод  
...
link [FileLink](T_TFlex_Model_FileLink.md)
    Используемая ссылка
insertOptions [RichTextInsertObjectOptions](T_TFlex_Model_Model2D_RichText_InsertObjectOptions.md)
    Опции вставки
...
[InsertFragment - перегрузка](Overload_TFlex_Model_Model2D_RichText_InsertFragment.md)
