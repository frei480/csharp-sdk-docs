...
# UnitsManagerFindUnit(LinearUnitType) - метод  
...
unit [LinearUnitType](T_TFlex_Configuration_LinearUnitType.md)
...
[FindUnit - перегрузка](Overload_TFlex_Model_Units_UnitsManager_FindUnit.md)
