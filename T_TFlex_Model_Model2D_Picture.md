...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DPicture
...
|  | [Picture(FileLink)](M_TFlex_Model_Model2D_Picture__ctor_2.md) | Конструктор с именем файла картинки |
|  | [Picture(Document, String)](M_TFlex_Model_Model2D_Picture__ctor_1.md) | Конструктор с именем файла картинки |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model2D_Picture_Angle.md) | Угол поворота картинки |
...
|  | [FileLink](P_TFlex_Model_Model2D_Picture_FileLink.md) | Ссылка на файл картинки |
|  | [FilePath](P_TFlex_Model_Model2D_Picture_FilePath.md) | Имя файла картинки |
|  | [FullFilePath](P_TFlex_Model_Model2D_Picture_FullFilePath.md) | Полный путь файла картинки |
|  | [GroupType](P_TFlex_Model_Model2D_Picture_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [IsMultipage](P_TFlex_Model_Model2D_Picture_IsMultipage.md) | true, если картинка содержит несколько страниц |
...
|  | [Layer](P_TFlex_Model_Model2D_Picture_Layer.md) | Слой, на котором размещается объект |
|  | [Level](P_TFlex_Model_Model2D_Picture_Level.md) | Уровень объекта |
...
|  | [Node1](P_TFlex_Model_Model2D_Picture_Node1.md) | Первый узел привязки картинки |
|  | [Node2](P_TFlex_Model_Model2D_Picture_Node2.md) | Второй узел привязки картинки |
...
|  | [Page](P_TFlex_Model_Model2D_Picture_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [PictureFixingMode](P_TFlex_Model_Model2D_Picture_PictureFixingMode.md) | Способ привязки картинки |
|  | [Priority](P_TFlex_Model_Model2D_Picture_Priority.md) | Приоритет объекта |
|  | [Scale](P_TFlex_Model_Model2D_Picture_Scale.md) | Масштаб изображения |
|  | [ShownPageCount](P_TFlex_Model_Model2D_Picture_ShownPageCount.md) | Количество страниц изображения |
|  | [ShownPageID](P_TFlex_Model_Model2D_Picture_ShownPageID.md) | ID отображаемой страницы чертежа |
|  | [ShownPageIndex](P_TFlex_Model_Model2D_Picture_ShownPageIndex.md) | Индекс отображаемой страницы |
|  | [ShownPageName](P_TFlex_Model_Model2D_Picture_ShownPageName.md) | Имя отображаемой страницы |
...
|  | [X1](P_TFlex_Model_Model2D_Picture_X1.md) | Координата X первой точки привязки |
|  | [X2](P_TFlex_Model_Model2D_Picture_X2.md) | Координата X второй точки привязки |
|  | [Y1](P_TFlex_Model_Model2D_Picture_Y1.md) | Координата Y первой точки привязки |
|  | [Y2](P_TFlex_Model_Model2D_Picture_Y2.md) | Координата Y второй точки привязки |
