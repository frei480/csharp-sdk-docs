...
Манипулятор для радиального изменения данных

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.VisualDragger](T_TFlex_Model_Model3D_Visual_Dragger.md) TFlex.Model.Model3D.VisualRadiusDragger
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [RadiusDragger](M_TFlex_Model_Model3D_Visual_RadiusDragger__ctor.md) | Конструктор по умолчанию |
...
|  | [Center](P_TFlex_Model_Model3D_Visual_RadiusDragger_Center.md) | Центральная точка вложения двумерного диска в трёхмерное пространство |
...
|  | [Direction](P_TFlex_Model_Model3D_Visual_RadiusDragger_Direction.md) | Ориентация вложения двумерного диска в трёхмерное пространство |
...
|  | [Step](P_TFlex_Model_Model3D_Visual_RadiusDragger_Step.md) | (Переопределяет [DraggerStep](P_TFlex_Model_Model3D_Visual_Dragger_Step.md)) |
...
|  | [Value](P_TFlex_Model_Model3D_Visual_RadiusDragger_Value.md) | Текущее значение(Переопределяет [DraggerValue](P_TFlex_Model_Model3D_Visual_Dragger_Value.md)) |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Activate](M_TFlex_Model_Model3D_Visual_RadiusDragger_Activate.md) | Переопределённый метод класса Dragger(Переопределяет [DraggerActivate(View3D, Int32, Int32, Single)](M_TFlex_Model_Model3D_Visual_Dragger_Activate.md)) |
...
|  | [Release](M_TFlex_Model_Model3D_Visual_RadiusDragger_Release.md) | Переопределённый метод класса Dragger(Переопределяет [DraggerRelease](M_TFlex_Model_Model3D_Visual_Dragger_Release.md)) |
|  | [ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring) | Returns a string that represents the current object.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [UpdatePosition](M_TFlex_Model_Model3D_Visual_RadiusDragger_UpdatePosition.md) | Переопределённый метод класса Dragger(Переопределяет [DraggerUpdatePosition(View3D, Int32, Int32)](M_TFlex_Model_Model3D_Visual_Dragger_UpdatePosition.md)) |
...
Манипулятор позволяет изменять данные с помощью перемещения декораций из заданной точки радиально по двумерному диску. 
