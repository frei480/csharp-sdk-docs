...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DMate
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Mate](M_TFlex_Model_Model3D_Mate__ctor.md) | Конструктор для создания нового сопряжения |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AngAngRatio1](P_TFlex_Model_Model3D_Mate_AngAngRatio1.md) | Передаточное значение первого элемента сопряжения типа AngAngTransmission, натуральное число |
|  | [AngAngRatio2](P_TFlex_Model_Model3D_Mate_AngAngRatio2.md) | Передаточное значение второго элемента сопряжения типа AngAngTransmission, натуральное число |
|  | [AngleValue](P_TFlex_Model_Model3D_Mate_AngleValue.md) | Угол для сопряжения типа Angle |
|  | [AngLinRatio](P_TFlex_Model_Model3D_Mate_AngLinRatio.md) | Шаг на оборот сопряжения типа AngLinTransmission |
...
|  | [DistanceValue](P_TFlex_Model_Model3D_Mate_DistanceValue.md) | Расстояние для сопряжения типа Distance |
...
|  | [Element1](P_TFlex_Model_Model3D_Mate_Element1.md) | Первый сопрягаемый элемент |
|  | [Element2](P_TFlex_Model_Model3D_Mate_Element2.md) | Второй сопрягаемый элемент |
|  | [GroupType](P_TFlex_Model_Model3D_Mate_GroupType.md) | (Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [LinLinRatio](P_TFlex_Model_Model3D_Mate_LinLinRatio.md) | Передаточное отношение сопряжения типа LinLinTransmission |
...
|  | [Operation1](P_TFlex_Model_Model3D_Mate_Operation1.md) | Первая сопрягаемая операция (если имеется) |
|  | [Operation2](P_TFlex_Model_Model3D_Mate_Operation2.md) | Вторая сопрягаемая операция (если имеется) |
...
|  | [ReversedDirection](P_TFlex_Model_Model3D_Mate_ReversedDirection.md) | Развернуть направления |
|  | [ReversedNormal](P_TFlex_Model_Model3D_Mate_ReversedNormal.md) | Развернуть нормали (для сопряжения плоскостей на расстоянии) |
|  | [Suppressed](P_TFlex_Model_Model3D_Mate_Suppressed.md) | Подавление сопряжения |
...
|  | [Type](P_TFlex_Model_Model3D_Mate_Type.md) | Тип сопряжения |
