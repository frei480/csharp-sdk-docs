...
# TwoPointArcOutline - класс  
  
---  
  
Линия изображения - дуга окружности, проходящая через два узла с заданным радиусом

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DTwoPointArcOutline

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class TwoPointArcOutline : Outline
```
```vb
Public Class TwoPointArcOutline
	Inherits Outline
```
```cpp
public ref class TwoPointArcOutline : public Outline
```


Тип TwoPointArcOutline предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [TwoPointArcOutline](M_TFlex_Model_Model2D_TwoPointArcOutline__ctor.md) | Конструктор |
...
|  | [EndNode](P_TFlex_Model_Model2D_TwoPointArcOutline_EndNode.md) | Конечный узел дуги |
...
|  | [Radius](P_TFlex_Model_Model2D_TwoPointArcOutline_Radius.md) | Радиус окружности |
...
|  | [StartNode](P_TFlex_Model_Model2D_TwoPointArcOutline_StartNode.md) | Начальный узел дуги |
...
|  | [SubType](P_TFlex_Model_Model2D_TwoPointArcOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
