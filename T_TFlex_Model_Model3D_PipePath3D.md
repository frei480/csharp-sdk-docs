...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PipePath3D](M_TFlex_Model_Model3D_PipePath3D__ctor.md) | Инициализирует новый экземпляр класса PipePath3D |
...
|  | [ConvertToSpline](P_TFlex_Model_Model3D_Path3D_ConvertToSpline.md) | Получить параметры для преобразования пути в сплайн(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
|  | [CountSegments](P_TFlex_Model_Model3D_PipePath3D_CountSegments.md) | Возвращает количество участков |
|  | [CutIndex](P_TFlex_Model_Model3D_Path3D_CutIndex.md) | Индекс решения(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
...
|  | [FirstCutPoint](P_TFlex_Model_Model3D_Path3D_FirstCutPoint.md) | Первая точка обрезки(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
|  | [Geometry](P_TFlex_Model_Model3D_Path3D_Geometry.md) | Получить геометрические данные пути(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
|  | [GroupType](P_TFlex_Model_Model3D_Path3D_GroupType.md) | Получить тип объекта(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
...
|  | [Path3DSegments](P_TFlex_Model_Model3D_Path3D_Path3DSegments.md) | Возвращает информацию об участках пути(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
|  | [Reverse](P_TFlex_Model_Model3D_Path3D_Reverse.md) | Реверисровать направление пути(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
|  | [SecondCutPoint](P_TFlex_Model_Model3D_Path3D_SecondCutPoint.md) | Вторая точка обрезки(Унаследован от [Path3D](T_TFlex_Model_Model3D_Path3D.md)) |
|  | [Smoothness](P_TFlex_Model_Model3D_PipePath3D_Smoothness.md) | Управляет сглаживанием |
...
|  | [Tube](P_TFlex_Model_Model3D_PipePath3D_Tube.md) | Управляет опцией трубы |
|  | [TubeRadius](P_TFlex_Model_Model3D_PipePath3D_TubeRadius.md) | Управляет радиусом трубы |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddBackSegmentType](M_TFlex_Model_Model3D_PipePath3D_AddBackSegment__1.md) | Добавить участок в конец |
|  | [AddFrontSegmentType](M_TFlex_Model_Model3D_PipePath3D_AddFrontSegment__1.md) | Добавить участок в начало |
|  | [AddSegment_backType](M_TFlex_Model_Model3D_PipePath3D_AddSegment_back__1.md) | **Устарело.** Добавить участок в конец |
|  | [AddSegment_frontType](M_TFlex_Model_Model3D_PipePath3D_AddSegment_front__1.md) | **Устарело.** Добавить участок в начало |
|  | [BeginEdit](M_TFlex_Model_Model3D_PipePath3D_BeginEdit.md) | Подготавливает объект к редактированию |
...
|  | [Complete](M_TFlex_Model_Model3D_PipePath3D_Complete.md) | (Переопределяет [ModelObjectComplete](M_TFlex_Model_ModelObject_Complete.md)) |
...
|  | [EndEdit](M_TFlex_Model_Model3D_PipePath3D_EndEdit.md) | Закончить редактирование объекта |
...
|  | [GetBeginSegment](M_TFlex_Model_Model3D_PipePath3D_GetBeginSegment.md) | Получить первый участок |
|  | [GetEndPoint](M_TFlex_Model_Model3D_PipePath3D_GetEndPoint.md) | Получить объект которым заканчивается путь |
|  | [GetEndSegment](M_TFlex_Model_Model3D_PipePath3D_GetEndSegment.md) | Получить последний участок |
...
|  | [GetNextSegment](M_TFlex_Model_Model3D_PipePath3D_GetNextSegment.md) | Получить следующий участок |
|  | [GetPrevSegment](M_TFlex_Model_Model3D_PipePath3D_GetPrevSegment.md) | Получить предыдущий участок |
...
|  | [GetSegment](M_TFlex_Model_Model3D_PipePath3D_GetSegment.md) | Получить участок |
|  | [GetStartPoint](M_TFlex_Model_Model3D_PipePath3D_GetStartPoint.md) | Получить объект с которого начинается путь |
...
|  | [MakeSmoothness](M_TFlex_Model_Model3D_PipePath3D_MakeSmoothness.md) | Делает сглаживание |
...
|  | [OnCancelChanges](M_TFlex_Model_Model3D_PipePath3D_OnCancelChanges.md) | (Переопределяет [ModelObjectOnCancelChanges](M_TFlex_Model_ModelObject_OnCancelChanges.md)) |
|  | [OnEndChanges](M_TFlex_Model_Model3D_PipePath3D_OnEndChanges.md) | (Переопределяет [ModelObjectOnEndChanges](M_TFlex_Model_ModelObject_OnEndChanges.md)) |
...
|  | [RemoveSegment(Int32)](M_TFlex_Model_Model3D_PipePath3D_RemoveSegment.md) | Удалить участок по индексу |
