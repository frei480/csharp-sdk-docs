...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DScenario
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Scenario](M_TFlex_Model_Model3D_Scenario__ctor.md) | Инициализирует новый экземпляр класса Scenario |
...
|  | [IsActiveScenario](P_TFlex_Model_Model3D_Scenario_IsActiveScenario.md) |  |
...
|  | [PlaybackRate](P_TFlex_Model_Model3D_Scenario_PlaybackRate.md) |  |
|  | [PlaybackType](P_TFlex_Model_Model3D_Scenario_PlaybackType.md) |  |
|  | [Stages](P_TFlex_Model_Model3D_Scenario_Stages.md) |  |
...
|  | [MakeActiveScenario](M_TFlex_Model_Model3D_Scenario_MakeActiveScenario.md) |  |
