...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddCuttingItem](M_TFlex_Model_Model3D_BasePipe_AddCuttingItem.md) | Добавляет операцию для создание "врезки" |
...
|  | [Complete](M_TFlex_Model_Model3D_BasePipe_Complete.md) | (Переопределяет [ModelObjectComplete](M_TFlex_Model_ModelObject_Complete.md)) |
...
|  | [GetBeginPartVariables](M_TFlex_Model_Model3D_BasePipe_GetBeginPartVariables.md) | Получить переменные начала трубы |
|  | [GetCuttingItem](M_TFlex_Model_Model3D_BasePipe_GetCuttingItem.md) | Возвращает операцию "врезки" по индексу |
|  | [GetEndPartVariables](M_TFlex_Model_Model3D_BasePipe_GetEndPartVariables.md) | Получить переменные конца трубы |
...
|  | [GetMidPartVariables](M_TFlex_Model_Model3D_BasePipe_GetMidPartVariables.md) | Получить переменные середины трубы |
...
|  | [getProfileProperties](M_TFlex_Model_Model3D_BasePipe_getProfileProperties.md) |  |
...
|  | [OnCancelChanges](M_TFlex_Model_Model3D_BasePipe_OnCancelChanges.md) | (Переопределяет [ModelObjectOnCancelChanges](M_TFlex_Model_ModelObject_OnCancelChanges.md)) |
|  | [OnEndChanges](M_TFlex_Model_Model3D_BasePipe_OnEndChanges.md) | (Переопределяет [ModelObjectOnEndChanges](M_TFlex_Model_ModelObject_OnEndChanges.md)) |
...
|  | [RemoveAllCuttingItem](M_TFlex_Model_Model3D_BasePipe_RemoveAllCuttingItem.md) | Удаляет все операции "врезки" |
|  | [RemoveCuttingItem(Int32)](M_TFlex_Model_Model3D_BasePipe_RemoveCuttingItem.md) | Удаляет операцию "врезки" по индексу |
|  | [RemoveCuttingItem(Operation)](M_TFlex_Model_Model3D_BasePipe_RemoveCuttingItem_1.md) | Удаляет операцию "врезки" |
...
|  | [TryCopyPipeStandardFrom](M_TFlex_Model_Model3D_BasePipe_TryCopyPipeStandardFrom.md) | Попробовать скопировать стандарт из другой трубы |
|  | [UpdateEnds](M_TFlex_Model_Model3D_BasePipe_UpdateEnds.md) |  |
