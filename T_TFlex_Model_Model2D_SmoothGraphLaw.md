...
# SmoothGraphLaw - класс  
    
Зависимость F(x), заданная набором точек со сглаживанием

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DGraphLaw](T_TFlex_Model_Model2D_GraphLaw.md) TFlex.Model.Model2DSmoothGraphLaw
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SmoothGraphLaw](M_TFlex_Model_Model2D_SmoothGraphLaw__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ArgumentName](P_TFlex_Model_Model2D_GraphLaw_ArgumentName.md) | Название аргумента (x) в форме: [имя], [буквы_обозначения], [единицы](Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [ArgumentTolerance](P_TFlex_Model_Model2D_GraphLaw_ArgumentTolerance.md) | Наименьшее допустимое расстояние между соседними узлами по значению аргумента(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [ArgumentToValueVisualRatio](P_TFlex_Model_Model2D_GraphLaw_ArgumentToValueVisualRatio.md) | Визуальное соотношение единиц аргумента и функции (для отображения в диалоге)(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [Color](P_TFlex_Model_Model2D_GraphLaw_Color.md) | Цвет (для отображения в диалоге)(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [GroupType](P_TFlex_Model_Model2D_GraphLaw_GroupType.md) | Тип объекта(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [IsSmooth](P_TFlex_Model_Model2D_GraphLaw_IsSmooth.md) | График является сглаженным(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [NodeCount](P_TFlex_Model_Model2D_GraphLaw_NodeCount.md) | Количество точек графика(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [Nodes](P_TFlex_Model_Model2D_GraphLaw_Nodes.md) | Точки графика(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [NodesBounds](P_TFlex_Model_Model2D_GraphLaw_NodesBounds.md) | Ограничивающий прямоугольник узлов(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [SpecialName](P_TFlex_Model_Model2D_GraphLaw_SpecialName.md) | Специальное имя(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [UseBeginTangent](P_TFlex_Model_Model2D_SmoothGraphLaw_UseBeginTangent.md) | Использование значения касательной в начале |
|  | [UseEndTangent](P_TFlex_Model_Model2D_SmoothGraphLaw_UseEndTangent.md) | Использование значения касательной в конце |
|  | [UseLogarArgScale](P_TFlex_Model_Model2D_GraphLaw_UseLogarArgScale.md) | Использование логарифмической шкалы аргумента(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [UseWorkingArea](P_TFlex_Model_Model2D_GraphLaw_UseWorkingArea.md) | Использование области допустимых значений(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [ValueName](P_TFlex_Model_Model2D_GraphLaw_ValueName.md) | Название функции (F) в форме: [имя], [буквы_обозначения], [единицы](Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [ViewOnly](P_TFlex_Model_Model2D_GraphLaw_ViewOnly.md) | Редактирование в диалоге запрещено(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [WorkingArea](P_TFlex_Model_Model2D_GraphLaw_WorkingArea.md) | Область допустимых значений(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [GetNode](M_TFlex_Model_Model2D_GraphLaw_GetNode.md) | Получение узла по номеру(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [GetRepeatCount](M_TFlex_Model_Model2D_GraphLaw_GetRepeatCount.md) | Количество повторений графика в положительном и отрицательном направлениях(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [GetTangents](M_TFlex_Model_Model2D_SmoothGraphLaw_GetTangents.md) | Получение значений производных в начале и в конце |
...
|  | [GetValue](M_TFlex_Model_Model2D_GraphLaw_GetValue.md) | Получение значения по аргументу(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [InsertNode](M_TFlex_Model_Model2D_GraphLaw_InsertNode.md) | Вставка узла в соответствии со значением аргумента(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [RemoveAllNodes](M_TFlex_Model_Model2D_GraphLaw_RemoveAllNodes.md) | Удаление всех узлов(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [RemoveNode](M_TFlex_Model_Model2D_GraphLaw_RemoveNode.md) | Удаление узла(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Save](M_TFlex_Model_Model2D_GraphLaw_Save.md) | Сохранение в отдельный файл *.tflaw(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [SetNode](M_TFlex_Model_Model2D_GraphLaw_SetNode.md) | Установка узла по номеру(Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
...
|  | [SetRepeatCount](M_TFlex_Model_Model2D_GraphLaw_SetRepeatCount.md) | (Унаследован от [GraphLaw](T_TFlex_Model_Model2D_GraphLaw.md)) |
|  | [SetTangents](M_TFlex_Model_Model2D_SmoothGraphLaw_SetTangents.md) | Установка значений производных в начале и в конце |
