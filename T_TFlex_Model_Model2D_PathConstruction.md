...
# PathConstruction - класс  
    
Линия построения - путь

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DPathConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PathConstruction](M_TFlex_Model_Model2D_PathConstruction__ctor.md) | Конструктор по умолчанию |
...
|  | [ConstructionGeometry](P_TFlex_Model_Model2D_PathConstruction_ConstructionGeometry.md) | Геометрия линии построения(Переопределяет [ConstructionConstructionGeometry](P_TFlex_Model_Model2D_Construction_ConstructionGeometry.md)) |
|  | [Contour](P_TFlex_Model_Model2D_PathConstruction_Contour.md) | Контур пути |
...
|  | [GeometryType](P_TFlex_Model_Model2D_PathConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [Length](P_TFlex_Model_Model2D_PathConstruction_Length.md) | Длина пути |
...
|  | [PolylineConstructionGeometry](P_TFlex_Model_Model2D_PathConstruction_PolylineConstructionGeometry.md) | Геометрия линии построения (полилиния) |
|  | [SubType](P_TFlex_Model_Model2D_PathConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
...
|  | [GetAngle](M_TFlex_Model_Model2D_PathConstruction_GetAngle.md) | Получить угол наклона касательной в заданной точке пути |
...
|  | [GetCircleArcApproximation](M_TFlex_Model_Model2D_PathConstruction_GetCircleArcApproximation.md) | Геометрия дуг окружностей |
...
|  | [GetRelativePointToBegin](M_TFlex_Model_Model2D_PathConstruction_GetRelativePointToBegin.md) | Получить точку на пути |
