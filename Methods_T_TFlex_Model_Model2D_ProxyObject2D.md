...
# ProxyObject2D - методы  
  
---  
  
Тип [ProxyObject2D](T_TFlex_Model_Model2D_ProxyObject2D.md) предоставляет следующие члены.
...
[ProxyObject2D - ](T_TFlex_Model_Model2D_ProxyObject2D.md)
