...
# StandardColorsDecoration1Index - свойство  
...
```csharp
public static int Decoration1Index { get; }
```
```vb
Public Shared ReadOnly Property Decoration1Index As Integer
	Get
```
```cpp
public:
static property int Decoration1Index {
	int get ();
}
```
