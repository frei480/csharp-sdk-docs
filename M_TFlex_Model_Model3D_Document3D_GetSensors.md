...
```csharp
public static ICollection<Sensor> GetSensors(
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Sensor](T_TFlex_Model_Model3D_Sensor.md)
