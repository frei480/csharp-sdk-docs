...
# Document3DGetCopyOperations2 - метод  
  
---  
  
Контейнер операций копирования

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public static ICollection<CopyOperation2> GetCopyOperations2(
	this Document document
)
```
```vb
<ExtensionAttribute>
Public Shared Function GetCopyOperations2 ( 
	document As Document
) As ICollection(Of CopyOperation2)
```
```cpp
public:
[ExtensionAttribute]
static ICollection<CopyOperation2^>^ GetCopyOperations2(
	Document^ document
)
```
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[CopyOperation2](T_TFlex_Model_Model3D_CopyOperation2.md)
