...
Класс 3D-сварного шва

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DWeld3D [TFlex.Model.Model3DReferenceWeld3D](T_TFlex_Model_Model3D_ReferenceWeld3D.md)
...
|  | [GroupType](P_TFlex_Model_Model3D_Weld3D_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Length](P_TFlex_Model_Model3D_Weld3D_Length.md) | Длина сварного шва |
...
|  | [Weld2D](P_TFlex_Model_Model3D_Weld3D_Weld2D.md) | 2D-сварной шов, связанный с этим 3D-швом |
|  | [WeldType](P_TFlex_Model_Model3D_Weld3D_WeldType.md) | Тип сварного шва |
