...
|  | Имя | Описание |
| --- | --- | --- |
|  | [IntersectionNode3D](M_TFlex_Model_Model3D_IntersectionNode3D__ctor.md) | Конструктор для создания узла на пересечении элементов |
...
|  | [FirstAxis](P_TFlex_Model_Model3D_IntersectionNode3D_FirstAxis.md) | Первый элемент как ось |
|  | [FirstWire](P_TFlex_Model_Model3D_IntersectionNode3D_FirstWire.md) | Первый элемент как проволочная модель |
...
|  | [GroupType](P_TFlex_Model_Model3D_Node3D_GroupType.md) | Получить тип объекта(Унаследован от [Node3D](T_TFlex_Model_Model3D_Node3D.md)) |
...
|  | [Number](P_TFlex_Model_Model3D_IntersectionNode3D_Number.md) | Получить номер пересечения |
...
|  | [Points](P_TFlex_Model_Model3D_IntersectionNode3D_Points.md) |  |
|  | [SecondAxis](P_TFlex_Model_Model3D_IntersectionNode3D_SecondAxis.md) | Второй элемент как ось |
|  | [SecondPlane](P_TFlex_Model_Model3D_IntersectionNode3D_SecondPlane.md) | Второй элемент как листовое тело |
|  | [SecondSheet](P_TFlex_Model_Model3D_IntersectionNode3D_SecondSheet.md) | Второй элемент как листовое тело |
|  | [SecondSolid](P_TFlex_Model_Model3D_IntersectionNode3D_SecondSolid.md) | Второй элемент как твёрдое тело |
|  | [SecondWire](P_TFlex_Model_Model3D_IntersectionNode3D_SecondWire.md) | Второй элемент как проволочная модель |
|  | [TotalNumber](P_TFlex_Model_Model3D_IntersectionNode3D_TotalNumber.md) | Количество найденных пересечений во время последней регенерации |
