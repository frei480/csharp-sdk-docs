...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DHole
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Hole](M_TFlex_Model_Model3D_Hole__ctor.md) | Конструктор для создания 3D отверстия |
...
|  | [End](P_TFlex_Model_Model3D_Hole_End.md) | Конец отверстия |
|  | [EndFace](P_TFlex_Model_Model3D_Hole_EndFace.md) | Грань определяющая конец отверстия |
|  | [Facet](P_TFlex_Model_Model3D_Operation_Facet.md) | (Унаследован от [Operation](T_TFlex_Model_Model3D_Operation.md)) |
|  | [FileName](P_TFlex_Model_Model3D_Hole_FileName.md) | Имя файла 3D Фрагмента |
...
|  | [GroupType](P_TFlex_Model_Model3D_Hole_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
|  | [HideConnectors](P_TFlex_Model_Model3D_Hole_HideConnectors.md) | Скрывать коннекторы |
|  | [HoleBaseFaceMode](P_TFlex_Model_Model3D_Hole_HoleBaseFaceMode.md) | Режим поиска базовой грани |
|  | [HoleCount](P_TFlex_Model_Model3D_Hole_HoleCount.md) | Количество отверстий |
...
|  | [PathName](P_TFlex_Model_Model3D_Hole_PathName.md) | Путь файла 3D Фрагмента |
...
|  | [AddHole(Operation, Node3D)](M_TFlex_Model_Model3D_Hole_AddHole_1.md) | Добавить отверстие на грани |
|  | [AddHoles](M_TFlex_Model_Model3D_Hole_AddHoles.md) | Добавить отверстия по массиву |
...
|  | [DeleteHole](M_TFlex_Model_Model3D_Hole_DeleteHole.md) | Удалить отверстие по индексу |
...
|  | [EditFragment](M_TFlex_Model_Model3D_Hole_EditFragment.md) | **Устарело.** |
...
|  | [GetBaseFace](M_TFlex_Model_Model3D_Hole_GetBaseFace.md) | Получение базовой грани для отверстия по индексу отверстия |
|  | [GetDirectionLCS](M_TFlex_Model_Model3D_Hole_GetDirectionLCS.md) | Получение системы координат, задающей направление, по индексу отверстия |
|  | [GetDirectionTopol](M_TFlex_Model_Model3D_Hole_GetDirectionTopol.md) | Получение элемента, задающего направление, по индексу отверстия |
...
|  | [GetOrigin](M_TFlex_Model_Model3D_Hole_GetOrigin.md) |  |
...
|  | [GetRotation](M_TFlex_Model_Model3D_Hole_GetRotation.md) | Получение задающего поворот элемента по индексу отверстия |
|  | [GetTargetLCS](M_TFlex_Model_Model3D_Hole_GetTargetLCS.md) | Получение целевой системы координат, используемой для привязки отверстия |
...
|  | [GetVariables](M_TFlex_Model_Model3D_Hole_GetVariables.md) | Получить переменные по индексу отверстия |
|  | [GetVariableValue](M_TFlex_Model_Model3D_Hole_GetVariableValue.md) | Получить переменную отверстия по имени |
...
|  | [IsOrientationSet](M_TFlex_Model_Model3D_Hole_IsOrientationSet.md) | Проверка заданной ориентации по индексу отверстия |
...
|  | [SetBaseFace](M_TFlex_Model_Model3D_Hole_SetBaseFace.md) | Задать базовую грань для отверстия |
|  | [SetDirection(Int32, ModelTopol)](M_TFlex_Model_Model3D_Hole_SetDirection.md) | Задать направление отверстия |
|  | [SetDirection(Int32, LCS)](M_TFlex_Model_Model3D_Hole_SetDirection_1.md) | Задать направление отверстия |
...
|  | [SetRotation](M_TFlex_Model_Model3D_Hole_SetRotation.md) | Задать поворот отверстия |
