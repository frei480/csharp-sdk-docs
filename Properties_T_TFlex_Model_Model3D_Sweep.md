...
Тип [Sweep](T_TFlex_Model_Model3D_Sweep.md) предоставляет следующие члены.
...
|  | [BottomFitting](P_TFlex_Model_Model3D_Sweep_BottomFitting.md) | Способ обработки рёбер на нижней грани |
|  | [BottomRadius](P_TFlex_Model_Model3D_Sweep_BottomRadius.md) | Радиус сглаживания или смещения для фаски на нижнем ребре |
...
|  | [GapFillType](P_TFlex_Model_Model3D_Sweep_GapFillType.md) | Способ обработки разрывов |
...
|  | [Profile](P_TFlex_Model_Model3D_Sweep_Profile.md) | Множество образующих контуров |
|  | [Reverse](P_TFlex_Model_Model3D_Sweep_Reverse.md) | Параметр реверсирования направления |
|  | [SideBlending](P_TFlex_Model_Model3D_Sweep_SideBlending.md) | Сглаживание боковых рёбер |
|  | [SideFitting](P_TFlex_Model_Model3D_Sweep_SideFitting.md) | Способ обработки боковых рёбер |
...
|  | [Thickness1](P_TFlex_Model_Model3D_Sweep_Thickness1.md) | Первое значение толщины стенок |
|  | [Thickness2](P_TFlex_Model_Model3D_Sweep_Thickness2.md) | Второе значение толщины стенок |
|  | [ThicknessType](P_TFlex_Model_Model3D_Sweep_ThicknessType.md) | Тип тонкостенного элемента |
|  | [TopFitting](P_TFlex_Model_Model3D_Sweep_TopFitting.md) | Способ обработки рёбер на верхней грани |
...
|  | [TopRadius](P_TFlex_Model_Model3D_Sweep_TopRadius.md) | Радиус сглаживания или смещения для фаски на верхнем ребре |
