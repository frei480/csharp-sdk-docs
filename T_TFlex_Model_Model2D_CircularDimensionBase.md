...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CircularDimensionBase(Document)](M_TFlex_Model_Model2D_CircularDimensionBase__ctor_2.md) | Инициализирует новый экземпляр класса CircularDimensionBase |
|  | [CircularDimensionBase(IntPtr)](M_TFlex_Model_Model2D_CircularDimensionBase__ctor.md) | Инициализирует новый экземпляр класса CircularDimensionBase |
|  | [CircularDimensionBase(IntPtr, Boolean)](M_TFlex_Model_Model2D_CircularDimensionBase__ctor_1.md) | Инициализирует новый экземпляр класса CircularDimensionBase |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model2D_CircularDimensionBase_Accuracy.md) | Точность |
|  | [AltAccuracy](P_TFlex_Model_Model2D_CircularDimensionBase_AltAccuracy.md) | Точность для альтернативного размера |
|  | [AltLocation](P_TFlex_Model_Model2D_CircularDimensionBase_AltLocation.md) | Расположение альтернативного размера |
|  | [AltMinDigits](P_TFlex_Model_Model2D_CircularDimensionBase_AltMinDigits.md) | Минимальное количество знаков после запятой для альтернативного размера |
|  | [AltScaleFactor](P_TFlex_Model_Model2D_CircularDimensionBase_AltScaleFactor.md) | Величина дополнительного масштабирования альтернативного размера |
|  | [AltScaleFactorType](P_TFlex_Model_Model2D_CircularDimensionBase_AltScaleFactorType.md) | Тип дополнительного масштабирования альтернативного размера |
|  | [AltSeparator](P_TFlex_Model_Model2D_CircularDimensionBase_AltSeparator.md) | Тип разделителя для альтернативного размера |
|  | [AltTextAfter](P_TFlex_Model_Model2D_CircularDimensionBase_AltTextAfter.md) | Текст после числа альтернативного размера |
|  | [AltTextBefore](P_TFlex_Model_Model2D_CircularDimensionBase_AltTextBefore.md) | Текст перед числом альтернативного размера |
|  | [AltTextParameters](P_TFlex_Model_Model2D_CircularDimensionBase_AltTextParameters.md) | Параметры для отображения в тексте альтернативного размера |
|  | [AltTolerLetters](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerLetters.md) | Поле допуска с квалитетом для альтернативного размера |
|  | [AltTolerLowerDev](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerLowerDev.md) | Величина нижнего отклонения допуска для альтернативного размера |
|  | [AltTolerType](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerType.md) | Тип задания допуска для альтернативного размера |
|  | [AltTolerUpperDev](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerUpperDev.md) | Величина верхнего отклонения допуска для альтернативного размера |
|  | [AltUnits](P_TFlex_Model_Model2D_CircularDimensionBase_AltUnits.md) | Тип единиц измерения |
...
|  | [CircularDimType](P_TFlex_Model_Model2D_CircularDimensionBase_CircularDimType.md) | Подтип размера на окружности |
...
|  | [Cross](P_TFlex_Model_Model2D_CircularDimensionBase_Cross.md) | Состояние флага отображения крестика |
...
|  | [Dual](P_TFlex_Model_Model2D_CircularDimensionBase_Dual.md) | Режим отображения двойного размера |
...
|  | [EndArrowSize](P_TFlex_Model_Model2D_CircularDimensionBase_EndArrowSize.md) | Размер конечной стрелки |
|  | [EndArrowType](P_TFlex_Model_Model2D_CircularDimensionBase_EndArrowType.md) | Типа конечной стрелки |
|  | [FitLetters](P_TFlex_Model_Model2D_CircularDimensionBase_FitLetters.md) | Поле посадки с квалитетом |
|  | [FitLowerDev](P_TFlex_Model_Model2D_CircularDimensionBase_FitLowerDev.md) | Величина нижнего отклонения посадки |
|  | [FitUpperDev](P_TFlex_Model_Model2D_CircularDimensionBase_FitUpperDev.md) | Величина верхнего отклонения посадки |
|  | [FitView](P_TFlex_Model_Model2D_CircularDimensionBase_FitView.md) | Вид посадки |
...
|  | [MinDigits](P_TFlex_Model_Model2D_CircularDimensionBase_MinDigits.md) | Минимальное число знаков после запятой |
...
|  | [OutsideArrows](P_TFlex_Model_Model2D_CircularDimensionBase_OutsideArrows.md) | Состояние флага отображения стрелок с внешней стороны |
...
|  | [PlaceFit](P_TFlex_Model_Model2D_CircularDimensionBase_PlaceFit.md) | Параметр отображения посадки |
|  | [PrefixSymbol](P_TFlex_Model_Model2D_CircularDimensionBase_PrefixSymbol.md) | Символ перед размерным числом |
...
|  | [ScaleFactor](P_TFlex_Model_Model2D_CircularDimensionBase_ScaleFactor.md) | Величина дополнительного масштабирования размера |
|  | [ScaleFactorType](P_TFlex_Model_Model2D_CircularDimensionBase_ScaleFactorType.md) | Тип дополнительного масштабирования размера |
|  | [Standard](P_TFlex_Model_Model2D_CircularDimensionBase_Standard.md) | Тип стандарта размера |
|  | [StartArrowSize](P_TFlex_Model_Model2D_CircularDimensionBase_StartArrowSize.md) | Размер начальной стрелки |
|  | [StartArrowType](P_TFlex_Model_Model2D_CircularDimensionBase_StartArrowType.md) | Тип начальной стрелки |
...
|  | [StringsOffset](P_TFlex_Model_Model2D_CircularDimensionBase_StringsOffset.md) | Величина смещения строк от размерной линии |
...
|  | [TolerAutomatic](P_TFlex_Model_Model2D_CircularDimensionBase_TolerAutomatic.md) | Указывает на то, что допуск будет рассчитываться автоматически |
|  | [TolerLetters](P_TFlex_Model_Model2D_CircularDimensionBase_TolerLetters.md) | Поле допуска с квалитетом |
|  | [TolerLowerDev](P_TFlex_Model_Model2D_CircularDimensionBase_TolerLowerDev.md) | Величина нижнего отклонения допуска |
|  | [TolerSize](P_TFlex_Model_Model2D_CircularDimensionBase_TolerSize.md) | Тип отображения допуска |
|  | [TolerUpperDev](P_TFlex_Model_Model2D_CircularDimensionBase_TolerUpperDev.md) | Величина верхнего отклонения допуска |
|  | [Units](P_TFlex_Model_Model2D_CircularDimensionBase_Units.md) | Тип единиц измерения |
...
|  | [SetDiametralDimensionType](M_TFlex_Model_Model2D_CircularDimensionBase_SetDiametralDimensionType.md) |  |
...
|  | [SetOffsets](M_TFlex_Model_Model2D_CircularDimensionBase_SetOffsets.md) |  |
|  | [SetRadialDimensionType](M_TFlex_Model_Model2D_CircularDimensionBase_SetRadialDimensionType.md) |  |
