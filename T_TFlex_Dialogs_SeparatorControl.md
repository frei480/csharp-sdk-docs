...
# SeparatorControl - класс  
    
Элемент, отображающий разделитель

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsSeparatorControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SeparatorControl](M_TFlex_Dialogs_SeparatorControl__ctor.md) | Инициализирует новый экземпляр класса SeparatorControl |
|  | [SeparatorControl(String)](M_TFlex_Dialogs_SeparatorControl__ctor_1.md) | Инициализирует новый экземпляр класса SeparatorControl |
