...
# FillHoleOperation - класс  
  
---  
  
Заполнение области

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFillHoleOperation

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class FillHoleOperation : Operation
```
```vb
Public Class FillHoleOperation
	Inherits Operation
```
```cpp
public ref class FillHoleOperation : public Operation
```


Тип FillHoleOperation предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [FillHoleOperation](M_TFlex_Model_Model3D_FillHoleOperation__ctor.md) | Конструктор для создания Заполнения области |
...
|  | [GroupType](P_TFlex_Model_Model3D_FillHoleOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [MergeWithSourceOper](P_TFlex_Model_Model3D_FillHoleOperation_MergeWithSourceOper.md) | Объединить с исходной операцией |
...
|  | [Split](P_TFlex_Model_Model3D_FillHoleOperation_Split.md) | Разбиение |
...
|  | [ThinElement](P_TFlex_Model_Model3D_FillHoleOperation_ThinElement.md) | Тонкостенный элемент |
|  | [Tolerance](P_TFlex_Model_Model3D_FillHoleOperation_Tolerance.md) | Точность |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddContour](M_TFlex_Model_Model3D_FillHoleOperation_AddContour.md) | Добавить контур |
...
|  | [CountContours](M_TFlex_Model_Model3D_FillHoleOperation_CountContours.md) | Количество контуров |
|  | [Create](M_TFlex_Model_Model3D_FillHoleOperation_Create.md) |  |
...
|  | [GetContour](M_TFlex_Model_Model3D_FillHoleOperation_GetContour.md) | Получить контур |
...
|  | [GetSourceOper](M_TFlex_Model_Model3D_FillHoleOperation_GetSourceOper.md) | Получить исходную операцию |
...
|  | [InsertContour](M_TFlex_Model_Model3D_FillHoleOperation_InsertContour.md) | Вставить контур |
...
|  | [IsExistSourceOper](M_TFlex_Model_Model3D_FillHoleOperation_IsExistSourceOper.md) | Задана ли исходная операция |
...
|  | [RemoveContour](M_TFlex_Model_Model3D_FillHoleOperation_RemoveContour.md) | Удалить контур |
|  | [RemoveSourceOper](M_TFlex_Model_Model3D_FillHoleOperation_RemoveSourceOper.md) | Удалить исходную операцию |
...
|  | [SetSourceOper](M_TFlex_Model_Model3D_FillHoleOperation_SetSourceOper.md) | Задать исходную операцию |
