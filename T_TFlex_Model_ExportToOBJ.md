...
Класс экспорта в файл форматa OBJ

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelExportTo](T_TFlex_Model_ExportTo.md) [TFlex.ModelExportToFacet](T_TFlex_Model_ExportToFacet.md) TFlex.ModelExportToOBJ
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExportToOBJ](M_TFlex_Model_ExportToOBJ__ctor.md) | Инициализирует новый экземпляр класса ExportToOBJ |
...
|  | [Archive](P_TFlex_Model_ExportToOBJ_Archive.md) | Запаковать в архив |
...
|  | [ExportMaterials](P_TFlex_Model_ExportToOBJ_ExportMaterials.md) | Экспорт материалов |
...
|  | [Export](M_TFlex_Model_ExportToOBJ_Export.md) | Функция экспорта документа(Переопределяет [ExportToFacetExport(String)](M_TFlex_Model_ExportToFacet_Export.md)) |
