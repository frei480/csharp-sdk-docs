...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationZones
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Zones](M_TFlex_Configuration_Zones__ctor.md) | Инициализирует новый экземпляр класса Zones |
|  | [Zones(IntPtr, Boolean)](M_TFlex_Configuration_Zones__ctor_1.md) | Инициализирует новый экземпляр класса Zones |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Direction](P_TFlex_Configuration_Zones_Direction.md) |  |
|  | [FirstCharacter](P_TFlex_Configuration_Zones_FirstCharacter.md) |  |
|  | [Offset](P_TFlex_Configuration_Zones_Offset.md) |  |
|  | [OffsetPoint](P_TFlex_Configuration_Zones_OffsetPoint.md) |  |
|  | [Size](P_TFlex_Configuration_Zones_Size.md) |  |
|  | [Step](P_TFlex_Configuration_Zones_Step.md) |  |
|  | [VBegin](P_TFlex_Configuration_Zones_VBegin.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Zones_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Zones_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Zones_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
...
|  | [ToString](M_TFlex_Configuration_Zones_ToString.md) | (Переопределяет [ObjectToString](https://learn.microsoft.com/dotnet/api/system.object.tostring)) |
