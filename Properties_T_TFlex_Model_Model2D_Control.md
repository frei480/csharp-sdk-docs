...
|  | [ControlType](P_TFlex_Model_Model2D_Control_ControlType.md) | Тип элемента управления |
...
|  | [GroupType](P_TFlex_Model_Model2D_Control_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_Control_Layer.md) |  |
...
|  | [Rectangle](P_TFlex_Model_Model2D_Control_Rectangle.md) | Прямоугольник элемента управления |
...
[Control - ](T_TFlex_Model_Model2D_Control.md)
