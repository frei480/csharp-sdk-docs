...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PointsLCS](M_TFlex_Model_Model3D_PointsLCS__ctor.md) | Конструктор систем координат построенных по точкам |
...
|  | [Comment](P_TFlex_Model_Model3D_LCS_Comment.md) | Комментарий(Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
|  | [ConnectorParameters](P_TFlex_Model_Model3D_LCS_ConnectorParameters.md) | (Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
...
|  | [DirectionToAxisX](P_TFlex_Model_Model3D_PointsLCS_DirectionToAxisX.md) | Направление задающее ось Х |
|  | [DirectionToAxisY](P_TFlex_Model_Model3D_PointsLCS_DirectionToAxisY.md) | Направление задающее ось Y |
...
|  | [External](P_TFlex_Model_Model3D_PointsLCS_External.md) | **Устарело.** Внешняя ЛСК |
|  | [ExternalType](P_TFlex_Model_Model3D_PointsLCS_ExternalType.md) | Тип внешней ЛСК |
|  | [Geometry](P_TFlex_Model_Model3D_LCS_Geometry.md) | Геометрические данные системы координат(Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
|  | [GroupType](P_TFlex_Model_Model3D_LCS_GroupType.md) | Получить тип объекта(Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
...
|  | [Info](P_TFlex_Model_Model3D_LCS_Info.md) | (Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
...
|  | [MoveToSurface](P_TFlex_Model_Model3D_PointsLCS_MoveToSurface.md) | Переместить до поверхности |
|  | [MoveX](P_TFlex_Model_Model3D_PointsLCS_MoveX.md) | Перемещение вдоль оси X |
|  | [MoveY](P_TFlex_Model_Model3D_PointsLCS_MoveY.md) | Перемещение вдоль оси Y |
|  | [MoveZ](P_TFlex_Model_Model3D_PointsLCS_MoveZ.md) | Перемещение вдоль оси Z |
...
|  | [OneColor](P_TFlex_Model_Model3D_PointsLCS_OneColor.md) | Одним цветом |
...
|  | [PointToAxisX](P_TFlex_Model_Model3D_PointsLCS_PointToAxisX.md) | Точка задающая направление оси Х |
|  | [PointToAxisY](P_TFlex_Model_Model3D_PointsLCS_PointToAxisY.md) | Точка задающая направление оси Y |
|  | [PointToOrigin](P_TFlex_Model_Model3D_PointsLCS_PointToOrigin.md) | Точка, задающая начало системы координат |
|  | [RotateToSurface](P_TFlex_Model_Model3D_PointsLCS_RotateToSurface.md) | Повернуть до ближайшей точки поверхности |
|  | [RotateX](P_TFlex_Model_Model3D_PointsLCS_RotateX.md) | Вращение по оси X |
|  | [RotateY](P_TFlex_Model_Model3D_PointsLCS_RotateY.md) | Вращение по оси Y |
|  | [RotateZ](P_TFlex_Model_Model3D_PointsLCS_RotateZ.md) | Вращение по оси Z |
...
|  | [UseForFragment](P_TFlex_Model_Model3D_PointsLCS_UseForFragment.md) | Использовать для привязки фрагмента |
|  | [UseForFragmentFixing](P_TFlex_Model_Model3D_LCS_UseForFragmentFixing.md) | Значение свойства "Использовать для привязки фрагмента"(Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
...
|  | [ChangeConnectorParameters](M_TFlex_Model_Model3D_LCS_ChangeConnectorParameters.md) | (Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
|  | [ClearSwitch](M_TFlex_Model_Model3D_PointsLCS_ClearSwitch.md) | Сбросить все довороты и сдвиги осей |
...
|  | [IsConnector](M_TFlex_Model_Model3D_LCS_IsConnector.md) | (Унаследован от [LCS](T_TFlex_Model_Model3D_LCS.md)) |
...
|  | [SwitchAroundX](M_TFlex_Model_Model3D_PointsLCS_SwitchAroundX.md) | Повернуть ЛСК на 90 градусов вокруг оси X |
|  | [SwitchAroundY](M_TFlex_Model_Model3D_PointsLCS_SwitchAroundY.md) | Повернуть ЛСК на 90 градусов вокруг оси Y |
|  | [SwitchAroundZ](M_TFlex_Model_Model3D_PointsLCS_SwitchAroundZ.md) | Повернуть ЛСК на 90 градусов вокруг оси Z |
|  | [SwitchXYZ](M_TFlex_Model_Model3D_PointsLCS_SwitchXYZ.md) | Повернуть оси X, Y, Z |
