...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsGridControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [GridControl](M_TFlex_Dialogs_GridControl__ctor.md) | Инициализирует новый экземпляр класса GridControl |
|  | [GridControl(String)](M_TFlex_Dialogs_GridControl__ctor_1.md) | Инициализирует новый экземпляр класса GridControl |
|  | [GridControl(String, Int32, Int32)](M_TFlex_Dialogs_GridControl__ctor_2.md) | Инициализирует новый экземпляр класса GridControl |
...
|  | [AutoRatioValue](P_TFlex_Dialogs_GridControl_AutoRatioValue.md) | Автоподбор пропорции по содержимому. Используется в HeightRatios и WidthRatios. |
...
|  | [ColumnCount](P_TFlex_Dialogs_GridControl_ColumnCount.md) | Количество столбцов |
...
|  | [HeightRatios](P_TFlex_Dialogs_GridControl_HeightRatios.md) | Коллекция, хранящая отношения высоты для строк |
...
|  | [RowCount](P_TFlex_Dialogs_GridControl_RowCount.md) | Количество строк |
|  | [Tag](P_TFlex_Dialogs_BaseControl_Tag.md) | Пользовательские данные(Унаследован от [BaseControl](T_TFlex_Dialogs_BaseControl.md)) |
|  | [WidthRatios](P_TFlex_Dialogs_GridControl_WidthRatios.md) | Коллекция, хранящая отношения ширины для столбцов |
...
|  | [GetColumnSpan](M_TFlex_Dialogs_GridControl_GetColumnSpan.md) | Получить ширину данной ячейки в клетках |
|  | [GetControl](M_TFlex_Dialogs_GridControl_GetControl.md) | Получить элемент управления в заданной ячейке |
|  | [GetHashCode](https://learn.microsoft.com/dotnet/api/system.object.gethashcode) | Serves as the default hash function. (Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetRowSpan](M_TFlex_Dialogs_GridControl_GetRowSpan.md) | Получить высоту данной ячейки в клетках |
...
|  | [SetAutoHeight](M_TFlex_Dialogs_GridControl_SetAutoHeight.md) | Задать автоподбор высоты для строки |
|  | [SetAutoWidth](M_TFlex_Dialogs_GridControl_SetAutoWidth.md) | Задать автоподбор ширины для колонки |
|  | [SetColumnSpan](M_TFlex_Dialogs_GridControl_SetColumnSpan.md) | Установить ширину данной ячейки в клетках |
|  | [SetControl](M_TFlex_Dialogs_GridControl_SetControl.md) | Установить элемент управления заданной ячейки |
...
|  | [SetDimensions](M_TFlex_Dialogs_GridControl_SetDimensions.md) | Установить размер сетки |
|  | [SetRowSpan](M_TFlex_Dialogs_GridControl_SetRowSpan.md) | Установить высоту данной ячейки в клетках |
