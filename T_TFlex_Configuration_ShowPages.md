...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationShowPages
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ShowPages](M_TFlex_Configuration_ShowPages__ctor.md) | Инициализирует новый экземпляр класса ShowPages |
|  | [ShowPages(IntPtr, Boolean)](M_TFlex_Configuration_ShowPages__ctor_1.md) | Инициализирует новый экземпляр класса ShowPages |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AuxiliaryVisible](P_TFlex_Configuration_ShowPages_AuxiliaryVisible.md) |  |
|  | [BillOfMaterialsVisible](P_TFlex_Configuration_ShowPages_BillOfMaterialsVisible.md) |  |
|  | [CircuitVisible](P_TFlex_Configuration_ShowPages_CircuitVisible.md) |  |
|  | [DialogVisible](P_TFlex_Configuration_ShowPages_DialogVisible.md) |  |
|  | [ProjectionVisible](P_TFlex_Configuration_ShowPages_ProjectionVisible.md) |  |
|  | [TextVisible](P_TFlex_Configuration_ShowPages_TextVisible.md) |  |
|  | [WorkplaneVisible](P_TFlex_Configuration_ShowPages_WorkplaneVisible.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_ShowPages_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_ShowPages_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_ShowPages_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
