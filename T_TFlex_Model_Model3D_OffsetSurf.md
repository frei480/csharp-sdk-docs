...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DOffsetSurf
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OffsetSurf](M_TFlex_Model_Model3D_OffsetSurf__ctor.md) | Конструктор для создания Тела смещения |
...
|  | [GroupType](P_TFlex_Model_Model3D_OffsetSurf_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [OffsetFaceCount](P_TFlex_Model_Model3D_OffsetSurf_OffsetFaceCount.md) | Число особых граней |
|  | [Outside](P_TFlex_Model_Model3D_OffsetSurf_Outside.md) | Параметр построения оболочки наружу |
...
|  | [SourceOperation](P_TFlex_Model_Model3D_OffsetSurf_SourceOperation.md) |  |
|  | [StoreSourceBody](P_TFlex_Model_Model3D_OffsetSurf_StoreSourceBody.md) | Параметр сохранения исходного тела |
...
|  | [Value](P_TFlex_Model_Model3D_OffsetSurf_Value.md) | Величина смещения |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddOffsetFace](M_TFlex_Model_Model3D_OffsetSurf_AddOffsetFace.md) | Добавить грань с особым смещением |
...
|  | [GetOffsetFace](M_TFlex_Model_Model3D_OffsetSurf_GetOffsetFace.md) | Получить особую грань |
...
|  | [RemoveAllOffsetFaces](M_TFlex_Model_Model3D_OffsetSurf_RemoveAllOffsetFaces.md) | Удалить все особые грани |
|  | [RemoveOffsetFace](M_TFlex_Model_Model3D_OffsetSurf_RemoveOffsetFace.md) | Удалить особую грань |
