...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DUnbend
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Unbend](M_TFlex_Model_Model3D_Unbend__ctor.md) | Конструктор для операции "Разгибка" |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AutoNLF](P_TFlex_Model_Model3D_Unbend_AutoNLF.md) | Используется ли автоматический поиск коэффициента нейтрального слоя |
...
|  | [CylindricalFaces](P_TFlex_Model_Model3D_Unbend_CylindricalFaces.md) | Получить цилиндрические поверхности |
...
|  | [GroupType](P_TFlex_Model_Model3D_Unbend_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [KeptPlanarFace](P_TFlex_Model_Model3D_Unbend_KeptPlanarFace.md) | Неподвижная грань |
...
|  | [NLF](P_TFlex_Model_Model3D_Unbend_NLF.md) | Коэффициент нейтрального слоя |
...
|  | [GetLengthArray](M_TFlex_Model_Model3D_Unbend_GetLengthArray.md) | Получить список длин гибов |
