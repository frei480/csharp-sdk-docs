...
|  | Имя | Описание |
| --- | --- | --- |
|  | [EdgePath](M_TFlex_Model_Model3D_EdgePath__ctor.md) | Конструктор для создания пути по набору рёбер |
...
|  | [Edges](P_TFlex_Model_Model3D_EdgePath_Edges.md) | Множество рёбер |
