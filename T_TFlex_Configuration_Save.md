...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSave
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Save](M_TFlex_Configuration_Save__ctor.md) | Инициализирует новый экземпляр класса Save |
|  | [Save(IntPtr, Boolean)](M_TFlex_Configuration_Save__ctor_1.md) | Инициализирует новый экземпляр класса Save |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AutoSave](P_TFlex_Configuration_Save_AutoSave.md) |  |
|  | [AutoSaveTime](P_TFlex_Configuration_Save_AutoSaveTime.md) |  |
|  | [CreateBackup](P_TFlex_Configuration_Save_CreateBackup.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Save_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Save_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Save_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
