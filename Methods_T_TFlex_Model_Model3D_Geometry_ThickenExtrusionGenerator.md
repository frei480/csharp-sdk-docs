...
# ThickenExtrusionGenerator - методы  
    
Тип [ThickenExtrusionGenerator](T_TFlex_Model_Model3D_Geometry_ThickenExtrusionGenerator.md) предоставляет следующие члены.
