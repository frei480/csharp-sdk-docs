...
# LinesConstructionsDrawLast - свойство  
  
---  
**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool ConstructionsDrawLast { get; set; }
```
```vb
Public Property ConstructionsDrawLast As Boolean
	Get
	Set
```
```cpp
public:
property bool ConstructionsDrawLast {
	bool get ();
	void set (bool value);
}
```
