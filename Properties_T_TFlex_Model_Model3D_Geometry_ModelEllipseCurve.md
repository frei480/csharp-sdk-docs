...
# ModelEllipseCurve - свойства  
    
Тип [ModelEllipseCurve](T_TFlex_Model_Model3D_Geometry_ModelEllipseCurve.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Center](P_TFlex_Model_Model3D_Geometry_ModelEllipseCurve_Center.md) | Получить центр эллипса |
|  | [MajorRadius](P_TFlex_Model_Model3D_Geometry_ModelEllipseCurve_MajorRadius.md) | Получить большой радиус эллипса |
|  | [MinorRadius](P_TFlex_Model_Model3D_Geometry_ModelEllipseCurve_MinorRadius.md) | Получить малый радиус эллипса |
|  | [Normal](P_TFlex_Model_Model3D_Geometry_ModelEllipseCurve_Normal.md) | Получить нормаль к плоскости эллипса |
...
|  | [SemiAxis](P_TFlex_Model_Model3D_Geometry_ModelEllipseCurve_SemiAxis.md) | Получить полуось, от которой откладывается угол эллипса |
...
[ModelEllipseCurve - ](T_TFlex_Model_Model3D_Geometry_ModelEllipseCurve.md)
