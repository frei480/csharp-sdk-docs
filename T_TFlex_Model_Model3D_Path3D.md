...
Базовый класс для всех типов 3D путей

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DPath3D Подробнее

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class Path3D : Construction3D
```
```vb
Public Class Path3D
...
```
```cpp
public ref class Path3D : public Construction3D
```


Тип Path3D предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Path3D](M_TFlex_Model_Model3D_Path3D__ctor.md) | Конструктор для создания нового пути |
...
|  | [ConvertToSpline](P_TFlex_Model_Model3D_Path3D_ConvertToSpline.md) | Получить параметры для преобразования пути в сплайн |
|  | [CutIndex](P_TFlex_Model_Model3D_Path3D_CutIndex.md) | Индекс решения |
...
|  | [FirstCutPoint](P_TFlex_Model_Model3D_Path3D_FirstCutPoint.md) | Первая точка обрезки |
|  | [Geometry](P_TFlex_Model_Model3D_Path3D_Geometry.md) | Получить геометрические данные пути |
|  | [GroupType](P_TFlex_Model_Model3D_Path3D_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Path3DSegments](P_TFlex_Model_Model3D_Path3D_Path3DSegments.md) | Возвращает информацию об участках пути |
|  | [Reverse](P_TFlex_Model_Model3D_Path3D_Reverse.md) | Реверисровать направление пути |
|  | [SecondCutPoint](P_TFlex_Model_Model3D_Path3D_SecondCutPoint.md) | Вторая точка обрезки |
...
|  | [Create](M_TFlex_Model_Model3D_Path3D_Create.md) |  |
...
|  | [TestCompatibility](M_TFlex_Model_Model3D_Path3D_TestCompatibility.md) | Проверить совместимость типов, трасса и трасса |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DPath3D [TFlex.Model.Model3DAreaPath](T_TFlex_Model_Model3D_AreaPath.md) [TFlex.Model.Model3DCopyPath](T_TFlex_Model_Model3D_CopyPath.md) [TFlex.Model.Model3DEdgePath](T_TFlex_Model_Model3D_EdgePath.md) [TFlex.Model.Model3DEquidistant3DPath](T_TFlex_Model_Model3D_Equidistant3DPath.md) [TFlex.Model.Model3DEquidistantPath](T_TFlex_Model_Model3D_EquidistantPath.md) [TFlex.Model.Model3DIntersectionPath](T_TFlex_Model_Model3D_IntersectionPath.md) [TFlex.Model.Model3DOffsetPath](T_TFlex_Model_Model3D_OffsetPath.md) [TFlex.Model.Model3DOutlinePath](T_TFlex_Model_Model3D_OutlinePath.md) [TFlex.Model.Model3DParametricPath](T_TFlex_Model_Model3D_ParametricPath.md) [TFlex.Model.Model3DPath2DPath](T_TFlex_Model_Model3D_Path2DPath.md) [TFlex.Model.Model3DPath3DPath](T_TFlex_Model_Model3D_Path3DPath.md) [TFlex.Model.Model3DPathBy2DElems](T_TFlex_Model_Model3D_PathBy2DElems.md) [TFlex.Model.Model3DPipePath3D](T_TFlex_Model_Model3D_PipePath3D.md) [TFlex.Model.Model3DProjectionPath](T_TFlex_Model_Model3D_ProjectionPath.md) [TFlex.Model.Model3DReferencePath](T_TFlex_Model_Model3D_ReferencePath.md) [TFlex.Model.Model3DSectionPath](T_TFlex_Model_Model3D_SectionPath.md) [TFlex.Model.Model3DSplinePath3D](T_TFlex_Model_Model3D_SplinePath3D.md) [TFlex.Model.Model3DTwoProjectionsPath](T_TFlex_Model_Model3D_TwoProjectionsPath.md)