...
# ComparisonOperatorGreaterThanOrEqual - поле  
...
```
```vb
Public Shared ReadOnly GreaterThanOrEqual As ComparisonOperator
```
```cpp
public:
static initonly ComparisonOperator^ GreaterThanOrEqual
```
