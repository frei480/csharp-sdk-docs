...
# EllipseOutline - класс  
    
Эллипс по центру и точке

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DEllipseOutline
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [EllipseOutline](M_TFlex_Model_Model2D_EllipseOutline__ctor.md) | Конструктор |
...
|  | [CenterNode](P_TFlex_Model_Model2D_EllipseOutline_CenterNode.md) | Центр эллипса |
...
|  | [Point](P_TFlex_Model_Model2D_EllipseOutline_Point.md) | Точка эллипса |
...
|  | [Radius](P_TFlex_Model_Model2D_EllipseOutline_Radius.md) | Радиус эллипса |
