...
# StandardColorsDecoration3 - свойство  
...
```csharp
public static Color Decoration3 { get; }
```
```vb
Public Shared ReadOnly Property Decoration3 As Color
	Get
```
```cpp
public:
static property Color Decoration3 {
	Color get ();
}
```
