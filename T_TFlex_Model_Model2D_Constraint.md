...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DConstraint
...
|  | [GroupType](P_TFlex_Model_Model2D_Constraint_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_Constraint_Layer.md) | Слой, на котором размещается объект |
...
|  | [CreateAlignHorizontal](M_TFlex_Model_Model2D_Constraint_CreateAlignHorizontal.md) | Создать ограничение "Выравнивание по горизонтали" |
|  | [CreateAlignVertical](M_TFlex_Model_Model2D_Constraint_CreateAlignVertical.md) | Создать ограничение "Выравнивание по вертикали" |
|  | [CreateCoincident](M_TFlex_Model_Model2D_Constraint_CreateCoincident.md) | Создать ограничение "Совпадение" |
|  | [CreateCollinear](M_TFlex_Model_Model2D_Constraint_CreateCollinear.md) | Создать ограничение "Коллинеарность" |
|  | [CreateConcentric](M_TFlex_Model_Model2D_Constraint_CreateConcentric.md) | Создать ограничение "Соосность" |
|  | [CreateEqualLength](M_TFlex_Model_Model2D_Constraint_CreateEqualLength.md) | Создать ограничение "Равная длина" |
|  | [CreateEqualRadius](M_TFlex_Model_Model2D_Constraint_CreateEqualRadius.md) | Создать ограничение "Равный радиус" |
|  | [CreateFixed](M_TFlex_Model_Model2D_Constraint_CreateFixed.md) | Создать ограничение "Фиксация" |
|  | [CreateFixedAngle](M_TFlex_Model_Model2D_Constraint_CreateFixedAngle.md) | Создать ограничение "Фиксированный угол" |
|  | [CreateFixedLength](M_TFlex_Model_Model2D_Constraint_CreateFixedLength.md) | Создать ограничение "Фиксированная длина" |
|  | [CreateHorizontal](M_TFlex_Model_Model2D_Constraint_CreateHorizontal.md) | Создать ограничение "Горизонтальность" |
|  | [CreateMidPoint](M_TFlex_Model_Model2D_Constraint_CreateMidPoint.md) | Создать ограничение "Симметрия" |
|  | [CreateObject](M_TFlex_Model_Model2D_Object2D_CreateObject.md) | (Унаследован от [Object2D](T_TFlex_Model_Model2D_Object2D.md)) |
|  | [CreateParallel](M_TFlex_Model_Model2D_Constraint_CreateParallel.md) | Создать ограничение "Параллельность" |
|  | [CreatePerpendicular](M_TFlex_Model_Model2D_Constraint_CreatePerpendicular.md) | Создать ограничение "Перпендикулярность" |
...
|  | [CreateSymmetric](M_TFlex_Model_Model2D_Constraint_CreateSymmetric.md) | Создать ограничение "Симметрия" |
|  | [CreateTangent](M_TFlex_Model_Model2D_Constraint_CreateTangent.md) | Создать ограничение "Касательность" |
|  | [CreateVertical](M_TFlex_Model_Model2D_Constraint_CreateVertical.md) | Создать ограничение "Вертиклаьность" |
