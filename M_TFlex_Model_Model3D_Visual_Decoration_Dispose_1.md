...
# DecorationDispose(Boolean) - метод  
    
Освобождает неуправляемые ресурсы, используемые объектом [Decoration](T_TFlex_Model_Model3D_Visual_Decoration.md), а при необходимости освобождает также управляемые ресурсы
...
[Dispose - перегрузка](Overload_TFlex_Model_Model3D_Visual_Decoration_Dispose.md)
