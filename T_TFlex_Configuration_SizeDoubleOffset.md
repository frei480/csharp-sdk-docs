...
# SizeDoubleOffset - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSizeDoubleOffset
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SizeDoubleOffset](M_TFlex_Configuration_SizeDoubleOffset__ctor.md) | Инициализирует новый экземпляр класса SizeDoubleOffset |
|  | [SizeDoubleOffset(IntPtr, Boolean)](M_TFlex_Configuration_SizeDoubleOffset__ctor_1.md) | Инициализирует новый экземпляр класса SizeDoubleOffset |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [X](P_TFlex_Configuration_SizeDoubleOffset_X.md) |  |
|  | [Y](P_TFlex_Configuration_SizeDoubleOffset_Y.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_SizeDoubleOffset_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_SizeDoubleOffset_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_SizeDoubleOffset_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
...
|  | [ToString](M_TFlex_Configuration_SizeDoubleOffset_ToString.md) | (Переопределяет [ObjectToString](https://learn.microsoft.com/dotnet/api/system.object.tostring)) |
