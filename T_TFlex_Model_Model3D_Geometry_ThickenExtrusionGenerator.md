...
# ThickenExtrusionGenerator - класс  
    
Генератор придания толщины

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryBaseGenerator](T_TFlex_Model_Model3D_Geometry_BaseGenerator.md) [TFlex.Model.Model3D.GeometryBodyGenerator](T_TFlex_Model_Model3D_Geometry_BodyGenerator.md) TFlex.Model.Model3D.GeometryThickenExtrusionGenerator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ThickenExtrusionGenerator](M_TFlex_Model_Model3D_Geometry_ThickenExtrusionGenerator__ctor.md) | Конструктор для задания придания толщины |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_ThickenExtrusionGenerator_Run.md) | Функция генерации придания толщины(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
