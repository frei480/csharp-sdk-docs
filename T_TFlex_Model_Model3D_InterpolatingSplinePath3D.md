...
# InterpolatingSplinePath3D - класс  
    
Класс сплайна построенного через узлы

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DPath3D](T_TFlex_Model_Model3D_Path3D.md) [TFlex.Model.Model3DSplinePath3D](T_TFlex_Model_Model3D_SplinePath3D.md) TFlex.Model.Model3DInterpolatingSplinePath3D

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class InterpolatingSplinePath3D : SplinePath3D
```
```vb
Public Class InterpolatingSplinePath3D
	Inherits SplinePath3D
```
```cpp
public ref class InterpolatingSplinePath3D : public SplinePath3D
```


Тип InterpolatingSplinePath3D предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [InterpolatingSplinePath3D](M_TFlex_Model_Model3D_InterpolatingSplinePath3D__ctor.md) | Конструктор для создания сплайна через узлы |
...
|  | [EndDerivative](P_TFlex_Model_Model3D_InterpolatingSplinePath3D_EndDerivative.md) | Касательные условия в конце кривой |
...
|  | [StartDerivative](P_TFlex_Model_Model3D_InterpolatingSplinePath3D_StartDerivative.md) | Касательные условия в начале кривой |
