...
Класс экспорта в формат DWG

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelExportTo](T_TFlex_Model_ExportTo.md) [TFlex.ModelExportToACAD](T_TFlex_Model_ExportToACAD.md) TFlex.ModelExportToDWG
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExportToDWG](M_TFlex_Model_ExportToDWG__ctor.md) | Инициализирует новый экземпляр класса ExportToDWG |
...
|  | [Export](M_TFlex_Model_ExportToDWG_Export.md) | Функция экспорта документа(Переопределяет [ExportToExport(String)](M_TFlex_Model_ExportTo_Export.md)) |
