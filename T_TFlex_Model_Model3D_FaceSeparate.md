...
Операция отделения граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFaceSeparate
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FaceSeparate](M_TFlex_Model_Model3D_FaceSeparate__ctor.md) | Конструктор для создания операции "Отделения граней" |
...
|  | [Faces](P_TFlex_Model_Model3D_FaceSeparate_Faces.md) | Отделяемые грани |
...
|  | [SourceHealingMethod](P_TFlex_Model_Model3D_FaceSeparate_SourceHealingMethod.md) | Обработка исходных граней |
...
|  | [TargetHealingMethod](P_TFlex_Model_Model3D_FaceSeparate_TargetHealingMethod.md) | Обработка отделяемых граней |
