...
# ConstraintCreatePerpendicular - метод  
...
```csharp
public static Constraint CreatePerpendicular(
	Document iDoc,
	Object2D iObject1,
	Object2D iObject2
)
```
```vb
Public Shared Function CreatePerpendicular ( 
	iDoc As Document,
...
```cpp
public:
static Constraint^ CreatePerpendicular(
	Document^ iDoc, 
	Object2D^ iObject1, 
	Object2D^ iObject2
)
