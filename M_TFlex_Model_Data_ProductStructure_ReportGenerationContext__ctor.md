...
# ReportGenerationContext - конструктор  
    
Инициализирует новый экземпляр класса [ReportGenerationContext](T_TFlex_Model_Data_ProductStructure_ReportGenerationContext.md)
