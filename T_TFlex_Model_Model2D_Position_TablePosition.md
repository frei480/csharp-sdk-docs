...
# PositionTablePosition - структура  
    
Положение курсора в таблице

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model2DPositionTablePosition
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PositionTablePosition](M_TFlex_Model_Model2D_Position_TablePosition__ctor.md) | Конструктор |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Cell](F_TFlex_Model_Model2D_Position_TablePosition_Cell.md) | Порядковый номер ячейки таблицы |
|  | [Index](F_TFlex_Model_Model2D_Position_TablePosition_Index.md) | Порядковый номер таблицы относительно начала текста |
