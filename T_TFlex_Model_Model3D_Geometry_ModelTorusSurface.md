...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Axis](P_TFlex_Model_Model3D_Geometry_ModelTorusSurface_Axis.md) | Получить ось симметрии |
|  | [MajorRadius](P_TFlex_Model_Model3D_Geometry_ModelTorusSurface_MajorRadius.md) | Получить большой радиус |
|  | [MinorRadius](P_TFlex_Model_Model3D_Geometry_ModelTorusSurface_MinorRadius.md) | Получить малый радиус |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Geometry_ModelTorusSurface_ReferenceDirection.md) | Получить полуось основания, от которой откладываются углы |
