...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LineSurfaceDevelopmentProfile](M_TFlex_Model_Model3D_LineSurfaceDevelopmentProfile__ctor.md) | Конструктор для создания развёртки грани на линейчатой поверхности |
...
|  | [Face](P_TFlex_Model_Model3D_LineSurfaceDevelopmentProfile_Face.md) | Разворачиваемая грань |
...
|  | [PointOnFace](P_TFlex_Model_Model3D_LineSurfaceDevelopmentProfile_PointOnFace.md) | Точка на грани |
