...
# ThreeFaceBlending - класс  
  
---  
  
Сглаживание 3-х граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DThreeFaceBlending
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ThreeFaceBlending](M_TFlex_Model_Model3D_ThreeFaceBlending__ctor.md) | Конструктор для создания объекта ThreeFaceBlending |
...
|  | [CenterFaceReverse](P_TFlex_Model_Model3D_ThreeFaceBlending_CenterFaceReverse.md) | Тип реверса для центральных граней |
...
|  | [GroupType](P_TFlex_Model_Model3D_ThreeFaceBlending_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [LeftFaceReverse](P_TFlex_Model_Model3D_ThreeFaceBlending_LeftFaceReverse.md) | Тип реверса для левых граней |
...
|  | [NumberOfCenterFaces](P_TFlex_Model_Model3D_ThreeFaceBlending_NumberOfCenterFaces.md) | Получить число центральных граней |
|  | [NumberOfLeftFaces](P_TFlex_Model_Model3D_ThreeFaceBlending_NumberOfLeftFaces.md) | Число левых граней |
|  | [NumberOfRightFaces](P_TFlex_Model_Model3D_ThreeFaceBlending_NumberOfRightFaces.md) | Число правых граней |
...
|  | [Path](P_TFlex_Model_Model3D_ThreeFaceBlending_Path.md) | Путь |
|  | [PropagateFlag](P_TFlex_Model_Model3D_ThreeFaceBlending_PropagateFlag.md) | Параметр "продолжить по касательной" |
|  | [RightFaceReverse](P_TFlex_Model_Model3D_ThreeFaceBlending_RightFaceReverse.md) | Тип реверса для правых граней |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddCenterFace](M_TFlex_Model_Model3D_ThreeFaceBlending_AddCenterFace.md) | Добавить центральную грань |
|  | [AddLeftFace](M_TFlex_Model_Model3D_ThreeFaceBlending_AddLeftFace.md) | Добавить левую грань |
|  | [AddRightFace](M_TFlex_Model_Model3D_ThreeFaceBlending_AddRightFace.md) | Добавить правой грань |
...
|  | [GetCenterFace](M_TFlex_Model_Model3D_ThreeFaceBlending_GetCenterFace.md) | Получить центральную грань |
...
|  | [GetLeftFace](M_TFlex_Model_Model3D_ThreeFaceBlending_GetLeftFace.md) | Получить левую грань |
...
|  | [GetRightFace](M_TFlex_Model_Model3D_ThreeFaceBlending_GetRightFace.md) | Получить правую грань |
...
|  | [RemoveAllCenterFaces](M_TFlex_Model_Model3D_ThreeFaceBlending_RemoveAllCenterFaces.md) | Удалить все центральные грани |
|  | [RemoveAllLeftFaces](M_TFlex_Model_Model3D_ThreeFaceBlending_RemoveAllLeftFaces.md) | Удалить все левые грани |
|  | [RemoveAllRightFaces](M_TFlex_Model_Model3D_ThreeFaceBlending_RemoveAllRightFaces.md) | Удалить все правые грани |
|  | [RemoveCenterFace](M_TFlex_Model_Model3D_ThreeFaceBlending_RemoveCenterFace.md) | Удалить центральную грань |
|  | [RemoveLeftFace](M_TFlex_Model_Model3D_ThreeFaceBlending_RemoveLeftFace.md) | Удалить левую грань |
|  | [RemoveRightFace](M_TFlex_Model_Model3D_ThreeFaceBlending_RemoveRightFace.md) | Удалить правую грань |
