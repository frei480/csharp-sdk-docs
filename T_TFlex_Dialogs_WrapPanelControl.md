...
# WrapPanelControl - класс  
    
Панель элементов управления с переносом

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsWrapPanelControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [WrapPanelControl](M_TFlex_Dialogs_WrapPanelControl__ctor.md) | Инициализирует новый экземпляр класса WrapPanelControl |
|  | [WrapPanelControl(String)](M_TFlex_Dialogs_WrapPanelControl__ctor_1.md) | Инициализирует новый экземпляр класса WrapPanelControl |
|  | [WrapPanelControl(String, WrapPanelControlOrientation)](M_TFlex_Dialogs_WrapPanelControl__ctor_2.md) | Инициализирует новый экземпляр класса WrapPanelControl |
...
|  | [ItemHeight](P_TFlex_Dialogs_WrapPanelControl_ItemHeight.md) | Получает или задает значение, указывающее высоту всех элементов, содержащихся внутри WrapPanel. |
|  | [ItemWidth](P_TFlex_Dialogs_WrapPanelControl_ItemWidth.md) | Получает или задает значение, указывающее ширину всех элементов, содержащихся внутри WrapPanel. |
...
|  | [Orientation](P_TFlex_Dialogs_WrapPanelControl_Orientation.md) | Устанавливает ориентацию группы |
...
Дочерние элементы стыкуются вертикально или горизонтально
