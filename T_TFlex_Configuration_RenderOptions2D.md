...
# RenderOptions2D - класс  
  
---  
  
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationRenderOptions2D

**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class RenderOptions2D : SettingsGroup
```
```vb
Public Class RenderOptions2D
	Inherits SettingsGroup
```
```cpp
public ref class RenderOptions2D : public SettingsGroup
```


Тип RenderOptions2D предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [RenderOptions2D](M_TFlex_Configuration_RenderOptions2D__ctor.md) | Инициализирует новый экземпляр класса RenderOptions2D |
|  | [RenderOptions2D(IntPtr, Boolean)](M_TFlex_Configuration_RenderOptions2D__ctor_1.md) | Инициализирует новый экземпляр класса RenderOptions2D |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ShowDebugInfo](P_TFlex_Configuration_RenderOptions2D_ShowDebugInfo.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_RenderOptions2D_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_RenderOptions2D_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_RenderOptions2D_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
