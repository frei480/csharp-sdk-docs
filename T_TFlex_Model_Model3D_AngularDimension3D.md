...
|  | [IsExternal](P_TFlex_Model_Model3D_AngularDimension3D_IsExternal.md) | Управление параметром "Внешний" 3D-размера |
...
|  | [SubType](P_TFlex_Model_Model3D_AngularDimension3D_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [CreateProjected](M_TFlex_Model_Model3D_AngularDimension3D_CreateProjected.md) | Создание проекции размера |
...
|  | [SetElements](M_TFlex_Model_Model3D_AngularDimension3D_SetElements.md) | Установка привязок размера к 3D элементам |
...
|  | [SetLeaderNote](M_TFlex_Model_Model3D_AngularDimension3D_SetLeaderNote.md) | Установка привязок размера по относительным смещениям |
|  | [SetOffsets](M_TFlex_Model_Model3D_AngularDimension3D_SetOffsets.md) | Установка привязок размера по относительным смещениям |
