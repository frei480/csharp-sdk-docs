...
# FixScriptResult - методы  
  
---  
  
Тип [FixScriptResult](T_TFlex_QualityManagement_FixScriptResult.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Dispose](M_TFlex_QualityManagement_FixScriptResult_Dispose.md) |  |
