...
# ListControlButtonCollectionContains(ListControlStandardButton) - метод  
  
---  
  
Проверка наличия стандартной кнопки
...
[Contains - перегрузка](Overload_TFlex_Dialogs_ListControlButtonCollection_Contains.md)
