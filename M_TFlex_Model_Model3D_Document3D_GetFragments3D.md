...
# Document3DGetFragments3D - метод  
    
Контейнер 3D фрагментов

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public static ICollection<Fragment3D> GetFragments3D(
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Fragment3D](T_TFlex_Model_Model3D_Fragment3D.md)
