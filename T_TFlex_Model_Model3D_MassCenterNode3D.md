...
|  | Имя | Описание |
| --- | --- | --- |
|  | [MassCenterNode3D](M_TFlex_Model_Model3D_MassCenterNode3D__ctor.md) | Конструктор для создания узла в центре масс |
...
|  | [Operations](P_TFlex_Model_Model3D_MassCenterNode3D_Operations.md) | Множество операций |
...
|  | [ResultByBoundBox](P_TFlex_Model_Model3D_MassCenterNode3D_ResultByBoundBox.md) |  |
