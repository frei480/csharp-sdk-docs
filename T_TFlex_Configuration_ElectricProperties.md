...
# ElectricProperties - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationElectricProperties

**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class ElectricProperties : SettingsGroup
```
```vb
...
```
```cpp
public ref class ElectricProperties : public SettingsGroup
```


Тип ElectricProperties предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [ElectricProperties](M_TFlex_Configuration_ElectricProperties__ctor.md) | Инициализирует новый экземпляр класса ElectricProperties |
|  | [ElectricProperties(IntPtr, Boolean)](M_TFlex_Configuration_ElectricProperties__ctor_1.md) | Инициализирует новый экземпляр класса ElectricProperties |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ChainsAndSignals](P_TFlex_Configuration_ElectricProperties_ChainsAndSignals.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_ElectricProperties_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_ElectricProperties_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_ElectricProperties_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
