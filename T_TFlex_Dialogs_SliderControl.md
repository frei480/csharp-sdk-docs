...
Элемент управления Слайдер

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsSliderControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SliderControl](M_TFlex_Dialogs_SliderControl__ctor.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String)](M_TFlex_Dialogs_SliderControl__ctor_1.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, NumericInputControl)](M_TFlex_Dialogs_SliderControl__ctor_2.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, Range)](M_TFlex_Dialogs_SliderControl__ctor_5.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, NumericInputControl, Double)](M_TFlex_Dialogs_SliderControl__ctor_3.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, Range, Double)](M_TFlex_Dialogs_SliderControl__ctor_6.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, NumericInputControl, Double, Double)](M_TFlex_Dialogs_SliderControl__ctor_4.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, Range, Double, Double)](M_TFlex_Dialogs_SliderControl__ctor_7.md) | Инициализирует новый экземпляр класса SliderControl |
|  | [SliderControl(String, Range, Double, Double, Double)](M_TFlex_Dialogs_SliderControl__ctor_8.md) | Инициализирует новый экземпляр класса SliderControl |
...
|  | [LinkedInputControl](P_TFlex_Dialogs_SliderControl_LinkedInputControl.md) | Связанный контрол ввода числового значения |
...
|  | [Range](P_TFlex_Dialogs_SliderControl_Range.md) | Управление диапазоном значений слайдера |
|  | [Step](P_TFlex_Dialogs_SliderControl_Step.md) | Шаг изменения значения |
|  | [Tag](P_TFlex_Dialogs_BaseControl_Tag.md) | Пользовательские данные(Унаследован от [BaseControl](T_TFlex_Dialogs_BaseControl.md)) |
|  | [Value](P_TFlex_Dialogs_SliderControl_Value.md) | Текущее значение слайдера |
|  | [VisualStep](P_TFlex_Dialogs_SliderControl_VisualStep.md) | Шаг графических отметок на слайдере |
...
|  | [ValueChanged](E_TFlex_Dialogs_SliderControl_ValueChanged.md) | Событие смены текущего значения |
