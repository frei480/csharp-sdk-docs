...
|  | [AsTerm](P_TFlex_Model_Data_Filters_Term_AsTerm.md) | Приводит текущий объект к типу [Term](T_TFlex_Model_Data_Filters_Term.md)(Переопределяет [TermGroupItemAsTerm](P_TFlex_Model_Data_Filters_TermGroupItem_AsTerm.md)) |
