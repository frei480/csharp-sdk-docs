...
# MoveVectorTransformation - класс  
  
---  
  
Класс преобразования перемещения вдоль вектора

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) [TFlex.Model.Model3DVectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md) TFlex.Model.Model3DMoveVectorTransformation

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class MoveVectorTransformation : VectorTransformation
```
```vb
Public Class MoveVectorTransformation
	Inherits VectorTransformation
```
```cpp
public ref class MoveVectorTransformation : public VectorTransformation
```


Тип MoveVectorTransformation предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [MoveVectorTransformation](M_TFlex_Model_Model3D_MoveVectorTransformation__ctor.md) | Конструктор для создания нового преобразования перемещения вдоль вектора |
...
|  | [Offset](P_TFlex_Model_Model3D_MoveVectorTransformation_Offset.md) | Длина перемещения |
