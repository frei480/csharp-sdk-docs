...
# ProjectionNode - класс  
    
Узел полученный проецированием

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DProjectionNode
...
|  | [ProjectionNode(Document, ModelObject, ModelObject)](M_TFlex_Model_Model2D_ProjectionNode__ctor_1.md) | Конструктор, задающий 3d объекты |
...
|  | [ProjectedObject](P_TFlex_Model_Model2D_ProjectionNode_ProjectedObject.md) | проецируемый объект |
|  | [SubType](P_TFlex_Model_Model2D_ProjectionNode_SubType.md) | Тип узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
...
|  | [Workplane](P_TFlex_Model_Model2D_ProjectionNode_Workplane.md) | Рабочая плоскость |
