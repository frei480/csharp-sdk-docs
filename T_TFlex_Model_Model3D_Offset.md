...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DOffset
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Offset](M_TFlex_Model_Model3D_Offset__ctor.md) | Конструктор для создания Тела смещения |
...
|  | [GroupType](P_TFlex_Model_Model3D_Offset_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [OffsetFaceCount](P_TFlex_Model_Model3D_Offset_OffsetFaceCount.md) | Число особых граней |
|  | [Outside](P_TFlex_Model_Model3D_Offset_Outside.md) | Параметр построения оболочки наружу |
...
|  | [SourceOperation](P_TFlex_Model_Model3D_Offset_SourceOperation.md) |  |
|  | [StoreSourceBody](P_TFlex_Model_Model3D_Offset_StoreSourceBody.md) | Параметр сохранения исходного тела |
...
|  | [Value](P_TFlex_Model_Model3D_Offset_Value.md) | Величина смещения |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddOffsetFace](M_TFlex_Model_Model3D_Offset_AddOffsetFace.md) | Добавить грань с особым смещением |
...
|  | [GetOffsetFace](M_TFlex_Model_Model3D_Offset_GetOffsetFace.md) | Получить особую грань |
...
|  | [RemoveAllOffsetFaces](M_TFlex_Model_Model3D_Offset_RemoveAllOffsetFaces.md) | Удалить все особые грани |
|  | [RemoveOffsetFace](M_TFlex_Model_Model3D_Offset_RemoveOffsetFace.md) | Удалить особую грань |
