...
# StandardColorsActiveNodeMark - свойство  
...
```csharp
public static Color ActiveNodeMark { get; }
```
```vb
Public Shared ReadOnly Property ActiveNodeMark As Color
	Get
```
```cpp
public:
static property Color ActiveNodeMark {
	Color get ();
}
```
