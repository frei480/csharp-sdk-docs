...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DTaper
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Taper](M_TFlex_Model_Model3D_Taper__ctor.md) | Конструктор для создания Уклона |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AnalyzeFlag](P_TFlex_Model_Model3D_Taper_AnalyzeFlag.md) | Параметр разбиения грани |
|  | [Angle](P_TFlex_Model_Model3D_Taper_Angle.md) | Угол |
...
|  | [CoprocessingFlag](P_TFlex_Model_Model3D_Taper_CoprocessingFlag.md) | Параметр совместной обработки граней |
|  | [Direction](P_TFlex_Model_Model3D_Taper_Direction.md) | Направление |
...
|  | [FixedPlane](P_TFlex_Model_Model3D_Taper_FixedPlane.md) | Плоскость |
...
|  | [GroupType](P_TFlex_Model_Model3D_Taper_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Method](P_TFlex_Model_Model3D_Taper_Method.md) | Метод |
...
|  | [NumberOfFaces](P_TFlex_Model_Model3D_Taper_NumberOfFaces.md) | Получить число уклоняемых граней |
|  | [NumberOfStepEdges](P_TFlex_Model_Model3D_Taper_NumberOfStepEdges.md) | Получить число рёбер |
...
|  | [OffsetFace](P_TFlex_Model_Model3D_Taper_OffsetFace.md) | Грань смещения |
...
|  | [ReverseFlag](P_TFlex_Model_Model3D_Taper_ReverseFlag.md) | Реверс угла |
|  | [SmoothFlag](P_TFlex_Model_Model3D_Taper_SmoothFlag.md) | Параметр учёта гладкости |
|  | [StepEdges](P_TFlex_Model_Model3D_Taper_StepEdges.md) | Тип рёбер ступенчатого уклона |
...
|  | [AddFace(ModelFace, ModelFace)](M_TFlex_Model_Model3D_Taper_AddFace_1.md) | Добавить пару опорная грань - уклоняемая грань |
|  | [AddStepEdge](M_TFlex_Model_Model3D_Taper_AddStepEdge.md) | Добавить ребро задающее шаг |
...
|  | [GetStepEdge](M_TFlex_Model_Model3D_Taper_GetStepEdge.md) | Получить ребро |
|  | [GetStepPath](M_TFlex_Model_Model3D_Taper_GetStepPath.md) | Получить путь связанный с уклоняемой гранью |
...
|  | [RemoveAllFaces](M_TFlex_Model_Model3D_Taper_RemoveAllFaces.md) | Удалить все грани |
|  | [RemoveAllStepEdges](M_TFlex_Model_Model3D_Taper_RemoveAllStepEdges.md) | Удалить все рёбра |
|  | [RemoveStepEdge](M_TFlex_Model_Model3D_Taper_RemoveStepEdge.md) | Удалить ребро |
...
|  | [SetStepPath](M_TFlex_Model_Model3D_Taper_SetStepPath.md) | Задать путь связанный с уклоняемой гранью |
