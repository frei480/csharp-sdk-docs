...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DBodyTaper
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [BodyTaper](M_TFlex_Model_Model3D_BodyTaper__ctor.md) | Конструктор для создания операция "Изменение граней" |
...
|  | [BottomAngle](P_TFlex_Model_Model3D_BodyTaper_BottomAngle.md) | Нижний угол |
|  | [BottomEdgeCount](P_TFlex_Model_Model3D_BodyTaper_BottomEdgeCount.md) | Получить число нижних рёбер |
|  | [BottomFaceCount](P_TFlex_Model_Model3D_BodyTaper_BottomFaceCount.md) | Получить число нижних граней |
...
|  | [Concave](P_TFlex_Model_Model3D_BodyTaper_Concave.md) | Исправление внутренних углов |
|  | [ConcaveRadius](P_TFlex_Model_Model3D_BodyTaper_ConcaveRadius.md) | Радиус исправления внутренних углов |
...
|  | [Corner](P_TFlex_Model_Model3D_BodyTaper_Corner.md) | Обработка стыкующихся углов уклоняемых граней |
|  | [Direction](P_TFlex_Model_Model3D_BodyTaper_Direction.md) | Направление |
|  | [DirectionReverse](P_TFlex_Model_Model3D_BodyTaper_DirectionReverse.md) | Реверс направления |
...
|  | [GroupType](P_TFlex_Model_Model3D_BodyTaper_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [KeepSourceBody](P_TFlex_Model_Model3D_BodyTaper_KeepSourceBody.md) | Оставлять исходное тело |
...
|  | [Method](P_TFlex_Model_Model3D_BodyTaper_Method.md) | Метод |
|  | [Miter](P_TFlex_Model_Model3D_BodyTaper_Miter.md) | Двухстороннее соединение |
...
|  | [PartingBody](P_TFlex_Model_Model3D_BodyTaper_PartingBody.md) | Разделящее тело |
|  | [PartingSheet](P_TFlex_Model_Model3D_BodyTaper_PartingSheet.md) | Разделящее листовое тело |
|  | [Point1](P_TFlex_Model_Model3D_BodyTaper_Point1.md) | Первая точка задающая направление |
|  | [Point2](P_TFlex_Model_Model3D_BodyTaper_Point2.md) | Вторая точка задающая направление |
|  | [SourceBody](P_TFlex_Model_Model3D_BodyTaper_SourceBody.md) | Исходное тело |
...
|  | [TopAngle](P_TFlex_Model_Model3D_BodyTaper_TopAngle.md) | Верхний угол |
|  | [TopEdgeCount](P_TFlex_Model_Model3D_BodyTaper_TopEdgeCount.md) | Получить число верхних рёбер |
|  | [TopFaceCount](P_TFlex_Model_Model3D_BodyTaper_TopFaceCount.md) | Получить число верхних граней |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddBottomEdge](M_TFlex_Model_Model3D_BodyTaper_AddBottomEdge.md) | Добавить нижнее ребро |
|  | [AddBottomFace](M_TFlex_Model_Model3D_BodyTaper_AddBottomFace.md) | Добавить нижнюю грань |
|  | [AddTopEdge](M_TFlex_Model_Model3D_BodyTaper_AddTopEdge.md) | Добавить верхнее ребро |
|  | [AddTopFace](M_TFlex_Model_Model3D_BodyTaper_AddTopFace.md) | Добавить верхнюю грань |
...
|  | [GetBottomEdge](M_TFlex_Model_Model3D_BodyTaper_GetBottomEdge.md) | Получить нижнее ребро |
|  | [GetBottomFace](M_TFlex_Model_Model3D_BodyTaper_GetBottomFace.md) | Получить нижнюю грань |
...
|  | [GetTopEdge](M_TFlex_Model_Model3D_BodyTaper_GetTopEdge.md) | Получить верхнее ребро |
|  | [GetTopFace](M_TFlex_Model_Model3D_BodyTaper_GetTopFace.md) | Получить верхнюю грань |
...
|  | [RemoveAllBottomEdges](M_TFlex_Model_Model3D_BodyTaper_RemoveAllBottomEdges.md) | Удалить все нижние рёбра |
|  | [RemoveAllBottomFaces](M_TFlex_Model_Model3D_BodyTaper_RemoveAllBottomFaces.md) | Удалить все нижние грани |
|  | [RemoveAllTopEdges](M_TFlex_Model_Model3D_BodyTaper_RemoveAllTopEdges.md) | Удалить все верхние рёбра |
|  | [RemoveAllTopFaces](M_TFlex_Model_Model3D_BodyTaper_RemoveAllTopFaces.md) | Удалить все верхние грани |
