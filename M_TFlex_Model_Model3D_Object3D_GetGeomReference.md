...
# Object3DGetGeomReference(Int32) - метод  
  
---  
  
Получить ссылку на родительский объект по ключу
...
Поскольку геометрические данные связаны с родительской операцией, то саму родительскую операцию также можно получить по такому же ключу через функции [GetReference(Int32)](M_TFlex_Model_Model3D_Object3D_GetReference.md) />
