...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SheetFromFaces](M_TFlex_Model_Model3D_Geometry_SheetFromFaces__ctor.md) | Конструктор для задания листового тела по набору граней |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_SheetFromFaces_Run.md) | Функция генерации листового тела(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
