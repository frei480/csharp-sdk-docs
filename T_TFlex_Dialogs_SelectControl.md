...
Выбор элемента. Может иметь вид панели, списка, выпадающего списка или набора радиокнопок.

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsSelectControl
...
```
```cpp
public ref class SelectControl : public BaseControl
```


Тип SelectControl предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [SelectControl](M_TFlex_Dialogs_SelectControl__ctor.md) | Инициализирует новый экземпляр класса SelectControl |
|  | [SelectControl(String)](M_TFlex_Dialogs_SelectControl__ctor_1.md) | Инициализирует новый экземпляр класса SelectControl |
|  | [SelectControl(String, SelectControlMode)](M_TFlex_Dialogs_SelectControl__ctor_2.md) | Инициализирует новый экземпляр класса SelectControl |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AllowComboBoxMode](P_TFlex_Dialogs_SelectControl_AllowComboBoxMode.md) | Разрешить отображение в режиме выпадающего списка |
|  | [AllowListBoxMode](P_TFlex_Dialogs_SelectControl_AllowListBoxMode.md) | Разрешить отображение в режиме списка |
|  | [AllowRadioButtonMode](P_TFlex_Dialogs_SelectControl_AllowRadioButtonMode.md) | Разрешить отображение в режиме радио кнопок |
|  | [AllowToolBarMode](P_TFlex_Dialogs_SelectControl_AllowToolBarMode.md) | Разрешить отображение в режиме панели |
|  | [AllowWrapRadioButtonMode](P_TFlex_Dialogs_SelectControl_AllowWrapRadioButtonMode.md) | Разрешить отображение в режиме радио кнопок c переносом |
|  | [AllowWrapToolBarMode](P_TFlex_Dialogs_SelectControl_AllowWrapToolBarMode.md) | Разрешить отображение в режиме панели с переносом |
...
|  | [Items](P_TFlex_Dialogs_SelectControl_Items.md) | Доступ к элементам |
...
|  | [Mode](P_TFlex_Dialogs_SelectControl_Mode.md) | Режим отображения |
...
|  | [SelectedIndex](P_TFlex_Dialogs_SelectControl_SelectedIndex.md) | Индекс выбранного элемента |
|  | [SelectedItem](P_TFlex_Dialogs_SelectControl_SelectedItem.md) | Выбранный элемент |
|  | [ShowModeSwitchLink](P_TFlex_Dialogs_SelectControl_ShowModeSwitchLink.md) | Отображать кнопку переключения в режим панели |
...
|  | [ModeChanged](E_TFlex_Dialogs_SelectControl_ModeChanged.md) | Событие смены режима отображения |
|  | [SelectedItemChanged](E_TFlex_Dialogs_SelectControl_SelectedItemChanged.md) | Событие смены выбранного элемента |
