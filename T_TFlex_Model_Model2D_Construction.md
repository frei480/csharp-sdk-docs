...
Базовый класс линии построения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DConstruction Подробнее
...
|  | [Color](P_TFlex_Model_Model2D_Construction_Color.md) | Цвет объекта |
|  | [ConstructionGeometry](P_TFlex_Model_Model2D_Construction_ConstructionGeometry.md) | Геометрия линии построения |
...
|  | [GeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md) | Тип геометрии линии построения |
|  | [GroupType](P_TFlex_Model_Model2D_Construction_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [IsFixedPosition](P_TFlex_Model_Model2D_Construction_IsFixedPosition.md) | Lock position of line |
|  | [IsFixedPositionLocked](P_TFlex_Model_Model2D_Construction_IsFixedPositionLocked.md) | Block the ability to control fixation of construction line from interface |
...
|  | [Layer](P_TFlex_Model_Model2D_Construction_Layer.md) | Слой, на котором размещается объект |
|  | [Level](P_TFlex_Model_Model2D_Construction_Level.md) | Уровень объекта |
...
|  | [Page](P_TFlex_Model_Model2D_Construction_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [Param](P_TFlex_Model_Model2D_Construction_Param.md) | Значение параметра линии построения. Тип параметра зависит от типа линии построения. |
...
|  | [SubType](P_TFlex_Model_Model2D_Construction_SubType.md) | Подтип линии построения |
...
|  | [RepairPerpendicularDirection](M_TFlex_Model_Model2D_Construction_RepairPerpendicularDirection.md) |  |
...
|  | [UpdateLimits](M_TFlex_Model_Model2D_Construction_UpdateLimits.md) | Обновление выступания линии построения |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DConstruction [TFlex.Model.Model2DCircleConstruction](T_TFlex_Model_Model2D_CircleConstruction.md) [TFlex.Model.Model2DCopyConstruction](T_TFlex_Model_Model2D_CopyConstruction.md) [TFlex.Model.Model2DEllipseConstruction](T_TFlex_Model_Model2D_EllipseConstruction.md) [TFlex.Model.Model2DFunctionConstruction](T_TFlex_Model_Model2D_FunctionConstruction.md) [TFlex.Model.Model2DLineConstruction](T_TFlex_Model_Model2D_LineConstruction.md) [TFlex.Model.Model2DOffsetConstruction](T_TFlex_Model_Model2D_OffsetConstruction.md) [TFlex.Model.Model2DPathConstruction](T_TFlex_Model_Model2D_PathConstruction.md) [TFlex.Model.Model2DSplineConstruction](T_TFlex_Model_Model2D_SplineConstruction.md) [TFlex.Model.Model2DSymmetryConstruction](T_TFlex_Model_Model2D_SymmetryConstruction.md)