...
# ShellGenerator - класс  
    
Генератор сглаживания рёбер

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryBaseGenerator](T_TFlex_Model_Model3D_Geometry_BaseGenerator.md) [TFlex.Model.Model3D.GeometryBodyGenerator](T_TFlex_Model_Model3D_Geometry_BodyGenerator.md) TFlex.Model.Model3D.GeometryShellGenerator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ShellGenerator](M_TFlex_Model_Model3D_Geometry_ShellGenerator__ctor.md) | Конструктор для задания базовых объектов построения оболочки |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddFace](M_TFlex_Model_Model3D_Geometry_ShellGenerator_AddFace.md) | Функция задаёт параметры отступа индивидуально для грани |
|  | [AddPiercedFace](M_TFlex_Model_Model3D_Geometry_ShellGenerator_AddPiercedFace.md) | Функция задаёт пробиваемые грани |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_ShellGenerator_Run.md) | Функция генерации оболочки(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
