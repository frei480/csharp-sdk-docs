...
# StandardColorsActiveDraggerIndex - свойство  
...
```csharp
public static int ActiveDraggerIndex { get; }
```
```vb
Public Shared ReadOnly Property ActiveDraggerIndex As Integer
	Get
```
```cpp
public:
static property int ActiveDraggerIndex {
	int get ();
}
```
