...
# ImportedTransformation - класс  
    
Класс внешнего преобразования

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) TFlex.Model.Model3DImportedTransformation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ImportedTransformation](M_TFlex_Model_Model3D_ImportedTransformation__ctor.md) | Конструктор для создания внешнего преобразования |
...
|  | [Matrix](P_TFlex_Model_Model3D_ImportedTransformation_Matrix.md) | Матрица преобразований |
...
|  | [OriginType](P_TFlex_Model_Model3D_ImportedTransformation_OriginType.md) | Тип поиска системы координат, относительно которой производится преобразование |
