...
# EllipseConstruction - класс  
  
---  
  
Линия построения - эллипс

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DEllipseConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [EllipseConstruction](M_TFlex_Model_Model2D_EllipseConstruction__ctor.md) | Конструктор по умолчанию |
...
|  | [ConstructionGeometry](P_TFlex_Model_Model2D_EllipseConstruction_ConstructionGeometry.md) | Геометрия линии построения(Переопределяет [ConstructionConstructionGeometry](P_TFlex_Model_Model2D_Construction_ConstructionGeometry.md)) |
...
|  | [EllipseConstructionGeometry](P_TFlex_Model_Model2D_EllipseConstruction_EllipseConstructionGeometry.md) | Геометрия линии построения (эллипса) |
|  | [EllipseType](P_TFlex_Model_Model2D_EllipseConstruction_EllipseType.md) | Тип привязки эллипса |
|  | [GeometryType](P_TFlex_Model_Model2D_EllipseConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [SubType](P_TFlex_Model_Model2D_EllipseConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
...
|  | [SetCenterAndLineAndNode](M_TFlex_Model_Model2D_EllipseConstruction_SetCenterAndLineAndNode.md) | Эллипс с центром в узле, касательный к прямой, проходящий через узел |
|  | [SetCenterAndLineAndRadius](M_TFlex_Model_Model2D_EllipseConstruction_SetCenterAndLineAndRadius.md) | Эллипс проходящий через узел, касательный к прямой, с заданным радиусом |
|  | [SetCenterAndNodeAndLine](M_TFlex_Model_Model2D_EllipseConstruction_SetCenterAndNodeAndLine.md) | Эллипс с центром, проходящий через узел и касательный к прямой |
|  | [SetCenterAndNodeAndRadius](M_TFlex_Model_Model2D_EllipseConstruction_SetCenterAndNodeAndRadius.md) | Эллипс с центром в узле, проходящий через узел, с заданным радиусом |
|  | [SetCenterAndTwoNodes](M_TFlex_Model_Model2D_EllipseConstruction_SetCenterAndTwoNodes.md) | Эллипс с центром в узле, проходящий через два узла |
|  | [SetCircleAndLine](M_TFlex_Model_Model2D_EllipseConstruction_SetCircleAndLine.md) | Эллипс с полуосью, заданной окружностью, касательный к прямой |
|  | [SetCircleAndNode](M_TFlex_Model_Model2D_EllipseConstruction_SetCircleAndNode.md) | Эллипс с полуосью, заданной окружностью, проходящий через узел |
...
|  | [SetNodeAndTwoLines](M_TFlex_Model_Model2D_EllipseConstruction_SetNodeAndTwoLines.md) | Эллипс проходящий через узел, касательный к двум прямым |
|  | [SetOutline](M_TFlex_Model_Model2D_EllipseConstruction_SetOutline.md) | Эллипс, проходящий по линии изображения (эллипсу или дуге эллипса) |
...
|  | [SetThreeNodes](M_TFlex_Model_Model2D_EllipseConstruction_SetThreeNodes.md) | Эллипс с заданной полуосью, проходящий через узел |
|  | [SetTwoNodesAndLine](M_TFlex_Model_Model2D_EllipseConstruction_SetTwoNodesAndLine.md) | Эллипс с заданной полуосью, касательный к прямой |
|  | [SetTwoNodesAndRadius](M_TFlex_Model_Model2D_EllipseConstruction_SetTwoNodesAndRadius.md) | Эллипс с заданной полуосью, с заданным радиусом |
