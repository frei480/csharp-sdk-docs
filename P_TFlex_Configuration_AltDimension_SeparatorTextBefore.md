...
# AltDimensionSeparatorTextBefore - свойство  
  **Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public CompoundStringParameter SeparatorTextBefore { get; set; }
```
```vb
Public Property SeparatorTextBefore As CompoundStringParameter
	Get
	Set
```
```cpp
public:
property CompoundStringParameter^ SeparatorTextBefore {
