...
# ConeSurface - свойства  
    
Тип [ConeSurface](T_TFlex_Model_Model3D_Geometry_ConeSurface.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Axis](P_TFlex_Model_Model3D_Geometry_ConeSurface_Axis.md) | Ось симметрии |
...
|  | [Radius](P_TFlex_Model_Model3D_Geometry_ConeSurface_Radius.md) | Радиус |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Geometry_ConeSurface_ReferenceDirection.md) | Полуось основания, от которой откладывается угол |
|  | [SemiAngle](P_TFlex_Model_Model3D_Geometry_ConeSurface_SemiAngle.md) | Половина угла конуса в градусах |
