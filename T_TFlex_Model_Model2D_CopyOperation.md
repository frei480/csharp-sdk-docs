...
|  | [CopyType](P_TFlex_Model_Model2D_CopyOperation_CopyType.md) | Значение подтипа объекта "Копия" |
...
|  | [GroupType](P_TFlex_Model_Model2D_CopyOperation_GroupType.md) | Тип объекта "Копия"(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Page](P_TFlex_Model_Model2D_CopyOperation_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [SourcesCount](P_TFlex_Model_Model2D_CopyOperation_SourcesCount.md) | Количество копируемых объектов |
|  | [TransformationCount](P_TFlex_Model_Model2D_CopyOperation_TransformationCount.md) | Количество преобразований копируемых объектов |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddSource](M_TFlex_Model_Model2D_CopyOperation_AddSource.md) | Добавление в копию исходного объекта |
...
|  | [DeleteAssociative](M_TFlex_Model_Model2D_CopyOperation_DeleteAssociative.md) | Удаление ассоциативного объекта |
...
|  | [Explode](M_TFlex_Model_Model2D_CopyOperation_Explode.md) | Разрушение операции |
|  | [Finalize](https://learn.microsoft.com/dotnet/api/system.object.finalize) | Allows an object to try to free resources and perform other cleanup operations before it is reclaimed by garbage collection.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetAssociate](M_TFlex_Model_Model2D_CopyOperation_GetAssociate.md) | Получение ассоциативного объекта (результата копирования) |
...
|  | [GetSourceObject](M_TFlex_Model_Model2D_CopyOperation_GetSourceObject.md) | Получение исходного объекта |
...
|  | [RemoveSource](M_TFlex_Model_Model2D_CopyOperation_RemoveSource.md) | Удаление исходного объекта из копии |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [RestoreDeletedAssociatives](M_TFlex_Model_Model2D_CopyOperation_RestoreDeletedAssociatives.md) | Восстановление удаленных ассоциативных объектов |
