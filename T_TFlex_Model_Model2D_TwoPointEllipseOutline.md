...
# TwoPointEllipseOutline - класс  
    
Эллипс через две точки и радиус

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DTwoPointEllipseOutline

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class TwoPointEllipseOutline : Outline
```
```vb
Public Class TwoPointEllipseOutline
	Inherits Outline
```
```cpp
public ref class TwoPointEllipseOutline : public Outline
```


Тип TwoPointEllipseOutline предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [TwoPointEllipseOutline](M_TFlex_Model_Model2D_TwoPointEllipseOutline__ctor.md) | Конструктор |
...
|  | [EndNode](P_TFlex_Model_Model2D_TwoPointEllipseOutline_EndNode.md) | Конечная точка эллипса |
...
|  | [Radius](P_TFlex_Model_Model2D_TwoPointEllipseOutline_Radius.md) | Радиус эллипса |
...
|  | [StartNode](P_TFlex_Model_Model2D_TwoPointEllipseOutline_StartNode.md) | Начальная точка эллипса |
