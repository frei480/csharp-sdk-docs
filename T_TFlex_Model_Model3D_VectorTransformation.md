...
|  | [Axis](P_TFlex_Model_Model3D_VectorTransformation_Axis.md) | Ось |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_VectorTransformation_FirstPoint.md) | Первая точка оси |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_VectorTransformation_SecondPoint.md) | Вторая точка оси |
