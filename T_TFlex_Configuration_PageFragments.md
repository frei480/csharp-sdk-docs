...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationPageFragments
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PageFragments](M_TFlex_Configuration_PageFragments__ctor.md) | Инициализирует новый экземпляр класса PageFragments |
|  | [PageFragments(IntPtr, Boolean)](M_TFlex_Configuration_PageFragments__ctor_1.md) | Инициализирует новый экземпляр класса PageFragments |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [DynamicFragmentEdit](P_TFlex_Configuration_PageFragments_DynamicFragmentEdit.md) |  |
|  | [FragmentForNewPage](P_TFlex_Configuration_PageFragments_FragmentForNewPage.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_PageFragments_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_PageFragments_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_PageFragments_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
