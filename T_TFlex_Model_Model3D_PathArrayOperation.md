...
|  | [PathArrayOperation(Document, ArrayOperationType)](M_TFlex_Model_Model3D_PathArrayOperation__ctor_1.md) | Конструктор для операции "Массив по пути" |
...
|  | [GroupType](P_TFlex_Model_Model3D_PathArrayOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Path](P_TFlex_Model_Model3D_PathArrayOperation_Path.md) | Путь |
...
|  | [Usage](P_TFlex_Model_Model3D_PathArrayOperation_Usage.md) | Тип использования пути |
