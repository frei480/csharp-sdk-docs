...
Класс операции Копирования в T-Flex CAD до версии 11

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) [TFlex.Model.Model3DCopyBaseOperation](T_TFlex_Model_Model3D_CopyBaseOperation.md) TFlex.Model.Model3DCopyOperation

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class CopyOperation : CopyBaseOperation
```
```vb
...
```
```cpp
public ref class CopyOperation : public CopyBaseOperation
```
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CopyOperation](M_TFlex_Model_Model3D_CopyOperation__ctor.md) | **Устарело.** Конструктор для операции Копирования |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AttributesFromSource](P_TFlex_Model_Model3D_CopyBaseOperation_AttributesFromSource.md) | Значение свойства "Атрибуты с исходной операции"(Унаследован от [CopyBaseOperation](T_TFlex_Model_Model3D_CopyBaseOperation.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_CopyOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [IsMove](P_TFlex_Model_Model3D_CopyBaseOperation_IsMove.md) | Значение свойства "Перенос без дублирования"(Унаследован от [CopyBaseOperation](T_TFlex_Model_Model3D_CopyBaseOperation.md)) |
...
|  | [Source](P_TFlex_Model_Model3D_CopyBaseOperation_Source.md) | Исходная операция(Унаследован от [CopyBaseOperation](T_TFlex_Model_Model3D_CopyBaseOperation.md)) |
|  | [SourceLCS](P_TFlex_Model_Model3D_CopyOperation_SourceLCS.md) | Исходная система коодинат |
...
|  | [TargetLCS](P_TFlex_Model_Model3D_CopyOperation_TargetLCS.md) | Целевая система коодинат |
