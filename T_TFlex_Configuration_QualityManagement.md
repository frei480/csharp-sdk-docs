...
# QualityManagement - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationQualityManagement
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [QualityManagement](M_TFlex_Configuration_QualityManagement__ctor.md) | Инициализирует новый экземпляр класса QualityManagement |
|  | [QualityManagement(IntPtr, Boolean)](M_TFlex_Configuration_QualityManagement__ctor_1.md) | Инициализирует новый экземпляр класса QualityManagement |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [DefaultScript](P_TFlex_Configuration_QualityManagement_DefaultScript.md) |  |
|  | [LoadDefaultScriptOnStart](P_TFlex_Configuration_QualityManagement_LoadDefaultScriptOnStart.md) |  |
|  | [ScriptsFolder](P_TFlex_Configuration_QualityManagement_ScriptsFolder.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_QualityManagement_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_QualityManagement_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_QualityManagement_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
