...
Тип [BaseBody](T_TFlex_Model_Model3D_Geometry_BaseBody.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseBody_Dispose_1.md) |  |
