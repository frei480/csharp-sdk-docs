...
Базовый класс текста

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DText [TFlex.Model.Model2DCopyText](T_TFlex_Model_Model2D_CopyText.md) [TFlex.Model.Model2DLineText](T_TFlex_Model_Model2D_LineText.md) [TFlex.Model.Model2DRichText](T_TFlex_Model_Model2D_RichText.md)
...
|  | [Color](P_TFlex_Model_Model2D_Text_Color.md) | Цвет объекта |
...
|  | [FontStyle](P_TFlex_Model_Model2D_Text_FontStyle.md) | Стиль шрифта текста |
|  | [GroupType](P_TFlex_Model_Model2D_Text_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_Text_Layer.md) | Слой, на котором размещается объект |
|  | [Level](P_TFlex_Model_Model2D_Text_Level.md) | Уровень объекта |
...
|  | [Page](P_TFlex_Model_Model2D_Text_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [Priority](P_TFlex_Model_Model2D_Text_Priority.md) | Приоритет объекта |
|  | [SubType](P_TFlex_Model_Model2D_Text_SubType.md) | Подтип текста |
