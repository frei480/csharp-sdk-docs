...
# BipolarElement - класс  
    
Биполярный силовой элемент

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DRestraint](T_TFlex_Model_Model3D_Restraint.md) TFlex.Model.Model3DBipolarElement
...
|  | [Compression](P_TFlex_Model_Model3D_BipolarElement_Compression.md) | Ограничение силы на сжатие (если элемент работает в режиме привода) |
|  | [Control](P_TFlex_Model_Model3D_BipolarElement_Control.md) | Управляемое значение (если элемент работает в режиме привода) |
...
|  | [Force](P_TFlex_Model_Model3D_BipolarElement_Force.md) | Сила (если элемент работает в режиме пружины) |
...
|  | [Stretching](P_TFlex_Model_Model3D_BipolarElement_Stretching.md) | Ограничение силы на растяжение (если элемент работает в режиме привода) |
|  | [Type](P_TFlex_Model_Model3D_BipolarElement_Type.md) | Тип нагрузки(Переопределяет [RestraintType](P_TFlex_Model_Model3D_Restraint_Type.md)) |
