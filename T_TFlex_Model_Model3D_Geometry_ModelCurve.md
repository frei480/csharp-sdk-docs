...
Класс кривой с модели

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseCurve](T_TFlex_Model_Model3D_Geometry_BaseCurve.md) TFlex.Model.Model3D.GeometryModelCurve Подробнее

**Пространство имён:** [TFlex.Model.Model3D.Geometry](N_TFlex_Model_Model3D_Geometry.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class ModelCurve : BaseCurve
```
```vb
...
```
```cpp
public ref class ModelCurve : public BaseCurve
```


Тип ModelCurve предоставляет следующие члены.
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseCurve](T_TFlex_Model_Model3D_Geometry_BaseCurve.md) TFlex.Model.Model3D.GeometryModelCurve [TFlex.Model.Model3D.GeometryModelCircleCurve](T_TFlex_Model_Model3D_Geometry_ModelCircleCurve.md) [TFlex.Model.Model3D.GeometryModelEllipseCurve](T_TFlex_Model_Model3D_Geometry_ModelEllipseCurve.md) [TFlex.Model.Model3D.GeometryModelLineCurve](T_TFlex_Model_Model3D_Geometry_ModelLineCurve.md) [TFlex.Model.Model3D.GeometryModelParametricCurve](T_TFlex_Model_Model3D_Geometry_ModelParametricCurve.md) [TFlex.Model.Model3D.GeometryModelSplineCurve](T_TFlex_Model_Model3D_Geometry_ModelSplineCurve.md)