...
```csharp
public class BoxManipulator : BoxManipulatorBase
```
```vb
...
```
```cpp
public ref class BoxManipulator : public BoxManipulatorBase
```


Тип BoxManipulator предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [BoxManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulator__ctor.md) | Инициализирует новый экземпляр класса BoxManipulator |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [PointColor](P_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_PointColor.md) | (Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_Dispose.md) | (Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
...
|  | [GetCommitedResultPoints](M_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_GetCommitedResultPoints.md) | (Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
|  | [GetEnqueuedResultPoints](M_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_GetEnqueuedResultPoints.md) | (Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
...
|  | [Reset](M_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_Reset.md) | Устанавливает параметры настраиваемого параллелепипеда(Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
...
|  | [OffsetCommited](E_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_OffsetCommited.md) | (Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
|  | [OffsetEnqueued](E_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_OffsetEnqueued.md) | (Унаследован от [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md)) |
