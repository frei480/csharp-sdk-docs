...
# EllipseCurve - свойства  
  
---  
  
Тип [EllipseCurve](T_TFlex_Model_Model3D_Geometry_EllipseCurve.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Center](P_TFlex_Model_Model3D_Geometry_EllipseCurve_Center.md) | Центр эллипса |
|  | [MajorRadius](P_TFlex_Model_Model3D_Geometry_EllipseCurve_MajorRadius.md) | Большой радиус эллипса |
|  | [MinorRadius](P_TFlex_Model_Model3D_Geometry_EllipseCurve_MinorRadius.md) | Малый радиус эллипса |
|  | [Normal](P_TFlex_Model_Model3D_Geometry_EllipseCurve_Normal.md) | Нормаль к плоскости эллипса |
...
|  | [SemiAxis](P_TFlex_Model_Model3D_Geometry_EllipseCurve_SemiAxis.md) | Полуось, от которой откладывается угол эллипса |
...
[EllipseCurve - ](T_TFlex_Model_Model3D_Geometry_EllipseCurve.md)
