...
# ElementTypeRunMethod(String, Object) - метод  
...
methodSystemName [String](https://learn.microsoft.com/dotnet/api/system.string)
...
[RunMethod - перегрузка](Overload_TFlex_Model_Structure_ElementType_RunMethod.md)
