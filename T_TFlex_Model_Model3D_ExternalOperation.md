...
# ExternalOperation - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DExternalOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExternalOperation](M_TFlex_Model_Model3D_ExternalOperation__ctor.md) | Конструктор для создания внешней операции |
...
|  | [ConstObject](P_TFlex_Model_Model3D_ExternalOperation_ConstObject.md) | 3D операция внешнего приложения, встраиваемого в модель, для опроса её свойств |
...
|  | [GroupType](P_TFlex_Model_Model3D_ExternalOperation_GroupType.md) | Идентификатор типа объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [PluginGuid](P_TFlex_Model_Model3D_ExternalOperation_PluginGuid.md) | System::Guid плагина |
...
|  | [TypeID](P_TFlex_Model_Model3D_ExternalOperation_TypeID.md) | Пользовательский идентификатор типа объекта |
...
|  | [VolatileObject](P_TFlex_Model_Model3D_ExternalOperation_VolatileObject.md) | 3D операция внешнего приложения, встраиваемого в модель, для изменения её свойств |
