...
|  | Имя | Описание |
| --- | --- | --- |
|  | [EditControl](M_TFlex_Model_Model2D_EditControl__ctor.md) | Инициализирует новый экземпляр класса EditControl |
...
|  | [ControlType](P_TFlex_Model_Model2D_EditControl_ControlType.md) | Тип элемента управления(Переопределяет [ControlControlType](P_TFlex_Model_Model2D_Control_ControlType.md)) |
...
|  | [Variable](P_TFlex_Model_Model2D_VariableControl_Variable.md) | Переменная элемента управления(Унаследован от [VariableControl](T_TFlex_Model_Model2D_VariableControl.md)) |
