...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseCurve](T_TFlex_Model_Model3D_Geometry_BaseCurve.md) TFlex.Model.Model3D.GeometryCurve Подробнее
...
|  | [Curve(Int32, Boolean)](M_TFlex_Model_Model3D_Geometry_Curve__ctor_1.md) | Инициализирует новый экземпляр класса Curve |
...
|  | [Create](M_TFlex_Model_Model3D_Geometry_Curve_Create.md) |  |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseCurve](T_TFlex_Model_Model3D_Geometry_BaseCurve.md) TFlex.Model.Model3D.GeometryCurve [TFlex.Model.Model3D.GeometryCircleCurve](T_TFlex_Model_Model3D_Geometry_CircleCurve.md) [TFlex.Model.Model3D.GeometryEllipseCurve](T_TFlex_Model_Model3D_Geometry_EllipseCurve.md) [TFlex.Model.Model3D.GeometryLineCurve](T_TFlex_Model_Model3D_Geometry_LineCurve.md) [TFlex.Model.Model3D.GeometryParametricCurve](T_TFlex_Model_Model3D_Geometry_ParametricCurve.md) [TFlex.Model.Model3D.GeometrySplineCurve](T_TFlex_Model_Model3D_Geometry_SplineCurve.md)