...
|  | Имя | Описание |
| --- | --- | --- |
|  | [TwoProjectionsPath](M_TFlex_Model_Model3D_TwoProjectionsPath__ctor.md) | Конструктор для создания пути по двум проекциям |
...
|  | [FirstProjection](P_TFlex_Model_Model3D_TwoProjectionsPath_FirstProjection.md) | Первая проекция |
...
|  | [SecondProjection](P_TFlex_Model_Model3D_TwoProjectionsPath_SecondProjection.md) | Вторая проекция |
