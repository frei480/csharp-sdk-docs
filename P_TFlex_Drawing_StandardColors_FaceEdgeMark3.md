...
# StandardColorsFaceEdgeMark3 - свойство  
...
```csharp
public static Color FaceEdgeMark3 { get; }
```
```vb
Public Shared ReadOnly Property FaceEdgeMark3 As Color
	Get
```
```cpp
public:
static property Color FaceEdgeMark3 {
	Color get ();
}
```
