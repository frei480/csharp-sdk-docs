...
|  | Имя | Описание |
| --- | --- | --- |
|  | [NativeControl](M_TFlex_Dialogs_NativeControl__ctor.md) | Инициализирует новый экземпляр класса NativeControl |
|  | [NativeControl(String)](M_TFlex_Dialogs_NativeControl__ctor_1.md) | Инициализирует новый экземпляр класса NativeControl |
|  | [NativeControl(String, NativeWindow)](M_TFlex_Dialogs_NativeControl__ctor_2.md) | Инициализирует новый экземпляр класса NativeControl |
|  | [NativeControl(String, NativeWindow, Int32)](M_TFlex_Dialogs_NativeControl__ctor_3.md) | Инициализирует новый экземпляр класса NativeControl |
...
|  | [Window](P_TFlex_Dialogs_NativeControl_Window.md) | Отображаемое окно |
