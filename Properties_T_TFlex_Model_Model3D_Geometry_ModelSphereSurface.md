...
# ModelSphereSurface - свойства  
  
---  
  
Тип [ModelSphereSurface](T_TFlex_Model_Model3D_Geometry_ModelSphereSurface.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Center](P_TFlex_Model_Model3D_Geometry_ModelSphereSurface_Center.md) | Получить центр сферы |
|  | [Normal](P_TFlex_Model_Model3D_Geometry_ModelSphereSurface_Normal.md) | Получить нормаль к плоскости в которой откладываются углы |
...
|  | [Radius](P_TFlex_Model_Model3D_Geometry_ModelSphereSurface_Radius.md) | Получить радиус сферы |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Geometry_ModelSphereSurface_ReferenceDirection.md) | Получить полуось основания, от которой откладываются углы |
...
[ModelSphereSurface - ](T_TFlex_Model_Model3D_Geometry_ModelSphereSurface.md)
