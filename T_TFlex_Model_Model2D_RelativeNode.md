...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DRelativeNode
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [RelativeNode](M_TFlex_Model_Model2D_RelativeNode__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AbsX](P_TFlex_Model_Model2D_Node_AbsX.md) | Координата X в системе координат модели (без учёта масштаба страницы)(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
|  | [AbsY](P_TFlex_Model_Model2D_Node_AbsY.md) | Координата Y в системе координат модели (без учёта масштаба страницы)(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
...
|  | [Color](P_TFlex_Model_Model2D_Node_Color.md) | Цвет объекта(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
|  | [Coordinates](P_TFlex_Model_Model2D_Node_Coordinates.md) | Координаты узла в системе координат модели (без учёта масштаба страницы)(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
...
|  | [GroupType](P_TFlex_Model_Model2D_Node_GroupType.md) | Тип объекта(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
...
|  | [IsEndOfPolylineAlignToStart](P_TFlex_Model_Model2D_RelativeNode_IsEndOfPolylineAlignToStart.md) | Параметр для определения положения узла - для RelativeType.EndOfPolyline |
...
|  | [Layer](P_TFlex_Model_Model2D_Node_Layer.md) | Слой, на котором размещается объект(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
|  | [Level](P_TFlex_Model_Model2D_Node_Level.md) | Уровень объекта(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
...
|  | [Page](P_TFlex_Model_Model2D_Node_Page.md) | Страница, на которой размещается элемент(Унаследован от [Node](T_TFlex_Model_Model2D_Node.md)) |
...
|  | [ParameterX](P_TFlex_Model_Model2D_RelativeNode_ParameterX.md) | Параметр(в зависимости от значения RelationType) |
|  | [ParameterY](P_TFlex_Model_Model2D_RelativeNode_ParameterY.md) | Смещение по оси Y (без учёта масштаба текущей страницы) - для RelativeType.Offset |
|  | [ParentNode](P_TFlex_Model_Model2D_RelativeNode_ParentNode.md) |  |
...
|  | [RelationType](P_TFlex_Model_Model2D_RelativeNode_RelationType.md) | Тип привязки узла |
|  | [SourceConstruction](P_TFlex_Model_Model2D_RelativeNode_SourceConstruction.md) |  |
|  | [SubType](P_TFlex_Model_Model2D_RelativeNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
...
|  | [SetByParameter](M_TFlex_Model_Model2D_RelativeNode_SetByParameter.md) | Установка привязки к линии построения (Окружность, Эллипс, Полилиния) по параметру |
|  | [SetEndOfPolyline](M_TFlex_Model_Model2D_RelativeNode_SetEndOfPolyline.md) | Установка привязки к одному из концов линии построения - полилинии |
...
|  | [SetOffset](M_TFlex_Model_Model2D_RelativeNode_SetOffset.md) | Установка смещения относительно родительского узла |
|  | [SetOnConstruction](M_TFlex_Model_Model2D_RelativeNode_SetOnConstruction.md) | Установка смещения относительно родительского узла по линии построения |
