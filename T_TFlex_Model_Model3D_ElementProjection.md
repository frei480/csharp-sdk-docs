...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ElementProjection(Document)](M_TFlex_Model_Model3D_ElementProjection__ctor.md) | Конструктор для создания новой проекции |
|  | [ElementProjection(Document, Page)](M_TFlex_Model_Model3D_ElementProjection__ctor_1.md) | Конструктор для создания новой проекции |
...
|  | [Center](P_TFlex_Model_Model3D_NonStandardProjection_Center.md) | Проекция позиционируется по центру ограничивающиего прямоугольника(Унаследован от [NonStandardProjection](T_TFlex_Model_Model3D_NonStandardProjection.md)) |
...
|  | [ViewPlane](P_TFlex_Model_Model3D_NonStandardProjection_ViewPlane.md) | Топологический элемент для определения направления проецирования. Поддерживаются два типа элементов грани и вершины. Элемент для опеределения направления проецирования.(Унаследован от [NonStandardProjection](T_TFlex_Model_Model3D_NonStandardProjection.md)) |
|  | [ViewTiePoint3D](P_TFlex_Model_Model3D_NonStandardProjection_ViewTiePoint3D.md) | Привязка проекции к 3d точке(Унаследован от [NonStandardProjection](T_TFlex_Model_Model3D_NonStandardProjection.md)) |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddBody](M_TFlex_Model_Model3D_ElementProjection_AddBody.md) | Добавить операцию как тело для проецирования |
...
|  | [AddGeometry](M_TFlex_Model_Model3D_ElementProjection_AddGeometry.md) | Добавить геометрический объект (грань, ребро, цикл) для проецирования |
|  | [AddObject](M_TFlex_Model_Model3D_ElementProjection_AddObject.md) | Добавить модельный объект (путь, профиль, операцию) для проецирования |
...
|  | [CreateLegacy](M_TFlex_Model_Model3D_ElementProjection_CreateLegacy.md) |  |
...
|  | [RemoveAllObjects](M_TFlex_Model_Model3D_ElementProjection_RemoveAllObjects.md) | Удалить все заданные для проецирования объекты из проекции |
...
|  | [SetViewPoint](M_TFlex_Model_Model3D_NonStandardProjection_SetViewPoint.md) | Установить координаты точки проецирования(Унаследован от [NonStandardProjection](T_TFlex_Model_Model3D_NonStandardProjection.md)) |
