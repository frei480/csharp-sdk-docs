...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ContainerResultNode](M_TFlex_Model_Data_ProductStructure_ContainerResultNode__ctor.md) | Инициализирует новый экземпляр класса ContainerResultNode |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Children](P_TFlex_Model_Data_ProductStructure_ContainerResultNode_Children.md) |  |
|  | [NodeType](P_TFlex_Model_Data_ProductStructure_ContainerResultNode_NodeType.md) |  |
|  | [Titles](P_TFlex_Model_Data_ProductStructure_ContainerResultNode_Titles.md) |  |
