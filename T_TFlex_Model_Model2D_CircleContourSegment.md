...
# CircleContourSegment - класс  
    
Сегмент контура штриховки, являющийся окружностью.

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model2DContourSegment](T_TFlex_Model_Model2D_ContourSegment.md) TFlex.Model.Model2DCircleContourSegment
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CircleContourSegment](M_TFlex_Model_Model2D_CircleContourSegment__ctor.md) | Конструктор, добавляющий сегмент в конец контура |
