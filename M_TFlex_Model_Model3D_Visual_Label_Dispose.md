...
Освобождает все ресурсы, используемые объектом [Label](T_TFlex_Model_Model3D_Visual_Label.md)
...
[Dispose - перегрузка](Overload_TFlex_Model_Model3D_Visual_Label_Dispose.md)
