...
Операция удаления граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFaceDelete
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FaceDelete](M_TFlex_Model_Model3D_FaceDelete__ctor.md) | Конструктор для создания операция "Удаление граней" |
...
|  | [Faces](P_TFlex_Model_Model3D_FaceDelete_Faces.md) | Удаляемые грани |
...
|  | [GroupType](P_TFlex_Model_Model3D_FaceDelete_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
|  | [HealingMethod](P_TFlex_Model_Model3D_FaceDelete_HealingMethod.md) | Способ обработки граней |
...
|  | [IndependentHealing](P_TFlex_Model_Model3D_FaceDelete_IndependentHealing.md) | Независимая обработка циклов |
