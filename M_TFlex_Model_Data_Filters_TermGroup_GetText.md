...
# TermGroupGetText - метод  
    
Возвращает текстовое представление группы условий
...
[String](https://learn.microsoft.com/dotnet/api/system.string)Текстовое представление группы условий
