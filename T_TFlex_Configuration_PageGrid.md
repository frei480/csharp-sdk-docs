...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationPageGrid
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PageGrid](M_TFlex_Configuration_PageGrid__ctor.md) | Инициализирует новый экземпляр класса PageGrid |
|  | [PageGrid(IntPtr, Boolean)](M_TFlex_Configuration_PageGrid__ctor_1.md) | Инициализирует новый экземпляр класса PageGrid |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [DrawnLast](P_TFlex_Configuration_PageGrid_DrawnLast.md) |  |
|  | [OffsetX](P_TFlex_Configuration_PageGrid_OffsetX.md) |  |
|  | [OffsetY](P_TFlex_Configuration_PageGrid_OffsetY.md) |  |
|  | [PointSize](P_TFlex_Configuration_PageGrid_PointSize.md) |  |
|  | [RotationAngle](P_TFlex_Configuration_PageGrid_RotationAngle.md) |  |
|  | [Snap](P_TFlex_Configuration_PageGrid_Snap.md) |  |
|  | [StepX](P_TFlex_Configuration_PageGrid_StepX.md) |  |
|  | [StepY](P_TFlex_Configuration_PageGrid_StepY.md) |  |
|  | [Visible](P_TFlex_Configuration_PageGrid_Visible.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_PageGrid_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_PageGrid_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_PageGrid_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
