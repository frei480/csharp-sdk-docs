...
# ModelVertex - свойства  
    
Тип [ModelVertex](T_TFlex_Model_Model3D_Geometry_ModelVertex.md) предоставляет следующие члены.
...
|  | [Edges](P_TFlex_Model_Model3D_Geometry_ModelVertex_Edges.md) | Множество смежных рёбер |
...
|  | [Faces](P_TFlex_Model_Model3D_Geometry_ModelVertex_Faces.md) | Множество смежных граней |
|  | [Geometry](P_TFlex_Model_Model3D_Geometry_ModelVertex_Geometry.md) | Получить геометрические данные вершины |
...
|  | [Loops](P_TFlex_Model_Model3D_Geometry_ModelVertex_Loops.md) | Множество смежных циклов |
...
|  | [Point](P_TFlex_Model_Model3D_Geometry_ModelVertex_Point.md) | Получить точку |
...
[ModelVertex - ](T_TFlex_Model_Model3D_Geometry_ModelVertex.md)
