...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SymmetryOperation](M_TFlex_Model_Model3D_SymmetryOperation__ctor.md) | **Устарело.** Конструктор для операции Симметрия |
...
|  | [GroupType](P_TFlex_Model_Model3D_SymmetryOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Plane](P_TFlex_Model_Model3D_SymmetryOperation_Plane.md) | Плоскость симметрии |
