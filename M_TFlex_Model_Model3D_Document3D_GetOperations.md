...
# Document3DGetOperations - метод  
    
Контейнер всех операций

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public static ICollection<Operation> GetOperations(
	this Document document
)
```
```vb
<ExtensionAttribute>
Public Shared Function GetOperations ( 
	document As Document
) As ICollection(Of Operation)
```
```cpp
public:
[ExtensionAttribute]
static ICollection<Operation^>^ GetOperations(
	Document^ document
)
```
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Operation](T_TFlex_Model_Model3D_Operation.md)
