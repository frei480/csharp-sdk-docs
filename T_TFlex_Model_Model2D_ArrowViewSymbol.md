...
# ArrowViewSymbol - класс  
    
Класс обозначения вида по стрелке

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DViewSymbol](T_TFlex_Model_Model2D_ViewSymbol.md) TFlex.Model.Model2DArrowViewSymbol
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ArrowViewSymbol](M_TFlex_Model_Model2D_ArrowViewSymbol__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model2D_ArrowViewSymbol_Angle.md) | Угол наклона стрелки |
|  | [ArrowLength](P_TFlex_Model_Model2D_ArrowViewSymbol_ArrowLength.md) | Длина стрелки |
|  | [ArrowLineWidth](P_TFlex_Model_Model2D_ArrowViewSymbol_ArrowLineWidth.md) | Толщина линий стрелки |
|  | [ArrowSize](P_TFlex_Model_Model2D_ArrowViewSymbol_ArrowSize.md) | Размер стрелки |
|  | [ArrowType](P_TFlex_Model_Model2D_ArrowViewSymbol_ArrowType.md) | Тип стрелки |
|  | [AttachmentType](P_TFlex_Model_Model2D_ArrowViewSymbol_AttachmentType.md) | Тип привязки |
...
|  | [Node1](P_TFlex_Model_Model2D_ArrowViewSymbol_Node1.md) | Первый узел привязки |
|  | [Node2](P_TFlex_Model_Model2D_ArrowViewSymbol_Node2.md) | Второй узел привязки |
|  | [Note](P_TFlex_Model_Model2D_ArrowViewSymbol_Note.md) | Надпись |
|  | [NoteOffset1](P_TFlex_Model_Model2D_ArrowViewSymbol_NoteOffset1.md) | Смещение надписи перпендикулярно полке |
|  | [NoteOffset2](P_TFlex_Model_Model2D_ArrowViewSymbol_NoteOffset2.md) | Смещение надписи вдоль полки |
|  | [NotePosition](P_TFlex_Model_Model2D_ArrowViewSymbol_NotePosition.md) | Положение надписи |
...
|  | [Point](P_TFlex_Model_Model2D_ArrowViewSymbol_Point.md) | Координаты точки привязки стрелки |
...
|  | [SetAbsolutePosition](M_TFlex_Model_Model2D_ArrowViewSymbol_SetAbsolutePosition.md) | Установка привязки стрелки по абсолютным координатам |
...
|  | [SetNodeAndAngle](M_TFlex_Model_Model2D_ArrowViewSymbol_SetNodeAndAngle.md) | Установка привязки по узлу и углу |
|  | [SetNodes](M_TFlex_Model_Model2D_ArrowViewSymbol_SetNodes.md) | Установка привязки к узлам |
