...
|  | [ParamCurve](P_TFlex_Model_Model3D_Geometry_ModelParametricCurve_ParamCurve.md) | Получить плоскую кривую, задающую форму кривой в параметрической области поверхности |
...
|  | [Surface](P_TFlex_Model_Model3D_Geometry_ModelParametricCurve_Surface.md) | Получить поверхность, на которой строится кривая |
