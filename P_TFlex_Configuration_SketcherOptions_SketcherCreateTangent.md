...
# SketcherOptionsSketcherCreateTangent - свойство  
  
---  
**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool SketcherCreateTangent { get; set; }
```
```vb
Public Property SketcherCreateTangent As Boolean
	Get
	Set
```
```cpp
public:
property bool SketcherCreateTangent {
	bool get ();
	void set (bool value);
}
```
