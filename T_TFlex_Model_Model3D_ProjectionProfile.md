...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ProjectionProfile](M_TFlex_Model_Model3D_ProjectionProfile__ctor.md) | Конструктор для создания проекции контура на листовое или твёрдое тело |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_ProjectionProfile_FirstPoint.md) | Первая точка, задающая направление проецирования |
...
|  | [ProjectedContour](P_TFlex_Model_Model3D_ProjectionProfile_ProjectedContour.md) | Проецируемый контур |
|  | [ProjectionDirection](P_TFlex_Model_Model3D_ProjectionProfile_ProjectionDirection.md) | Направление проецирования |
|  | [ProjectionSurface](P_TFlex_Model_Model3D_ProjectionProfile_ProjectionSurface.md) | Поверхность проецирования |
|  | [SecondPoint](P_TFlex_Model_Model3D_ProjectionProfile_SecondPoint.md) | Вторая точка, задающая направление проецирования |
