...
Поверхность с модели

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseSurface](T_TFlex_Model_Model3D_Geometry_BaseSurface.md) TFlex.Model.Model3D.GeometryModelSurface Подробнее
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseSurface](T_TFlex_Model_Model3D_Geometry_BaseSurface.md) TFlex.Model.Model3D.GeometryModelSurface [TFlex.Model.Model3D.GeometryModelConeSurface](T_TFlex_Model_Model3D_Geometry_ModelConeSurface.md) [TFlex.Model.Model3D.GeometryModelCylinderSurface](T_TFlex_Model_Model3D_Geometry_ModelCylinderSurface.md) [TFlex.Model.Model3D.GeometryModelPlaneSurface](T_TFlex_Model_Model3D_Geometry_ModelPlaneSurface.md) [TFlex.Model.Model3D.GeometryModelSphereSurface](T_TFlex_Model_Model3D_Geometry_ModelSphereSurface.md) [TFlex.Model.Model3D.GeometryModelSplineSurface](T_TFlex_Model_Model3D_Geometry_ModelSplineSurface.md) [TFlex.Model.Model3D.GeometryModelSpunSurface](T_TFlex_Model_Model3D_Geometry_ModelSpunSurface.md) [TFlex.Model.Model3D.GeometryModelSweptSurface](T_TFlex_Model_Model3D_Geometry_ModelSweptSurface.md) [TFlex.Model.Model3D.GeometryModelTorusSurface](T_TFlex_Model_Model3D_Geometry_ModelTorusSurface.md)