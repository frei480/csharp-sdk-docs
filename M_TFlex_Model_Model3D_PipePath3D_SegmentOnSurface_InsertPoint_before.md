...
# PipePath3DSegmentOnSurfaceInsertPoint_before - метод  
...
public PipePath3DPointOnSurface InsertPoint_before(
...
PipePath3DPointOnSurface^ InsertPoint_before(
	PipePath3DPointOnSurface^ pPoint
)
```
...
pPoint [PipePath3DPointOnSurface](T_TFlex_Model_Model3D_PipePath3D_PointOnSurface.md)
