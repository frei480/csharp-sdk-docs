...
# NonSectionCondition - класс  
  
---  
  
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationNonSectionCondition
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [NonSectionCondition](M_TFlex_Configuration_NonSectionCondition__ctor.md) | Инициализирует новый экземпляр класса NonSectionCondition |
|  | [NonSectionCondition(IntPtr, Boolean)](M_TFlex_Configuration_NonSectionCondition__ctor_1.md) | Инициализирует новый экземпляр класса NonSectionCondition |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ConditionType](P_TFlex_Configuration_NonSectionCondition_ConditionType.md) |  |
|  | [ObjectName](P_TFlex_Configuration_NonSectionCondition_ObjectName.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_NonSectionCondition_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_NonSectionCondition_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_NonSectionCondition_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
