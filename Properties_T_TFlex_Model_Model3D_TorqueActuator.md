...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AngVel](P_TFlex_Model_Model3D_TorqueActuator_AngVel.md) | Угловая скорость |
...
|  | [Torque](P_TFlex_Model_Model3D_TorqueActuator_Torque.md) | Максимальный крутящий момент |
|  | [Type](P_TFlex_Model_Model3D_TorqueActuator_Type.md) | Тип нагрузки(Переопределяет [RestraintType](P_TFlex_Model_Model3D_Restraint_Type.md)) |
...
[TorqueActuator - ](T_TFlex_Model_Model3D_TorqueActuator.md)
