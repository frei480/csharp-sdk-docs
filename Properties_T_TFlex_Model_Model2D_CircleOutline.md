...
# CircleOutline - свойства  
  
---  
  
Тип [CircleOutline](T_TFlex_Model_Model2D_CircleOutline.md) предоставляет следующие члены.
...
[CircleOutline - ](T_TFlex_Model_Model2D_CircleOutline.md)
