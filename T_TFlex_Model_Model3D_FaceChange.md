...
Операция изменения граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFaceChange
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FaceChange](M_TFlex_Model_Model3D_FaceChange__ctor.md) | Конструктор для создания операция "Изменение граней" |
...
|  | [CommonParameter1](P_TFlex_Model_Model3D_FaceChange_CommonParameter1.md) | Первый общий параметр (используется для граней с установленным флагом commonParameter) |
|  | [CommonParameter2](P_TFlex_Model_Model3D_FaceChange_CommonParameter2.md) | Второй общий параметр (используется для граней с установленным флагом commonParameter) |
...
|  | [FaceCount](P_TFlex_Model_Model3D_FaceChange_FaceCount.md) | Получить число граней |
...
|  | [GroupType](P_TFlex_Model_Model3D_FaceChange_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [RelativeParameter](P_TFlex_Model_Model3D_FaceChange_RelativeParameter.md) | Флаг относительного изменения размеров |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddFace](M_TFlex_Model_Model3D_FaceChange_AddFace.md) | Задать грань и параметры |
...
|  | [GetFace](M_TFlex_Model_Model3D_FaceChange_GetFace.md) | Получить грань и параметры |
...
|  | [RemoveAllFaces](M_TFlex_Model_Model3D_FaceChange_RemoveAllFaces.md) | Удалить все грани |
