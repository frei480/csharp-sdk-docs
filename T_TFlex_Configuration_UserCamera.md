...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationUserCamera
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [UserCamera](M_TFlex_Configuration_UserCamera__ctor.md) | Инициализирует новый экземпляр класса UserCamera |
|  | [UserCamera(IntPtr, Boolean)](M_TFlex_Configuration_UserCamera__ctor_1.md) | Инициализирует новый экземпляр класса UserCamera |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ScreenPlaneSpeed](P_TFlex_Configuration_UserCamera_ScreenPlaneSpeed.md) |  |
|  | [WalkInfoAngleSpeed](P_TFlex_Configuration_UserCamera_WalkInfoAngleSpeed.md) |  |
|  | [WalkInfoSpeed](P_TFlex_Configuration_UserCamera_WalkInfoSpeed.md) |  |
|  | [WasdStep](P_TFlex_Configuration_UserCamera_WasdStep.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_UserCamera_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_UserCamera_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_UserCamera_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
