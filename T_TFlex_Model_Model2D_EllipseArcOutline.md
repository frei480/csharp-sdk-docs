...
# EllipseArcOutline - класс  
  
---  
  
Дуга эллипса

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DEllipseArcOutline

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class EllipseArcOutline : Outline
```
```vb
Public Class EllipseArcOutline
	Inherits Outline
```
```cpp
public ref class EllipseArcOutline : public Outline
```


Тип EllipseArcOutline предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [EllipseArcOutline](M_TFlex_Model_Model2D_EllipseArcOutline__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ArcNode](P_TFlex_Model_Model2D_EllipseArcOutline_ArcNode.md) | Точка на дуге эллипса |
...
|  | [CenterNode](P_TFlex_Model_Model2D_EllipseArcOutline_CenterNode.md) | Центр дуги эллипса |
...
|  | [EndNode](P_TFlex_Model_Model2D_EllipseArcOutline_EndNode.md) | Конечная точка дуги эллипса |
...
|  | [StartNode](P_TFlex_Model_Model2D_EllipseArcOutline_StartNode.md) | Начальная точка дуги эллипса |
...
|  | [SubType](P_TFlex_Model_Model2D_Outline_SubType.md) | Подтип линии изображения(Унаследован от [Outline](T_TFlex_Model_Model2D_Outline.md)) |
