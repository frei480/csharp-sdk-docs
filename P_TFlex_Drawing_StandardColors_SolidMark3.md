...
# StandardColorsSolidMark3 - свойство  
...
```csharp
public static Color SolidMark3 { get; }
```
```vb
Public Shared ReadOnly Property SolidMark3 As Color
	Get
```
```cpp
public:
static property Color SolidMark3 {
	Color get ();
}
```
