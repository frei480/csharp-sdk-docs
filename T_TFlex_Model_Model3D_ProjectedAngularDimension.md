...
# ProjectedAngularDimension - класс  
  
---  
  
Спроецированный угловой размер

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DDimension](T_TFlex_Model_Model2D_Dimension.md) [TFlex.Model.Model2DAngularDimensionBase](T_TFlex_Model_Model2D_AngularDimensionBase.md) TFlex.Model.Model3DProjectedAngularDimension
...
|  | [SubType](P_TFlex_Model_Model3D_ProjectedAngularDimension_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [SetLeaderNote](M_TFlex_Model_Model3D_ProjectedAngularDimension_SetLeaderNote.md) | Установка привязок размера к узлам, либо по относительным смещениям |
|  | [SetOffsets](M_TFlex_Model_Model3D_ProjectedAngularDimension_SetOffsets.md) | Установка привязок размера к узлам, либо по относительным смещениям |
