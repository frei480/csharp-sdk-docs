...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DCutOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CutOperation](M_TFlex_Model_Model3D_CutOperation__ctor.md) | Конструктор для создания отсечения |
...
|  | [GroupType](P_TFlex_Model_Model3D_CutOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Offset](P_TFlex_Model_Model3D_CutOperation_Offset.md) | Значение отступа |
|  | [Operation](P_TFlex_Model_Model3D_CutOperation_Operation.md) | Исходная операцию |
|  | [Orientation](P_TFlex_Model_Model3D_CutOperation_Orientation.md) | Направление сечения |
...
|  | [Section](P_TFlex_Model_Model3D_CutOperation_Section.md) | Сечение |
|  | [Sheets](P_TFlex_Model_Model3D_CutOperation_Sheets.md) | Множество секущих поверхностей |
...
|  | [Workplane](P_TFlex_Model_Model3D_CutOperation_Workplane.md) | Рабочая плоскость |
