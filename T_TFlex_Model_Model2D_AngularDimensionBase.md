...
# AngularDimensionBase - класс  
    
Базовый класс угловых размеров

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DDimension](T_TFlex_Model_Model2D_Dimension.md) TFlex.Model.Model2DAngularDimensionBase [TFlex.Model.Model2DAngularDimension](T_TFlex_Model_Model2D_AngularDimension.md) [TFlex.Model.Model3DAngularDimension3D](T_TFlex_Model_Model3D_AngularDimension3D.md) [TFlex.Model.Model3DProjectedAngularDimension](T_TFlex_Model_Model3D_ProjectedAngularDimension.md)

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class AngularDimensionBase : Dimension
```
```vb
Public Class AngularDimensionBase
	Inherits Dimension
```
```cpp
public ref class AngularDimensionBase : public Dimension
```


Тип AngularDimensionBase предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [AngularDimensionBase(Document)](M_TFlex_Model_Model2D_AngularDimensionBase__ctor_2.md) | Инициализирует новый экземпляр класса AngularDimensionBase |
|  | [AngularDimensionBase(IntPtr)](M_TFlex_Model_Model2D_AngularDimensionBase__ctor.md) | Инициализирует новый экземпляр класса AngularDimensionBase |
|  | [AngularDimensionBase(IntPtr, Boolean)](M_TFlex_Model_Model2D_AngularDimensionBase__ctor_1.md) | Инициализирует новый экземпляр класса AngularDimensionBase |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model2D_AngularDimensionBase_Accuracy.md) | Точность |
...
|  | [EndArrowSize](P_TFlex_Model_Model2D_AngularDimensionBase_EndArrowSize.md) | Размер конечной стрелки |
|  | [EndArrowType](P_TFlex_Model_Model2D_AngularDimensionBase_EndArrowType.md) | Тип конечной стрелки |
|  | [ExtOffset](P_TFlex_Model_Model2D_AngularDimensionBase_ExtOffset.md) | Величина смещения выносных линий |
...
|  | [LinesType](P_TFlex_Model_Model2D_AngularDimensionBase_LinesType.md) | Режим отображения размерных и выносных линий |
...
|  | [MinDigits](P_TFlex_Model_Model2D_AngularDimensionBase_MinDigits.md) | Минимальное число знаков после запятой |
...
|  | [OutsideArrows](P_TFlex_Model_Model2D_AngularDimensionBase_OutsideArrows.md) | Состояние флага отображения стрелок с внешней стороны |
...
|  | [Standard](P_TFlex_Model_Model2D_AngularDimensionBase_Standard.md) | Тип стандарта размера |
|  | [StartArrowSize](P_TFlex_Model_Model2D_AngularDimensionBase_StartArrowSize.md) | Размер начальной стрелки |
|  | [StartArrowType](P_TFlex_Model_Model2D_AngularDimensionBase_StartArrowType.md) | Тип начальной стрелки |
...
|  | [StringsOffset](P_TFlex_Model_Model2D_AngularDimensionBase_StringsOffset.md) | Величина смещения строк от размерной линии |
...
|  | [TolerAutomatic](P_TFlex_Model_Model2D_AngularDimensionBase_TolerAutomatic.md) | Указывает на то, что допуск будет рассчитываться автоматически |
|  | [TolerLowerDev](P_TFlex_Model_Model2D_AngularDimensionBase_TolerLowerDev.md) | Величина нижнего отклонения допуска |
|  | [TolerUpperDev](P_TFlex_Model_Model2D_AngularDimensionBase_TolerUpperDev.md) | Величина верхнего отклонения допуска |
|  | [Units](P_TFlex_Model_Model2D_AngularDimensionBase_Units.md) | Тип единиц измерения |
