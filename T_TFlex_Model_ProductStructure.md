...
# ProductStructure - класс  
    
Класс структуры изделия

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.ModelProductStructure
...
|  | [IsCreatedForVersion](P_TFlex_Model_ProductStructure_IsCreatedForVersion.md) | Структура изделия связана с исполнением |
...
|  | [IsShownInProductStructureWindow](P_TFlex_Model_ProductStructure_IsShownInProductStructureWindow.md) | Структура изделия показана в окне "Структура изделия" |
...
|  | [SchemeId](P_TFlex_Model_ProductStructure_SchemeId.md) | Идентификатор типа структуры изделия |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddElement](M_TFlex_Model_ProductStructure_AddElement.md) | Добавить элемент в структуру изделия |
|  | [AddExternalReport](M_TFlex_Model_ProductStructure_AddExternalReport.md) | Добавить ссылку на внешний отчёт |
...
|  | [CreateChangesScope](M_TFlex_Model_ProductStructure_CreateChangesScope.md) | Создать область изменений. Структура изделия не будет автоматически пересчитываться при изменениях. Вместо этого она пересчитается когда будет вызван Dispose. |
...
|  | [CreateProductStructure(Document, FileLink)](M_TFlex_Model_ProductStructure_CreateProductStructure_1.md) | Создать новую структуру изделия |
...
|  | [ExportToCSV](M_TFlex_Model_ProductStructure_ExportToCSV.md) | Экспортировать структуру изделия в CSV |
|  | [ExportToExcel](M_TFlex_Model_ProductStructure_ExportToExcel.md) | Экспортировать структуру изделия в Excel |
|  | [ExportToXml](M_TFlex_Model_ProductStructure_ExportToXml.md) | Экспортировать структуру изделия в xml |
|  | [Finalize](https://learn.microsoft.com/dotnet/api/system.object.finalize) | Allows an object to try to free resources and perform other cleanup operations before it is reclaimed by garbage collection.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetActiveProductStructure](M_TFlex_Model_ProductStructure_GetActiveProductStructure.md) | Получить активную структуру изделия |
|  | [GetAllRowElements](M_TFlex_Model_ProductStructure_GetAllRowElements.md) | Получить все элементы структуры изделия |
...
|  | [GetExternalReports](M_TFlex_Model_ProductStructure_GetExternalReports.md) | Получить коллекцию ссылок на внешние отчёты структуры изделия |
...
|  | [GetRowElementGroups(Guid)](M_TFlex_Model_ProductStructure_GetRowElementGroups_1.md) | Получить группы элементов структуры изделия |
|  | [GetRowElementGroups(Int32)](M_TFlex_Model_ProductStructure_GetRowElementGroups_2.md) | Получить группы элементов структуры изделия |
|  | [GetScheme](M_TFlex_Model_ProductStructure_GetScheme.md) | Получить тип структуры изделия |
...
|  | [GetVersionGroups(VersionGroupingType)](M_TFlex_Model_ProductStructure_GetVersionGroups_1.md) |  |
|  | [HighlightRowElementsConnectedObjects](M_TFlex_Model_ProductStructure_HighlightRowElementsConnectedObjects.md) |  |
|  | [InitializeByPrototype](M_TFlex_Model_ProductStructure_InitializeByPrototype.md) | Инициалихация структуры изделия по прототипу |
...
|  | [RemoveExternalReport](M_TFlex_Model_ProductStructure_RemoveExternalReport.md) | Удалить ссылку на внешний отчёт |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [RunReportGeneration](M_TFlex_Model_ProductStructure_RunReportGeneration.md) | Запустить генерацию отчета структуры изделия |
|  | [SetActiveProductStructure](M_TFlex_Model_ProductStructure_SetActiveProductStructure.md) | Сделать структуру изделия активной |
...
|  | [SetScheme](M_TFlex_Model_ProductStructure_SetScheme.md) | Изменить тип структуры изделия |
|  | [ShowInProductStructureWindow](M_TFlex_Model_ProductStructure_ShowInProductStructureWindow.md) | Показать структуру изделия в окне "Структура изделия" |
...
|  | [UpdateReports(IEnumerableRichText)](M_TFlex_Model_ProductStructure_UpdateReports_1.md) |  |
|  | [UpdateStructure](M_TFlex_Model_ProductStructure_UpdateStructure.md) | Обновить структуру изделия |
