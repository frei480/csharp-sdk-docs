...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationWeld
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Weld](M_TFlex_Configuration_Weld__ctor.md) | Инициализирует новый экземпляр класса Weld |
|  | [Weld(IntPtr, Boolean)](M_TFlex_Configuration_Weld__ctor_1.md) | Инициализирует новый экземпляр класса Weld |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [UserWeldTypeSourcePath](P_TFlex_Configuration_Weld_UserWeldTypeSourcePath.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Weld_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Weld_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Weld_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
