...
# Document3DGetThreads - метод  
    
Контейнер операций "Резьба"
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Thread](T_TFlex_Model_Model3D_Thread.md)
