...
# DraggerDispose(Boolean) - метод  
  
---  
  
Освобождает неуправляемые ресурсы, используемые объектом [Dragger](T_TFlex_Model_Model3D_Visual_Dragger.md), а при необходимости освобождает также управляемые ресурсы
...
[Dispose - перегрузка](Overload_TFlex_Model_Model3D_Visual_Dragger_Dispose.md)
