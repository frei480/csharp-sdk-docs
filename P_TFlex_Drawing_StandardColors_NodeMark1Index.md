...
# StandardColorsNodeMark1Index - свойство  
...
```csharp
public static int NodeMark1Index { get; }
```
```vb
Public Shared ReadOnly Property NodeMark1Index As Integer
	Get
```
```cpp
public:
static property int NodeMark1Index {
	int get ();
}
```
