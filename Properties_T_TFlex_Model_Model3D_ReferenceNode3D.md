...
# ReferenceNode3D - свойства  
    
Тип [ReferenceNode3D](T_TFlex_Model_Model3D_ReferenceNode3D.md) предоставляет следующие члены.
...
|  | [OriginalLayerName](P_TFlex_Model_Model3D_ReferenceNode3D_OriginalLayerName.md) | Имя слоя, на котором объект лежит в документе фрагмента |
|  | [OriginalName](P_TFlex_Model_Model3D_ReferenceNode3D_OriginalName.md) | Имя объекта в документе фрагмента |
|  | [Owner](P_TFlex_Model_Model3D_ReferenceNode3D_Owner.md) | Владелец ссылочного объекта |
...
[ReferenceNode3D - ](T_TFlex_Model_Model3D_ReferenceNode3D.md)
