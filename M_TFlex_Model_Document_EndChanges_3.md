...
# DocumentEndChanges(Boolean, Boolean, Boolean) - метод  
...
Unconditionally [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
    Условие корректности модели с ошибками пересчета
Regenerate [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
    Пересчитывать модель
Merge [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
    Объединить Undo-блок с верхним Undo-блоком
