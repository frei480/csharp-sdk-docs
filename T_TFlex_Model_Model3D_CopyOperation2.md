...
# CopyOperation2 - класс  
  
---  
  
Класс операции Копирования

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) [TFlex.Model.Model3DCopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md) TFlex.Model.Model3DCopyOperation2

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class CopyOperation2 : CopyBaseOperation2
```
```vb
Public Class CopyOperation2
	Inherits CopyBaseOperation2
```
```cpp
public ref class CopyOperation2 : public CopyBaseOperation2
```


Тип CopyOperation2 предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [CopyOperation2(Document)](M_TFlex_Model_Model3D_CopyOperation2__ctor.md) | Конструктор для Копирования операций |
|  | [CopyOperation2(Document, CopyBaseOperation2Type)](M_TFlex_Model_Model3D_CopyOperation2__ctor_1.md) | Конструктор для операции Копирования |
...
|  | [Constructions](P_TFlex_Model_Model3D_CopyBaseOperation2_Constructions.md) | Коллекция копируемых элементов построения(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [CopyMode](P_TFlex_Model_Model3D_CopyBaseOperation2_CopyMode.md) | Тип копирования(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [Edges](P_TFlex_Model_Model3D_CopyBaseOperation2_Edges.md) | Коллекция рёбер, используемых для выбора копируемых граней(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [Faces](P_TFlex_Model_Model3D_CopyBaseOperation2_Faces.md) | Коллекция копируемых граней(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_CopyOperation2_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [IncludeInBom](P_TFlex_Model_Model3D_CopyBaseOperation2_IncludeInBom.md) | Включать в спецификацию(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [Loops](P_TFlex_Model_Model3D_CopyBaseOperation2_Loops.md) | Коллекция циклов, используемых для выбора копируемых граней(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [ObjectsType](P_TFlex_Model_Model3D_CopyBaseOperation2_ObjectsType.md) | Тип копируемых элементов(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
|  | [Operations](P_TFlex_Model_Model3D_CopyBaseOperation2_Operations.md) | Коллекция копируемых операций(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
...
|  | [SourceLCS](P_TFlex_Model_Model3D_CopyOperation2_SourceLCS.md) | Исходная система коодинат |
...
|  | [Symmetry](P_TFlex_Model_Model3D_CopyOperation2_Symmetry.md) | Плоскость симметрии |
|  | [TargetLCS](P_TFlex_Model_Model3D_CopyOperation2_TargetLCS.md) | Целевая система коодинат |
...
|  | [IsModeAvailable](M_TFlex_Model_Model3D_CopyBaseOperation2_IsModeAvailable.md) | Определить, доступен ли указанный режим копирования для данной операции(Унаследован от [CopyBaseOperation2](T_TFlex_Model_Model3D_CopyBaseOperation2.md)) |
