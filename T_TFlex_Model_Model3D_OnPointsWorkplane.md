...
|  | [OnPointsWorkplane(Document, Page)](M_TFlex_Model_Model3D_OnPointsWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [Angle](P_TFlex_Model_Model3D_OnPointsWorkplane_Angle.md) | Угол поворота |
...
|  | [AxisOnWorkplane](P_TFlex_Model_Model3D_OnPointsWorkplane_AxisOnWorkplane.md) | Ось, через которую проходит рабочая плоскость |
|  | [BaseDirection](P_TFlex_Model_Model3D_OnPointsWorkplane_BaseDirection.md) | Направление, относительно которого задаётся доворот рабочей плоскости |
|  | [BasePlane](P_TFlex_Model_Model3D_OnPointsWorkplane_BasePlane.md) | Плоскость, относительно которой задаётся доворот рабочей плоскости |
...
|  | [FaceTangentToWorkplane](P_TFlex_Model_Model3D_OnPointsWorkplane_FaceTangentToWorkplane.md) | Поверхность, которой касается рабочая плоскость |
|  | [FirstPointOnWorkplane](P_TFlex_Model_Model3D_OnPointsWorkplane_FirstPointOnWorkplane.md) | Первая точка, задающая положение рабочей плоскости |
...
|  | [Location](P_TFlex_Model_Model3D_Model3DWorkplane_Location.md) | Точка, задающая начало координат рабочей плоскости(Унаследован от [Model3DWorkplane](T_TFlex_Model_Model3D_Model3DWorkplane.md)) |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Model3DWorkplane_ReferenceDirection.md) | Точка, задающая направление оси X рабочей плоскости(Унаследован от [Model3DWorkplane](T_TFlex_Model_Model3D_Model3DWorkplane.md)) |
...
|  | [SecondPointOnWorkplane](P_TFlex_Model_Model3D_OnPointsWorkplane_SecondPointOnWorkplane.md) | Вторая точку, задающая положение рабочей плоскости |
...
|  | [ThirdPointOnWorkplane](P_TFlex_Model_Model3D_OnPointsWorkplane_ThirdPointOnWorkplane.md) | Третья точка, задающая положение рабочей плоскости |
