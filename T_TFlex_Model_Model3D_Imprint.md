...
Операция разделения граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DImprint
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Imprint](M_TFlex_Model_Model3D_Imprint__ctor.md) | Конструктор для создания операция "Разбиение граней" |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model3D_Imprint_Angle.md) | Угол |
...
|  | [Direction](P_TFlex_Model_Model3D_Imprint_Direction.md) | Направление |
|  | [DirectionReverse](P_TFlex_Model_Model3D_Imprint_DirectionReverse.md) | Флаг реверса направления |
...
|  | [ExtendedFace](P_TFlex_Model_Model3D_Imprint_ExtendedFace.md) | **Устарело.** Флаг расширения списка обрабатываемых граней при построении пересечений. Примечание: Это свойство устарело и было заменено на ExtendedFaceType |
|  | [ExtendedFaceType](P_TFlex_Model_Model3D_Imprint_ExtendedFaceType.md) | Тип расширения списка обрабатываемых граней при построении пересечений |
|  | [Facet](P_TFlex_Model_Model3D_Operation_Facet.md) | (Унаследован от [Operation](T_TFlex_Model_Model3D_Operation.md)) |
|  | [FirstPoint](P_TFlex_Model_Model3D_Imprint_FirstPoint.md) | Первая точка задающая направление |
...
|  | [GroupType](P_TFlex_Model_Model3D_Imprint_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [ImprintComplete](P_TFlex_Model_Model3D_Imprint_ImprintComplete.md) | Завершение рёбер |
|  | [ImprintConnect](P_TFlex_Model_Model3D_Imprint_ImprintConnect.md) | Способ соединения рёбер |
|  | [ImprintExtend](P_TFlex_Model_Model3D_Imprint_ImprintExtend.md) | Направление продления рёбер |
|  | [ImprintOverlapping](P_TFlex_Model_Model3D_Imprint_ImprintOverlapping.md) | Флаг обработки перекрытий |
...
|  | [Method](P_TFlex_Model_Model3D_Imprint_Method.md) | Установить способ разделения грани |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_Imprint_SecondPoint.md) | Вторая точка задающая направление |
...
|  | [TargetFaces](P_TFlex_Model_Model3D_Imprint_TargetFaces.md) | Разделяемые грани |
|  | [TargetOperation](P_TFlex_Model_Model3D_Imprint_TargetOperation.md) | Разделяемая операция |
|  | [ToolFaces](P_TFlex_Model_Model3D_Imprint_ToolFaces.md) | Установить разделяющие грани |
|  | [ToolOperation](P_TFlex_Model_Model3D_Imprint_ToolOperation.md) | Разделяющая операция |
