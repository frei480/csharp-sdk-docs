...
# MultiLinksGroup - методы  
    
Тип [MultiLinksGroup](T_TFlex_Model_Circuits_MultiLinksGroup.md) предоставляет следующие члены.
...
[MultiLinksGroup - ](T_TFlex_Model_Circuits_MultiLinksGroup.md)
