...
|  | [LocalSectionProjection(Document, Page)](M_TFlex_Model_Model3D_LocalSectionProjection__ctor_1.md) | Конструктор для создания новой проекции |
...
|  | [BaseProjection](P_TFlex_Model_Model3D_LocalSectionProjection_BaseProjection.md) | Проекция на базе которой строится локальная проекция |
...
|  | [HatchScale](P_TFlex_Model_Model3D_LocalSectionProjection_HatchScale.md) | Масштаб штриховки |
...
|  | [LocalProjection](P_TFlex_Model_Model3D_LocalSectionProjection_LocalProjection.md) | Проекция на которой определяется положение узла привязки |
...
|  | [SectionArea](P_TFlex_Model_Model3D_LocalSectionProjection_SectionArea.md) | Штриховка задающая область вырыва |
...
|  | [TieNode2D](P_TFlex_Model_Model3D_LocalSectionProjection_TieNode2D.md) | Узел по которому определяется положение секущей плоскости |
|  | [TiePoint3D](P_TFlex_Model_Model3D_LocalSectionProjection_TiePoint3D.md) | Точка по которой определяется положение секущей плоскости |
...
|  | [Complete](M_TFlex_Model_Model3D_LocalSectionProjection_Complete.md) | Для внутреннего использования(Переопределяет [ProjectionComplete](M_TFlex_Model_Model3D_Projection_Complete.md)) |
