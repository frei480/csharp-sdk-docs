...
# SheetMetalPart - класс  
    
Операция "Листовая заготовка"

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSheetMetalPart
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SheetMetalPart](M_TFlex_Model_Model3D_SheetMetalPart__ctor.md) | Конструктор для операции "Листовая заготовка" |
...
|  | [GroupType](P_TFlex_Model_Model3D_SheetMetalPart_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Profiles](P_TFlex_Model_Model3D_SheetMetalPart_Profiles.md) | Образующие контуры |
...
|  | [Thickness](P_TFlex_Model_Model3D_SheetMetalPart_Thickness.md) | Толщина |
...
|  | [Type](P_TFlex_Model_Model3D_SheetMetalPart_Type.md) | Положение |
