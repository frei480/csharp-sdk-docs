...
# StandardColorsFaceMark2Index - свойство  
...
```csharp
public static int FaceMark2Index { get; }
```
```vb
Public Shared ReadOnly Property FaceMark2Index As Integer
	Get
```
```cpp
public:
static property int FaceMark2Index {
	int get ();
}
```
