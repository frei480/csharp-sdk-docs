...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ProjectionPath](M_TFlex_Model_Model3D_ProjectionPath__ctor.md) | Конструктор для создания проекции проволочной модели на листовое или твёрдое тело |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_ProjectionPath_FirstPoint.md) | Первая точка, задающая направление проецирования |
...
|  | [ProjectedWire](P_TFlex_Model_Model3D_ProjectionPath_ProjectedWire.md) | Проецируемая провлочная геометрия |
|  | [ProjectionDirection](P_TFlex_Model_Model3D_ProjectionPath_ProjectionDirection.md) | Направление проецирования |
|  | [ProjectionSurface](P_TFlex_Model_Model3D_ProjectionPath_ProjectionSurface.md) | Поверхность проецирования |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_ProjectionPath_SecondPoint.md) | Вторая точка, задающая направление проецирования |
