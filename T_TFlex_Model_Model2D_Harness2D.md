...
Класс для 2D жгутов (сборочный чертёж кабельного изделия)

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DHarness2D
...
|  | [GroupType](P_TFlex_Model_Model2D_Harness2D_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [OwnerHarness3D](P_TFlex_Model_Model2D_Harness2D_OwnerHarness3D.md) | Кабельное изделие, по которому создан Harness2D |
...
|  | [GetEdges](M_TFlex_Model_Model2D_Harness2D_GetEdges.md) | Получить информацию о ребрах |
...
|  | [GetNodes](M_TFlex_Model_Model2D_Harness2D_GetNodes.md) | Получить информацию об узлах |
...
|  | [GetSegments](M_TFlex_Model_Model2D_Harness2D_GetSegments.md) | Получить информацию о сегментах |
