...
Геометрическая сплайновая поверхность
...
|  | [SplineSurface(SurfaceSplineData)](M_TFlex_Model_Model3D_Geometry_SplineSurface__ctor_1.md) | Создание сплайновой поверхности по набору контрольных точек, весов и последовательности узлов параметризации |
|  | [SplineSurface(SurfaceSplinewiseData)](M_TFlex_Model_Model3D_Geometry_SplineSurface__ctor_2.md) | Создание интерполяционной сплайновой поверхности по набору точек, через которые проходит сплайновая поверхность, по параметрам поверхности в этих точках и условиям на концах |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Data](P_TFlex_Model_Model3D_Geometry_SplineSurface_Data.md) | Описание сплайновой поверхности |
...
|  | [Splinewise](P_TFlex_Model_Model3D_Geometry_SplineSurface_Splinewise.md) | Получить описание интерполяционной сплайновой поверхности по набору точек, через которые проходит сплайновая поверхность, по параметрам поверхности в этих точках и условиям на концах |
...
|  | [Piecewise](M_TFlex_Model_Model3D_Geometry_SplineSurface_Piecewise.md) | Получить описание интерполяционной сплайновой поверхности по набору точек, через которые проходит сплайновая поверхность, по параметрам поверхности в этих точках и условиям на концах |
...
|  | [SetPiecewise](M_TFlex_Model_Model3D_Geometry_SplineSurface_SetPiecewise.md) | Установить описание сплайновой поверхности по набору сегментов |
