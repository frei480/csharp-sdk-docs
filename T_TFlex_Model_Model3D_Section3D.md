...
Базовый класс для всех типов сечений

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DSection3D [TFlex.Model.Model3DModel2DSection](T_TFlex_Model_Model3D_Model2DSection.md) [TFlex.Model.Model3DPlaneSection](T_TFlex_Model_Model3D_PlaneSection.md) [TFlex.Model.Model3DViewSection](T_TFlex_Model_Model3D_ViewSection.md)
...
|  | [Geometry](P_TFlex_Model_Model3D_Section3D_Geometry.md) | Получить геометрические данные сечения |
|  | [GroupType](P_TFlex_Model_Model3D_Section3D_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Orientation](P_TFlex_Model_Model3D_Section3D_Orientation.md) | Направление сечения |
|  | [Page](P_TFlex_Model_Model3D_Section3D_Page.md) | Страница |
...
|  | [ShowOn3D](P_TFlex_Model_Model3D_Section3D_ShowOn3D.md) | Признак рисования сечения в 3D сцене |
...
|  | [UseColorFromBody](P_TFlex_Model_Model3D_Section3D_UseColorFromBody.md) | Признак использования цвета с тела |
