...
# ProjectedCircularDimensionSetDiametralDimensionType(DiametralDimensionType) - метод  
...
```csharp
public void SetDiametralDimensionType(
...
[SetDiametralDimensionType - перегрузка](Overload_TFlex_Model_Model3D_ProjectedCircularDimension_SetDiametralDimensionType.md)
