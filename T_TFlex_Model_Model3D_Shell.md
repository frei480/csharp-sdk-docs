...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DShell
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Shell](M_TFlex_Model_Model3D_Shell__ctor.md) | Конструктор для создания Оболочки |
...
|  | [EquidistantBody](P_TFlex_Model_Model3D_Shell_EquidistantBody.md) | **Устарело.** Параметр создания эквидистантного тела |
...
|  | [GroupType](P_TFlex_Model_Model3D_Shell_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Offset](P_TFlex_Model_Model3D_Shell_Offset.md) | Толщина оболочки |
|  | [OffsetFaceCount](P_TFlex_Model_Model3D_Shell_OffsetFaceCount.md) | Число особых граней |
|  | [Outside](P_TFlex_Model_Model3D_Shell_Outside.md) | Параметр построения оболочки наружу |
...
|  | [PierceFaces](P_TFlex_Model_Model3D_Shell_PierceFaces.md) |  |
|  | [PierceSmoothingSurfaces](P_TFlex_Model_Model3D_Shell_PierceSmoothingSurfaces.md) | Пробивать касательные грани |
|  | [SourceOperation](P_TFlex_Model_Model3D_Shell_SourceOperation.md) |  |
|  | [StoreSourceBody](P_TFlex_Model_Model3D_Shell_StoreSourceBody.md) | Параметр сохранения исходного тела |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddOffsetFace](M_TFlex_Model_Model3D_Shell_AddOffsetFace.md) | Добавить грань с особой толщиной |
...
|  | [GetOffsetFace](M_TFlex_Model_Model3D_Shell_GetOffsetFace.md) | Получить особую грань |
...
|  | [RemoveAllOffsetFaces](M_TFlex_Model_Model3D_Shell_RemoveAllOffsetFaces.md) | Удалить все особые грани |
|  | [RemoveOffsetFace](M_TFlex_Model_Model3D_Shell_RemoveOffsetFace.md) | Удалить особую грань |
