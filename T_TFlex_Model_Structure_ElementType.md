...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.StructureElementType
...
|  | [GroupType](P_TFlex_Model_Structure_ElementType_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
|  | [HasElements](P_TFlex_Model_Structure_ElementType_HasElements.md) |  |
...
|  | [IsAbstract](P_TFlex_Model_Structure_ElementType_IsAbstract.md) |  |
...
|  | [IsEnum](P_TFlex_Model_Structure_ElementType_IsEnum.md) |  |
...
|  | [ItemString](P_TFlex_Model_Structure_ElementType_Item_1.md) |  |
...
|  | [ParentType](P_TFlex_Model_Structure_ElementType_ParentType.md) |  |
|  | [SystemName](P_TFlex_Model_Structure_ElementType_SystemName.md) |  |
|  | [UID](P_TFlex_Model_Structure_ElementType_UID.md) |  |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddParameter](M_TFlex_Model_Structure_ElementType_AddParameter.md) |  |
...
|  | [CreateElement](M_TFlex_Model_Structure_ElementType_CreateElement.md) |  |
...
|  | [GetMethods](M_TFlex_Model_Structure_ElementType_GetMethods.md) |  |
...
|  | [GetParameters](M_TFlex_Model_Structure_ElementType_GetParameters.md) |  |
|  | [GetPossibleLinks](M_TFlex_Model_Structure_ElementType_GetPossibleLinks.md) |  |
...
|  | [GetTypeIcon](M_TFlex_Model_Structure_ElementType_GetTypeIcon.md) |  |
|  | [GetValue(Guid)](M_TFlex_Model_Structure_ElementType_GetValue.md) |  |
|  | [GetValue(String)](M_TFlex_Model_Structure_ElementType_GetValue_1.md) |  |
...
|  | [IsSubtypeOf(Guid)](M_TFlex_Model_Structure_ElementType_IsSubtypeOf.md) |  |
|  | [IsSubtypeOf(String)](M_TFlex_Model_Structure_ElementType_IsSubtypeOf_1.md) |  |
...
|  | [RunMethod(Guid, Object)](M_TFlex_Model_Structure_ElementType_RunMethod.md) |  |
|  | [RunMethod(String, Object)](M_TFlex_Model_Structure_ElementType_RunMethod_1.md) |  |
