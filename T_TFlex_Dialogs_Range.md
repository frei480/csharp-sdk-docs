...
Задаёт диапазон зачений

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.DialogsRange
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Range](M_TFlex_Dialogs_Range__ctor.md) | Инициализирует новый экземпляр класса Range |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Max](P_TFlex_Dialogs_Range_Max.md) |  |
|  | [Min](P_TFlex_Dialogs_Range_Min.md) |  |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AnyRealValue](F_TFlex_Dialogs_Range_AnyRealValue.md) | Диапазон, включающий все вещественные числа |
