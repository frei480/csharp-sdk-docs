...
# CircleConstruction - класс  
    
Линия построения - окружность

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DCircleConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CircleConstruction(Document)](M_TFlex_Model_Model2D_CircleConstruction__ctor.md) | Конструктор по умолчанию |
|  | [CircleConstruction(Document, Point, Construction, Construction)](M_TFlex_Model_Model2D_CircleConstruction__ctor_1.md) | Конструктор |
...
|  | [CircleConstructionGeometry](P_TFlex_Model_Model2D_CircleConstruction_CircleConstructionGeometry.md) | Геометрия линии построения (окружности) |
|  | [CircleType](P_TFlex_Model_Model2D_CircleConstruction_CircleType.md) | Тип привязки окружности |
|  | [Color](P_TFlex_Model_Model2D_Construction_Color.md) | Цвет объекта(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
|  | [ConstructionGeometry](P_TFlex_Model_Model2D_CircleConstruction_ConstructionGeometry.md) | Геометрия линии построения(Переопределяет [ConstructionConstructionGeometry](P_TFlex_Model_Model2D_Construction_ConstructionGeometry.md)) |
...
|  | [GeometryType](P_TFlex_Model_Model2D_CircleConstruction_GeometryType.md) | Тип геометрии линии построения (окружность)(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
|  | [GroupType](P_TFlex_Model_Model2D_Construction_GroupType.md) | Тип объекта(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
...
|  | [IsFixedPosition](P_TFlex_Model_Model2D_Construction_IsFixedPosition.md) | Lock position of line(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
|  | [IsFixedPositionLocked](P_TFlex_Model_Model2D_Construction_IsFixedPositionLocked.md) | Block the ability to control fixation of construction line from interface(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_Construction_Layer.md) | Слой, на котором размещается объект(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
|  | [Level](P_TFlex_Model_Model2D_Construction_Level.md) | Уровень объекта(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
...
|  | [Page](P_TFlex_Model_Model2D_Construction_Page.md) | Страница, на которой размещается элемент(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
...
|  | [Param](P_TFlex_Model_Model2D_Construction_Param.md) | Значение параметра линии построения. Тип параметра зависит от типа линии построения.(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
...
|  | [SubType](P_TFlex_Model_Model2D_CircleConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
...
|  | [RepairPerpendicularDirection](M_TFlex_Model_Model2D_Construction_RepairPerpendicularDirection.md) | (Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [SetCenterAndCircle](M_TFlex_Model_Model2D_CircleConstruction_SetCenterAndCircle.md) | Окружность с центром в узле, касательная к окружности |
|  | [SetCenterAndEllipse](M_TFlex_Model_Model2D_CircleConstruction_SetCenterAndEllipse.md) | Окружность с центром в узле, касательная к эллипсу |
|  | [SetCenterAndLine](M_TFlex_Model_Model2D_CircleConstruction_SetCenterAndLine.md) | Окружность с центром в узле, касательная к прямой |
|  | [SetCenterAndNode](M_TFlex_Model_Model2D_CircleConstruction_SetCenterAndNode.md) | Окружность с центром в узле, проходящая через узел |
|  | [SetCenterAndRadius](M_TFlex_Model_Model2D_CircleConstruction_SetCenterAndRadius.md) | Окружность с центром в узле и заданным радиусом |
...
|  | [SetNodeTangentToLineAndCircle](M_TFlex_Model_Model2D_CircleConstruction_SetNodeTangentToLineAndCircle.md) | Окружность, проходящая через узел, касательная к прямой и окружности |
|  | [SetNodeTangentToTwoCircles](M_TFlex_Model_Model2D_CircleConstruction_SetNodeTangentToTwoCircles.md) | Окружность, проходящая через узел, касательная к двум окружностям |
|  | [SetNodeTangentToTwoLines](M_TFlex_Model_Model2D_CircleConstruction_SetNodeTangentToTwoLines.md) | Окружность, проходящая через узел, касательная к двум прямым |
|  | [SetOffset](M_TFlex_Model_Model2D_CircleConstruction_SetOffset.md) | Окружность, концентричная исходной окружности на заданном расстоянии |
|  | [SetOutline](M_TFlex_Model_Model2D_CircleConstruction_SetOutline.md) | Окружность, проходящая по линии изображения (окружности или дуге окружности) |
...
|  | [SetSymmetric](M_TFlex_Model_Model2D_CircleConstruction_SetSymmetric.md) | Окружность, симметричная другой окружности относительно оси (прямой) |
|  | [SetTangentToCircleAndEllipse](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToCircleAndEllipse.md) | Окружность, касательная к окружности и эллипсу |
|  | [SetTangentToCircleAndLine](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToCircleAndLine.md) | Окружность, касательная к окружности и прямой |
|  | [SetTangentToCircleAndNode](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToCircleAndNode.md) | Окружность, касательная к окружности, проходящая через узел |
|  | [SetTangentToCircleAndPolyline](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToCircleAndPolyline.md) | Окружность, касательная к окружности и сплайну или другой полилинии |
|  | [SetTangentToEllipseAndPolyline](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToEllipseAndPolyline.md) | Окружность, касательная к эллипсу и сплайну или другой полилинии |
|  | [SetTangentToLineAndEllipse](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToLineAndEllipse.md) | Окружность, касательная к прямой и эллипсу |
|  | [SetTangentToLineAndNode](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToLineAndNode.md) | Окружность, касательная к прямой, проходящая через узел |
|  | [SetTangentToLineAndPolyline(Construction, Construction, Parameter, Int32)](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToLineAndPolyline_1.md) | Окружность, касательная к прямой и сплайну или другой полилинии |
|  | [SetTangentToLineAndPolyline(Construction, Construction, Parameter, ValueType)](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToLineAndPolyline.md) | Окружность, касательная к прямой и сплайну или другой полилинии |
|  | [SetTangentToLineAndTwoCircles](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToLineAndTwoCircles.md) | Окружность, касательная к прямой и двум окружностям |
|  | [SetTangentToThreeCircles](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToThreeCircles.md) | Окружность, касательная к трём окружностям |
|  | [SetTangentToThreeLines](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToThreeLines.md) | Окружность, касательная к трём прямым |
|  | [SetTangentToTwoCircles](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToTwoCircles.md) | Окружность, касательная к двум окружностям |
|  | [SetTangentToTwoEllipses](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToTwoEllipses.md) | Окружность, касательная к двум эллипсам |
...
|  | [SetTangentToTwoLines(Construction, Construction, Parameter, Node)](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToTwoLines_1.md) | Окружность, касательная к двум прямым |
|  | [SetTangentToTwoLinesAndCircle](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToTwoLinesAndCircle.md) | Окружность, касательная к двум прямым и окружности |
|  | [SetTangentToTwoPolylines](M_TFlex_Model_Model2D_CircleConstruction_SetTangentToTwoPolylines.md) | Окружность, касательная к двум сплайнам или другим полилиниям |
|  | [SetThreeNodes](M_TFlex_Model_Model2D_CircleConstruction_SetThreeNodes.md) | Окружность, проходящая через три узла |
|  | [SetTwoNodes](M_TFlex_Model_Model2D_CircleConstruction_SetTwoNodes.md) | Окружность, проходящая через два узла |
|  | [SetTwoNodesTangentToCircle](M_TFlex_Model_Model2D_CircleConstruction_SetTwoNodesTangentToCircle.md) | Окружность, проходящая через два узла, касательная к окружности |
|  | [SetTwoNodesTangentToLine](M_TFlex_Model_Model2D_CircleConstruction_SetTwoNodesTangentToLine.md) | Окружность, проходящая через два узла, касательная к прямой |
...
|  | [UpdateLimits](M_TFlex_Model_Model2D_Construction_UpdateLimits.md) | Обновление выступания линии построения(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
