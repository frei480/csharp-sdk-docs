...
# SweepGenerator - методы  
  
---  
  
Тип [SweepGenerator](T_TFlex_Model_Model3D_Geometry_SweepGenerator.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_SweepGenerator_Dispose.md) | (Переопределяет [BaseGeneratorDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Dispose_1.md)) |
