...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OnAxisWorkplane(Document)](M_TFlex_Model_Model3D_OnAxisWorkplane__ctor.md) | Конструктор для создания рабочей плоскости |
|  | [OnAxisWorkplane(Document, Page)](M_TFlex_Model_Model3D_OnAxisWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [Angle](P_TFlex_Model_Model3D_OnAxisWorkplane_Angle.md) | Угол поворота |
...
|  | [AxisOnWorkplane](P_TFlex_Model_Model3D_OnAxisWorkplane_AxisOnWorkplane.md) | Ось, которая лежит на рабочей плоскости |
|  | [BasePlane](P_TFlex_Model_Model3D_OnAxisWorkplane_BasePlane.md) | Плоскость, относительно которой задаётся доворот рабочей плоскости |
...
|  | [EdgeOnWorkplane](P_TFlex_Model_Model3D_OnAxisWorkplane_EdgeOnWorkplane.md) | **Устарело.** Плоское ребро, которое лежит на рабочей плоскости |
...
|  | [FaceTangentToWorkplane](P_TFlex_Model_Model3D_OnAxisWorkplane_FaceTangentToWorkplane.md) | Поверхность, которой касается рабочая плоскость |
...
|  | [PointOnWorkplane](P_TFlex_Model_Model3D_OnAxisWorkplane_PointOnWorkplane.md) | Точка, задающая доворот рабочей плоскости |
