...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ApproximatedSplinePath3D](M_TFlex_Model_Model3D_ApproximatedSplinePath3D__ctor.md) | Конструктор для создания сплайна по ломаной |
...
|  | [Degree](P_TFlex_Model_Model3D_ApproximatedSplinePath3D_Degree.md) | Степень сплайна |
...
|  | [Parameterization](P_TFlex_Model_Model3D_ApproximatedSplinePath3D_Parameterization.md) | Тип параметризации |
...
|  | [Periodic](P_TFlex_Model_Model3D_SplinePath3D_Periodic.md) | Свойство периодичности сплайна(Унаследован от [SplinePath3D](T_TFlex_Model_Model3D_SplinePath3D.md)) |
|  | [Points](P_TFlex_Model_Model3D_SplinePath3D_Points.md) | Множество контрольных точек(Унаследован от [SplinePath3D](T_TFlex_Model_Model3D_SplinePath3D.md)) |
...
|  | [Dispose](M_TFlex_Model_Model3D_SplinePath3D_Dispose.md) | Выполняет определяемые приложением задачи, связанные с удалением, высвобождением или сбросом неуправляемых ресурсов(Унаследован от [SplinePath3D](T_TFlex_Model_Model3D_SplinePath3D.md)) |
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_SplinePath3D_Dispose_1.md) | (Унаследован от [SplinePath3D](T_TFlex_Model_Model3D_SplinePath3D.md)) |
...
|  | [GetKnot](M_TFlex_Model_Model3D_ApproximatedSplinePath3D_GetKnot.md) | Получить значение узла параметризации |
...
|  | [GetWeight](M_TFlex_Model_Model3D_ApproximatedSplinePath3D_GetWeight.md) | Получить вес точки |
...
|  | [SetKnot](M_TFlex_Model_Model3D_ApproximatedSplinePath3D_SetKnot.md) | Установить значение узла параметризации |
...
|  | [SetWeight](M_TFlex_Model_Model3D_ApproximatedSplinePath3D_SetWeight.md) | Установить вес точки |
