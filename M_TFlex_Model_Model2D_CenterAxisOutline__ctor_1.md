...
# CenterAxisOutline(Document, Outline, CenterAxisOutlineCenterAxisType, Construction, Outline, Outline, Node, Node) - конструктор  
...
public CenterAxisOutline(
	...
	Construction centerConstruction,
...
Public Sub New ( 
	...
	centerConstruction As Construction,
...
axisType [CenterAxisOutlineCenterAxisType](T_TFlex_Model_Model2D_CenterAxisOutline_CenterAxisType.md)
    Тип оси
centerConstruction [Construction](T_TFlex_Model_Model2D_Construction.md)
    Окружность, определяющая центр
