...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Cone](M_TFlex_Model_Model3D_Cone__ctor.md) | Конструктор для создания Конуса |
...
|  | [Diameter](P_TFlex_Model_Model3D_Cone_Diameter.md) | Диаметр |
|  | [Diameter2](P_TFlex_Model_Model3D_Cone_Diameter2.md) | Диаметр 2 |
...
|  | [Height](P_TFlex_Model_Model3D_Cone_Height.md) | Высота |
...
|  | [PrimaryParameters](P_TFlex_Model_Model3D_Cone_PrimaryParameters.md) | Главные параметры конуса |
...
|  | [SemiAngle](P_TFlex_Model_Model3D_Cone_SemiAngle.md) | Угол |
