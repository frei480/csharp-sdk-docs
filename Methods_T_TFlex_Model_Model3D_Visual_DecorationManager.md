...
# DecorationManager - методы  
    
Тип [DecorationManager](T_TFlex_Model_Model3D_Visual_DecorationManager.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [AddDecoration](M_TFlex_Model_Model3D_Visual_DecorationManager_AddDecoration.md) | Регистрация декорации |
|  | [Dispose](M_TFlex_Model_Model3D_Visual_DecorationManager_Dispose.md) |  |
