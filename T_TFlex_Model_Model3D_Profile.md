...
Базовый класс для всех типов профилей

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DProfile Подробнее
...
|  | [ConvertToSpline](P_TFlex_Model_Model3D_Profile_ConvertToSpline.md) | Получить параметры для преобразования составных контуров профиля в сплайны |
...
|  | [Geometry](P_TFlex_Model_Model3D_Profile_Geometry.md) | Получить геометрические данные профиля |
|  | [GroupType](P_TFlex_Model_Model3D_Profile_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Thickness](P_TFlex_Model_Model3D_Profile_Thickness.md) | Получить свойства толщины |
...
|  | [Transparency](P_TFlex_Model_Model3D_Profile_Transparency.md) | Прозрачность |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DProfile [TFlex.Model.Model3DAreaProfile](T_TFlex_Model_Model3D_AreaProfile.md) [TFlex.Model.Model3DConeDevelopmentProfile](T_TFlex_Model_Model3D_ConeDevelopmentProfile.md) [TFlex.Model.Model3DConvolutionProfile](T_TFlex_Model_Model3D_ConvolutionProfile.md) [TFlex.Model.Model3DCopyProfile](T_TFlex_Model_Model3D_CopyProfile.md) [TFlex.Model.Model3DCylinderDevelopmentProfile](T_TFlex_Model_Model3D_CylinderDevelopmentProfile.md) [TFlex.Model.Model3DFaceProfile](T_TFlex_Model_Model3D_FaceProfile.md) [TFlex.Model.Model3DLineSurfaceDevelopmentProfile](T_TFlex_Model_Model3D_LineSurfaceDevelopmentProfile.md) [TFlex.Model.Model3DOffsetProfile](T_TFlex_Model_Model3D_OffsetProfile.md) [TFlex.Model.Model3DProjectionProfile](T_TFlex_Model_Model3D_ProjectionProfile.md) [TFlex.Model.Model3DReferenceProfile](T_TFlex_Model_Model3D_ReferenceProfile.md) [TFlex.Model.Model3DSketchProfile](T_TFlex_Model_Model3D_SketchProfile.md) [TFlex.Model.Model3DSurfaceSetDevelopmentProfile](T_TFlex_Model_Model3D_SurfaceSetDevelopmentProfile.md) [TFlex.Model.Model3DTextProfile](T_TFlex_Model_Model3D_TextProfile.md) [TFlex.Model.Model3DWireGeometryProfile](T_TFlex_Model_Model3D_WireGeometryProfile.md)