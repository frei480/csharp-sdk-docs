...
# ModelPlaneSurface - свойства  
    
Тип [ModelPlaneSurface](T_TFlex_Model_Model3D_Geometry_ModelPlaneSurface.md) предоставляет следующие члены.
...
|  | [Plane](P_TFlex_Model_Model3D_Geometry_ModelPlaneSurface_Plane.md) | Получить описание плоскости |
...
[ModelPlaneSurface - ](T_TFlex_Model_Model3D_Geometry_ModelPlaneSurface.md)
