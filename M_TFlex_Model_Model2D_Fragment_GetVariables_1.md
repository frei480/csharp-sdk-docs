...
# FragmentGetVariables(Boolean) - метод  
  
---  
  
Получить контейнер переменных фрагмента
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[FragmentVariableValue](T_TFlex_Model_FragmentVariableValue.md)Контейнер переменных фрагмента
