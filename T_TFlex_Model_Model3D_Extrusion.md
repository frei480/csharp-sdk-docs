...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Extrusion](M_TFlex_Model_Model3D_Extrusion__ctor.md) | Конструктор для создания выталкивания |
...
|  | [BackwardTaper](P_TFlex_Model_Model3D_Extrusion_BackwardTaper.md) | Получить параметр построения уклона в обратном направлении |
|  | [BackwardTaperAngle](P_TFlex_Model_Model3D_Extrusion_BackwardTaperAngle.md) | Угол уклона в обратном направлении |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_Extrusion_FirstPoint.md) | Первая точка, задающая направление выталкивания |
...
|  | [ForwardTaper](P_TFlex_Model_Model3D_Extrusion_ForwardTaper.md) | Параметр построения уклона в прямом направлении |
|  | [ForwardTaperAngle](P_TFlex_Model_Model3D_Extrusion_ForwardTaperAngle.md) | Получить угол уклона в прямом направлении |
...
|  | [GroupType](P_TFlex_Model_Model3D_Extrusion_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_Extrusion_SecondPoint.md) | Вторая точка, задающая направление выталкивания |
...
|  | [Vector](P_TFlex_Model_Model3D_Extrusion_Vector.md) | Направление выталкивания |
