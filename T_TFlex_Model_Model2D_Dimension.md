...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AltValueCorrection](P_TFlex_Model_Model2D_Dimension_AltValueCorrection.md) | Коррекция номинала альтернативного размера (применяется после применения масштаба) |
...
|  | [BoxAroundText](P_TFlex_Model_Model2D_Dimension_BoxAroundText.md) | Рамка вокруг текста |
|  | [ClearUnderArrows](P_TFlex_Model_Model2D_Dimension_ClearUnderArrows.md) | Параметр очистки фона под стрелками и размерной линией |
|  | [ClearUnderEndArrow](P_TFlex_Model_Model2D_Dimension_ClearUnderEndArrow.md) | Параметр очистки фона под второй стрелкой |
|  | [ClearUnderLines](P_TFlex_Model_Model2D_Dimension_ClearUnderLines.md) | Параметр очистки фона под выносными линиями |
|  | [ClearUnderStartArrow](P_TFlex_Model_Model2D_Dimension_ClearUnderStartArrow.md) | Параметр очистки фона под первой стрелкой |
|  | [Color](P_TFlex_Model_Model2D_Dimension_Color.md) | Цвет объекта |
...
|  | [FontStyle](P_TFlex_Model_Model2D_Dimension_FontStyle.md) | Получение стиля шрифта текста для получения или установки его параметров |
|  | [GroupType](P_TFlex_Model_Model2D_Dimension_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
|  | [HasSourceLines](P_TFlex_Model_Model2D_Dimension_HasSourceLines.md) | Проверить размер на возможность приведения параметра номинала размера к типу "По исходным линиям" |
...
|  | [Layer](P_TFlex_Model_Model2D_Dimension_Layer.md) | Слой, на котором размещается объект |
|  | [LeaderDirection](P_TFlex_Model_Model2D_Dimension_LeaderDirection.md) | Направление полки с размерным числом |
|  | [Level](P_TFlex_Model_Model2D_Dimension_Level.md) | Уровень объекта |
|  | [ManualValue](P_TFlex_Model_Model2D_Dimension_ManualValue.md) | **Устарело.** |
|  | [ManualValueCorrection](P_TFlex_Model_Model2D_Dimension_ManualValueCorrection.md) | Использование заданного вручную значения коррекции размера |
...
|  | [NominalOnlyText](P_TFlex_Model_Model2D_Dimension_NominalOnlyText.md) | Строка текста со значением только номинала размера |
...
|  | [Offset1](P_TFlex_Model_Model2D_Dimension_Offset1.md) | Отступ размера. Тип отступа зависит от типа размера |
|  | [Offset2](P_TFlex_Model_Model2D_Dimension_Offset2.md) | Отступ размера. Тип отступа зависит от типа размера |
|  | [Offset3](P_TFlex_Model_Model2D_Dimension_Offset3.md) | Отступ размера. Тип отступа зависит от типа размера |
|  | [Page](P_TFlex_Model_Model2D_Dimension_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [ParentDimension](P_TFlex_Model_Model2D_Dimension_ParentDimension.md) | Родительский размер |
...
|  | [Priority](P_TFlex_Model_Model2D_Dimension_Priority.md) | Приоритет объекта |
|  | [State](P_TFlex_Model_Model2D_Dimension_State.md) | Тип положения размера |
|  | [SubType](P_TFlex_Model_Model2D_Dimension_SubType.md) | Подтип размера |
|  | [TextAfter](P_TFlex_Model_Model2D_Dimension_TextAfter.md) | Строка текста после текстом значения размера |
|  | [TextBefore](P_TFlex_Model_Model2D_Dimension_TextBefore.md) | Строка текста перед текстом значения размера |
|  | [TextParameters](P_TFlex_Model_Model2D_Dimension_TextParameters.md) | Способ отображения параметров размера |
|  | [TextUnder](P_TFlex_Model_Model2D_Dimension_TextUnder.md) | Строка текста под текстом значения размера |
|  | [Value](P_TFlex_Model_Model2D_Dimension_Value.md) | Численное значение размера |
|  | [ValueCorrection](P_TFlex_Model_Model2D_Dimension_ValueCorrection.md) | Коррекция номинала размера (применяется после применения масштаба) |
|  | [ValueText](P_TFlex_Model_Model2D_Dimension_ValueText.md) | Строка текста со значением размера |
|  | [ValueType](P_TFlex_Model_Model2D_Dimension_ValueType.md) | Способ формирования строки номинала размера |
...
|  | [OnEndChanges](M_TFlex_Model_Model2D_Dimension_OnEndChanges.md) | (Переопределяет [ModelObjectOnEndChanges](M_TFlex_Model_ModelObject_OnEndChanges.md)) |
...
|  | [ResetParameters](M_TFlex_Model_Model2D_Dimension_ResetParameters.md) | Установка параметров размера по-умолчанию |
|  | [SetDefaults](M_TFlex_Model_Model2D_Dimension_SetDefaults.md) | Установка параметров размера в соответствии с параметрами по умолчанию |
...
|  | [SetValue](M_TFlex_Model_Model2D_Dimension_SetValue.md) | Установка значения размера |
