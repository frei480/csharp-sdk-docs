...
# LengthDiameterManipulator - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.Visual.ManipulatorsManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_Manipulator.md) TFlex.Model.Model3D.Visual.ManipulatorsLengthDiameterManipulator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LengthDiameterManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator__ctor.md) | Инициализирует новый экземпляр класса LengthDiameterManipulator |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ColorDiameter](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_ColorDiameter.md) |  |
|  | [ColorLength](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_ColorLength.md) |  |
|  | [EnableDiameter](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_EnableDiameter.md) |  |
|  | [EnableLength](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_EnableLength.md) |  |
|  | [ToolTipDiameter](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_ToolTipDiameter.md) |  |
|  | [ToolTipLength](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_ToolTipLength.md) |  |
...
|  | [VisibleDiameter](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_VisibleDiameter.md) |  |
|  | [VisibleLength](P_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_VisibleLength.md) |  |
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_Dispose.md) | Освобождает неуправляемые ресурсы, используемые объектом LengthDiameterManipulator, а при необходимости освобождает также управляемые ресурсы(Переопределяет [ManipulatorDispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_Manipulator_Dispose_1.md)) |
...
|  | [Initalize(BaseAxis, BaseDirection, Double, Double)](M_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_Initalize.md) |  |
...
|  | [SetRangeDiameter](M_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_SetRangeDiameter.md) |  |
|  | [SetRangeLength](M_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_SetRangeLength.md) |  |
...
|  | [ValueCommited](E_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_ValueCommited.md) |  |
|  | [ValueEnqueued](E_TFlex_Model_Model3D_Visual_Manipulators_LengthDiameterManipulator_ValueEnqueued.md) |  |
