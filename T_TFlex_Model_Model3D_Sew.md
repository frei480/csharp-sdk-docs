...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSew
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Sew](M_TFlex_Model_Model3D_Sew__ctor.md) | Конструктор для создания сшивки |
...
|  | [GroupType](P_TFlex_Model_Model3D_Sew_GroupType.md) | (Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [MakeSolid](P_TFlex_Model_Model3D_Sew_MakeSolid.md) | Создавать твердое тело |
...
|  | [Sheets](P_TFlex_Model_Model3D_Sew_Sheets.md) | Множество сшиваемых тел |
