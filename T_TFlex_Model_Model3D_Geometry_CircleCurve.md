...
Класс геометрической окружности
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CircleCurve](M_TFlex_Model_Model3D_Geometry_CircleCurve__ctor.md) | Создание окружности |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Center](P_TFlex_Model_Model3D_Geometry_CircleCurve_Center.md) | Центр окружности |
|  | [Normal](P_TFlex_Model_Model3D_Geometry_CircleCurve_Normal.md) | Нормаль к плоскости окружности |
...
|  | [Radius](P_TFlex_Model_Model3D_Geometry_CircleCurve_Radius.md) | Радиус окружности |
...
|  | [SemiAxis](P_TFlex_Model_Model3D_Geometry_CircleCurve_SemiAxis.md) | Полуось, от которой откладывается угол окружности |
