...
# FormlimitsSymbol - класс  
  
---  
  
Класс обозначения допуска

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DFormlimits](T_TFlex_Model_Model2D_Formlimits.md) TFlex.Model.Model2DFormlimitsSymbol

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class FormlimitsSymbol : Formlimits
```
```vb
Public Class FormlimitsSymbol
	Inherits Formlimits
```
```cpp
public ref class FormlimitsSymbol : public Formlimits
```


Тип FormlimitsSymbol предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [FormlimitsSymbol](M_TFlex_Model_Model2D_FormlimitsSymbol__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AltFit](P_TFlex_Model_Model2D_Formlimits_AltFit.md) | Проставлять дополнительную посадку(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [AltFitView](P_TFlex_Model_Model2D_Formlimits_AltFitView.md) | Вид простановки дополнительной посадки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AutoNamingDatum](P_TFlex_Model_Model2D_Formlimits_AutoNamingDatum.md) | Автоматическое именование базы(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [Color](P_TFlex_Model_Model2D_Formlimits_Color.md) | Цвет объекта(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [CompoundTolerance](P_TFlex_Model_Model2D_FormlimitsSymbol_CompoundTolerance.md) | Составной допуск |
|  | [Construction](P_TFlex_Model_Model2D_Formlimits_Construction.md) | Линия построения, к которой привязана стрелка(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Datum1](P_TFlex_Model_Model2D_FormlimitsSymbol_Datum1.md) | База 1 |
|  | [Datum2](P_TFlex_Model_Model2D_FormlimitsSymbol_Datum2.md) | База 2 |
|  | [Datum3](P_TFlex_Model_Model2D_FormlimitsSymbol_Datum3.md) | База 3 |
|  | [Dimension](P_TFlex_Model_Model2D_Formlimits_Dimension.md) | Размер, к которому привязан данный объект(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [DimValue](P_TFlex_Model_Model2D_FormlimitsSymbol_DimValue.md) | Значение размера |
...
|  | [Expression](P_TFlex_Model_Model2D_FormlimitsSymbol_Expression.md) | Тип выражения |
|  | [Fit](P_TFlex_Model_Model2D_Formlimits_Fit.md) | Проставлять посадку(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [FitView](P_TFlex_Model_Model2D_Formlimits_FitView.md) | Вид простановки посадки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [FontStyle](P_TFlex_Model_Model2D_Formlimits_FontStyle.md) | Стиль шрифта текста для получения или установки его параметров(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [FormlimitsObj](P_TFlex_Model_Model2D_Formlimits_FormlimitsObj.md) | Другой объект обозначения допуска, к которому привязан данный объект(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [GroupType](P_TFlex_Model_Model2D_Formlimits_GroupType.md) | Тип объекта(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [IsTurned](P_TFlex_Model_Model2D_FormlimitsSymbol_IsTurned.md) | Повернуть обозначение |
...
|  | [Layer](P_TFlex_Model_Model2D_Formlimits_Layer.md) | Слой, на котором размещается объект(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Leader](P_TFlex_Model_Model2D_Formlimits_Leader.md) | Линия-выноска, которая связана с данным объектом(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Level](P_TFlex_Model_Model2D_Formlimits_Level.md) | Уровень объекта(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [LineWidth](P_TFlex_Model_Model2D_Formlimits_LineWidth.md) | Толщина линий объекта(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [Node](P_TFlex_Model_Model2D_Formlimits_Node.md) | Узел привязки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [Outline](P_TFlex_Model_Model2D_Formlimits_Outline.md) | Линия изображения, к которой привязана стрелка(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Page](P_TFlex_Model_Model2D_Formlimits_Page.md) | Cтраница, на которой размещается объект(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [Placement](P_TFlex_Model_Model2D_Formlimits_Placement.md) | Номер точки привязки на таблице (от 0 до 7)(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Point](P_TFlex_Model_Model2D_Formlimits_Point.md) | Абсолютные координаты точки привязки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [PrecisionClass](P_TFlex_Model_Model2D_FormlimitsSymbol_PrecisionClass.md) | Класс точности (3-16) |
|  | [Priority](P_TFlex_Model_Model2D_Formlimits_Priority.md) | Приоритет объекта(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [SettingMethod](P_TFlex_Model_Model2D_FormlimitsSymbol_SettingMethod.md) | Тип простановки |
|  | [ShowDimValue](P_TFlex_Model_Model2D_FormlimitsSymbol_ShowDimValue.md) | Показывать номинальное значение размера допуска |
|  | [ShowLeader](P_TFlex_Model_Model2D_FormlimitsSymbol_ShowLeader.md) | Показывать выносную линию |
|  | [SubType](P_TFlex_Model_Model2D_FormlimitsSymbol_SubType.md) | Значение подтипа объекта (Переопределяет [FormlimitsSubType](P_TFlex_Model_Model2D_Formlimits_SubType.md)) |
|  | [TextAfter](P_TFlex_Model_Model2D_FormlimitsSymbol_TextAfter.md) | Строка после значения |
|  | [ToleranceType](P_TFlex_Model_Model2D_FormlimitsSymbol_ToleranceType.md) | Тип допуска |
|  | [Value](P_TFlex_Model_Model2D_FormlimitsSymbol_Value.md) | Значение допуска |
...
|  | [X](P_TFlex_Model_Model2D_Formlimits_X.md) | Координата X точки привязки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [Y](P_TFlex_Model_Model2D_Formlimits_Y.md) | Координата Y точки привязки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [SetConstruction](M_TFlex_Model_Model2D_Formlimits_SetConstruction.md) | Установка параметров привязки к прямой(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [SetDimension](M_TFlex_Model_Model2D_Formlimits_SetDimension.md) | Установка привязки к размеру(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
...
|  | [SetFormlimitsObj](M_TFlex_Model_Model2D_Formlimits_SetFormlimitsObj.md) | Установка привязки к другому обозначению допуска(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [SetLeader](M_TFlex_Model_Model2D_Formlimits_SetLeader.md) | Установить привязку к линии-выноске(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [SetNode](M_TFlex_Model_Model2D_Formlimits_SetNode.md) | Установка привязки к узлу(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [SetOutline](M_TFlex_Model_Model2D_Formlimits_SetOutline.md) | Установка параметров привязки к отрезку(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
|  | [SetPoint](M_TFlex_Model_Model2D_Formlimits_SetPoint.md) | Установка абсолютных координат точки привязки(Унаследован от [Formlimits](T_TFlex_Model_Model2D_Formlimits.md)) |
