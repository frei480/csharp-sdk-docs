...
Элемент управления для отображения других элементов во вкладках

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsTabControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [TabControl](M_TFlex_Dialogs_TabControl__ctor.md) | Инициализирует новый экземпляр класса TabControl |
|  | [TabControl(String)](M_TFlex_Dialogs_TabControl__ctor_1.md) | Инициализирует новый экземпляр класса TabControl |
...
|  | [SelectedTab](P_TFlex_Dialogs_TabControl_SelectedTab.md) | Текущая вкладка |
|  | [Tabs](P_TFlex_Dialogs_TabControl_Tabs.md) | Коллекция вкладок |
...
|  | [SelectedTabChanged](E_TFlex_Dialogs_TabControl_SelectedTabChanged.md) | Событие смены вкладки |
