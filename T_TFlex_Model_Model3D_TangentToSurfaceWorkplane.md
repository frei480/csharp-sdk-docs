...
# TangentToSurfaceWorkplane - класс  
...
|  | [TangentToSurfaceWorkplane(Document, Page)](M_TFlex_Model_Model3D_TangentToSurfaceWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [PointNearToSurface](P_TFlex_Model_Model3D_TangentToSurfaceWorkplane_PointNearToSurface.md) | Точка, задающая положение рабочей плоскости |
...
|  | [TangentSurface](P_TFlex_Model_Model3D_TangentToSurfaceWorkplane_TangentSurface.md) | Поверхность, которой касается рабочая плоскость |
