...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.StructureLinkDescriptor
...
|  | [Cardinality](P_TFlex_Model_Structure_LinkDescriptor_Cardinality.md) |  |
...
|  | [GroupType](P_TFlex_Model_Structure_LinkDescriptor_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [LinkBackName](P_TFlex_Model_Structure_LinkDescriptor_LinkBackName.md) |  |
|  | [LinkName](P_TFlex_Model_Structure_LinkDescriptor_LinkName.md) |  |
...
|  | [SupportsOrder](P_TFlex_Model_Structure_LinkDescriptor_SupportsOrder.md) |  |
|  | [SystemName](P_TFlex_Model_Structure_LinkDescriptor_SystemName.md) |  |
|  | [UID](P_TFlex_Model_Structure_LinkDescriptor_UID.md) |  |
...
|  | [GetLeftElementTypes](M_TFlex_Model_Structure_LinkDescriptor_GetLeftElementTypes.md) |  |
...
|  | [GetRightElementTypes](M_TFlex_Model_Structure_LinkDescriptor_GetRightElementTypes.md) |  |
