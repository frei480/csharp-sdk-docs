...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseSurface](T_TFlex_Model_Model3D_Geometry_BaseSurface.md) TFlex.Model.Model3D.GeometrySurface Подробнее
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Surface](M_TFlex_Model_Model3D_Geometry_Surface__ctor.md) | Конструктор |
|  | [Surface(Int32, Boolean)](M_TFlex_Model_Model3D_Geometry_Surface__ctor_1.md) | Инициализирует новый экземпляр класса Surface |
...
|  | [Create](M_TFlex_Model_Model3D_Geometry_Surface_Create.md) |  |
|  | [CreateSpin](M_TFlex_Model_Model3D_Geometry_Surface_CreateSpin.md) | Создать поверхность вращения |
|  | [CreateSweep](M_TFlex_Model_Model3D_Geometry_Surface_CreateSweep.md) | Создать поверхность выталкивания |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseSurface](T_TFlex_Model_Model3D_Geometry_BaseSurface.md) TFlex.Model.Model3D.GeometrySurface [TFlex.Model.Model3D.GeometryConeSurface](T_TFlex_Model_Model3D_Geometry_ConeSurface.md) [TFlex.Model.Model3D.GeometryCylinderSurface](T_TFlex_Model_Model3D_Geometry_CylinderSurface.md) [TFlex.Model.Model3D.GeometryPlaneSurface](T_TFlex_Model_Model3D_Geometry_PlaneSurface.md) [TFlex.Model.Model3D.GeometrySphereSurface](T_TFlex_Model_Model3D_Geometry_SphereSurface.md) [TFlex.Model.Model3D.GeometrySplineSurface](T_TFlex_Model_Model3D_Geometry_SplineSurface.md) [TFlex.Model.Model3D.GeometrySpunSurface](T_TFlex_Model_Model3D_Geometry_SpunSurface.md) [TFlex.Model.Model3D.GeometrySweptSurface](T_TFlex_Model_Model3D_Geometry_SweptSurface.md) [TFlex.Model.Model3D.GeometryTorusSurface](T_TFlex_Model_Model3D_Geometry_TorusSurface.md)