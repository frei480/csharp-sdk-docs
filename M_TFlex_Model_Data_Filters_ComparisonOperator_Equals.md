...
# ComparisonOperatorEquals - метод  
  
---  
  
Возвращает значение, указывающее, равен ли заданный объект текущему
...
[Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)Значение true, если объекты равны; в противном случае - значение false
