...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DLoftOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LoftOperation](M_TFlex_Model_Model3D_LoftOperation__ctor.md) | Конструктор для создания Лофта |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AutoAlignment](P_TFlex_Model_Model3D_LoftOperation_AutoAlignment.md) | Автовыравнивание |
...
|  | [Cut](P_TFlex_Model_Model3D_LoftOperation_Cut.md) | Обрезка |
...
|  | [Faces](P_TFlex_Model_Model3D_LoftOperation_Faces.md) | Грани |
...
|  | [GroupType](P_TFlex_Model_Model3D_LoftOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
|  | [GuideAutoReverse](P_TFlex_Model_Model3D_LoftOperation_GuideAutoReverse.md) | Автореверс направляющих |
...
|  | [Linear](P_TFlex_Model_Model3D_LoftOperation_Linear.md) | Линейчатое тело |
...
|  | [Periodic](P_TFlex_Model_Model3D_LoftOperation_Periodic.md) | Периодическое тело |
|  | [SectionAutoReverse](P_TFlex_Model_Model3D_LoftOperation_SectionAutoReverse.md) | Автореверс сечений |
|  | [Simplify](P_TFlex_Model_Model3D_LoftOperation_Simplify.md) | Упрощённая геометрия |
...
|  | [Synchronization](P_TFlex_Model_Model3D_LoftOperation_Synchronization.md) | Синхронизировать |
|  | [ThinWall](P_TFlex_Model_Model3D_LoftOperation_ThinWall.md) | Тонкостенный элемент |
|  | [Tolerance](P_TFlex_Model_Model3D_LoftOperation_Tolerance.md) | Точность |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddGuide](M_TFlex_Model_Model3D_LoftOperation_AddGuide.md) | Добавить направляющую |
|  | [AddMatch](M_TFlex_Model_Model3D_LoftOperation_AddMatch.md) | Добавить соответствие |
|  | [AddSection](M_TFlex_Model_Model3D_LoftOperation_AddSection.md) | Добавить сечение |
...
|  | [CountGuides](M_TFlex_Model_Model3D_LoftOperation_CountGuides.md) | Количество направляющих |
|  | [CountMatches](M_TFlex_Model_Model3D_LoftOperation_CountMatches.md) | Количество соответствий |
|  | [CountSections](M_TFlex_Model_Model3D_LoftOperation_CountSections.md) | Количество сечений |
|  | [Create](M_TFlex_Model_Model3D_LoftOperation_Create.md) |  |
...
|  | [GetGuide](M_TFlex_Model_Model3D_LoftOperation_GetGuide.md) | Получить направляющую |
...
|  | [GetMatch](M_TFlex_Model_Model3D_LoftOperation_GetMatch.md) | Получить соответствие |
...
|  | [GetPath](M_TFlex_Model_Model3D_LoftOperation_GetPath.md) | Получить траекторию |
...
|  | [GetSection](M_TFlex_Model_Model3D_LoftOperation_GetSection.md) | Получить сечение |
...
|  | [InsertGuide](M_TFlex_Model_Model3D_LoftOperation_InsertGuide.md) | Вставить направляющую |
|  | [InsertMatch](M_TFlex_Model_Model3D_LoftOperation_InsertMatch.md) | Вставить соответствие |
|  | [InsertSection](M_TFlex_Model_Model3D_LoftOperation_InsertSection.md) | Вставить сечение |
...
|  | [RemoveGuide](M_TFlex_Model_Model3D_LoftOperation_RemoveGuide.md) | Удалить направляющую |
|  | [RemoveMatch](M_TFlex_Model_Model3D_LoftOperation_RemoveMatch.md) | Удалить соответствие |
|  | [RemoveSection](M_TFlex_Model_Model3D_LoftOperation_RemoveSection.md) | Удалить сечение |
