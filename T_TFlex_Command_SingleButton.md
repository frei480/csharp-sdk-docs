...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.CommandButton](T_TFlex_Command_Button.md) TFlex.CommandSingleButton
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SingleButton](M_TFlex_Command_SingleButton__ctor.md) | Конструктор |
