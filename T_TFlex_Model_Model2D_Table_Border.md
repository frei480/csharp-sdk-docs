...
# TableBorder - структура  
    
Границы

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model2DTableBorder
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Color](F_TFlex_Model_Model2D_Table_Border_Color.md) | Цвет |
|  | [DefaultColor](F_TFlex_Model_Model2D_Table_Border_DefaultColor.md) | Цвет по умолчанию |
|  | [Type](F_TFlex_Model_Model2D_Table_Border_Type.md) | Тип |
|  | [Visible](F_TFlex_Model_Model2D_Table_Border_Visible.md) | Видимость |
|  | [Width](F_TFlex_Model_Model2D_Table_Border_Width.md) | Толщина |
