...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationZoneDirection
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ZoneDirection](M_TFlex_Configuration_ZoneDirection__ctor.md) | Инициализирует новый экземпляр класса ZoneDirection |
|  | [ZoneDirection(IntPtr, Boolean)](M_TFlex_Configuration_ZoneDirection__ctor_1.md) | Инициализирует новый экземпляр класса ZoneDirection |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [LeftToRight](P_TFlex_Configuration_ZoneDirection_LeftToRight.md) |  |
|  | [TopToBottom](P_TFlex_Configuration_ZoneDirection_TopToBottom.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_ZoneDirection_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_ZoneDirection_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_ZoneDirection_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
...
|  | [ToString](M_TFlex_Configuration_ZoneDirection_ToString.md) | (Переопределяет [ObjectToString](https://learn.microsoft.com/dotnet/api/system.object.tostring)) |
