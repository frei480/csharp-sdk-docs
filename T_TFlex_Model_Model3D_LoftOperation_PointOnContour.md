...
Тип LoftOperationPointOnContour предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [LoftOperationPointOnContour](M_TFlex_Model_Model3D_LoftOperation_PointOnContour__ctor.md) | Инициализирует новый экземпляр класса LoftOperationPointOnContour |
