...
|  | Имя | Описание |
| --- | --- | --- |
|  | [EdgeBlendingAttribute](M_TFlex_Model_Model3D_EdgeBlending_Attribute__ctor.md) | Инициализирует новый экземпляр класса EdgeBlendingAttribute |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Type](P_TFlex_Model_Model3D_EdgeBlending_Attribute_Type.md) | Тип |
