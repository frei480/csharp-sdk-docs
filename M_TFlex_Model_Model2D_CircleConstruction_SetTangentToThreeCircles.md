...
# CircleConstructionSetTangentToThreeCircles - метод  
  
---  
  
Окружность, касательная к трём окружностям

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public void SetTangentToThreeCircles(
...
srcCircle3 [Construction](T_TFlex_Model_Model2D_Construction.md)
    Третья окружность, которой касается окружность
