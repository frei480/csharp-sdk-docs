...
# StandardColorsFaceMark3Index - свойство  
...
```csharp
public static int FaceMark3Index { get; }
```
```vb
Public Shared ReadOnly Property FaceMark3Index As Integer
	Get
```
```cpp
public:
static property int FaceMark3Index {
	int get ();
}
```
