...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSymbol
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Symbol](M_TFlex_Configuration_Symbol__ctor.md) | Инициализирует новый экземпляр класса Symbol |
|  | [Symbol(IntPtr, Boolean)](M_TFlex_Configuration_Symbol__ctor_1.md) | Инициализирует новый экземпляр класса Symbol |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [DegreeCode](P_TFlex_Configuration_Symbol_DegreeCode.md) |  |
|  | [DiameterCode](P_TFlex_Configuration_Symbol_DiameterCode.md) |  |
|  | [PlusMinusCode](P_TFlex_Configuration_Symbol_PlusMinusCode.md) |  |
|  | [SpecialFontName](P_TFlex_Configuration_Symbol_SpecialFontName.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Symbol_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Symbol_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Symbol_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
