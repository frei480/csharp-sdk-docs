...
# TorusSurface - свойства  
  
---  
  
Тип [TorusSurface](T_TFlex_Model_Model3D_Geometry_TorusSurface.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Axis](P_TFlex_Model_Model3D_Geometry_TorusSurface_Axis.md) | Ось симметрии |
|  | [MajorRadius](P_TFlex_Model_Model3D_Geometry_TorusSurface_MajorRadius.md) | Большой радиус |
|  | [MinorRadius](P_TFlex_Model_Model3D_Geometry_TorusSurface_MinorRadius.md) | Малый радиус |
...
|  | [ReferenceDirection](P_TFlex_Model_Model3D_Geometry_TorusSurface_ReferenceDirection.md) | Полуось основания, от которой откладываются углы |
