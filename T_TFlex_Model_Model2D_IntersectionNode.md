...
# IntersectionNode - класс  
    
Класс узла, построенного на пересечении линий построения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DIntersectionNode
...
|  | [IntersectionNode(Document, Construction, Construction)](M_TFlex_Model_Model2D_IntersectionNode__ctor_1.md) | Конструктор, задающий линии построения, на пересечении которых находится узел |
|  | [IntersectionNode(Document, Construction, Construction, Int32)](M_TFlex_Model_Model2D_IntersectionNode__ctor_3.md) | Конструктор, задающий линии построения, на пересечении которых находится узел и вариант пересечения |
|  | [IntersectionNode(Document, Construction, Construction, Double, Double)](M_TFlex_Model_Model2D_IntersectionNode__ctor_2.md) | Конструктор, задающий линии построения, на пересечении которых находится узел и координаты точки, ближайшей к требуемому варианту пересечения |
...
|  | [Construction1](P_TFlex_Model_Model2D_IntersectionNode_Construction1.md) | Первая линия построения, к которой привязан узел |
|  | [Construction2](P_TFlex_Model_Model2D_IntersectionNode_Construction2.md) | Вторая линия построения, к которой будет привязан узел |
...
|  | [SubType](P_TFlex_Model_Model2D_IntersectionNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
