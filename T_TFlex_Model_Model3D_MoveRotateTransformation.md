...
# MoveRotateTransformation - класс  
  
---  
  
Класс преобразования перемещения/поворота

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) TFlex.Model.Model3DMoveRotateTransformation [TFlex.Model.Model3DFragmentTransformation](T_TFlex_Model_Model3D_FragmentTransformation.md) [TFlex.Model.Model3DLCSTransformation](T_TFlex_Model_Model3D_LCSTransformation.md)
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [MoveRotateTransformation](M_TFlex_Model_Model3D_MoveRotateTransformation__ctor.md) | Конструктор для создания нового преобразования перемещения поворота |
...
|  | [LCS](P_TFlex_Model_Model3D_MoveRotateTransformation_LCS.md) | Система координат, относительно которой производится преобразование |
...
|  | [Offset_X](P_TFlex_Model_Model3D_MoveRotateTransformation_Offset_X.md) | Значение свойства перемещения вдоль оси X |
|  | [Offset_Y](P_TFlex_Model_Model3D_MoveRotateTransformation_Offset_Y.md) | Значение свойства перемещения вдоль оси Y |
|  | [Offset_Z](P_TFlex_Model_Model3D_MoveRotateTransformation_Offset_Z.md) | Значение свойства перемещения вдоль оси Z |
...
|  | [OriginType](P_TFlex_Model_Model3D_MoveRotateTransformation_OriginType.md) | Тип поиска системы координат, относительно которой производится преобразование |
...
|  | [RotationsCount](P_TFlex_Model_Model3D_MoveRotateTransformation_RotationsCount.md) | Количество поворотов |
|  | [Scale](P_TFlex_Model_Model3D_MoveRotateTransformation_Scale.md) | Значение свойства масштабирования |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddRotation](M_TFlex_Model_Model3D_MoveRotateTransformation_AddRotation.md) | Добавить поворот вокруг оси |
...
|  | [GetRotation](M_TFlex_Model_Model3D_MoveRotateTransformation_GetRotation.md) | Получить параметры поворота по индексу |
...
|  | [MoveRotation](M_TFlex_Model_Model3D_MoveRotateTransformation_MoveRotation.md) | Переместить вращение вниз или вверх |
