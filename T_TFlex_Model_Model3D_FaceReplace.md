...
Операция замены граней

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFaceReplace
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FaceReplace](M_TFlex_Model_Model3D_FaceReplace__ctor.md) | Конструктор для создания операция "Трансформация граней" |
...
|  | [FaceCount](P_TFlex_Model_Model3D_FaceReplace_FaceCount.md) | Число пар "заменяемая грань-заменяющая поверхность" |
...
|  | [GroupType](P_TFlex_Model_Model3D_FaceReplace_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Sheet](P_TFlex_Model_Model3D_FaceReplace_Sheet.md) | Заменяющее листовое тело. Заданные грани заменяются гранями листового тела. |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddFace](M_TFlex_Model_Model3D_FaceReplace_AddFace.md) | Задать пару "заменяемая грань-заменяющая поверхность" |
...
|  | [GetFace](M_TFlex_Model_Model3D_FaceReplace_GetFace.md) | Получить пару "заменяемая грань-заменяющая поверхность" |
...
|  | [RemoveAllFaces](M_TFlex_Model_Model3D_FaceReplace_RemoveAllFaces.md) | Удалить все пары "заменяемая грань-заменяющая поверхность" |
