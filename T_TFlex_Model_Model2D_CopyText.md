...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DText](T_TFlex_Model_Model2D_Text.md) TFlex.Model.Model2DCopyText
...
|  | [Source](P_TFlex_Model_Model2D_CopyText_Source.md) | Исходный текст |
|  | [SourceCopyOperation](P_TFlex_Model_Model2D_CopyText_SourceCopyOperation.md) | Исходный объект-копия |
|  | [SubType](P_TFlex_Model_Model2D_CopyText_SubType.md) | Подтип текста(Переопределяет [TextSubType](P_TFlex_Model_Model2D_Text_SubType.md)) |
|  | [Transformation](P_TFlex_Model_Model2D_CopyText_Transformation.md) | Преобразование |
