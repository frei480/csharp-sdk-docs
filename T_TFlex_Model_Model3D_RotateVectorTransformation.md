...
# RotateVectorTransformation - класс  
    
Класс преобразования поворота вокруг вектора

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) [TFlex.Model.Model3DVectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md) TFlex.Model.Model3DRotateVectorTransformation

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class RotateVectorTransformation : VectorTransformation
```
```vb
Public Class RotateVectorTransformation
	Inherits VectorTransformation
```
```cpp
public ref class RotateVectorTransformation : public VectorTransformation
```


Тип RotateVectorTransformation предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [RotateVectorTransformation](M_TFlex_Model_Model3D_RotateVectorTransformation__ctor.md) | Конструктор для создания нового преобразования поворота вокруг вектора |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model3D_RotateVectorTransformation_Angle.md) | Значение угла поворота |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Axis](P_TFlex_Model_Model3D_VectorTransformation_Axis.md) | Ось(Унаследован от [VectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md)) |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_VectorTransformation_FirstPoint.md) | Первая точка оси(Унаследован от [VectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md)) |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_VectorTransformation_SecondPoint.md) | Вторая точка оси(Унаследован от [VectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md)) |
