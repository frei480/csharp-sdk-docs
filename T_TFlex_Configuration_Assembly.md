...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationAssembly
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assembly](M_TFlex_Configuration_Assembly__ctor.md) | Инициализирует новый экземпляр класса Assembly |
|  | [Assembly(IntPtr, Boolean)](M_TFlex_Configuration_Assembly__ctor_1.md) | Инициализирует новый экземпляр класса Assembly |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AssemblyMode](P_TFlex_Configuration_Assembly_AssemblyMode.md) |  |
|  | [CheckMinSize](P_TFlex_Configuration_Assembly_CheckMinSize.md) |  |
|  | [MinBodySize](P_TFlex_Configuration_Assembly_MinBodySize.md) |  |
|  | [ShowThreads](P_TFlex_Configuration_Assembly_ShowThreads.md) |  |
|  | [ShowWeld](P_TFlex_Configuration_Assembly_ShowWeld.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Assembly_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Assembly_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Assembly_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
