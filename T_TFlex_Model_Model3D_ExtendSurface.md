...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DExtendSurface
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ExtendSurface(Document)](M_TFlex_Model_Model3D_ExtendSurface__ctor_1.md) | Конструктор для создания операции "Заполнение области" |
|  | [ExtendSurface(IntPtr, Boolean)](M_TFlex_Model_Model3D_ExtendSurface__ctor.md) | Инициализирует новый экземпляр класса ExtendSurface |
...
|  | [Edges](P_TFlex_Model_Model3D_ExtendSurface_Edges.md) | Рёбра |
...
|  | [ExtensionSmoothness](P_TFlex_Model_Model3D_ExtendSurface_ExtensionSmoothness.md) | Сглаживание |
...
|  | [GroupType](P_TFlex_Model_Model3D_ExtendSurface_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [KeepSource](P_TFlex_Model_Model3D_ExtendSurface_KeepSource.md) | Оставлять исходное тело |
...
|  | [Length](P_TFlex_Model_Model3D_ExtendSurface_Length.md) | Величина продления грани |
...
|  | [Modify](P_TFlex_Model_Model3D_ExtendSurface_Modify.md) | Модифицировать исходные грани |
...
|  | [Shape](P_TFlex_Model_Model3D_ExtendSurface_Shape.md) | Форма поверхности |
|  | [Sheet](P_TFlex_Model_Model3D_ExtendSurface_Sheet.md) | Листовое тело. |
