...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FaceProfile](M_TFlex_Model_Model3D_FaceProfile__ctor.md) | Конструктор для создания профиля по набору граней |
...
|  | [Faces](P_TFlex_Model_Model3D_FaceProfile_Faces.md) | Множество граней |
