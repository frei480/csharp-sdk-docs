...
# SheetFromTrimmedSurface - класс  
  
---  
  
Генератор листового тела на поверхности, обрезанной набором параметрических составных кривых

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryBaseGenerator](T_TFlex_Model_Model3D_Geometry_BaseGenerator.md) [TFlex.Model.Model3D.GeometryBodyGenerator](T_TFlex_Model_Model3D_Geometry_BodyGenerator.md) TFlex.Model.Model3D.GeometrySheetFromTrimmedSurface
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SheetFromTrimmedSurface](M_TFlex_Model_Model3D_Geometry_SheetFromTrimmedSurface__ctor.md) | Конструктор для задания листового тела на поверхности по набору параметрических составных кривых |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_SheetFromTrimmedSurface_Run.md) | Функция генерации листового тела(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
