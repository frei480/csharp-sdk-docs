...
# EquidistantPath - класс  
  
---  
  
Эквидистанта к кривой на поверхности

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DPath3D](T_TFlex_Model_Model3D_Path3D.md) TFlex.Model.Model3DEquidistantPath

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class EquidistantPath : Path3D
```
```vb
Public Class EquidistantPath
	Inherits Path3D
```
```cpp
public ref class EquidistantPath : public Path3D
```


Тип EquidistantPath предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [EquidistantPath](M_TFlex_Model_Model3D_EquidistantPath__ctor.md) | Конструктор для создания эквидистанты к кривой на поверхности |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model3D_EquidistantPath_Accuracy.md) | Точность |
|  | [Approximation](P_TFlex_Model_Model3D_EquidistantPath_Approximation.md) | Тип приближения |
...
|  | [ConstantOffset](P_TFlex_Model_Model3D_EquidistantPath_ConstantOffset.md) | Значение константного смещения |
...
|  | [FunctionOffset](P_TFlex_Model_Model3D_EquidistantPath_FunctionOffset.md) | Табличная функция смещения |
...
|  | [InverseAlgorithm](P_TFlex_Model_Model3D_EquidistantPath_InverseAlgorithm.md) | Параметр инвертирования алгоритма выбора граней |
...
|  | [MovingDirection](P_TFlex_Model_Model3D_EquidistantPath_MovingDirection.md) | Направление движения |
...
|  | [Offset](P_TFlex_Model_Model3D_EquidistantPath_Offset.md) | Тип смещения |
...
|  | [PathOnSurface](P_TFlex_Model_Model3D_EquidistantPath_PathOnSurface.md) | Путь на поверхнсти |
|  | [PointsQuantity](P_TFlex_Model_Model3D_EquidistantPath_PointsQuantity.md) | Количество точек |
