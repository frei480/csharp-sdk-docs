...
Базовый класс камеры

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DCamera [TFlex.Model.Model3DOrthographicCamera](T_TFlex_Model_Model3D_OrthographicCamera.md) [TFlex.Model.Model3DPerspectiveCamera](T_TFlex_Model_Model3D_PerspectiveCamera.md)
...
```
```cpp
public ref class Camera : public Object3D
```


Тип Camera предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Active](P_TFlex_Model_Model3D_Camera_Active.md) | Активна ли камера |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AutoClip](P_TFlex_Model_Model3D_Camera_AutoClip.md) | **Устарело.** Включен или нет режим автоматической обрезки |
...
|  | [GroupType](P_TFlex_Model_Model3D_Camera_GroupType.md) | (Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [NearDistance](P_TFlex_Model_Model3D_Camera_NearDistance.md) | **Устарело.** Растояние до ближней плоскости отсечения |
...
|  | [OffsetX](P_TFlex_Model_Model3D_Camera_OffsetX.md) | **Устарело.** Смещение по оси X |
|  | [OffsetY](P_TFlex_Model_Model3D_Camera_OffsetY.md) | **Устарело.** Смещение по оси Y |
|  | [OffsetZ](P_TFlex_Model_Model3D_Camera_OffsetZ.md) | **Устарело.** Смещение по оси Z |
|  | [OriginLCS](P_TFlex_Model_Model3D_Camera_OriginLCS.md) | **Устарело.** Система координат камеры |
...
|  | [RotateOrder](P_TFlex_Model_Model3D_Camera_RotateOrder.md) | **Устарело.** Порядок применения поворотов |
|  | [RotateX](P_TFlex_Model_Model3D_Camera_RotateX.md) | **Устарело.** Поворот вокруг оси X |
|  | [RotateY](P_TFlex_Model_Model3D_Camera_RotateY.md) | **Устарело.** Поворот вокруг оси Y |
|  | [RotateZ](P_TFlex_Model_Model3D_Camera_RotateZ.md) | **Устарело.** Поворот вокруг оси Z |
...
|  | [Walk](P_TFlex_Model_Model3D_Camera_Walk.md) | **Устарело.** Находится ли камера в режиме прогулки |
