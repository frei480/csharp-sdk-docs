...
Тип [Dragger](T_TFlex_Model_Model3D_Visual_Dragger.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Activate](M_TFlex_Model_Model3D_Visual_Dragger_Activate.md) | Активизация манипулятора |
|  | [Dispose](M_TFlex_Model_Model3D_Visual_Dragger_Dispose.md) |  |
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Dragger_Dispose_1.md) |  |
