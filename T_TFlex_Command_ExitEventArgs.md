...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemEventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) [TFlex.CommandCommandEventArgs](T_TFlex_Command_CommandEventArgs.md) TFlex.CommandExitEventArgs
...
|  | [Result](P_TFlex_Command_ExitEventArgs_Result.md) | Объект, который необходимо передать из вложенной команды в вызывающую |
