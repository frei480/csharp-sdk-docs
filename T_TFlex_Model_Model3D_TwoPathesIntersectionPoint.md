...
|  | [CanSelect](P_TFlex_Model_Model3D_TwoPathesIntersectionPoint_CanSelect.md) | Управление выбором точек на пересечении путей |
...
|  | [Coords](P_TFlex_Model_Model3D_TwoPathesIntersectionPoint_Coords.md) | Получить координаты точки |
...
|  | [GroupType](P_TFlex_Model_Model3D_TwoPathesIntersectionPoint_GroupType.md) | Тип объекта(Переопределяет [Node3DGroupType](P_TFlex_Model_Model3D_Node3D_GroupType.md)) |
|  | [HandleForSelection](P_TFlex_Model_Model3D_TwoPathesIntersectionPoint_HandleForSelection.md) | Для внутреннего использования(Переопределяет ModelObject.HandleForSelection) |
...
|  | [PathFirst](P_TFlex_Model_Model3D_TwoPathesIntersectionPoint_PathFirst.md) | Первый путь |
|  | [PathSecond](P_TFlex_Model_Model3D_TwoPathesIntersectionPoint_PathSecond.md) | Второй путь |
...
|  | [Create](M_TFlex_Model_Model3D_TwoPathesIntersectionPoint_Create.md) | Создать или найти модельный узел на пересечении, если установлен sourceNode использовать этот узел, а не создавать новый |
...
|  | [IsTemporaryObject](M_TFlex_Model_Model3D_TwoPathesIntersectionPoint_IsTemporaryObject.md) | (Переопределяет [ModelObjectIsTemporaryObject](M_TFlex_Model_ModelObject_IsTemporaryObject.md)) |
