...
# StandardColorsNodeMark2Index - свойство  
...
```csharp
public static int NodeMark2Index { get; }
```
```vb
Public Shared ReadOnly Property NodeMark2Index As Integer
	Get
```
```cpp
public:
static property int NodeMark2Index {
	int get ();
}
```
