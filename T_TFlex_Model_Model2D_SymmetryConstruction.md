...
# SymmetryConstruction - класс  
    
Линия построения, симметричная относительно оси

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DSymmetryConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SymmetryConstruction](M_TFlex_Model_Model2D_SymmetryConstruction__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Axis](P_TFlex_Model_Model2D_SymmetryConstruction_Axis.md) | Ось |
...
|  | [GeometryType](P_TFlex_Model_Model2D_SymmetryConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [Source](P_TFlex_Model_Model2D_SymmetryConstruction_Source.md) | Исходная линия построения |
|  | [SubType](P_TFlex_Model_Model2D_SymmetryConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
