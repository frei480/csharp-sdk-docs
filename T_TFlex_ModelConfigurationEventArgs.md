...
# ModelConfigurationEventArgs - класс  
    
Информация о событии с конфигурацией модели

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemEventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) [TFlexPluginEventArgs](T_TFlex_PluginEventArgs.md) [TFlexDocumentEventArgs](T_TFlex_DocumentEventArgs.md) TFlexModelConfigurationEventArgs
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Action](P_TFlex_ModelConfigurationEventArgs_Action.md) | Тип действия с конфигурацией модели |
...
|  | [ModelConfiguration](P_TFlex_ModelConfigurationEventArgs_ModelConfiguration.md) | Конфигурация модели |
