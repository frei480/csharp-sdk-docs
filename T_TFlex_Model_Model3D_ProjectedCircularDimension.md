...
|  | [SubType](P_TFlex_Model_Model3D_ProjectedCircularDimension_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [SetOffsets](M_TFlex_Model_Model3D_ProjectedCircularDimension_SetOffsets.md) | Установка положения размера на окружности |
