...
# FormlimitsLeader - класс  
    
Класс линии-выноски обозначения допуска формы

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DFormlimitsLeader
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FormlimitsLeader](M_TFlex_Model_Model2D_FormlimitsLeader__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ArrowSize](P_TFlex_Model_Model2D_FormlimitsLeader_ArrowSize.md) | Размер стрелки |
|  | [ArrowType](P_TFlex_Model_Model2D_FormlimitsLeader_ArrowType.md) | Тип стрелки |
...
|  | [Color](P_TFlex_Model_Model2D_FormlimitsLeader_Color.md) | Цвет объекта |
|  | [Construction](P_TFlex_Model_Model2D_FormlimitsLeader_Construction.md) | Линия построения, к которой привязана стрелка |
|  | [Dimension](P_TFlex_Model_Model2D_FormlimitsLeader_Dimension.md) | Размер, к которому привязана стрелка |
...
|  | [FontStyle](P_TFlex_Model_Model2D_FormlimitsLeader_FontStyle.md) | Стиль шрифта текста для получения или установки его параметров |
|  | [FormlimitsObj](P_TFlex_Model_Model2D_FormlimitsLeader_FormlimitsObj.md) | Обозначение допуска, к которому привязан объект |
...
|  | [Layer](P_TFlex_Model_Model2D_FormlimitsLeader_Layer.md) | Слой, на котором размещается объект |
|  | [Level](P_TFlex_Model_Model2D_FormlimitsLeader_Level.md) | Уровень объекта |
|  | [LineWidth](P_TFlex_Model_Model2D_FormlimitsLeader_LineWidth.md) | Толщина линий |
...
|  | [Offsets](P_TFlex_Model_Model2D_FormlimitsLeader_Offsets.md) | Набор смещений, определяющих положение углов линии |
|  | [Outline](P_TFlex_Model_Model2D_FormlimitsLeader_Outline.md) | Линия изображения, к которой привязана стрелка |
|  | [Page](P_TFlex_Model_Model2D_FormlimitsLeader_Page.md) | Cтраница, на которой размещается объект(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [Point](P_TFlex_Model_Model2D_FormlimitsLeader_Point.md) | Абсолютные координаты точки привязки |
|  | [Position](P_TFlex_Model_Model2D_FormlimitsLeader_Position.md) | Номер точки привязки на таблице допуска (от 0 до 7) |
|  | [Priority](P_TFlex_Model_Model2D_FormlimitsLeader_Priority.md) | Приоритет объекта |
|  | [StartOffsetIsHoriz](P_TFlex_Model_Model2D_FormlimitsLeader_StartOffsetIsHoriz.md) | Направление первого смещения: true - по горизонтали, false - по вертикали |
...
|  | [X](P_TFlex_Model_Model2D_FormlimitsLeader_X.md) | Координата X точки привязки |
|  | [Y](P_TFlex_Model_Model2D_FormlimitsLeader_Y.md) | Координата Y точки привязки |
...
|  | [SetConstruction](M_TFlex_Model_Model2D_FormlimitsLeader_SetConstruction.md) | Установка параметров привязки к прямой |
|  | [SetDimension](M_TFlex_Model_Model2D_FormlimitsLeader_SetDimension.md) | Установка привязки к размеру |
...
|  | [SetFormlimitsObj](M_TFlex_Model_Model2D_FormlimitsLeader_SetFormlimitsObj.md) | Установка привязки к обозначению допуска |
|  | [SetOutline](M_TFlex_Model_Model2D_FormlimitsLeader_SetOutline.md) | Установка параметров привязки к отрезку |
|  | [SetPoint](M_TFlex_Model_Model2D_FormlimitsLeader_SetPoint.md) | Установка абсолютных координат точки привязки |
