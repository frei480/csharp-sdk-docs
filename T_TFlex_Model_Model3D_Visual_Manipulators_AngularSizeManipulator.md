...
# AngularSizeManipulator - класс  
  
---  
  
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.Visual.ManipulatorsManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_Manipulator.md) TFlex.Model.Model3D.Visual.ManipulatorsAngularSizeManipulator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AngularSizeManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator__ctor.md) | Инициализирует новый экземпляр класса AngularSizeManipulator |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Radius](P_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_Radius.md) | Радиус |
...
|  | [ViewUnit](P_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_ViewUnit.md) | Единицы |
...
|  | [GetCommitedAngle](M_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_GetCommitedAngle.md) |  |
...
|  | [GetPendingAngle](M_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_GetPendingAngle.md) |  |
...
|  | [ResetAngle](M_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_ResetAngle.md) |  |
...
|  | [SetAxis](M_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_SetAxis.md) |  |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AngleCommited](E_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_AngleCommited.md) |  |
|  | [AngleEnqueued](E_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_AngleEnqueued.md) |  |
