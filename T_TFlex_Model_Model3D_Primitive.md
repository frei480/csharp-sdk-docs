...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DPrimitive Подробнее
...
|  | [BottomThickness](P_TFlex_Model_Model3D_Primitive_BottomThickness.md) | Толщина донышка |
|  | [CanBottomThicknessSet](P_TFlex_Model_Model3D_Primitive_CanBottomThicknessSet.md) | Разрешено управлять толщиной крышки примитива |
|  | [CanSymmetrySet](P_TFlex_Model_Model3D_Primitive_CanSymmetrySet.md) | Разрешено управлять симметрий примитива |
|  | [CanThicknessSet](P_TFlex_Model_Model3D_Primitive_CanThicknessSet.md) | Разрешено управлять толщиной стенок примитива |
|  | [CanTopThicknessSet](P_TFlex_Model_Model3D_Primitive_CanTopThicknessSet.md) | Разрешено управлять толщиной крышки примитива |
...
|  | [PrimitiveOperGet](P_TFlex_Model_Model3D_Primitive_PrimitiveOperGet.md) |  |
|  | [PrimitiveOperSet](P_TFlex_Model_Model3D_Primitive_PrimitiveOperSet.md) |  |
...
|  | [Symmetry](P_TFlex_Model_Model3D_Primitive_Symmetry.md) | Разрешено управлять симметрий примитива |
|  | [Thickness](P_TFlex_Model_Model3D_Primitive_Thickness.md) | Толщина стенок |
|  | [ThicknessMethod](P_TFlex_Model_Model3D_Primitive_ThicknessMethod.md) | Способ задания толщины стенок |
...
|  | [TopThickness](P_TFlex_Model_Model3D_Primitive_TopThickness.md) | Толщина крышки |
...
|  | [UseBottomThickness](P_TFlex_Model_Model3D_Primitive_UseBottomThickness.md) | Использовать толщину донышка примитива |
|  | [UseTopThickness](P_TFlex_Model_Model3D_Primitive_UseTopThickness.md) | Использовать толщину крышки примитива |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DPrimitive [TFlex.Model.Model3DBlock](T_TFlex_Model_Model3D_Block.md) [TFlex.Model.Model3DCone](T_TFlex_Model_Model3D_Cone.md) [TFlex.Model.Model3DCylinder](T_TFlex_Model_Model3D_Cylinder.md) [TFlex.Model.Model3DPiramida](T_TFlex_Model_Model3D_Piramida.md) [TFlex.Model.Model3DPrisma](T_TFlex_Model_Model3D_Prisma.md) [TFlex.Model.Model3DSphere](T_TFlex_Model_Model3D_Sphere.md) [TFlex.Model.Model3DTorus](T_TFlex_Model_Model3D_Torus.md)