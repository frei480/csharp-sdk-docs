...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PlaneSection](M_TFlex_Model_Model3D_PlaneSection__ctor.md) | Конструктор для создания сечения по плоскости |
...
|  | [Plane](P_TFlex_Model_Model3D_PlaneSection_Plane.md) | Плоскость сечения |
