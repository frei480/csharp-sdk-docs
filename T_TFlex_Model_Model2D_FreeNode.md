...
Класс узла, построенного в абсолютных координатах

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DFreeNode
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FreeNode(Document)](M_TFlex_Model_Model2D_FreeNode__ctor.md) | Конструктор по умолчанию. Координаты установлены в значение 0,0 |
|  | [FreeNode(Document, Parameter, Parameter)](M_TFlex_Model_Model2D_FreeNode__ctor_1.md) | Конструктор, задающий координаты x,y в системе координат модели, без учёта масштаба текущей страницы |
...
|  | [SubType](P_TFlex_Model_Model2D_FreeNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
...
|  | [X](P_TFlex_Model_Model2D_FreeNode_X.md) | Значение координаты X узла |
|  | [Y](P_TFlex_Model_Model2D_FreeNode_Y.md) | Значение координаты Y узла |
