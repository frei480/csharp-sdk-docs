...
|  | Имя | Описание |
| --- | --- | --- |
|  | [WorkplaneNode3D](M_TFlex_Model_Model3D_WorkplaneNode3D__ctor.md) | Конструктор для создания узла по проекциям |
...
|  | [FirstProjection](P_TFlex_Model_Model3D_WorkplaneNode3D_FirstProjection.md) | Первая проекция |
...
|  | [SecondProjection](P_TFlex_Model_Model3D_WorkplaneNode3D_SecondProjection.md) | Вторая проекция |
