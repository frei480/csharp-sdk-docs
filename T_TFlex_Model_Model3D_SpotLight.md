...
Класс прожекторного источника света

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DLight](T_TFlex_Model_Model3D_Light.md) [TFlex.Model.Model3DDirectionalLight](T_TFlex_Model_Model3D_DirectionalLight.md) TFlex.Model.Model3DSpotLight
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SpotLight](M_TFlex_Model_Model3D_SpotLight__ctor.md) | Конструктор для прожекторного источника света |
...
|  | [Direction](P_TFlex_Model_Model3D_DirectionalLight_Direction.md) | **Устарело.** Точка задающая направление источника света(Унаследован от [DirectionalLight](T_TFlex_Model_Model3D_DirectionalLight.md)) |
...
|  | [DropOffRate](P_TFlex_Model_Model3D_SpotLight_DropOffRate.md) | Коэффициент бокового затухания |
...
|  | [GroupType](P_TFlex_Model_Model3D_Light_GroupType.md) | (Унаследован от [Light](T_TFlex_Model_Model3D_Light.md)) |
...
|  | [Intensivity](P_TFlex_Model_Model3D_Light_Intensivity.md) | Интенсивность источника света(Унаследован от [Light](T_TFlex_Model_Model3D_Light.md)) |
...
|  | [Location](P_TFlex_Model_Model3D_Light_Location.md) | **Устарело.** Точка задающая положение источника света(Унаследован от [Light](T_TFlex_Model_Model3D_Light.md)) |
...
|  | [ShowIcon](P_TFlex_Model_Model3D_Light_ShowIcon.md) | Показывать или нет обозначение источника света в сцене(Унаследован от [Light](T_TFlex_Model_Model3D_Light.md)) |
|  | [SpotAngle](P_TFlex_Model_Model3D_SpotLight_SpotAngle.md) | Угол прожектора |
...
|  | [UseOnFragment](P_TFlex_Model_Model3D_Light_UseOnFragment.md) | Использовать или нет источник света в сборочных документах(Унаследован от [Light](T_TFlex_Model_Model3D_Light.md)) |
