...
Класс узла, полученного ассоциативным копированием

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DCopyNode
...
|  | [Source](P_TFlex_Model_Model2D_CopyNode_Source.md) | Исходный узел |
|  | [SourceCopyOperation](P_TFlex_Model_Model2D_CopyNode_SourceCopyOperation.md) | Исходный объект-копия |
|  | [SubType](P_TFlex_Model_Model2D_CopyNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
|  | [Transformation](P_TFlex_Model_Model2D_CopyNode_Transformation.md) | Преобразование |
...
Объект данного класса не может быть создан приложением. Он создаётся системой автоматически при создании операции копирования
