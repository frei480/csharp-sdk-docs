...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DBetweenNode
...
|  | [BetweenNode(Document, Node, Node, Double)](M_TFlex_Model_Model2D_BetweenNode__ctor_1.md) | Конструктор создающий узел по двум узлам и вещественному параметру. |
...
|  | [Coefficient](P_TFlex_Model_Model2D_BetweenNode_Coefficient.md) | Коэффициент, определящий положение между двумя узлами |
...
|  | [FirstNode](P_TFlex_Model_Model2D_BetweenNode_FirstNode.md) | Первый узел |
...
|  | [SecondNode](P_TFlex_Model_Model2D_BetweenNode_SecondNode.md) | Второй узел |
|  | [SubType](P_TFlex_Model_Model2D_BetweenNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
