...
# FirstCharacter - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationFirstCharacter
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FirstCharacter](M_TFlex_Configuration_FirstCharacter__ctor.md) | Инициализирует новый экземпляр класса FirstCharacter |
|  | [FirstCharacter(IntPtr, Boolean)](M_TFlex_Configuration_FirstCharacter__ctor_1.md) | Инициализирует новый экземпляр класса FirstCharacter |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [HChar](P_TFlex_Configuration_FirstCharacter_HChar.md) |  |
|  | [VChar](P_TFlex_Configuration_FirstCharacter_VChar.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_FirstCharacter_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_FirstCharacter_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_FirstCharacter_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
...
|  | [ToString](M_TFlex_Configuration_FirstCharacter_ToString.md) | (Переопределяет [ObjectToString](https://learn.microsoft.com/dotnet/api/system.object.tostring)) |
