...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Torus](M_TFlex_Model_Model3D_Torus__ctor.md) | Конструктор для создания Тора |
...
|  | [MajorDiameter](P_TFlex_Model_Model3D_Torus_MajorDiameter.md) | Диаметр 1 |
...
|  | [MinorDiameter](P_TFlex_Model_Model3D_Torus_MinorDiameter.md) | Диаметр 2 |
