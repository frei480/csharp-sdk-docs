...
```csharp
public ModelContour GetProfileContour(
	int profileIndex,
	int contourIndex
)
```
...
contourIndex [Int32](https://learn.microsoft.com/dotnet/api/system.int32)
    Номер контура профиля (начинается с 0)

#### Возвращаемое значение

[ModelContour](T_TFlex_Model_Model3D_Geometry_ModelContour.md)Контур профиля
