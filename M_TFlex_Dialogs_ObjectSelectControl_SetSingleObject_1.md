...
# ObjectSelectControlSetSingleObject(ObjectSelectControlPlainObject, Boolean) - метод  
...
endUserEdit [Boolean](https://learn.microsoft.com/dotnet/api/system.boolean)
...
[SetSingleObject - перегрузка](Overload_TFlex_Dialogs_ObjectSelectControl_SetSingleObject.md)
