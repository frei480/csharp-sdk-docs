...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DObjectNode
...
|  | [ObjectNode(Document, Object2D, UInt32)](M_TFlex_Model_Model2D_ObjectNode__ctor_1.md) | Конструктор, задающий родительский 2D объект и идентификатор узла |
...
|  | [Index](P_TFlex_Model_Model2D_ObjectNode_Index.md) | Идентификатор узла для определения номера его точки привязки к объекту |
...
|  | [ParentObject](P_TFlex_Model_Model2D_ObjectNode_ParentObject.md) | Объект, которому принадлежит узел |
...
|  | [SubType](P_TFlex_Model_Model2D_ObjectNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
