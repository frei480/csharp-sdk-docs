...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSpiral
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Spiral](M_TFlex_Model_Model3D_Spiral__ctor.md) | Конструктор для создания Пружины |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model3D_Spiral_Angle.md) | Угол |
...
|  | [Coils](P_TFlex_Model_Model3D_Spiral_Coils.md) | Число витков |
...
|  | [Contour](P_TFlex_Model_Model3D_Spiral_Contour.md) | Профиль, задающий сечение спирали |
|  | [ContourFirstPoint](P_TFlex_Model_Model3D_Spiral_ContourFirstPoint.md) | Первая точка на профиле |
|  | [ContourSecondPoint](P_TFlex_Model_Model3D_Spiral_ContourSecondPoint.md) | Вторая точка на профиле |
|  | [CounterClockwise](P_TFlex_Model_Model3D_Spiral_CounterClockwise.md) | Построение пружины против часовой стрелки |
...
|  | [EndRadius](P_TFlex_Model_Model3D_Spiral_EndRadius.md) | Конечный радиус витка пружины |
|  | [Facet](P_TFlex_Model_Model3D_Operation_Facet.md) | (Унаследован от [Operation](T_TFlex_Model_Model3D_Operation.md)) |
|  | [FirstPoint](P_TFlex_Model_Model3D_Spiral_FirstPoint.md) | Первая точка |
...
|  | [GroupType](P_TFlex_Model_Model3D_Spiral_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [LengthMethod](P_TFlex_Model_Model3D_Spiral_LengthMethod.md) | Тип |
...
|  | [ProfileOrientation](P_TFlex_Model_Model3D_Spiral_ProfileOrientation.md) | Тип ориентации профиля |
|  | [ProfileReverse](P_TFlex_Model_Model3D_Spiral_ProfileReverse.md) | Параметр реверса профиля |
|  | [RadiusFromStartPoint](P_TFlex_Model_Model3D_Spiral_RadiusFromStartPoint.md) | Параметр "Получить радиус по узлу" |
|  | [SecondPoint](P_TFlex_Model_Model3D_Spiral_SecondPoint.md) | Вторая точка |
|  | [StartPoint](P_TFlex_Model_Model3D_Spiral_StartPoint.md) | Установить стартовую точку |
|  | [StartRadius](P_TFlex_Model_Model3D_Spiral_StartRadius.md) | Начальный радиус витка пружины |
|  | [Step](P_TFlex_Model_Model3D_Spiral_Step.md) | Шаг витка пружины |
...
|  | [SetEndSmooth](M_TFlex_Model_Model3D_Spiral_SetEndSmooth.md) | Установить параметры сглаживания конечных витков |
...
|  | [SetStartSmooth](M_TFlex_Model_Model3D_Spiral_SetStartSmooth.md) | Установить параметры сглаживания начальных витков |
