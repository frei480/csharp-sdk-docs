...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.StructureElement

**Пространство имён:** [TFlex.Model.Structure](N_TFlex_Model_Structure.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class Element : ModelObject
```
```vb
...
```
```cpp
public ref class Element : public ModelObject
```


Тип Element предоставляет следующие члены.
...
|  | [ElementType](P_TFlex_Model_Structure_Element_ElementType.md) |  |
|  | [External](P_TFlex_Model_Structure_Element_External.md) |  |
|  | [GroupType](P_TFlex_Model_Structure_Element_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [ItemGuid](P_TFlex_Model_Structure_Element_Item.md) |  |
|  | [ItemString](P_TFlex_Model_Structure_Element_Item_1.md) |  |
...
|  | [SourceFragment](P_TFlex_Model_Structure_Element_SourceFragment.md) |  |
|  | [SourceFragmentUID](P_TFlex_Model_Structure_Element_SourceFragmentUID.md) |  |
|  | [SourcePrototypeUID](P_TFlex_Model_Structure_Element_SourcePrototypeUID.md) |  |
|  | [UID](P_TFlex_Model_Structure_Element_UID.md) |  |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddLinkedObject](M_TFlex_Model_Structure_Element_AddLinkedObject.md) |  |
...
|  | [CopyValuesFrom(PrototypeCopyValuesParameters)](M_TFlex_Model_Structure_Element_CopyValuesFrom_2.md) |  |
|  | [CopyValuesFrom(Element, CopyValuesMode)](M_TFlex_Model_Structure_Element_CopyValuesFrom.md) |  |
|  | [CopyValuesFrom(SourceFile, Guid, CopyValuesMode)](M_TFlex_Model_Structure_Element_CopyValuesFrom_3.md) |  |
...
|  | [DeleteLinkToObject](M_TFlex_Model_Structure_Element_DeleteLinkToObject.md) |  |
...
|  | [DetachLinkedObject](M_TFlex_Model_Structure_Element_DetachLinkedObject.md) |  |
...
|  | [GetAddableLinks(ModelObject, NullableBoolean)](M_TFlex_Model_Structure_Element_GetAddableLinks_1.md) |  |
...
|  | [GetExpressionResult](M_TFlex_Model_Structure_Element_GetExpressionResult.md) |  |
...
|  | [GetLinkedObjects(Boolean)](M_TFlex_Model_Structure_Element_GetLinkedObjects_1.md) |  |
...
|  | [GetValue(Guid)](M_TFlex_Model_Structure_Element_GetValue.md) |  |
|  | [GetValue(String)](M_TFlex_Model_Structure_Element_GetValue_1.md) |  |
...
|  | [RunMethod(String, Object)](M_TFlex_Model_Structure_Element_RunMethod_1.md) |  |
