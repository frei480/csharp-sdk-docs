...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.Model3DSensor
...
|  | [GroupType](P_TFlex_Model_Model3D_Sensor_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [getMeterage](M_TFlex_Model_Model3D_Sensor_getMeterage.md) | Получить значение датчика по ключу |
