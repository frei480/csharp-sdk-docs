...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Equidistant3DPath](M_TFlex_Model_Model3D_Equidistant3DPath__ctor.md) | Конструктор для создания эквидистанта к 3D пути по направлению |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model3D_Equidistant3DPath_Angle.md) | Значение угла |
...
|  | [Direction](P_TFlex_Model_Model3D_Equidistant3DPath_Direction.md) | Direction |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_Equidistant3DPath_FirstPoint.md) | Первая точка, задающая направление |
...
|  | [Offset](P_TFlex_Model_Model3D_Equidistant3DPath_Offset.md) | Значение смещения |
|  | [Operation](P_TFlex_Model_Model3D_Equidistant3DPath_Operation.md) | 3D операция |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_Equidistant3DPath_SecondPoint.md) | Вторая точка, задающая направление |
|  | [SourcePath3D](P_TFlex_Model_Model3D_Equidistant3DPath_SourcePath3D.md) | 3D путь, для которого строится эквидистанта |
