...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Harness3D](M_TFlex_Model_Model3D_Harness3D__ctor.md) | Конструктор для создания нового жгута |
...
|  | [HarnessInfo](P_TFlex_Model_Model3D_Harness3D_HarnessInfo.md) |  |
...
|  | [ItemCount](P_TFlex_Model_Model3D_Harness3D_ItemCount.md) | Количество элементов в жгуте |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddItem](M_TFlex_Model_Model3D_Harness3D_AddItem.md) | Добавляет элемент в жгут |
|  | [CanAddItem](M_TFlex_Model_Model3D_Harness3D_CanAddItem.md) | Проверяет возможность вставить элемент в жгут, критерий: нет входит в текущий жгут и поджгуты, не принадлежит другим жгутам |
...
|  | [ExistsItem](M_TFlex_Model_Model3D_Harness3D_ExistsItem.md) | Проверяет наличие элемента в жгуте |
...
|  | [GetItem](M_TFlex_Model_Model3D_Harness3D_GetItem.md) | Получить элемент из жгута |
...
|  | [RemoveItem](M_TFlex_Model_Model3D_Harness3D_RemoveItem.md) | Удаляет элемент из жгута |
