...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PendingGeometryChangedEventArgs](M_TFlex_Model_Model3D_Visual_Manipulators_PendingGeometryChangedEventArgs__ctor.md) | Инициализирует новый экземпляр класса PendingGeometryChangedEventArgs |
