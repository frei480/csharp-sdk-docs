...
# SpatialWorkSurface - класс  
    
Базовый класс для всех типов специальных координатных поверхностей

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DWorkSurface](T_TFlex_Model_Model3D_WorkSurface.md) TFlex.Model.Model3DSpatialWorkSurface [TFlex.Model.Model3DCylinderWorkSurface](T_TFlex_Model_Model3D_CylinderWorkSurface.md) [TFlex.Model.Model3DSphereWorkSurface](T_TFlex_Model_Model3D_SphereWorkSurface.md) [TFlex.Model.Model3DTorusWorkSurface](T_TFlex_Model_Model3D_TorusWorkSurface.md)
...
|  | [BoundQuadrant](P_TFlex_Model_Model3D_SpatialWorkSurface_BoundQuadrant.md) | Квадрант границы рабочей поверхности, если границы задаются одним узлом и границами листа |
...
|  | [FirstBoundCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_FirstBoundCorner.md) | Первый угол границы |
|  | [FirstUVBoxCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_FirstUVBoxCorner.md) | Начало координат параметрической области |
|  | [Geometry](P_TFlex_Model_Model3D_SpatialWorkSurface_Geometry.md) | Получить геометрические данные специальных координатных поверхностей |
|  | [GroupType](P_TFlex_Model_Model3D_SpatialWorkSurface_GroupType.md) | (Переопределяет [WorkSurfaceGroupType](P_TFlex_Model_Model3D_WorkSurface_GroupType.md)) |
...
|  | [LCS](P_TFlex_Model_Model3D_SpatialWorkSurface_LCS.md) | Локальная система координат, в которой задаётся рабочая поверхость |
...
|  | [Orientation](P_TFlex_Model_Model3D_SpatialWorkSurface_Orientation.md) | Соответствие координатных осей и параметров |
...
|  | [SecondBoundCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_SecondBoundCorner.md) | Второй угол границы |
|  | [SecondUVBoxCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_SecondUVBoxCorner.md) | Вторая граница области |
...
|  | [Create](M_TFlex_Model_Model3D_SpatialWorkSurface_Create.md) |  |
