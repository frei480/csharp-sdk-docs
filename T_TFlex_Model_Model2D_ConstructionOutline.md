...
# ConstructionOutline - класс  
  
---  
  
Класс линии изображения, основанной на узлах и линиях построения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DConstructionOutline
...
|     | [ConstructionOutline(Document, Node, Node)](M_TFlex_Model_Model2D_ConstructionOutline__ctor_1.md)               | Конструктор, задающий узлы между которыми будет проведён отрезок               |
|     | [ConstructionOutline(Document, Node, Node, Construction)](M_TFlex_Model_Model2D_ConstructionOutline__ctor_2.md) | Конструктор, задающий узлы, между которыми пройдет линия, и линию построения   |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AnchorNode](P_TFlex_Model_Model2D_ConstructionOutline_AnchorNode.md) | Узел привязки |
...
|  | [Construction](P_TFlex_Model_Model2D_ConstructionOutline_Construction.md) | Линия построения, по которой проходит линия изображения |
...
|  | [EndNode](P_TFlex_Model_Model2D_ConstructionOutline_EndNode.md) | Конечный узел линии изображения |
...
|  | [GeometryType](P_TFlex_Model_Model2D_ConstructionOutline_GeometryType.md) | Тип геометрии линии изображения(Переопределяет [OutlineGeometryType](P_TFlex_Model_Model2D_Outline_GeometryType.md)) |
...
|  | [StartNode](P_TFlex_Model_Model2D_ConstructionOutline_StartNode.md) | Начальный узел линии изображения |
...
|  | [SubType](P_TFlex_Model_Model2D_ConstructionOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
...
Геометрия линии изображения данного класса определяется положением конечных узлов и/или геометрией подложенной линии построения.
