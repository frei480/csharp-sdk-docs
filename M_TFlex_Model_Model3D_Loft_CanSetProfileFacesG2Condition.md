...
# LoftCanSetProfileFacesG2Condition - метод  
  
---  
  
Узнать можно ли установить параметр взятия 2-й производной с граней

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public bool CanSetProfileFacesG2Condition(
	int profileIndex
)
```
```vb
