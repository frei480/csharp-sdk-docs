...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DSpring
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Spring](M_TFlex_Model_Model3D_Spring__ctor.md) | Конструктор для создания Пружины |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AlignAtEndPoint](P_TFlex_Model_Model3D_Spring_AlignAtEndPoint.md) | Параметр выравнивания по конечному 3D-узлу |
|  | [AlignAtStartPoint](P_TFlex_Model_Model3D_Spring_AlignAtStartPoint.md) | Параметр выравнивания по начальному 3D-узлу |
|  | [Angle](P_TFlex_Model_Model3D_Spring_Angle.md) | Угол |
...
|  | [CircleRadius](P_TFlex_Model_Model3D_Spring_CircleRadius.md) | Радиус пружины |
...
|  | [Coils](P_TFlex_Model_Model3D_Spring_Coils.md) | Число витков |
...
|  | [CounterClockwise](P_TFlex_Model_Model3D_Spring_CounterClockwise.md) | Параметр построения пружины против часовой стрелки |
...
|  | [EndCompress](P_TFlex_Model_Model3D_Spring_EndCompress.md) | Число прижимаемых к концу витков |
|  | [EndCut](P_TFlex_Model_Model3D_Spring_EndCut.md) | Число шлифуемых конечных витков |
|  | [EndRadius](P_TFlex_Model_Model3D_Spring_EndRadius.md) | Конечный радиус витка пружины |
|  | [Facet](P_TFlex_Model_Model3D_Operation_Facet.md) | (Унаследован от [Operation](T_TFlex_Model_Model3D_Operation.md)) |
|  | [FirstPoint](P_TFlex_Model_Model3D_Spring_FirstPoint.md) | Первая точка |
...
|  | [GroupType](P_TFlex_Model_Model3D_Spring_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [LengthMethod](P_TFlex_Model_Model3D_Spring_LengthMethod.md) | Тип |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_Spring_SecondPoint.md) | Вторая точка |
|  | [Segments](P_TFlex_Model_Model3D_Spring_Segments.md) | Число сегментов |
|  | [StartCompress](P_TFlex_Model_Model3D_Spring_StartCompress.md) | Число прижимаемых к началу витков |
|  | [StartCut](P_TFlex_Model_Model3D_Spring_StartCut.md) | Число шлифуемых начальных витков |
|  | [StartPoint](P_TFlex_Model_Model3D_Spring_StartPoint.md) | Стартовая точку |
|  | [StartRadius](P_TFlex_Model_Model3D_Spring_StartRadius.md) | Начальный радиус витка пружины |
|  | [Step](P_TFlex_Model_Model3D_Spring_Step.md) | Шаг витка пружины |
