...
# ObjectTransformManipulator - методы  
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_ObjectTransformManipulator_Dispose.md) | (Переопределяет [ManipulatorDispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_Manipulator_Dispose_1.md)) |
