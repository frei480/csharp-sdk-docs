...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DFillHole
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FillHole](M_TFlex_Model_Model3D_FillHole__ctor.md) | Конструктор для создания операции "Заполнение области" |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AttachFlag](P_TFlex_Model_Model3D_FillHole_AttachFlag.md) | Объединять с существующим телом |
...
|  | [GroupType](P_TFlex_Model_Model3D_FillHole_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
