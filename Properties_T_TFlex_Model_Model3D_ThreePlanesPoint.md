...
# ThreePlanesPoint - свойства  
  
---  
  
Тип [ThreePlanesPoint](T_TFlex_Model_Model3D_ThreePlanesPoint.md) предоставляет следующие члены.
...
[ThreePlanesPoint - ](T_TFlex_Model_Model3D_ThreePlanesPoint.md)
