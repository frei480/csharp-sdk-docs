...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OffsetProfile](M_TFlex_Model_Model3D_OffsetProfile__ctor.md) | Конструктор для создания смещения к плоскому контуру |
...
|  | [BreakFillType](P_TFlex_Model_Model3D_OffsetProfile_BreakFillType.md) | Способ обработки разрывов |
...
|  | [InnerContourType](P_TFlex_Model_Model3D_OffsetProfile_InnerContourType.md) | Способ обработки внутреннего контура |
...
|  | [Offset](P_TFlex_Model_Model3D_OffsetProfile_Offset.md) | Значение смещения |
|  | [OffsetPoint](P_TFlex_Model_Model3D_OffsetProfile_OffsetPoint.md) | Точка, определяющая значение смещения |
...
|  | [SourceContour](P_TFlex_Model_Model3D_OffsetProfile_SourceContour.md) | Плоский контур, для которого строится смещение |
