...
# DocEditIniFileManager - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) TFlex.ControlServiceDocEditIniFileManager
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [DocEditIniFileManager](M_TFlex_ControlService_DocEditIniFileManager__ctor.md) | Инициализирует новый экземпляр класса DocEditIniFileManager |
