...
# StandardUnitsLengthMicrometer - свойство  
...
```csharp
public static Unit Micrometer { get; }
```
```vb
Public Shared ReadOnly Property Micrometer As Unit
	Get
```
```cpp
public:
static property Unit^ Micrometer {
	Unit^ get ();
}
```
