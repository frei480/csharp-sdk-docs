...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OnSurfacePoint](M_TFlex_Model_Model3D_OnSurfacePoint__ctor.md) | Конструктор для создания узла на поверхности |
...
|  | [Parameterization](P_TFlex_Model_Model3D_OnSurfacePoint_Parameterization.md) | Тип параметризации |
|  | [ParameterU](P_TFlex_Model_Model3D_OnSurfacePoint_ParameterU.md) | U - параметр узла на поверхности |
|  | [ParameterV](P_TFlex_Model_Model3D_OnSurfacePoint_ParameterV.md) | V - параметр узла на поверхности |
...
|  | [Surface](P_TFlex_Model_Model3D_OnSurfacePoint_Surface.md) | Поверхность, на которой строится точка |
...
|  | [U](P_TFlex_Model_Model3D_OnSurfacePoint_U.md) | **Устарело.** U - параметр узла на поверхности |
|  | [V](P_TFlex_Model_Model3D_OnSurfacePoint_V.md) | **Устарело.** V - параметр узла на поверхности |
...
|  | [ConvertUVToParameterUV](M_TFlex_Model_Model3D_OnSurfacePoint_ConvertUVToParameterUV.md) | Конвертировать UV to ParameterUV |
