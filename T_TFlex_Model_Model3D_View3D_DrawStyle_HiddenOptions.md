...
# View3DDrawStyleHiddenOptions - структура  
    
Дополнительные опции режимов с удалением скрытых линий

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model3DView3DDrawStyleHiddenOptions
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ShowHidden](F_TFlex_Model_Model3D_View3D_DrawStyle_HiddenOptions_ShowHidden.md) | Показывать невидимые ребра пунктиром |
|  | [ShowSilhouettes](F_TFlex_Model_Model3D_View3D_DrawStyle_HiddenOptions_ShowSilhouettes.md) | Показывать очерковые линии |
