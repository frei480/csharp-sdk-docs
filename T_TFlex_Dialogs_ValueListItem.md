...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ValueListItem(String)](M_TFlex_Dialogs_ValueListItem__ctor.md) | Инициализирует новый экземпляр класса ValueListItem |
|  | [ValueListItem(ValueListItemType)](M_TFlex_Dialogs_ValueListItem__ctor_1.md) | Инициализирует новый экземпляр класса ValueListItem |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Text](P_TFlex_Dialogs_ValueListItem_Text.md) | Текст элемента |
|  | [Type](P_TFlex_Dialogs_ValueListItem_Type.md) | Тип элемента |
