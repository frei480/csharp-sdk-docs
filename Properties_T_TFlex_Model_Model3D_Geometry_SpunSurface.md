...
# SpunSurface - свойства  
  
---  
  
Тип [SpunSurface](T_TFlex_Model_Model3D_Geometry_SpunSurface.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Data](P_TFlex_Model_Model3D_Geometry_SpunSurface_Data.md) | Свойства поверхности вращения |
