...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Maximum](P_TFlex_Model_Model3D_Geometry_BaseBox_Maximum.md) | Получить точку максимальных границ |
|  | [Minimum](P_TFlex_Model_Model3D_Geometry_BaseBox_Minimum.md) | Получить точку минимальных границ |
...
|  | [Update](M_TFlex_Model_Model3D_Geometry_BaseBox_Update.md) | Обновить геометрию для каждого конкретного порождённого типа(Переопределяет Geometry.Update) |
