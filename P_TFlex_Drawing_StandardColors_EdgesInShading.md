...
# StandardColorsEdgesInShading - свойство  
...
```csharp
public static Color EdgesInShading { get; }
```
```vb
Public Shared ReadOnly Property EdgesInShading As Color
	Get
```
```cpp
public:
static property Color EdgesInShading {
	Color get ();
}
```
