...
# RunScriptResult - методы  
    
Тип [RunScriptResult](T_TFlex_QualityManagement_RunScriptResult.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Dispose](M_TFlex_QualityManagement_RunScriptResult_Dispose.md) |  |
