...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Data](P_TFlex_Model_Model3D_Geometry_ModelSplineCurve_Data.md) | Получить описание сплайна |
...
|  | [Splinewise](P_TFlex_Model_Model3D_Geometry_ModelSplineCurve_Splinewise.md) | Получить описание интерполяционного сплайна по набору точек, через которые проходит сплайн, по параметрам кривой в этих точках и условиям на концах |
...
|  | [Piecewise](M_TFlex_Model_Model3D_Geometry_ModelSplineCurve_Piecewise.md) | Получить описание сплайна по набору сегментов |
