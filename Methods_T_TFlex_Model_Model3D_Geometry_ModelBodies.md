...
Тип [ModelBodies](T_TFlex_Model_Model3D_Geometry_ModelBodies.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_ModelBodies_Dispose.md) | (Переопределяет [GeometryDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_Geometry_Dispose_1.md)) |
