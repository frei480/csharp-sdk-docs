...
# AngularDimensionSetOffsets - метод  
...
offset2 [Double](https://learn.microsoft.com/dotnet/api/system.double)
    Смещение размерного числа по дуге относительно середины размерной линии (используется, если fixNode2 не задан)
...
offset3 [Double](https://learn.microsoft.com/dotnet/api/system.double)
    Смещение длина полки размера (используется, если fixNode3 не задан)
