...
|  | [BoundRect](P_TFlex_Model_Model2D_Object2D_BoundRect.md) | Получение координат прямоугольника, обрамляющего объект |
...
|  | [Page](P_TFlex_Model_Model2D_Object2D_Page.md) | Страница, на которой размещается объект |
...
|  | [CreateObject](M_TFlex_Model_Model2D_Object2D_CreateObject.md) |  |
...
|  | [Draw](M_TFlex_Model_Model2D_Object2D_Draw.md) | Нарисовать объект |
...
|  | [GetDistance](M_TFlex_Model_Model2D_Object2D_GetDistance.md) | Получение растояния до объекта |
...
|  | [GetPoint](M_TFlex_Model_Model2D_Object2D_GetPoint.md) | Получение координат характерной точки объекта |
|  | [GetPointCount](M_TFlex_Model_Model2D_Object2D_GetPointCount.md) | Получение количества характерных точек объекта, в которых может быть построен узел |
|  | [GetPointID](M_TFlex_Model_Model2D_Object2D_GetPointID.md) | Получение идентификатора характерной точеки объекта с номером index |
...
|  | [Transform](M_TFlex_Model_Model2D_Object2D_Transform.md) | Применение преобразования. |
|  | [Translate](M_TFlex_Model_Model2D_Object2D_Translate.md) | Сдвиг объекта на данный вектор |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.Model2DObject2D [TFlex.Model.CircuitsLinkBase](T_TFlex_Model_Circuits_LinkBase.md) [TFlex.Model.CircuitsLinkSymbol](T_TFlex_Model_Circuits_LinkSymbol.md) [TFlex.Model.Model2DArea](T_TFlex_Model_Model2D_Area.md) [TFlex.Model.Model2DConstraint](T_TFlex_Model_Model2D_Constraint.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) [TFlex.Model.Model2DControl](T_TFlex_Model_Model2D_Control.md) [TFlex.Model.Model2DCopyOperation](T_TFlex_Model_Model2D_CopyOperation.md) [TFlex.Model.Model2DDimension](T_TFlex_Model_Model2D_Dimension.md) [TFlex.Model.Model2DDrawingView](T_TFlex_Model_Model2D_DrawingView.md) [TFlex.Model.Model2DExternalObject](T_TFlex_Model_Model2D_ExternalObject.md) [TFlex.Model.Model2DFixingVector](T_TFlex_Model_Model2D_FixingVector.md) [TFlex.Model.Model2DFormlimits](T_TFlex_Model_Model2D_Formlimits.md) [TFlex.Model.Model2DFormlimitsLeader](T_TFlex_Model_Model2D_FormlimitsLeader.md) [TFlex.Model.Model2DFragment](T_TFlex_Model_Model2D_Fragment.md) [TFlex.Model.Model2DGraphLaw](T_TFlex_Model_Model2D_GraphLaw.md) [TFlex.Model.Model2DHarness2D](T_TFlex_Model_Model2D_Harness2D.md) [TFlex.Model.Model2DLeaderNote](T_TFlex_Model_Model2D_LeaderNote.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) [TFlex.Model.Model2DOutlinesIntersection](T_TFlex_Model_Model2D_OutlinesIntersection.md) [TFlex.Model.Model2DPicture](T_TFlex_Model_Model2D_Picture.md) [TFlex.Model.Model2DRoughnessSymbol](T_TFlex_Model_Model2D_RoughnessSymbol.md) [TFlex.Model.Model2DText](T_TFlex_Model_Model2D_Text.md) [TFlex.Model.Model2DViewSymbol](T_TFlex_Model_Model2D_ViewSymbol.md)