...
# ComparisonOperatorMatchMask - поле  
...
```csharp
public static readonly ComparisonOperator MatchMask
```
```vb
Public Shared ReadOnly MatchMask As ComparisonOperator
```
```cpp
public:
static initonly ComparisonOperator^ MatchMask
```
