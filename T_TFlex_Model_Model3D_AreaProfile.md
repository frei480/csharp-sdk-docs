...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AreaProfile](M_TFlex_Model_Model3D_AreaProfile__ctor.md) | Конструктор для создания профиля по штриховке и рабочей поверхности |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Area](P_TFlex_Model_Model3D_AreaProfile_Area.md) | Штриховка, задающая форму профиля |
...
|  | [OnHatch](P_TFlex_Model_Model3D_AreaProfile_OnHatch.md) | 2D узел, задающий перемещение узла контура в 3D узел |
...
|  | [Target](P_TFlex_Model_Model3D_AreaProfile_Target.md) | 3D узел для привязки плоскости контура |
...
|  | [WorkSurface](P_TFlex_Model_Model3D_AreaProfile_WorkSurface.md) | Рабочая поверхность, задающая ориентацию профиля |
