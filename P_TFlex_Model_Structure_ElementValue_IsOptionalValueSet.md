...
# ElementValueIsOptionalValueSet - свойство  
  **Пространство имён:** [TFlex.Model.Structure](N_TFlex_Model_Structure.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool IsOptionalValueSet { get; set; }
```
```vb
Public Property IsOptionalValueSet As Boolean
	Get
	Set
```
```cpp
public:
property bool IsOptionalValueSet {
	bool get ();
	void set (bool value);
}
```
