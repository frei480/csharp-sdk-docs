...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Pipe](M_TFlex_Model_Model3D_Pipe__ctor.md) | Создать круглый трубопровод в документе |
...
|  | [ProfileProps](P_TFlex_Model_Model3D_Pipe_ProfileProps.md) | Получить параметры профиля трубопровода |
...
|  | [getProfileProperties](M_TFlex_Model_Model3D_Pipe_getProfileProperties.md) | (Переопределяет [BasePipegetProfileProperties](M_TFlex_Model_Model3D_BasePipe_getProfileProperties.md)) |
