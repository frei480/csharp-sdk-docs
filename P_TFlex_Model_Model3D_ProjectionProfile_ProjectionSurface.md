...
# ProjectionProfileProjectionSurface - свойство  
...
В настоящей версии в качестве поверхности можно выбирать только операции и грани. В остальных случаях профиль строится не будет
