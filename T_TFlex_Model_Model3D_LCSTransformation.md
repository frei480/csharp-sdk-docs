...
# LCSTransformation - класс  
    
Класс преобразования перемещения из одной системы координат в другую

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) [TFlex.Model.Model3DMoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md) TFlex.Model.Model3DLCSTransformation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LCSTransformation](M_TFlex_Model_Model3D_LCSTransformation__ctor.md) | Конструктор для создания нового преобразования перемещения из одной системы координат в другую |
...
|  | [LCS](P_TFlex_Model_Model3D_MoveRotateTransformation_LCS.md) | Система координат, относительно которой производится преобразование(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
...
|  | [OriginType](P_TFlex_Model_Model3D_MoveRotateTransformation_OriginType.md) | Тип поиска системы координат, относительно которой производится преобразование(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
...
|  | [SourceLCS](P_TFlex_Model_Model3D_LCSTransformation_SourceLCS.md) | Исходная система координат |
...
|  | [TargetLCS](P_TFlex_Model_Model3D_LCSTransformation_TargetLCS.md) | Целевая система координат |
