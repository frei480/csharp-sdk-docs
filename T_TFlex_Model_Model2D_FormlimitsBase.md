...
# FormlimitsBase - класс  
  
---  
  
Класс обозначения базы

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DFormlimits](T_TFlex_Model_Model2D_Formlimits.md) TFlex.Model.Model2DFormlimitsBase
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FormlimitsBase](M_TFlex_Model_Model2D_FormlimitsBase__ctor.md) | Конструктор по умолчанию |
...
|  | [Datum](P_TFlex_Model_Model2D_FormlimitsBase_Datum.md) | Значение базы |
...
|  | [SubType](P_TFlex_Model_Model2D_FormlimitsBase_SubType.md) | Значение подтипа объекта(Переопределяет [FormlimitsSubType](P_TFlex_Model_Model2D_Formlimits_SubType.md)) |
