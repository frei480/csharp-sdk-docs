...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OnWirePoint](M_TFlex_Model_Model3D_OnWirePoint__ctor.md) | Конструктор для создания узла на проволочной модели (на пути) |
...
|  | [Offset](P_TFlex_Model_Model3D_OnWirePoint_Offset.md) | Смещение на пути |
...
|  | [Param](P_TFlex_Model_Model3D_OnWirePoint_Param.md) | Получить параметр на пути |
|  | [Parameterization](P_TFlex_Model_Model3D_OnWirePoint_Parameterization.md) | Тип параметризации |
...
|  | [Path](P_TFlex_Model_Model3D_OnWirePoint_Path.md) | Путь, на котором строится 3D узел |
|  | [Reference](P_TFlex_Model_Model3D_OnWirePoint_Reference.md) | Тип точки отсчёта |
|  | [ReferencePoint](P_TFlex_Model_Model3D_OnWirePoint_ReferencePoint.md) | Точка отсчёта смещения |
