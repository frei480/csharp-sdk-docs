...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DCopyOperation](T_TFlex_Model_Model2D_CopyOperation.md) TFlex.Model.Model2DRevolveArray
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [RevolveArray](M_TFlex_Model_Model2D_RevolveArray__ctor.md) | Стандартный конструктор |
...
|  | [CenterNode](P_TFlex_Model_Model2D_RevolveArray_CenterNode.md) | Центральный узел |
|  | [CenterX](P_TFlex_Model_Model2D_RevolveArray_CenterX.md) | X-координата центра массива |
|  | [CenterY](P_TFlex_Model_Model2D_RevolveArray_CenterY.md) | Y-координата центра массива |
|  | [CopyType](P_TFlex_Model_Model2D_RevolveArray_CopyType.md) | Подтип операции копирования(Переопределяет [CopyOperationCopyType](P_TFlex_Model_Model2D_CopyOperation_CopyType.md)) |
...
|  | [SetRowParameters](M_TFlex_Model_Model2D_RevolveArray_SetRowParameters.md) | Установка параметров массива |
