...
Класс многострочного форматированного текст

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DText](T_TFlex_Model_Model2D_Text.md) [TFlex.Model.Model2DRichText](T_TFlex_Model_Model2D_RichText.md) TFlex.Model.Model2DMultilineText
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [MultilineText](M_TFlex_Model_Model2D_MultilineText__ctor.md) | Конструктор для создания нового многострочного форматированного текста |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model2D_MultilineText_Angle.md) | Угол поворота текста |
...
|  | [HorizontalAlignment](P_TFlex_Model_Model2D_MultilineText_HorizontalAlignment.md) | Горизонтальное выравнивание текста |
...
|  | [Node](P_TFlex_Model_Model2D_MultilineText_Node.md) | Узел привязки текста |
...
|  | [SubType](P_TFlex_Model_Model2D_MultilineText_SubType.md) | Подтип текста, способ его задания(Переопределяет [TextSubType](P_TFlex_Model_Model2D_Text_SubType.md)) |
...
|  | [VerticalAlignment](P_TFlex_Model_Model2D_MultilineText_VerticalAlignment.md) | Вертикальное выравнивание текста |
...
|  | [X](P_TFlex_Model_Model2D_MultilineText_X.md) | Координата X или смещение X относительно узла привязки |
|  | [Y](P_TFlex_Model_Model2D_MultilineText_Y.md) | Координата Y или смещение Y относительно узла привязки |
