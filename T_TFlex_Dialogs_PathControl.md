...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PathControl](M_TFlex_Dialogs_PathControl__ctor.md) | Инициализирует новый экземпляр класса PathControl |
|  | [PathControl(String)](M_TFlex_Dialogs_PathControl__ctor_1.md) | Инициализирует новый экземпляр класса PathControl |
...
|  | [ExplodedString](P_TFlex_Dialogs_CompoundStringControl_ExplodedString.md) | Раскрытая строка (строка, в которую подставлены значения переменных) для текущего значения Text(Унаследован от [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md)) |
...
|  | [FullPath](P_TFlex_Dialogs_PathControl_FullPath.md) | Полный путь на файл. Путь введенный пользователем смотри в свойстве Text. Путь после подстановки переменных в ExplodedString |
...
|  | [IsDirectoryNeeded](P_TFlex_Dialogs_PathControl_IsDirectoryNeeded.md) | Контрол ожидает ввод пути к папке |
...
|  | [IsExplodeOn](P_TFlex_Dialogs_CompoundStringControl_IsExplodeOn.md) | "Раскрытие" строки влючено(Унаследован от [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md)) |
...
|  | [IsLibraryResolutionOn](P_TFlex_Dialogs_PathControl_IsLibraryResolutionOn.md) | Подставлять библиотечные пути |
...
|  | [IsRelativeToCurDocumentOn](P_TFlex_Dialogs_PathControl_IsRelativeToCurDocumentOn.md) | Подбирать путь относительно текущего документа |
...
|  | [OpenDialogCustomFilter](P_TFlex_Dialogs_PathControl_OpenDialogCustomFilter.md) | Строковый фильтр для окна "Открыть" в формате "описание_1 | фильтр_1 | описание_2 | фильтр_2 | ... | описание_N | фильтр_N |  | " |
|  | [OpenDialogInitialDirectory](P_TFlex_Dialogs_PathControl_OpenDialogInitialDirectory.md) | Начальная директория окна "Открыть" |
|  | [OpenDialogTitle](P_TFlex_Dialogs_PathControl_OpenDialogTitle.md) | Заголовок окна "Открыть" |
...
|  | [PathState](P_TFlex_Dialogs_PathControl_PathState.md) | Состояние выбора пути |
...
|  | [Text](P_TFlex_Dialogs_CompoundStringControl_Text.md) | Значение(Унаследован от [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md)) |
|  | [TextVariableOn](P_TFlex_Dialogs_CompoundStringControl_TextVariableOn.md) | Поддержка ввода выражений строковых переменных(Унаследован от [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md)) |
...
|  | [ExplodedStringChanged](E_TFlex_Dialogs_CompoundStringControl_ExplodedStringChanged.md) | (Унаследован от [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md)) |
...
|  | [FullPathChanged](E_TFlex_Dialogs_PathControl_FullPathChanged.md) |  |
...
|  | [TextChanged](E_TFlex_Dialogs_CompoundStringControl_TextChanged.md) | (Унаследован от [CompoundStringControl](T_TFlex_Dialogs_CompoundStringControl.md)) |
