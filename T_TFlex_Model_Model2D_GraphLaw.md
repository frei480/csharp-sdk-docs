...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ArgumentName](P_TFlex_Model_Model2D_GraphLaw_ArgumentName.md) | Название аргумента (x) в форме: [имя], [буквы_обозначения], [единицы] |
|  | [ArgumentTolerance](P_TFlex_Model_Model2D_GraphLaw_ArgumentTolerance.md) | Наименьшее допустимое расстояние между соседними узлами по значению аргумента |
|  | [ArgumentToValueVisualRatio](P_TFlex_Model_Model2D_GraphLaw_ArgumentToValueVisualRatio.md) | Визуальное соотношение единиц аргумента и функции (для отображения в диалоге) |
...
|  | [Color](P_TFlex_Model_Model2D_GraphLaw_Color.md) | Цвет (для отображения в диалоге) |
...
|  | [GroupType](P_TFlex_Model_Model2D_GraphLaw_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [IsSmooth](P_TFlex_Model_Model2D_GraphLaw_IsSmooth.md) | График является сглаженным |
...
|  | [NodeCount](P_TFlex_Model_Model2D_GraphLaw_NodeCount.md) | Количество точек графика |
|  | [Nodes](P_TFlex_Model_Model2D_GraphLaw_Nodes.md) | Точки графика |
|  | [NodesBounds](P_TFlex_Model_Model2D_GraphLaw_NodesBounds.md) | Ограничивающий прямоугольник узлов |
...
|  | [SpecialName](P_TFlex_Model_Model2D_GraphLaw_SpecialName.md) | Специальное имя |
|  | [UseLogarArgScale](P_TFlex_Model_Model2D_GraphLaw_UseLogarArgScale.md) | Использование логарифмической шкалы аргумента |
|  | [UseWorkingArea](P_TFlex_Model_Model2D_GraphLaw_UseWorkingArea.md) | Использование области допустимых значений |
|  | [ValueName](P_TFlex_Model_Model2D_GraphLaw_ValueName.md) | Название функции (F) в форме: [имя], [буквы_обозначения], [единицы] |
|  | [ViewOnly](P_TFlex_Model_Model2D_GraphLaw_ViewOnly.md) | Редактирование в диалоге запрещено |
...
|  | [WorkingArea](P_TFlex_Model_Model2D_GraphLaw_WorkingArea.md) | Область допустимых значений |
...
|  | [GetNode](M_TFlex_Model_Model2D_GraphLaw_GetNode.md) | Получение узла по номеру |
...
|  | [GetRepeatCount](M_TFlex_Model_Model2D_GraphLaw_GetRepeatCount.md) | Количество повторений графика в положительном и отрицательном направлениях |
...
|  | [GetValue](M_TFlex_Model_Model2D_GraphLaw_GetValue.md) | Получение значения по аргументу |
|  | [InsertNode](M_TFlex_Model_Model2D_GraphLaw_InsertNode.md) | Вставка узла в соответствии со значением аргумента |
...
|  | [Load](M_TFlex_Model_Model2D_GraphLaw_Load.md) | Создание графика из файла *.tflaw |
...
|  | [RemoveAllNodes](M_TFlex_Model_Model2D_GraphLaw_RemoveAllNodes.md) | Удаление всех узлов |
|  | [RemoveNode](M_TFlex_Model_Model2D_GraphLaw_RemoveNode.md) | Удаление узла |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Save](M_TFlex_Model_Model2D_GraphLaw_Save.md) | Сохранение в отдельный файл *.tflaw |
...
|  | [SetNode](M_TFlex_Model_Model2D_GraphLaw_SetNode.md) | Установка узла по номеру |
...
|  | [SetRepeatCount](M_TFlex_Model_Model2D_GraphLaw_SetRepeatCount.md) |  |
