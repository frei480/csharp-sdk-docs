...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SpecialBoxManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_SpecialBoxManipulator__ctor.md) | Инициализирует новый экземпляр класса SpecialBoxManipulator |
