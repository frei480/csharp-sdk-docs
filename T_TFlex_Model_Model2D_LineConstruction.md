...
# LineConstruction - класс  
    
Линия построения - прямая

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DLineConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LineConstruction](M_TFlex_Model_Model2D_LineConstruction__ctor.md) | Конструктор по умолчанию |
...
|  | [ConstructionGeometry](P_TFlex_Model_Model2D_LineConstruction_ConstructionGeometry.md) | Геометрия линии построения(Переопределяет [ConstructionConstructionGeometry](P_TFlex_Model_Model2D_Construction_ConstructionGeometry.md)) |
...
|  | [GeometryType](P_TFlex_Model_Model2D_LineConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [LineConstructionGeometry](P_TFlex_Model_Model2D_LineConstruction_LineConstructionGeometry.md) | Геометрия линии построения (прямой) |
|  | [LineType](P_TFlex_Model_Model2D_LineConstruction_LineType.md) | Тип привязки прямой |
|  | [LineView](P_TFlex_Model_Model2D_LineConstruction_LineView.md) | Вид прямой |
...
|  | [SubType](P_TFlex_Model_Model2D_LineConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
...
|  | [SetAxisOfLines](M_TFlex_Model_Model2D_LineConstruction_SetAxisOfLines.md) | Прямая, являющаяся осью симметрии двух прямых |
|  | [SetDividingNodes](M_TFlex_Model_Model2D_LineConstruction_SetDividingNodes.md) | Прямая, перпендикулярная отрезку между двумя узлами, делящая отрезок в заданной пропорции |
...
|  | [SetHorizontal](M_TFlex_Model_Model2D_LineConstruction_SetHorizontal.md) | Горизонтальная прямая |
|  | [SetHorizontalThroughNode](M_TFlex_Model_Model2D_LineConstruction_SetHorizontalThroughNode.md) | Горизонтальная прямая, проходящая через узел |
|  | [SetOnAngleThroughNode](M_TFlex_Model_Model2D_LineConstruction_SetOnAngleThroughNode.md) | Прямая, проходящая через узел, под углом к горизонтали |
|  | [SetOnAngleToLineThroughNode](M_TFlex_Model_Model2D_LineConstruction_SetOnAngleToLineThroughNode.md) | Прямая, проходящая через узел, под углом к другой прямой |
|  | [SetParallel](M_TFlex_Model_Model2D_LineConstruction_SetParallel.md) | Параллельная прямая |
|  | [SetParallelTangentToCircle](M_TFlex_Model_Model2D_LineConstruction_SetParallelTangentToCircle.md) | Прямая, параллельная другой прямой, касательная к окружности |
|  | [SetParallelTangentToEllipse](M_TFlex_Model_Model2D_LineConstruction_SetParallelTangentToEllipse.md) | Прямая, параллельная другой прямой, касательная к эллипсу |
|  | [SetParallelTangentToPolyline](M_TFlex_Model_Model2D_LineConstruction_SetParallelTangentToPolyline.md) | Прямая, параллельная другой прямой, касательная к сплайну или другой полилинии |
|  | [SetParallelThroughNode](M_TFlex_Model_Model2D_LineConstruction_SetParallelThroughNode.md) | Прямая, параллельная другой прямой, проходящая через узел |
|  | [SetPerpendicularThroughNode](M_TFlex_Model_Model2D_LineConstruction_SetPerpendicularThroughNode.md) | Прямая, перпендикулярная другой прямой, проходящая через узел |
...
|  | [SetSymmetric](M_TFlex_Model_Model2D_LineConstruction_SetSymmetric.md) | Прямая, симметричная другой прямой относительно оси (прямой) |
|  | [SetTangentToCircle](M_TFlex_Model_Model2D_LineConstruction_SetTangentToCircle.md) | Прямая, проходящая через узел, касательная к окружности |
|  | [SetTangentToCircleOnAngle](M_TFlex_Model_Model2D_LineConstruction_SetTangentToCircleOnAngle.md) | Прямая, касательная к окружности, под углом к другой прямой |
|  | [SetTangentToCircles](M_TFlex_Model_Model2D_LineConstruction_SetTangentToCircles.md) | Прямая, касательная к двум окружностям |
|  | [SetThoughNodeTangentToEllipse](M_TFlex_Model_Model2D_LineConstruction_SetThoughNodeTangentToEllipse.md) | Прямая, проходящая через узел, касательная к эллипсу |
|  | [SetThoughNodeTangentToPolyline](M_TFlex_Model_Model2D_LineConstruction_SetThoughNodeTangentToPolyline.md) | Прямая, проходящая через узел, касательная к сплайну или другой полилинии |
|  | [SetThroughNodes](M_TFlex_Model_Model2D_LineConstruction_SetThroughNodes.md) | Прямая, проходящая через два узла |
|  | [SetVertical](M_TFlex_Model_Model2D_LineConstruction_SetVertical.md) | Вертикальная прямая |
|  | [SetVerticalThroughNode](M_TFlex_Model_Model2D_LineConstruction_SetVerticalThroughNode.md) | Вертикальная прямая, проходящая через узел |
