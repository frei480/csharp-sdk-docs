...
Элемент, отображающий текст

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsStaticTextControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [StaticTextControl](M_TFlex_Dialogs_StaticTextControl__ctor.md) | Инициализирует новый экземпляр класса StaticTextControl |
|  | [StaticTextControl(String)](M_TFlex_Dialogs_StaticTextControl__ctor_1.md) | Инициализирует новый экземпляр класса StaticTextControl |
|  | [StaticTextControl(String, String)](M_TFlex_Dialogs_StaticTextControl__ctor_2.md) | Инициализирует новый экземпляр класса StaticTextControl |
|  | [StaticTextControl(String, String, HorizontalAlignment)](M_TFlex_Dialogs_StaticTextControl__ctor_3.md) | Инициализирует новый экземпляр класса StaticTextControl |
|  | [StaticTextControl(String, String, Icon)](M_TFlex_Dialogs_StaticTextControl__ctor_4.md) | Инициализирует новый экземпляр класса StaticTextControl |
|  | [StaticTextControl(String, String, Icon, HorizontalAlignment)](M_TFlex_Dialogs_StaticTextControl__ctor_5.md) | Инициализирует новый экземпляр класса StaticTextControl |
...
|  | [Icon](P_TFlex_Dialogs_StaticTextControl_Icon.md) | Иконка |
...
|  | [Text](P_TFlex_Dialogs_StaticTextControl_Text.md) | Отображаемый текст |
|  | [TextAlignment](P_TFlex_Dialogs_StaticTextControl_TextAlignment.md) | Выравнивание |
