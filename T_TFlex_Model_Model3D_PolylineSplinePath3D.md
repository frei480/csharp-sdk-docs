...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PolylineSplinePath3D](M_TFlex_Model_Model3D_PolylineSplinePath3D__ctor.md) | Конструктор для создания полилинии |
...
|  | [GeneralTopology](P_TFlex_Model_Model3D_PolylineSplinePath3D_GeneralTopology.md) |  |
