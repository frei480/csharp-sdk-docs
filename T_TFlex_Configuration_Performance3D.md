...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationPerformance3D
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Performance3D](M_TFlex_Configuration_Performance3D__ctor.md) | Инициализирует новый экземпляр класса Performance3D |
|  | [Performance3D(IntPtr, Boolean)](M_TFlex_Configuration_Performance3D__ctor_1.md) | Инициализирует новый экземпляр класса Performance3D |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Max](P_TFlex_Configuration_Performance3D_Max.md) |  |
|  | [SaveGeometry](P_TFlex_Configuration_Performance3D_SaveGeometry.md) |  |
|  | [SimplifyGeometry](P_TFlex_Configuration_Performance3D_SimplifyGeometry.md) |  |
|  | [Step](P_TFlex_Configuration_Performance3D_Step.md) |  |
|  | [WriteGeometry](P_TFlex_Configuration_Performance3D_WriteGeometry.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Performance3D_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Performance3D_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Performance3D_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
