...
|  | [GroupType](P_TFlex_Model_Model3D_SymmetryOperation2_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Plane](P_TFlex_Model_Model3D_SymmetryOperation2_Plane.md) | Плоскость симметрии |
