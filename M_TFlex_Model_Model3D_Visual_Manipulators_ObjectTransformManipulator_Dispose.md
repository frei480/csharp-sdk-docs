...
# ObjectTransformManipulatorDispose(Boolean) - метод  
    
Освобождает неуправляемые ресурсы, используемые объектом [ObjectTransformManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_ObjectTransformManipulator.md), а при необходимости освобождает также управляемые ресурсы
...
[Dispose - перегрузка](Overload_TFlex_Model_Model3D_Visual_Manipulators_ObjectTransformManipulator_Dispose.md)
