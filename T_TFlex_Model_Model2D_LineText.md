...
Класс строчного текста

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DText](T_TFlex_Model_Model2D_Text.md) TFlex.Model.Model2DLineText
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LineText](M_TFlex_Model_Model2D_LineText__ctor.md) | Конструктор для создания нового строчного текста |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AbsX](P_TFlex_Model_Model2D_LineText_AbsX.md) | Координата X |
|  | [AbsY](P_TFlex_Model_Model2D_LineText_AbsY.md) | Координата Y |
|  | [Angle](P_TFlex_Model_Model2D_LineText_Angle.md) | Угол поворота текста в градусах |
...
|  | [Circle](P_TFlex_Model_Model2D_LineText_Circle.md) | Окружность привязки текста |
...
|  | [HorizontalAlignment](P_TFlex_Model_Model2D_LineText_HorizontalAlignment.md) | Горизонтальное выравнивание текста |
...
|  | [Line](P_TFlex_Model_Model2D_LineText_Line.md) | Прямая привязки текста |
...
|  | [Node](P_TFlex_Model_Model2D_LineText_Node.md) | Узел привязки текста |
...
|  | [SubType](P_TFlex_Model_Model2D_LineText_SubType.md) | Подтип текста(Переопределяет [TextSubType](P_TFlex_Model_Model2D_Text_SubType.md)) |
|  | [Symmetric](P_TFlex_Model_Model2D_LineText_Symmetric.md) | Признак симметричности текста |
|  | [TextValue](P_TFlex_Model_Model2D_LineText_TextValue.md) | Строка (строки) текста |
|  | [VerticalAlignment](P_TFlex_Model_Model2D_LineText_VerticalAlignment.md) | Вертикальное выравнивание текста |
...
|  | [X](P_TFlex_Model_Model2D_LineText_X.md) | Координата X или смещение X относительно узла привязки |
|  | [Y](P_TFlex_Model_Model2D_LineText_Y.md) | Координата Y или смещение Y относительно узла привязки |
