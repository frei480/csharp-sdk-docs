...
```csharp
public class LineCurve : Curve, BaseLineCurve
```
```vb
...
```
```cpp
public ref class LineCurve : public Curve, 
	BaseLineCurve
```


Тип LineCurve предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [LineCurve](M_TFlex_Model_Model3D_Geometry_LineCurve__ctor.md) | Создание прямой |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Line](P_TFlex_Model_Model3D_Geometry_LineCurve_Line.md) | Получить описание прямой |
