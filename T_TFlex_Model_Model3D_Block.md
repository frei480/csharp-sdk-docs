...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Block](M_TFlex_Model_Model3D_Block__ctor.md) | Конструктор для создания Параллелепипеда |
...
|  | [Cube](P_TFlex_Model_Model3D_Block_Cube.md) | Создать куб |
...
|  | [XSize](P_TFlex_Model_Model3D_Block_XSize.md) | Длина стороны вдоль X |
|  | [YSize](P_TFlex_Model_Model3D_Block_YSize.md) | Длина стороны вдоль Y |
|  | [ZSize](P_TFlex_Model_Model3D_Block_ZSize.md) | Длина стороны вдоль Z |
