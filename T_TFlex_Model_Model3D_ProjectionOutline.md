...
# ProjectionOutline - класс  
    
Класс линии изображения, принадлежащей 2D проекции

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model3DProjectionOutline
...
|  | [EndPoint](P_TFlex_Model_Model3D_ProjectionOutline_EndPoint.md) |  |
...
|  | [IsWeld](P_TFlex_Model_Model3D_ProjectionOutline_IsWeld.md) |  |
...
|  | [Occurrence](P_TFlex_Model_Model3D_ProjectionOutline_Occurrence.md) |  |
...
|  | [ParentBodyID](P_TFlex_Model_Model3D_ProjectionOutline_ParentBodyID.md) | **Устарело.** |
|  | [ParentObject3D](P_TFlex_Model_Model3D_ProjectionOutline_ParentObject3D.md) | Получение родительского объекта, от которого построена линия |
...
|  | [Projection](P_TFlex_Model_Model3D_ProjectionOutline_Projection.md) | Получение родительского объекта проекции |
...
|  | [StartPoint](P_TFlex_Model_Model3D_ProjectionOutline_StartPoint.md) |  |
...
|  | [SubType](P_TFlex_Model_Model3D_ProjectionOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
...
|  | [GetBodyObjectID](M_TFlex_Model_Model3D_ProjectionOutline_GetBodyObjectID.md) | Идентификатор операции, в которой создан элемент |
...
Линия изображения данного класса может быть создана только при проецировании трёхмерных элементов и не может быть создана приложением
