...
|  | [NodeSection(Document, Page)](M_TFlex_Model_Model3D_NodeSection__ctor_1.md) | Конструктор для создания сечения по 2D узлам |
...
|  | [Nodes](P_TFlex_Model_Model3D_NodeSection_Nodes.md) | Множество узлов. Ломанная, построенная на последовательности этих узлов образуют контур сечения |
