...
# ConstructionDimension - класс  
    
Класс строительного размера

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DDimension](T_TFlex_Model_Model2D_Dimension.md) TFlex.Model.Model2DConstructionDimension
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ConstructionDimension](M_TFlex_Model_Model2D_ConstructionDimension__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model2D_ConstructionDimension_Accuracy.md) | Точность |
|  | [AltScaleFactor](P_TFlex_Model_Model2D_ConstructionDimension_AltScaleFactor.md) | Величина дополнительного масштабирования альтернативного размера |
|  | [AltScaleFactorType](P_TFlex_Model_Model2D_ConstructionDimension_AltScaleFactorType.md) | Тип дополнительного масштабирования альтернативного размера |
...
|  | [ArrowSize](P_TFlex_Model_Model2D_ConstructionDimension_ArrowSize.md) | Размер стрелки |
...
|  | [ConstructionDimType](P_TFlex_Model_Model2D_ConstructionDimension_ConstructionDimType.md) | Тип привязки размера |
...
|  | [DrawLeaderLine](P_TFlex_Model_Model2D_ConstructionDimension_DrawLeaderLine.md) | Параметр рисования выносной линии |
|  | [DrawPlus](P_TFlex_Model_Model2D_ConstructionDimension_DrawPlus.md) | Флага рисования знака "+" у положительных значений размера |
|  | [Dual](P_TFlex_Model_Model2D_ConstructionDimension_Dual.md) | Режим отображения двойного размера |
...
|  | [MinDigits](P_TFlex_Model_Model2D_ConstructionDimension_MinDigits.md) | Минимальное число знаков после запятой |
...
|  | [ParentDimension](P_TFlex_Model_Model2D_ConstructionDimension_ParentDimension.md) | Родительский размер |
...
|  | [ScaleFactor](P_TFlex_Model_Model2D_ConstructionDimension_ScaleFactor.md) | Величина дополнительного масштабирования размера |
|  | [ScaleFactorType](P_TFlex_Model_Model2D_ConstructionDimension_ScaleFactorType.md) | Тип дополнительного масштабирования размера |
|  | [Standard](P_TFlex_Model_Model2D_ConstructionDimension_Standard.md) | Тип стандарта размера |
...
|  | [StringsOffset](P_TFlex_Model_Model2D_ConstructionDimension_StringsOffset.md) | Величина смещения строк от размерной линии |
|  | [SubType](P_TFlex_Model_Model2D_ConstructionDimension_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [Units](P_TFlex_Model_Model2D_ConstructionDimension_Units.md) | Тип единиц измерения |
...
|  | [SetConstruction](M_TFlex_Model_Model2D_ConstructionDimension_SetConstruction.md) | Прикрепление размера к линии построения |
...
|  | [SetNode](M_TFlex_Model_Model2D_ConstructionDimension_SetNode.md) | Прикрепление размера к узлу |
|  | [SetOffsets](M_TFlex_Model_Model2D_ConstructionDimension_SetOffsets.md) | Установка привязок размера к узлам, либо по относительным смещениям |
|  | [SetOutline](M_TFlex_Model_Model2D_ConstructionDimension_SetOutline.md) | Прикрепление размера к линии изображения |
