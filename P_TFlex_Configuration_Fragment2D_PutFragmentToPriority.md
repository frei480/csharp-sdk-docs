...
# Fragment2DPutFragmentToPriority - свойство  
  **Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool PutFragmentToPriority { get; set; }
```
```vb
Public Property PutFragmentToPriority As Boolean
	Get
	Set
```
```cpp
public:
property bool PutFragmentToPriority {
	bool get ();
	void set (bool value);
}
```
