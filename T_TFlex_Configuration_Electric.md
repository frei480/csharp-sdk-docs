...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationElectric
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Electric](M_TFlex_Configuration_Electric__ctor.md) | Инициализирует новый экземпляр класса Electric |
|  | [Electric(IntPtr, Boolean)](M_TFlex_Configuration_Electric__ctor_1.md) | Инициализирует новый экземпляр класса Electric |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AskOnCommandCompletion](P_TFlex_Configuration_Electric_AskOnCommandCompletion.md) |  |
|  | [IsSynchronizationSilent](P_TFlex_Configuration_Electric_IsSynchronizationSilent.md) |  |
|  | [TypesSynchronizationMode](P_TFlex_Configuration_Electric_TypesSynchronizationMode.md) |  |
|  | [TypesSynchronizationPath](P_TFlex_Configuration_Electric_TypesSynchronizationPath.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_Electric_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_Electric_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_Electric_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
