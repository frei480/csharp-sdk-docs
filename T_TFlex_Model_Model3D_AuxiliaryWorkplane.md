...
|  | [AuxiliaryWorkplane(Document, Page)](M_TFlex_Model_Model3D_AuxiliaryWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [BaseWorkplane](P_TFlex_Model_Model3D_AuxiliaryWorkplane_BaseWorkplane.md) | Базовая рабочую плоскость |
...
|  | [FirstDirectionNode](P_TFlex_Model_Model3D_AuxiliaryWorkplane_FirstDirectionNode.md) | Первый узел направления взгляда |
|  | [FirstRotationNode](P_TFlex_Model_Model3D_AuxiliaryWorkplane_FirstRotationNode.md) | Первый узел направления вращения |
...
|  | [SecondDirectionNode](P_TFlex_Model_Model3D_AuxiliaryWorkplane_SecondDirectionNode.md) | Второй узел направления взгляда |
|  | [SecondRotationNode](P_TFlex_Model_Model3D_AuxiliaryWorkplane_SecondRotationNode.md) | Второй узел направления вращения |
