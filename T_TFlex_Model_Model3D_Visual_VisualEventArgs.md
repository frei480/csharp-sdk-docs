...
```
```cpp
public ref class VisualEventArgs : public EventArgs
```


Тип VisualEventArgs предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [VisualEventArgs](M_TFlex_Model_Model3D_Visual_VisualEventArgs__ctor.md) | Конструктор |
