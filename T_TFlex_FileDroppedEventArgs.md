...
# FileDroppedEventArgs - класс  
    
Класс, содержащий данные о событии, возникающем файл перетаскивается в одно из окон документа

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemEventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) [TFlexPluginEventArgs](T_TFlex_PluginEventArgs.md) [TFlexDocumentEventArgs](T_TFlex_DocumentEventArgs.md) [TFlexViewEventArgs](T_TFlex_ViewEventArgs.md) TFlexFileDroppedEventArgs
...
|  | [FileLibraryPath](P_TFlex_FileDroppedEventArgs_FileLibraryPath.md) | Получить имя файла с именем библиотеки |
|  | [FilePath](P_TFlex_FileDroppedEventArgs_FilePath.md) | Получить имя файла |
