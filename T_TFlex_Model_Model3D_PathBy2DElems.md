...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PathBy2DElems](M_TFlex_Model_Model3D_PathBy2DElems__ctor.md) | Конструктор для создания пути по набору сегментов: 2D путь и рабочая поверхность |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Area](P_TFlex_Model_Model3D_PathBy2DElems_Area.md) | Штриховка, задающая форму пути |
...
|  | [OnHatch](P_TFlex_Model_Model3D_PathBy2DElems_OnHatch.md) | 2D узел, задающий перемещение узла пути в 3D узел |
...
|  | [Segments](P_TFlex_Model_Model3D_PathBy2DElems_Segments.md) | Получить упорядоченное множество сегментов |
|  | [Target](P_TFlex_Model_Model3D_PathBy2DElems_Target.md) | 3D узел для привязки плоскости пути |
...
|  | [WorkSurface](P_TFlex_Model_Model3D_PathBy2DElems_WorkSurface.md) | Рабочая поверхность, задающая ориентацию пути (для штриховки) |
