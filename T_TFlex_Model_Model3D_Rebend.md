...
Операция "Повторная гибка"

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DRebend
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Rebend](M_TFlex_Model_Model3D_Rebend__ctor.md) | Конструктор для операции "Повторная гибка" |
...
|  | [CylindricalFaces](P_TFlex_Model_Model3D_Rebend_CylindricalFaces.md) | Цилиндрические поверхности |
...
|  | [GroupType](P_TFlex_Model_Model3D_Rebend_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [KeptPlanarFace](P_TFlex_Model_Model3D_Rebend_KeptPlanarFace.md) | Неподвижная грань |
