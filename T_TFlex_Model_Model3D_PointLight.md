...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DLight](T_TFlex_Model_Model3D_Light.md) TFlex.Model.Model3DPointLight
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PointLight](M_TFlex_Model_Model3D_PointLight__ctor.md) | Конструктор для точечного источника света |
