...
Базовый класс линии изображения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DOutline Подробнее
...
|  | [Color](P_TFlex_Model_Model2D_Outline_Color.md) | Цвет линии изображения |
...
|  | [EndArrowSize](P_TFlex_Model_Model2D_Outline_EndArrowSize.md) | Размер конечной стрелки линии изображения |
|  | [EndArrowType](P_TFlex_Model_Model2D_Outline_EndArrowType.md) | Тип конечной стрелки линии изображения |
|  | [Geometry](P_TFlex_Model_Model2D_Outline_Geometry.md) | Получение геометрии линии изображения с учётом масштаба |
|  | [GeometryAsPolyline](P_TFlex_Model_Model2D_Outline_GeometryAsPolyline.md) | Получение геометрии в виде полилинии независимо от типа |
|  | [GeometryType](P_TFlex_Model_Model2D_Outline_GeometryType.md) | Тип геометрии линии изображения |
|  | [GroupType](P_TFlex_Model_Model2D_Outline_GroupType.md) | Тип объекта "Линия изображения"(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [IsService](P_TFlex_Model_Model2D_Outline_IsService.md) | Вспомогательная линия |
...
|  | [Layer](P_TFlex_Model_Model2D_Outline_Layer.md) | Слой линии изображения |
|  | [Level](P_TFlex_Model_Model2D_Outline_Level.md) | Уровень линии |
|  | [LineWidth](P_TFlex_Model_Model2D_Outline_LineWidth.md) | Толщина линии изображения |
|  | [ModelGeometry](P_TFlex_Model_Model2D_Outline_ModelGeometry.md) | Получение геометрии линии изображения без учёта масштаба |
...
|  | [Page](P_TFlex_Model_Model2D_Outline_Page.md) | Страница линии изображения(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [PatternName](P_TFlex_Model_Model2D_Outline_PatternName.md) | Имя образца штриховой линии |
|  | [PatternScale](P_TFlex_Model_Model2D_Outline_PatternScale.md) | Масштаб штрихов штриховой линии |
|  | [Priority](P_TFlex_Model_Model2D_Outline_Priority.md) | Приоритет линии изображения |
|  | [StartArrowSize](P_TFlex_Model_Model2D_Outline_StartArrowSize.md) | Размер начальной стрелки линии изображения |
|  | [StartArrowType](P_TFlex_Model_Model2D_Outline_StartArrowType.md) | Тип начальной стрелки линии изображения |
|  | [Style](P_TFlex_Model_Model2D_Outline_Style.md) | Стиль линии изображения |
|  | [SubType](P_TFlex_Model_Model2D_Outline_SubType.md) | Подтип линии изображения |
...
|  | [WaveHeight](P_TFlex_Model_Model2D_Outline_WaveHeight.md) | Высота волны волнистой линии |
|  | [WaveLength](P_TFlex_Model_Model2D_Outline_WaveLength.md) | Длина волны волнистой линии |
|  | [WaveNumber](P_TFlex_Model_Model2D_Outline_WaveNumber.md) | Количество волн волнистой линии |
|  | [WaveSetting](P_TFlex_Model_Model2D_Outline_WaveSetting.md) | Способ задания волнистой линии |
...
|  | [CreateDefaultStyle](M_TFlex_Model_Model2D_Outline_CreateDefaultStyle.md) |  |
|  | [CreateDefaultStyleForAxes](M_TFlex_Model_Model2D_Outline_CreateDefaultStyleForAxes.md) |  |
...
|  | [EvaluatePoint](M_TFlex_Model_Model2D_Outline_EvaluatePoint.md) | Получить точку на кривой по параметру iU |
...
|  | [GetDashStyle](M_TFlex_Model_Model2D_Outline_GetDashStyle.md) | Получение штрихов |
...
|  | [SetDashStyle](M_TFlex_Model_Model2D_Outline_SetDashStyle.md) |  |
|  | [SetDefaults](M_TFlex_Model_Model2D_Outline_SetDefaults.md) | Установка параметров линий изображения в соответствии с параметрами по умолчанию |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DOutline [TFlex.Model.Model2DAxisOutline](T_TFlex_Model_Model2D_AxisOutline.md) [TFlex.Model.Model2DCenterAxisOutline](T_TFlex_Model_Model2D_CenterAxisOutline.md) [TFlex.Model.Model2DCircleOutline](T_TFlex_Model_Model2D_CircleOutline.md) [TFlex.Model.Model2DCircleToCircleAxisOutline](T_TFlex_Model_Model2D_CircleToCircleAxisOutline.md) [TFlex.Model.Model2DConstructionOutline](T_TFlex_Model_Model2D_ConstructionOutline.md) [TFlex.Model.Model2DCopyOutline](T_TFlex_Model_Model2D_CopyOutline.md) [TFlex.Model.Model2DEllipseArcOutline](T_TFlex_Model_Model2D_EllipseArcOutline.md) [TFlex.Model.Model2DEllipseOutline](T_TFlex_Model_Model2D_EllipseOutline.md) [TFlex.Model.Model2DFragmentOutline](T_TFlex_Model_Model2D_FragmentOutline.md) [TFlex.Model.Model2DPolylineOutline](T_TFlex_Model_Model2D_PolylineOutline.md) [TFlex.Model.Model2DSegmentOutline](T_TFlex_Model_Model2D_SegmentOutline.md) [TFlex.Model.Model2DThreePointArcOutline](T_TFlex_Model_Model2D_ThreePointArcOutline.md) [TFlex.Model.Model2DTwoPointArcOutline](T_TFlex_Model_Model2D_TwoPointArcOutline.md) [TFlex.Model.Model2DTwoPointCircleOutline](T_TFlex_Model_Model2D_TwoPointCircleOutline.md) [TFlex.Model.Model2DTwoPointEllipseOutline](T_TFlex_Model_Model2D_TwoPointEllipseOutline.md) [TFlex.Model.Model3DProjectionOutline](T_TFlex_Model_Model3D_ProjectionOutline.md)