...
# SelectEventArgs - класс  
  
---  
  
Класс аргументов события, возникающего при выборе объекта

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemEventArgs](https://learn.microsoft.com/dotnet/api/system.eventargs) [TFlex.CommandCommandEventArgs](T_TFlex_Command_CommandEventArgs.md) [TFlex.CommandCursorEventArgs](T_TFlex_Command_CursorEventArgs.md) TFlex.CommandSelectEventArgs

**Пространство имён:** [TFlex.Command](N_TFlex_Command.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public sealed class SelectEventArgs : CursorEventArgs
```
```vb
Public NotInheritable Class SelectEventArgs
	Inherits CursorEventArgs
```
```cpp
public ref class SelectEventArgs sealed : public CursorEventArgs
```


Тип SelectEventArgs предоставляет следующие члены.
...
|  | [GroupType](P_TFlex_Command_SelectEventArgs_GroupType.md) | Тип выбранного объекта |
...
|  | [Mode](P_TFlex_Command_SelectEventArgs_Mode.md) | Режим выбора объектов |
|  | [Object](P_TFlex_Command_SelectEventArgs_Object.md) | Выбранный объект |
|  | [OwnerObject](P_TFlex_Command_SelectEventArgs_OwnerObject.md) | Выбранный составной элемент объекта |
|  | [Result](P_TFlex_Command_SelectEventArgs_Result.md) | Результат выбора |
