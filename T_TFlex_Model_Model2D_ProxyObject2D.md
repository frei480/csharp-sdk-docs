...
Класс 2D прокси объекта

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelProxyObject](T_TFlex_Model_ProxyObject.md) TFlex.Model.Model2DProxyObject2D
...
|  | [ProxyObject2D(IntPtr)](M_TFlex_Model_Model2D_ProxyObject2D__ctor_1.md) | Конструктор, принимающий родительский объект |
...
|  | [Owner2D](P_TFlex_Model_Model2D_ProxyObject2D_Owner2D.md) | 2D владелец прокси объекта |
...
|  | [CanBeEverDissolved](M_TFlex_Model_Model2D_ProxyObject2D_CanBeEverDissolved.md) |  |
|  | [CanTransform](M_TFlex_Model_Model2D_ProxyObject2D_CanTransform.md) |  |
...
|  | [Transform](M_TFlex_Model_Model2D_ProxyObject2D_Transform.md) |  |
