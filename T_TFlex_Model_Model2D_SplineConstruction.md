...
# SplineConstruction - класс  
    
Линия построения - сплайн

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DSplineConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SplineConstruction](M_TFlex_Model_Model2D_SplineConstruction__ctor.md) | Конструктор по умолчанию |
...
|  | [Closed](P_TFlex_Model_Model2D_SplineConstruction_Closed.md) | Замкнутый сплайн |
...
|  | [ConstructionGeometry](P_TFlex_Model_Model2D_Construction_ConstructionGeometry.md) | Геометрия линии построения(Унаследован от [Construction](T_TFlex_Model_Model2D_Construction.md)) |
...
|  | [EndExtension](P_TFlex_Model_Model2D_SplineConstruction_EndExtension.md) | Управление удлинением в конце сплайна |
|  | [EndExtensionType](P_TFlex_Model_Model2D_SplineConstruction_EndExtensionType.md) | Тип управления удлинением в конце сплайна |
|  | [EndExtensionValue](P_TFlex_Model_Model2D_SplineConstruction_EndExtensionValue.md) | Значение смещения в конце сплайна |
|  | [EndTangentNode](P_TFlex_Model_Model2D_SplineConstruction_EndTangentNode.md) | Узел, задающий касание в конце |
|  | [GeometryType](P_TFlex_Model_Model2D_SplineConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [Interpolating](P_TFlex_Model_Model2D_SplineConstruction_Interpolating.md) | Интерполяционный сплайн |
...
|  | [IsPolyline](P_TFlex_Model_Model2D_SplineConstruction_IsPolyline.md) | Сплайн - полилиния |
...
|  | [PointCount](P_TFlex_Model_Model2D_SplineConstruction_PointCount.md) | Количество точек сплайна |
|  | [StartExtension](P_TFlex_Model_Model2D_SplineConstruction_StartExtension.md) | Управление удлинением в начале сплайна |
|  | [StartExtensionType](P_TFlex_Model_Model2D_SplineConstruction_StartExtensionType.md) | Тип управления удлинением в начале сплайна |
|  | [StartExtensionValue](P_TFlex_Model_Model2D_SplineConstruction_StartExtensionValue.md) | Значение смещения в начале сплайна |
|  | [StartTangentNode](P_TFlex_Model_Model2D_SplineConstruction_StartTangentNode.md) | Узел, задающий касание в начале |
|  | [SubType](P_TFlex_Model_Model2D_SplineConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
...
|  | [AddPoint(Node, Boolean)](M_TFlex_Model_Model2D_SplineConstruction_AddPoint_3.md) | Добавить точку |
|  | [AddPoint(Point, Parameter)](M_TFlex_Model_Model2D_SplineConstruction_AddPoint.md) | Добавить точку |
|  | [AddPoint(Point, Parameter, Boolean)](M_TFlex_Model_Model2D_SplineConstruction_AddPoint_1.md) | Добавить точку |
...
|  | [DeletePoint](M_TFlex_Model_Model2D_SplineConstruction_DeletePoint.md) | Удалить точку |
...
|  | [GetPointWeight](M_TFlex_Model_Model2D_SplineConstruction_GetPointWeight.md) | Получить вес точки |
...
|  | [InsertPoint](M_TFlex_Model_Model2D_SplineConstruction_InsertPoint.md) | Вставить точку |
...
|  | [SetDegree](M_TFlex_Model_Model2D_SplineConstruction_SetDegree.md) | Установить степень сплайна (может игнорироваться) |
...
|  | [SetPointWeight](M_TFlex_Model_Model2D_SplineConstruction_SetPointWeight.md) | Установить вес точки |
...
|  | [SetTolerance](M_TFlex_Model_Model2D_SplineConstruction_SetTolerance.md) | Точность |
