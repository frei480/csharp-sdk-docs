...
# ReferenceProfile - свойства  
    
Тип [ReferenceProfile](T_TFlex_Model_Model3D_ReferenceProfile.md) предоставляет следующие члены.
...
|  | [OriginalLayerName](P_TFlex_Model_Model3D_ReferenceProfile_OriginalLayerName.md) | Имя слоя, на котором объект лежит в документе фрагмента |
|  | [OriginalName](P_TFlex_Model_Model3D_ReferenceProfile_OriginalName.md) | Имя объекта в документе фрагмента |
|  | [Owner](P_TFlex_Model_Model3D_ReferenceProfile_Owner.md) | Владелец ссылочного объекта |
...
[ReferenceProfile - ](T_TFlex_Model_Model3D_ReferenceProfile.md)
