...
|  | [OriginalLayerName](P_TFlex_Model_Model3D_ReferenceLCS_OriginalLayerName.md) | Имя слоя, на котором объект лежит в документе фрагмента |
|  | [OriginalName](P_TFlex_Model_Model3D_ReferenceLCS_OriginalName.md) | Имя объекта в документе фрагмента |
|  | [Owner](P_TFlex_Model_Model3D_ReferenceLCS_Owner.md) | Владелец ссылочного объекта |
