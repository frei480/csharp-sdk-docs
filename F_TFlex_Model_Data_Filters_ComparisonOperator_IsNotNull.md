...
# ComparisonOperatorIsNotNull - поле  
...
```csharp
public static readonly ComparisonOperator IsNotNull
```
```vb
Public Shared ReadOnly IsNotNull As ComparisonOperator
```
```cpp
public:
static initonly ComparisonOperator^ IsNotNull
```
