...
|  | [Dispose(Boolean)](M_TFlex_Model_Model2D_ObjectGeometry_Dispose_1.md) | Освобождает неуправляемые ресурсы, используемые объектом [ObjectGeometry](T_TFlex_Model_Model2D_ObjectGeometry.md), а при необходимости освобождает также управляемые ресурсы |
