...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FixingVector](M_TFlex_Model_Model2D_FixingVector__ctor.md) | Конструктор по умолчанию |
...
|  | [Color](P_TFlex_Model_Model2D_FixingVector_Color.md) | Цвет объекта |
|  | [Comment](P_TFlex_Model_Model2D_FixingVector_Comment.md) | Комментарий (Имя) |
...
|  | [EndNode](P_TFlex_Model_Model2D_FixingVector_EndNode.md) | Конечный узел |
|  | [EndPoint](P_TFlex_Model_Model2D_FixingVector_EndPoint.md) | Конечная точка |
|  | [GroupType](P_TFlex_Model_Model2D_FixingVector_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Level](P_TFlex_Model_Model2D_FixingVector_Level.md) | Уровень объекта |
...
|  | [Page](P_TFlex_Model_Model2D_FixingVector_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [StartNode](P_TFlex_Model_Model2D_FixingVector_StartNode.md) | Начальный узел |
|  | [StartPoint](P_TFlex_Model_Model2D_FixingVector_StartPoint.md) | Начальная точка |
|  | [UseOnlyFirstPoint](P_TFlex_Model_Model2D_FixingVector_UseOnlyFirstPoint.md) | Использовать только первую точку |
...
|  | [FindByFragment](M_TFlex_Model_Model2D_FixingVector_FindByFragment.md) | Найти все коннекторы поднятые из фрагмента |
