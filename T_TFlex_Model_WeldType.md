...
Класс типа сварного шва

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.ModelWeldType

**Пространство имён:** [TFlex.Model](N_TFlex_Model.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class WeldType : ModelObject
```
```vb
...
```
```cpp
public ref class WeldType : public ModelObject
```


Тип WeldType предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [WeldType](M_TFlex_Model_WeldType__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Caption](P_TFlex_Model_WeldType_Caption.md) | Обозначение сварного шва |
...
|  | [GroupType](P_TFlex_Model_WeldType_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Number](P_TFlex_Model_WeldType_Number.md) | Номер типа сварного шва |
...
|  | [Standard](P_TFlex_Model_WeldType_Standard.md) | Стандарт сварного шва |
