...
# ConstraintCreateEqualLength - метод  
...
```csharp
public static Constraint CreateEqualLength(
	Document iDoc,
	Object2D iObject1,
	Object2D iObject2
)
```
```vb
Public Shared Function CreateEqualLength ( 
	iDoc As Document,
...
```cpp
public:
static Constraint^ CreateEqualLength(
	Document^ iDoc, 
	Object2D^ iObject1, 
	Object2D^ iObject2
)
