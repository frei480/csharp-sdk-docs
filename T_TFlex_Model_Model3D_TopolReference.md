...
# TopolReference - класс  
    
Базовый класс для всех типов ссылок на топологию

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DTopolReference
...
|  | [GeometryType](P_TFlex_Model_Model3D_TopolReference_GeometryType.md) | Тип геометрии |
|  | [GroupType](P_TFlex_Model_Model3D_TopolReference_GroupType.md) | Тип элемента(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Owner](P_TFlex_Model_Model3D_TopolReference_Owner.md) | Владелец |
...
|  | [Topol](P_TFlex_Model_Model3D_TopolReference_Topol.md) | Получить топологический элемент модели |
