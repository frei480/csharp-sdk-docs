...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.Model3DMaterial
...
|  | [Material(Document, String)](M_TFlex_Model_Model3D_Material__ctor_1.md) | Создать объект "Материал" из материала библиотеки |
|  | [Material(Document, MaterialParameters)](M_TFlex_Model_Model3D_Material__ctor_2.md) | Конструктор для объекта "Материал" |
...
|  | [GroupType](P_TFlex_Model_Model3D_Material_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Parameters](P_TFlex_Model_Model3D_Material_Parameters.md) | Получить свойства материала |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddToLibrary](M_TFlex_Model_Model3D_Material_AddToLibrary.md) | Добавить объект "Материал" в библиотеку |
...
|  | [CopyParameters](M_TFlex_Model_Model3D_Material_CopyParameters.md) | Копировать свойства материала |
...
|  | [GetFromLibrary](M_TFlex_Model_Model3D_Material_GetFromLibrary.md) | Получить объект "Материал" с указанным именем из библиотеки |
