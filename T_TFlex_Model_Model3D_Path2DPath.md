...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Path2DPath](M_TFlex_Model_Model3D_Path2DPath__ctor.md) | Конструктор для создания пути по набору сегментов: 2D путь и рабочая поверхность |
...
|  | [OnHatch](P_TFlex_Model_Model3D_Path2DPath_OnHatch.md) | 2D узел, задающий перемещение узла пути в 3D узел |
...
|  | [Segments](P_TFlex_Model_Model3D_Path2DPath_Segments.md) | Получить упорядоченное множество сегментов |
|  | [Target](P_TFlex_Model_Model3D_Path2DPath_Target.md) | 3D узел для привязки плоскости пути |
