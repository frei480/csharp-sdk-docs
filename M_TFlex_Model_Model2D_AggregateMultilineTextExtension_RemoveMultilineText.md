...
# AggregateMultilineTextExtensionRemoveMultilineText - метод  
    
Удалить многострочный текст по индексу

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public static void RemoveMultilineText(
...
A_1 [Int32](https://learn.microsoft.com/dotnet/api/system.int32)
