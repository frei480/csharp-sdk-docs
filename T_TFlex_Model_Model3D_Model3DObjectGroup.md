...
# Model3DObjectGroup - класс  
    
Класс группы объектов 3D модели.

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DModel3DObjectGroup
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Model3DObjectGroup](M_TFlex_Model_Model3D_Model3DObjectGroup__ctor.md) | Конструктор |
...
|  | [Items](P_TFlex_Model_Model3D_Model3DObjectGroup_Items.md) | Элементы группы |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Add](M_TFlex_Model_Model3D_Model3DObjectGroup_Add.md) | Добавление 3D объекта в группу |
...
|  | [GetItems](M_TFlex_Model_Model3D_Model3DObjectGroup_GetItems.md) |  |
...
|  | [Remove](M_TFlex_Model_Model3D_Model3DObjectGroup_Remove.md) | Удалить 3D объект из группы |
