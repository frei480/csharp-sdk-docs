...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DText](T_TFlex_Model_Model2D_Text.md) [TFlex.Model.Model2DRichText](T_TFlex_Model_Model2D_RichText.md) TFlex.Model.Model2DParagraphText
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ParagraphText](M_TFlex_Model_Model2D_ParagraphText__ctor.md) | Конструктор для создания нового параграф текста |
...
|  | [EmptyRectangleAction](P_TFlex_Model_Model2D_ParagraphText_EmptyRectangleAction.md) | Действие с пустым прямоугольником |
...
|  | [HeightAction](P_TFlex_Model_Model2D_ParagraphText_HeightAction.md) | Действие при необходимости увеличить высоту прямоугольника |
...
|  | [Page](P_TFlex_Model_Model2D_ParagraphText_Page.md) | Установить страницу(Переопределяет [TextPage](P_TFlex_Model_Model2D_Text_Page.md)) |
...
|  | [SubType](P_TFlex_Model_Model2D_ParagraphText_SubType.md) | Получение подтипа текста для задания способа его задания(Переопределяет [TextSubType](P_TFlex_Model_Model2D_Text_SubType.md)) |
...
|  | [WidthAction](P_TFlex_Model_Model2D_ParagraphText_WidthAction.md) | Действие при необходимости увеличить ширину прямоугольника |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddRectangle](M_TFlex_Model_Model2D_ParagraphText_AddRectangle.md) | Добавление прямоугольника в конец массива прямоугольников |
|  | [BeginEdit](M_TFlex_Model_Model2D_RichText_BeginEdit.md) | Начало редактирования текста(Унаследован от [RichText](T_TFlex_Model_Model2D_RichText.md)) |
...
|  | [EndEdit](M_TFlex_Model_Model2D_RichText_EndEdit.md) | Завершение редактирования текста(Унаследован от [RichText](T_TFlex_Model_Model2D_RichText.md)) |
...
|  | [GetRectangle](M_TFlex_Model_Model2D_ParagraphText_GetRectangle.md) | Получение параметров прямоугольника |
|  | [GetRectanglesCount](M_TFlex_Model_Model2D_ParagraphText_GetRectanglesCount.md) | Получение количества прямоугольников |
...
|  | [SetHeightAction](M_TFlex_Model_Model2D_ParagraphText_SetHeightAction.md) | Действие при необходимости увеличить высоту прямоугольника |
|  | [SetRectangle](M_TFlex_Model_Model2D_ParagraphText_SetRectangle.md) | Установка параметров прямоугольника |
