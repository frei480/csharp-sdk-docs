...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationUser
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [User](M_TFlex_Configuration_User__ctor.md) | Инициализирует новый экземпляр класса User |
|  | [User(IntPtr, Boolean)](M_TFlex_Configuration_User__ctor_1.md) | Инициализирует новый экземпляр класса User |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [CompanyName](P_TFlex_Configuration_User_CompanyName.md) |  |
|  | [License](P_TFlex_Configuration_User_License.md) |  |
|  | [TechnicalSupportFormPath](P_TFlex_Configuration_User_TechnicalSupportFormPath.md) |  |
|  | [UserName](P_TFlex_Configuration_User_UserName.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_User_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_User_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_User_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
