...
# Fragment2DAreModelEditorControlsBlocked - свойство  
  **Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool AreModelEditorControlsBlocked { get; set; }
```
```vb
Public Property AreModelEditorControlsBlocked As Boolean
	Get
	Set
```
```cpp
public:
property bool AreModelEditorControlsBlocked {
	bool get ();
	void set (bool value);
}
```
