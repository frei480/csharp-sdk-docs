...
# ParametricSweep - класс  
  
---  
  
Параметрическая операция

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) [TFlex.Model.Model3DSweep](T_TFlex_Model_Model3D_Sweep.md) TFlex.Model.Model3DParametricSweep
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ParametricSweep](M_TFlex_Model_Model3D_ParametricSweep__ctor.md) | Конструктор для создания параметрической операции |
...
|  | [Parametric](P_TFlex_Model_Model3D_ParametricSweep_Parametric.md) | Общие свойства параметрических объектов |
|  | [ParamType](P_TFlex_Model_Model3D_ParametricSweep_ParamType.md) | Cпособ задания параметризации |
