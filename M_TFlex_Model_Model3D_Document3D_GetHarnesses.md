...
```csharp
public static ICollection<BaseHarness3D> GetHarnesses(
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[BaseHarness3D](T_TFlex_Model_Model3D_BaseHarness3D.md)
