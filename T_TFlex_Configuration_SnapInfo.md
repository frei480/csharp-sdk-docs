...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSnapInfo
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SnapInfo](M_TFlex_Configuration_SnapInfo__ctor.md) | Инициализирует новый экземпляр класса SnapInfo |
|  | [SnapInfo(IntPtr, Boolean)](M_TFlex_Configuration_SnapInfo__ctor_1.md) | Инициализирует новый экземпляр класса SnapInfo |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Enabled](P_TFlex_Configuration_SnapInfo_Enabled.md) |  |
|  | [Priority](P_TFlex_Configuration_SnapInfo_Priority.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_SnapInfo_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_SnapInfo_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_SnapInfo_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
