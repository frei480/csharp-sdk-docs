...
|  | [ProjectionWithSection(Document, Page)](M_TFlex_Model_Model3D_ProjectionWithSection__ctor_1.md) | Конструктор для создания новой проекции |
...
|  | [HatchPrecision](P_TFlex_Model_Model3D_ProjectionWithSection_HatchPrecision.md) | Точность поиска штриховки |
|  | [HatchScale](P_TFlex_Model_Model3D_ProjectionWithSection_HatchScale.md) | Масштаб штриховки |
...
|  | [TypeOfSection](P_TFlex_Model_Model3D_ProjectionWithSection_TypeOfSection.md) | Тип сечения применяемый на проекции |
|  | [UseHatch](P_TFlex_Model_Model3D_ProjectionWithSection_UseHatch.md) | Штриховать ли разрез |
|  | [ViewSection](P_TFlex_Model_Model3D_ProjectionWithSection_ViewSection.md) | Установить сечение задающее направление взгляда |
