...
# ReflectTransformation - класс  
    
Класс преобразования симметрии

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) TFlex.Model.Model3DReflectTransformation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ReflectTransformation](M_TFlex_Model_Model3D_ReflectTransformation__ctor.md) | Конструктор для создания нового преобразования симметрии |
...
|  | [Plane](P_TFlex_Model_Model3D_ReflectTransformation_Plane.md) | Плоскость симметрии |
