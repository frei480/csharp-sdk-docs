...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DCopyOperation](T_TFlex_Model_Model2D_CopyOperation.md) TFlex.Model.Model2DSymmetryCopy

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class SymmetryCopy : CopyOperation
```
```vb
Public Class SymmetryCopy
	Inherits CopyOperation
```
```cpp
public ref class SymmetryCopy : public CopyOperation
```


Тип SymmetryCopy предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [SymmetryCopy](M_TFlex_Model_Model2D_SymmetryCopy__ctor.md) | Стандартный конструктор |
...
|  | [CopyType](P_TFlex_Model_Model2D_SymmetryCopy_CopyType.md) | Подтип операции копирования(Переопределяет [CopyOperationCopyType](P_TFlex_Model_Model2D_CopyOperation_CopyType.md)) |
...
|  | [SymmetryType](P_TFlex_Model_Model2D_SymmetryCopy_SymmetryType.md) | Тип задания оси симметрии |
...
|  | [SetLine](M_TFlex_Model_Model2D_SymmetryCopy_SetLine.md) | Установка оси симметрии по линии построения-прямой |
|  | [SetNodeAndOffset](M_TFlex_Model_Model2D_SymmetryCopy_SetNodeAndOffset.md) | Установка оси симметрии по узлу и смещению |
|  | [SetNodes](M_TFlex_Model_Model2D_SymmetryCopy_SetNodes.md) | Установка оси симметрии по двум узлам |
