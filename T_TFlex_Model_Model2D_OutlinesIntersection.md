...
# OutlinesIntersection - класс  
    
Обозначение пересечения линий изображения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DOutlinesIntersection
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OutlinesIntersection](M_TFlex_Model_Model2D_OutlinesIntersection__ctor.md) | Конструктор |
...
|  | [Form](P_TFlex_Model_Model2D_OutlinesIntersection_Form.md) | Форма пересечения |
...
|  | [Level](P_TFlex_Model_Model2D_OutlinesIntersection_Level.md) | Уровень |
|  | [LineWidth](P_TFlex_Model_Model2D_OutlinesIntersection_LineWidth.md) | Толщина линии |
...
|  | [Outline1](P_TFlex_Model_Model2D_OutlinesIntersection_Outline1.md) | Первая линия |
|  | [Outline2](P_TFlex_Model_Model2D_OutlinesIntersection_Outline2.md) | Вторая линия |
|  | [Page](P_TFlex_Model_Model2D_OutlinesIntersection_Page.md) | Страница(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [PointIndex](P_TFlex_Model_Model2D_OutlinesIntersection_PointIndex.md) | номер точки пересечения |
|  | [Size](P_TFlex_Model_Model2D_OutlinesIntersection_Size.md) | Размер |
