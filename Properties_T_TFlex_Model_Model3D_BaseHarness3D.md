...
# BaseHarness3D - свойства  
  
---  
  
Тип [BaseHarness3D](T_TFlex_Model_Model3D_BaseHarness3D.md) предоставляет следующие члены.
...
[BaseHarness3D - ](T_TFlex_Model_Model3D_BaseHarness3D.md)
