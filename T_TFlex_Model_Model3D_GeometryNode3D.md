...
|  | Имя | Описание |
| --- | --- | --- |
|  | [GeometryNode3D](M_TFlex_Model_Model3D_GeometryNode3D__ctor.md) | Конструктор для создания узла по координатам относительно другого узла |
...
|  | [BasePoint](P_TFlex_Model_Model3D_GeometryNode3D_BasePoint.md) | Узел, относительно которой строится 3D узел |
...
|  | [X](P_TFlex_Model_Model3D_GeometryNode3D_X.md) | X - координата узла относительно другого узла |
|  | [Y](P_TFlex_Model_Model3D_GeometryNode3D_Y.md) | Y - координата узла относительно другого узла |
|  | [Z](P_TFlex_Model_Model3D_GeometryNode3D_Z.md) | Z - координата узла относительно другого узла |
