...
# TermGroup(LogicalOperator) - конструктор  
  
---  
  
Инициализирует новый экземпляр класса [TermGroup](T_TFlex_Model_Data_Filters_TermGroup.md)
...
logicalOperator [LogicalOperator](T_TFlex_Model_Data_Filters_LogicalOperator.md)
...
[TermGroup - перегрузка](Overload_TFlex_Model_Data_Filters_TermGroup__ctor.md)
