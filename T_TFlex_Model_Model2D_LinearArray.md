...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DCopyOperation](T_TFlex_Model_Model2D_CopyOperation.md) TFlex.Model.Model2DLinearArray
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LinearArray](M_TFlex_Model_Model2D_LinearArray__ctor.md) | Стандартный конструктор |
...
|  | [CopyType](P_TFlex_Model_Model2D_LinearArray_CopyType.md) | Подтип операции копирования(Переопределяет [CopyOperationCopyType](P_TFlex_Model_Model2D_CopyOperation_CopyType.md)) |
...
|  | [EndNode](P_TFlex_Model_Model2D_LinearArray_EndNode.md) | Конечный узел |
|  | [EndX](P_TFlex_Model_Model2D_LinearArray_EndX.md) | X-координата конечной точки |
|  | [EndY](P_TFlex_Model_Model2D_LinearArray_EndY.md) | Y-координата конечной точки |
|  | [GroupType](P_TFlex_Model_Model2D_CopyOperation_GroupType.md) | Тип объекта "Копия"(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | [Page](P_TFlex_Model_Model2D_CopyOperation_Page.md) | Страница, на которой размещается элемент(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | [SourcesCount](P_TFlex_Model_Model2D_CopyOperation_SourcesCount.md) | Количество копируемых объектов(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
|  | [StartNode](P_TFlex_Model_Model2D_LinearArray_StartNode.md) | Начальный узел |
|  | [StartX](P_TFlex_Model_Model2D_LinearArray_StartX.md) | X-координата начальной точки |
|  | [StartY](P_TFlex_Model_Model2D_LinearArray_StartY.md) | Y-координата начальной точки |
|  | [TransformationCount](P_TFlex_Model_Model2D_CopyOperation_TransformationCount.md) | Количество преобразований копируемых объектов(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddSource](M_TFlex_Model_Model2D_CopyOperation_AddSource.md) | Добавление в копию исходного объекта(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | [DeleteAssociative](M_TFlex_Model_Model2D_CopyOperation_DeleteAssociative.md) | Удаление ассоциативного объекта(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | [Explode](M_TFlex_Model_Model2D_CopyOperation_Explode.md) | Разрушение операции(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
|  | [Finalize](https://learn.microsoft.com/dotnet/api/system.object.finalize) | Allows an object to try to free resources and perform other cleanup operations before it is reclaimed by garbage collection.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetAssociate](M_TFlex_Model_Model2D_CopyOperation_GetAssociate.md) | Получение ассоциативного объекта (результата копирования)(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | [GetSourceObject](M_TFlex_Model_Model2D_CopyOperation_GetSourceObject.md) | Получение исходного объекта(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
...
|  | [RemoveSource](M_TFlex_Model_Model2D_CopyOperation_RemoveSource.md) | Удаление исходного объекта из копии(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
|  | [Replace](M_TFlex_Model_ModelObject_Replace.md) | Заменить объект(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [RestoreDeletedAssociatives](M_TFlex_Model_Model2D_CopyOperation_RestoreDeletedAssociatives.md) | Восстановление удаленных ассоциативных объектов(Унаследован от [CopyOperation](T_TFlex_Model_Model2D_CopyOperation.md)) |
|  | [SetColumnParameters](M_TFlex_Model_Model2D_LinearArray_SetColumnParameters.md) | Установка параметров столбцов массива |
...
|  | [SetRowParameters](M_TFlex_Model_Model2D_LinearArray_SetRowParameters.md) | Установка параметров рядов массива |
