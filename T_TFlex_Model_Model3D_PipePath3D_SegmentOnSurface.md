...
# PipePath3DSegmentOnSurface - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3DPipePath3DBaseSegment](T_TFlex_Model_Model3D_PipePath3D_BaseSegment.md) TFlex.Model.Model3DPipePath3DSegmentOnSurface

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class SegmentOnSurface : PipePath3DBaseSegment
```
```vb
Public Class SegmentOnSurface
	Inherits PipePath3DBaseSegment
```
```cpp
public ref class SegmentOnSurface : public PipePath3DBaseSegment
```


Тип PipePath3DSegmentOnSurface предоставляет следующие члены.
...
|  | [Equidistant](P_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_Equidistant.md) | Управляет расстоянием до поверхности |
...
|  | [Surface](P_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_Surface.md) | Управляет поверхностью участка пути |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddBeginPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_AddBeginPoint.md) |  |
|  | [AddEndPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_AddEndPoint.md) |  |
|  | [AddPoint_begin](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_AddPoint_begin.md) | **Устарело.** |
|  | [AddPoint_end](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_AddPoint_end.md) | **Устарело.** |
...
|  | [GetBeginPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_GetBeginPoint.md) |  |
|  | [GetEndPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_GetEndPoint.md) |  |
|  | [GetHashCode](https://learn.microsoft.com/dotnet/api/system.object.gethashcode) | Serves as the default hash function. (Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetNextPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_GetNextPoint.md) |  |
|  | [GetPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_GetPoint.md) |  |
|  | [GetPrevPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_GetPrevPoint.md) |  |
|  | [GetType](https://learn.microsoft.com/dotnet/api/system.object.gettype) | Gets the [Type](https://learn.microsoft.com/dotnet/api/system.type) of the current instance.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [InsertAfterPoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_InsertAfterPoint.md) |  |
|  | [InsertBeforePoint](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_InsertBeforePoint.md) |  |
|  | [InsertPoint_after](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_InsertPoint_after.md) | **Устарело.** |
|  | [InsertPoint_before](M_TFlex_Model_Model3D_PipePath3D_SegmentOnSurface_InsertPoint_before.md) | **Устарело.** |
