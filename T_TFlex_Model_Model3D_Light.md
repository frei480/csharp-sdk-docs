...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DLight [TFlex.Model.Model3DDirectionalLight](T_TFlex_Model_Model3D_DirectionalLight.md) [TFlex.Model.Model3DPointLight](T_TFlex_Model_Model3D_PointLight.md)
...
|  | [GroupType](P_TFlex_Model_Model3D_Light_GroupType.md) | (Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Intensivity](P_TFlex_Model_Model3D_Light_Intensivity.md) | Интенсивность источника света |
...
|  | [Location](P_TFlex_Model_Model3D_Light_Location.md) | **Устарело.** Точка задающая положение источника света |
...
|  | [ShowIcon](P_TFlex_Model_Model3D_Light_ShowIcon.md) | Показывать или нет обозначение источника света в сцене |
...
|  | [UseOnFragment](P_TFlex_Model_Model3D_Light_UseOnFragment.md) | Использовать или нет источник света в сборочных документах |
