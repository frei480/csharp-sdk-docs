...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryBaseGenerator](T_TFlex_Model_Model3D_Geometry_BaseGenerator.md) [TFlex.Model.Model3D.GeometryBodyGenerator](T_TFlex_Model_Model3D_Geometry_BodyGenerator.md) TFlex.Model.Model3D.GeometrySewGenerator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SewGenerator](M_TFlex_Model_Model3D_Geometry_SewGenerator__ctor.md) | Конструктор для задания сшивки |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_SewGenerator_Run.md) | Функция генерации сшивки(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
