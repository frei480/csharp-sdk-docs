...
Класс определяет размер

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.DrawingSize
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Size](M_TFlex_Drawing_Size__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [cx](P_TFlex_Drawing_Size_cx.md) | Ширина |
|  | [cy](P_TFlex_Drawing_Size_cy.md) | Высота |
