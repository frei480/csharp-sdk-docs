...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DControl](T_TFlex_Model_Model2D_Control.md) [TFlex.Model.Model2DStaticTextControl](T_TFlex_Model_Model2D_StaticTextControl.md) TFlex.Model.Model2DLabel
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Label](M_TFlex_Model_Model2D_Label__ctor.md) | Инициализирует новый экземпляр класса Label |
