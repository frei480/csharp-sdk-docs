...
# StandardColorsSectionMark - свойство  
...
```csharp
public static Color SectionMark { get; }
```
```vb
Public Shared ReadOnly Property SectionMark As Color
	Get
```
```cpp
public:
static property Color SectionMark {
	Color get ();
}
```
