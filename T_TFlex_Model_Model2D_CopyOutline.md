...
Класс линии изображения, полученной ассоциативным копированием

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DCopyOutline
...
|  | [Source](P_TFlex_Model_Model2D_CopyOutline_Source.md) | Исходная линия изображения |
|  | [SourceCopyOperation](P_TFlex_Model_Model2D_CopyOutline_SourceCopyOperation.md) | Исходный объект-копия |
...
|  | [SubType](P_TFlex_Model_Model2D_CopyOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
|  | [Transformation](P_TFlex_Model_Model2D_CopyOutline_Transformation.md) | Преобразование |
