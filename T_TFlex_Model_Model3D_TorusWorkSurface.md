...
|  | Имя | Описание |
| --- | --- | --- |
|  | [TorusWorkSurface(Document)](M_TFlex_Model_Model3D_TorusWorkSurface__ctor.md) | Конструктор для создания тороидальной поверхности |
|  | [TorusWorkSurface(Document, Page)](M_TFlex_Model_Model3D_TorusWorkSurface__ctor_1.md) | Конструктор для создания сферической поверхности |
...
|  | [BoundQuadrant](P_TFlex_Model_Model3D_SpatialWorkSurface_BoundQuadrant.md) | Квадрант границы рабочей поверхности, если границы задаются одним узлом и границами листа(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
...
|  | [FirstBoundCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_FirstBoundCorner.md) | Первый угол границы(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
|  | [FirstUVBoxCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_FirstUVBoxCorner.md) | Начало координат параметрической области(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
|  | [Geometry](P_TFlex_Model_Model3D_SpatialWorkSurface_Geometry.md) | Получить геометрические данные специальных координатных поверхностей(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
|  | [GroupType](P_TFlex_Model_Model3D_SpatialWorkSurface_GroupType.md) | (Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
...
|  | [LCS](P_TFlex_Model_Model3D_SpatialWorkSurface_LCS.md) | Локальная система координат, в которой задаётся рабочая поверхость(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
|  | [Level](P_TFlex_Model_Model3D_Object3D_Level.md) | Уровень(Унаследован от [Object3D](T_TFlex_Model_Model3D_Object3D.md)) |
|  | [MajorRadius](P_TFlex_Model_Model3D_TorusWorkSurface_MajorRadius.md) | Первый радиус тора |
|  | [MinorRadius](P_TFlex_Model_Model3D_TorusWorkSurface_MinorRadius.md) | Второй радиус тора |
...
|  | [Orientation](P_TFlex_Model_Model3D_SpatialWorkSurface_Orientation.md) | Соответствие координатных осей и параметров(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
...
|  | [SecondBoundCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_SecondBoundCorner.md) | Второй угол границы(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
|  | [SecondUVBoxCorner](P_TFlex_Model_Model3D_SpatialWorkSurface_SecondUVBoxCorner.md) | Вторая граница области(Унаследован от [SpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md)) |
