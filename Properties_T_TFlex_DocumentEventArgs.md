...
# DocumentEventArgs - свойства  
  
---  
  
Тип [DocumentEventArgs](T_TFlex_DocumentEventArgs.md) предоставляет следующие члены.
...
[DocumentEventArgs - ](T_TFlex_DocumentEventArgs.md)
