...
Базовый класс для всех типов проекций

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) TFlex.Model.Model3DProjection [TFlex.Model.Model3DSimpleDrawingProjection](T_TFlex_Model_Model3D_SimpleDrawingProjection.md)
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Projection(Document)](M_TFlex_Model_Model3D_Projection__ctor.md) | Конструктор для создания новой проекции |
|  | [Projection(Document, Boolean, Page)](M_TFlex_Model_Model3D_Projection__ctor_1.md) | Конструктор для создания новой проекции |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Angle](P_TFlex_Model_Model3D_Projection_Angle.md) | Угол поворота проекции |
...
|  | [Bind](P_TFlex_Model_Model3D_Projection_Bind.md) | Проекция с которой берётся проекционная связь |
|  | [BoundRect](P_TFlex_Model_Model3D_Projection_BoundRect.md) | Ограничивающий прямоугольник проекции |
|  | [BrokenAmplitude](P_TFlex_Model_Model3D_Projection_BrokenAmplitude.md) | Амплитуда линии разрыва |
|  | [BrokenAngle](P_TFlex_Model_Model3D_Projection_BrokenAngle.md) | Угол поворота набора линий разрыва |
|  | [BrokenBorder](P_TFlex_Model_Model3D_Projection_BrokenBorder.md) | Длина выносной линии |
|  | [BrokenHAlign](P_TFlex_Model_Model3D_Projection_BrokenHAlign.md) | Тип горизонтального выравнивания |
|  | [BrokenLength](P_TFlex_Model_Model3D_Projection_BrokenLength.md) | Длина полупериода волны линии разрыва |
|  | [BrokenLineColor](P_TFlex_Model_Model3D_Projection_BrokenLineColor.md) | Цвет линий разрыва |
|  | [BrokenLineDistance](P_TFlex_Model_Model3D_Projection_BrokenLineDistance.md) | Расстояние между линиями разрыва |
|  | [BrokenLineName](P_TFlex_Model_Model3D_Projection_BrokenLineName.md) | Имя типа линий разрыва |
|  | [BrokenLineScale](P_TFlex_Model_Model3D_Projection_BrokenLineScale.md) | Масштаб линий разрыва |
|  | [BrokenLineWidth](P_TFlex_Model_Model3D_Projection_BrokenLineWidth.md) | Толщина линий разрыва |
|  | [BrokenMetric](P_TFlex_Model_Model3D_Projection_BrokenMetric.md) | Единицы измерения величины разрыва |
|  | [BrokenType](P_TFlex_Model_Model3D_Projection_BrokenType.md) | Тип линии разрыва |
|  | [BrokenVAlign](P_TFlex_Model_Model3D_Projection_BrokenVAlign.md) | Тип вертикального выравнивания |
...
|  | [FileLink](P_TFlex_Model_Model3D_Projection_FileLink.md) | Ссылка на файл, из которого берутся проецируемые элементы |
|  | [GroupType](P_TFlex_Model_Model3D_Projection_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layers](P_TFlex_Model_Model3D_Projection_Layers.md) | Множество слоёв |
|  | [LayersFilter](P_TFlex_Model_Model3D_Projection_LayersFilter.md) |  |
...
|  | [Page](P_TFlex_Model_Model3D_Projection_Page.md) | Страница, где отображается проекция |
...
|  | [Save3DDim](P_TFlex_Model_Model3D_Projection_Save3DDim.md) | Сохранять информацию для 3D размеров |
|  | [Scale](P_TFlex_Model_Model3D_Projection_Scale.md) | Масштаб проекции |
|  | [SourcePage](P_TFlex_Model_Model3D_Projection_SourcePage.md) | Исходная страница проекции |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddBreak](M_TFlex_Model_Model3D_Projection_AddBreak.md) | Метод для добавления информации о новом разрыве в список |
|  | [AddSection](M_TFlex_Model_Model3D_Projection_AddSection.md) |  |
...
|  | [Complete](M_TFlex_Model_Model3D_Projection_Complete.md) | Для внутреннего использования(Переопределяет [ModelObjectComplete](M_TFlex_Model_ModelObject_Complete.md)) |
...
|  | [DeleteAllBreaks](M_TFlex_Model_Model3D_Projection_DeleteAllBreaks.md) | Удаление всех разрывов |
|  | [DeleteBreak](M_TFlex_Model_Model3D_Projection_DeleteBreak.md) | Удаление разрыва |
...
|  | [Explode](M_TFlex_Model_Model3D_Projection_Explode.md) | Разрушить проекцию |
|  | [Finalize](https://learn.microsoft.com/dotnet/api/system.object.finalize) | Allows an object to try to free resources and perform other cleanup operations before it is reclaimed by garbage collection.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [FromFile](M_TFlex_Model_Model3D_Projection_FromFile.md) | Создание проекции из файла |
...
|  | [GetBrokenSize](M_TFlex_Model_Model3D_Projection_GetBrokenSize.md) | Метод для получения размера массива разрывов |
...
|  | [GetProjectedPoint](M_TFlex_Model_Model3D_Projection_GetProjectedPoint.md) | Функция возвращает 3D точку по точке на проекции |
|  | [GetProjectionTransform](M_TFlex_Model_Model3D_Projection_GetProjectionTransform.md) | Функция возвращает матрицу преобразования точки в 3d пространстве в систему координат проекции |
...
|  | [GetViewPoint](M_TFlex_Model_Model3D_Projection_GetViewPoint.md) | Опросить координаты точки проецирования |
...
|  | [ProjectPoint](M_TFlex_Model_Model3D_Projection_ProjectPoint.md) | Функция проецирует данную точку на проекцию |
|  | [Regenerate](M_TFlex_Model_Model3D_Projection_Regenerate.md) | Пометить объект как изменённый(Переопределяет [ModelObjectRegenerate(Boolean)](M_TFlex_Model_ModelObject_Regenerate.md)) |
|  | [RemoveAllSections](M_TFlex_Model_Model3D_Projection_RemoveAllSections.md) |  |
...
|  | [ScaleFitToPageSize](M_TFlex_Model_Model3D_Projection_ScaleFitToPageSize.md) | Подбор масшатаба для проекции, чтобы умещаться на странице |
|  | [SetBegin](M_TFlex_Model_Model3D_Projection_SetBegin.md) | Установка начального отступа разрыва |
|  | [SetConfiguration](M_TFlex_Model_Model3D_Projection_SetConfiguration.md) | Установить имя конфигурации |
|  | [SetEnd](M_TFlex_Model_Model3D_Projection_SetEnd.md) | Установка конечного отступа разрыва |
...
|  | [SetLatestAlgorithmVersion](M_TFlex_Model_Model3D_Projection_SetLatestAlgorithmVersion.md) |  |
|  | [SetNormal](M_TFlex_Model_Model3D_Projection_SetNormal.md) | Установка ориентации разрыва |
|  | [SetProjectionsElementsType](M_TFlex_Model_Model3D_Projection_SetProjectionsElementsType.md) |  |
...
|  | [SetTieNode](M_TFlex_Model_Model3D_Projection_SetTieNode.md) | Установить привязку проекции в соответствующий узел страницы |
|  | [SetTiePoint](M_TFlex_Model_Model3D_Projection_SetTiePoint.md) | Установить привязку проекции в соответствующую точку страницы |
...
|  | [SetViewType](M_TFlex_Model_Model3D_Projection_SetViewType.md) | Установить направление проецирования для стандартных видов |
|  | [SetViewWorkplane](M_TFlex_Model_Model3D_Projection_SetViewWorkplane.md) | Установить направление проецирования как нормаль к рабочей плоскости |
