...
# WireManipulator - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.Visual.ManipulatorsManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_Manipulator.md) TFlex.Model.Model3D.Visual.ManipulatorsWireManipulator
...
```csharp
public class WireManipulator : Manipulator
```
```vb
Public Class WireManipulator
	Inherits Manipulator
```
```cpp
public ref class WireManipulator : public Manipulator
```


Тип WireManipulator предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [WireManipulator](M_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator__ctor.md) | Инициализирует новый экземпляр класса WireManipulator |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [ActiveColor](P_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_ActiveColor.md) |  |
|  | [Color](P_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_Color.md) |  |
|  | [SelectedColor](P_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_SelectedColor.md) |  |
|  | [Size](P_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_Size.md) |  |
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_Dispose.md) | Освобождает неуправляемые ресурсы, используемые объектом WireManipulator, а при необходимости освобождает также управляемые ресурсы(Переопределяет [ManipulatorDispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_Manipulator_Dispose_1.md)) |
...
|  | [Line](M_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_Line.md) |  |
|  | [MemberwiseClone](https://learn.microsoft.com/dotnet/api/system.object.memberwiseclone) | Creates a shallow copy of the current [Object](https://learn.microsoft.com/dotnet/api/system.object).(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [Polyline](M_TFlex_Model_Model3D_Visual_Manipulators_WireManipulator_Polyline.md) |  |
