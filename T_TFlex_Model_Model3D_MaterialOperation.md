...
# MaterialOperation - класс  
    
Операция наложения материала

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DMaterialOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [MaterialOperation](M_TFlex_Model_Model3D_MaterialOperation__ctor.md) | Конструктор |
...
|  | [Count](P_TFlex_Model_Model3D_MaterialOperation_Count.md) | Число граней |
...
|  | [GroupCount](P_TFlex_Model_Model3D_MaterialOperation_GroupCount.md) | Число групп граней |
|  | [GroupType](P_TFlex_Model_Model3D_MaterialOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [AddFace(Int32, ModelFace)](M_TFlex_Model_Model3D_MaterialOperation_AddFace.md) | Добавить грань к наложению материала |
|  | [AddGroup](M_TFlex_Model_Model3D_MaterialOperation_AddGroup.md) | Добавить новую пустую группу граней к наложению материала |
...
|  | [GetFace(Int32, Int32)](M_TFlex_Model_Model3D_MaterialOperation_GetFace_1.md) | Получить грань из заданной группы граней по индексу |
|  | [GetFaceCount](M_TFlex_Model_Model3D_MaterialOperation_GetFaceCount.md) | Число граней в заданной группе |
|  | [GetFaceMaterial(Int32)](M_TFlex_Model_Model3D_MaterialOperation_GetFaceMaterial.md) | Получить материал грани по индексу |
|  | [GetFaceMaterial(Int32, Int32)](M_TFlex_Model_Model3D_MaterialOperation_GetFaceMaterial_1.md) | Получить материал грани из заданной группы граней по индексу |
...
|  | [GetMappingCoordSystem](M_TFlex_Model_Model3D_MaterialOperation_GetMappingCoordSystem.md) | Получить систему координат наложения текстуры для данной группы граней |
|  | [GetMappingType](M_TFlex_Model_Model3D_MaterialOperation_GetMappingType.md) | Получить способ наложения текстуры материала для заданной группы граней |
...
|  | [RemoveFace](M_TFlex_Model_Model3D_MaterialOperation_RemoveFace.md) | Исключить грань из операции наложения материала |
|  | [RemoveGroup](M_TFlex_Model_Model3D_MaterialOperation_RemoveGroup.md) | Удалить заданную группу граней из наложению материала |
...
|  | [SetMappingCoordSystem(Int32, Point3D, Direction, Direction, Direction)](M_TFlex_Model_Model3D_MaterialOperation_SetMappingCoordSystem.md) | Установить систему координат наложения текстуры для данной группы граней |
|  | [SetMappingType](M_TFlex_Model_Model3D_MaterialOperation_SetMappingType.md) | Установить способ наложения текстуры материала для заданной группы граней |
