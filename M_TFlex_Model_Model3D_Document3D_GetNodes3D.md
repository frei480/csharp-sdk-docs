...
```csharp
public static ICollection<Node3D> GetNodes3D(
...
[ICollection](https://learn.microsoft.com/dotnet/api/system.collections.generic.icollection-1)[Node3D](T_TFlex_Model_Model3D_Node3D.md)
