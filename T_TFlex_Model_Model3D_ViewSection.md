...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ViewSection](M_TFlex_Model_Model3D_ViewSection__ctor.md) | Конструктор для создания сечения по 3D узлам и экранной плоскости |
...
|  | [Normal](P_TFlex_Model_Model3D_ViewSection_Normal.md) | Получить вектор номали к экранной плоскости |
...
|  | [Origin](P_TFlex_Model_Model3D_ViewSection_Origin.md) | Получить точку, лежащую на экранной плоскости |
...
|  | [Points](P_TFlex_Model_Model3D_ViewSection_Points.md) | Множество точек. Ломанная, построенная на последовательности проекций этих точек на плоскость сечения образуют контур сечения |
