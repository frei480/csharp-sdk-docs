...
# CircleToCircleAxisOutline - класс  
  
---  
  
Линия изображения - ось между двумя окружностями

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DCircleToCircleAxisOutline

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class CircleToCircleAxisOutline : Outline
```
```vb
Public Class CircleToCircleAxisOutline
	Inherits Outline
```
```cpp
public ref class CircleToCircleAxisOutline : public Outline
```


Тип CircleToCircleAxisOutline предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [CircleToCircleAxisOutline](M_TFlex_Model_Model2D_CircleToCircleAxisOutline__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AxisType](P_TFlex_Model_Model2D_CircleToCircleAxisOutline_AxisType.md) | Тип оси |
...
|  | [Source1Outline](P_TFlex_Model_Model2D_CircleToCircleAxisOutline_Source1Outline.md) | Первая исходная линия изображения |
|  | [Source2Outline](P_TFlex_Model_Model2D_CircleToCircleAxisOutline_Source2Outline.md) | Вторая исходная линия изображения |
...
|  | [SubType](P_TFlex_Model_Model2D_CircleToCircleAxisOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
