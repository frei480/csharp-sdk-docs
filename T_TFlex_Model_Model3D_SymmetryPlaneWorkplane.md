...
|  | [SymmetryPlaneWorkplane(Document, Page)](M_TFlex_Model_Model3D_SymmetryPlaneWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [FirstPlane](P_TFlex_Model_Model3D_SymmetryPlaneWorkplane_FirstPlane.md) | Первая плоскость |
...
|  | [Ratio](P_TFlex_Model_Model3D_SymmetryPlaneWorkplane_Ratio.md) | Отношение |
...
|  | [SecondPlane](P_TFlex_Model_Model3D_SymmetryPlaneWorkplane_SecondPlane.md) | Вторая плоскость |
