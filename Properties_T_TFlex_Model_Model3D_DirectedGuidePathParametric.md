...
# DirectedGuidePathParametric - свойства  
  
---  
  
Тип [DirectedGuidePathParametric](T_TFlex_Model_Model3D_DirectedGuidePathParametric.md) предоставляет следующие члены.
