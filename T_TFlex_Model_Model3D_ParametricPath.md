...
```
```cpp
public ref class ParametricPath : public Path3D
```


Тип ParametricPath предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [ParametricPath](M_TFlex_Model_Model3D_ParametricPath__ctor.md) | Конструктор для создания параметрического пути |
...
|  | [GeneratrixPoint](P_TFlex_Model_Model3D_ParametricPath_GeneratrixPoint.md) | Образующая точка |
...
|  | [Parametric](P_TFlex_Model_Model3D_ParametricPath_Parametric.md) | Общие свойства параметрических объектов |
|  | [ParamType](P_TFlex_Model_Model3D_ParametricPath_ParamType.md) | Способ задания параметризации |
