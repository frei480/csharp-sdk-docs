...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_FaceFaceBlendGenerator_Dispose.md) | (Переопределяет [BaseGeneratorDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Dispose_1.md)) |
