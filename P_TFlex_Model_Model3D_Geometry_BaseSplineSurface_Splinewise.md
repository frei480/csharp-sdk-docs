...
# BaseSplineSurfaceSplinewise - свойство  
...
```csharp
SurfaceSplinewiseData Splinewise { get; }
```
```vb
ReadOnly Property Splinewise As SurfaceSplinewiseData
	Get
```
```cpp
property SurfaceSplinewiseData^ Splinewise {
