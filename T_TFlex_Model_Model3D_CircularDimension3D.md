...
# CircularDimension3D - класс  
    
Размер на окружности на 3D

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DDimension](T_TFlex_Model_Model2D_Dimension.md) [TFlex.Model.Model2DCircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md) TFlex.Model.Model3DCircularDimension3D

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class CircularDimension3D : CircularDimensionBase
```
```vb
Public Class CircularDimension3D
	Inherits CircularDimensionBase
```
```cpp
public ref class CircularDimension3D : public CircularDimensionBase
```


Тип CircularDimension3D предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [CircularDimension3D](M_TFlex_Model_Model3D_CircularDimension3D__ctor.md) | Конструктор по умолчанию |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model2D_CircularDimensionBase_Accuracy.md) | Точность(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltAccuracy](P_TFlex_Model_Model2D_CircularDimensionBase_AltAccuracy.md) | Точность для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltLocation](P_TFlex_Model_Model2D_CircularDimensionBase_AltLocation.md) | Расположение альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltMinDigits](P_TFlex_Model_Model2D_CircularDimensionBase_AltMinDigits.md) | Минимальное количество знаков после запятой для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltScaleFactor](P_TFlex_Model_Model2D_CircularDimensionBase_AltScaleFactor.md) | Величина дополнительного масштабирования альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltScaleFactorType](P_TFlex_Model_Model2D_CircularDimensionBase_AltScaleFactorType.md) | Тип дополнительного масштабирования альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltSeparator](P_TFlex_Model_Model2D_CircularDimensionBase_AltSeparator.md) | Тип разделителя для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTextAfter](P_TFlex_Model_Model2D_CircularDimensionBase_AltTextAfter.md) | Текст после числа альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTextBefore](P_TFlex_Model_Model2D_CircularDimensionBase_AltTextBefore.md) | Текст перед числом альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTextParameters](P_TFlex_Model_Model2D_CircularDimensionBase_AltTextParameters.md) | Параметры для отображения в тексте альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTolerLetters](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerLetters.md) | Поле допуска с квалитетом для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTolerLowerDev](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerLowerDev.md) | Величина нижнего отклонения допуска для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTolerType](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerType.md) | Тип задания допуска для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltTolerUpperDev](P_TFlex_Model_Model2D_CircularDimensionBase_AltTolerUpperDev.md) | Величина верхнего отклонения допуска для альтернативного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [AltUnits](P_TFlex_Model_Model2D_CircularDimensionBase_AltUnits.md) | Тип единиц измерения(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [CircularDimType](P_TFlex_Model_Model2D_CircularDimensionBase_CircularDimType.md) | Подтип размера на окружности(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [Cross](P_TFlex_Model_Model2D_CircularDimensionBase_Cross.md) | Состояние флага отображения крестика(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [Dual](P_TFlex_Model_Model2D_CircularDimensionBase_Dual.md) | Режим отображения двойного размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [EndArrowSize](P_TFlex_Model_Model2D_CircularDimensionBase_EndArrowSize.md) | Размер конечной стрелки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [EndArrowType](P_TFlex_Model_Model2D_CircularDimensionBase_EndArrowType.md) | Типа конечной стрелки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [FitLetters](P_TFlex_Model_Model2D_CircularDimensionBase_FitLetters.md) | Поле посадки с квалитетом(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [FitLowerDev](P_TFlex_Model_Model2D_CircularDimensionBase_FitLowerDev.md) | Величина нижнего отклонения посадки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [FitUpperDev](P_TFlex_Model_Model2D_CircularDimensionBase_FitUpperDev.md) | Величина верхнего отклонения посадки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [FitView](P_TFlex_Model_Model2D_CircularDimensionBase_FitView.md) | Вид посадки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [IsExternal](P_TFlex_Model_Model3D_CircularDimension3D_IsExternal.md) | Управление параметром "Внешний" 3D-размера |
...
|  | [MinDigits](P_TFlex_Model_Model2D_CircularDimensionBase_MinDigits.md) | Минимальное число знаков после запятой(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [OutsideArrows](P_TFlex_Model_Model2D_CircularDimensionBase_OutsideArrows.md) | Состояние флага отображения стрелок с внешней стороны(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [PlaceFit](P_TFlex_Model_Model2D_CircularDimensionBase_PlaceFit.md) | Параметр отображения посадки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [PrefixSymbol](P_TFlex_Model_Model2D_CircularDimensionBase_PrefixSymbol.md) | Символ перед размерным числом(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [ScaleFactor](P_TFlex_Model_Model2D_CircularDimensionBase_ScaleFactor.md) | Величина дополнительного масштабирования размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [ScaleFactorType](P_TFlex_Model_Model2D_CircularDimensionBase_ScaleFactorType.md) | Тип дополнительного масштабирования размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [Standard](P_TFlex_Model_Model2D_CircularDimensionBase_Standard.md) | Тип стандарта размера(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [StartArrowSize](P_TFlex_Model_Model2D_CircularDimensionBase_StartArrowSize.md) | Размер начальной стрелки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [StartArrowType](P_TFlex_Model_Model2D_CircularDimensionBase_StartArrowType.md) | Тип начальной стрелки(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [StringsOffset](P_TFlex_Model_Model2D_CircularDimensionBase_StringsOffset.md) | Величина смещения строк от размерной линии(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [SubType](P_TFlex_Model_Model3D_CircularDimension3D_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [TolerAutomatic](P_TFlex_Model_Model2D_CircularDimensionBase_TolerAutomatic.md) | Указывает на то, что допуск будет рассчитываться автоматически(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [TolerLetters](P_TFlex_Model_Model2D_CircularDimensionBase_TolerLetters.md) | Поле допуска с квалитетом(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [TolerLowerDev](P_TFlex_Model_Model2D_CircularDimensionBase_TolerLowerDev.md) | Величина нижнего отклонения допуска(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [TolerSize](P_TFlex_Model_Model2D_CircularDimensionBase_TolerSize.md) | Тип отображения допуска(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [TolerUpperDev](P_TFlex_Model_Model2D_CircularDimensionBase_TolerUpperDev.md) | Величина верхнего отклонения допуска(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [Units](P_TFlex_Model_Model2D_CircularDimensionBase_Units.md) | Тип единиц измерения(Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
...
|  | [CreateProjected](M_TFlex_Model_Model3D_CircularDimension3D_CreateProjected.md) | Создание проекции размера |
...
|  | [SetDiametralDimensionType(DiametralDimensionType)](M_TFlex_Model_Model3D_CircularDimension3D_SetDiametralDimensionType.md) | Установка размера, как диаметрального |
|  | [SetDiametralDimensionType(DiametralDimensionType, Boolean)](M_TFlex_Model_Model2D_CircularDimensionBase_SetDiametralDimensionType.md) | (Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [SetElement](M_TFlex_Model_Model3D_CircularDimension3D_SetElement.md) | Установка привязок размера к 3D элементам |
...
|  | [SetOffsets(Node, Double, Double)](M_TFlex_Model_Model2D_CircularDimensionBase_SetOffsets.md) | (Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
|  | [SetRadialDimensionType(RadialDimensionType)](M_TFlex_Model_Model3D_CircularDimension3D_SetRadialDimensionType.md) | Установка размера, как радиального |
|  | [SetRadialDimensionType(RadialDimensionType, Boolean)](M_TFlex_Model_Model2D_CircularDimensionBase_SetRadialDimensionType.md) | (Унаследован от [CircularDimensionBase](T_TFlex_Model_Model2D_CircularDimensionBase.md)) |
