...
Объект "Условное обозначение на линии связи"

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.CircuitsLinkSymbol
...
|  | [CanDraw](P_TFlex_Model_Circuits_LinkSymbol_CanDraw.md) | Управление отрисовкой |
...
|  | [GroupType](P_TFlex_Model_Circuits_LinkSymbol_GroupType.md) | (Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Page](P_TFlex_Model_Circuits_LinkSymbol_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [GetConnectors](M_TFlex_Model_Circuits_LinkSymbol_GetConnectors.md) | Получить коннекторы |
...
|  | [GetLinks](M_TFlex_Model_Circuits_LinkSymbol_GetLinks.md) | Получить линии связи, к которым привязан символ |
