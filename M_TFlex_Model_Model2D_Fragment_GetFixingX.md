...
```csharp
public double GetFixingX(
	int index
)
```
```vb
Public Function GetFixingX ( 
	index As Integer
) As Double
```
```cpp
...
[Double](https://learn.microsoft.com/dotnet/api/system.double)Координата X точки привязки
