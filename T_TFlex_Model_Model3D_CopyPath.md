...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CopyPath](M_TFlex_Model_Model3D_CopyPath__ctor.md) | Конструктор для создания копии пути |
...
|  | [EndPoint](P_TFlex_Model_Model3D_CopyPath_EndPoint.md) | Конечная граница копирования |
...
|  | [SourceLCS](P_TFlex_Model_Model3D_CopyPath_SourceLCS.md) | Исходная локальная система координат |
|  | [SourcePath3D](P_TFlex_Model_Model3D_CopyPath_SourcePath3D.md) | Копируемый путь |
|  | [StartPoint](P_TFlex_Model_Model3D_CopyPath_StartPoint.md) | Начальная граница копирования |
|  | [TargetLCS](P_TFlex_Model_Model3D_CopyPath_TargetLCS.md) | Целевая локальная система координат |
