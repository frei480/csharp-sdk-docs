...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OffsetPath](M_TFlex_Model_Model3D_OffsetPath__ctor.md) | Конструктор для создания пути как смещения к плоской проволочной модели |
...
|  | [BreakFillType](P_TFlex_Model_Model3D_OffsetPath_BreakFillType.md) | Способ обработки разрывов |
...
|  | [Offset](P_TFlex_Model_Model3D_OffsetPath_Offset.md) | Значение смещения |
|  | [OffsetPoint](P_TFlex_Model_Model3D_OffsetPath_OffsetPoint.md) | Точка, определяющая значение смещения |
...
|  | [PlanarWire](P_TFlex_Model_Model3D_OffsetPath_PlanarWire.md) | Проволочная модель |
|  | [RemoveLoops](P_TFlex_Model_Model3D_OffsetPath_RemoveLoops.md) | Удалять петли |
