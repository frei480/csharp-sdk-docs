...
# SegmentSplineToPoint - свойства  
  
---  
  
Тип [PipePath3DSegmentSplineToPoint](T_TFlex_Model_Model3D_PipePath3D_SegmentSplineToPoint.md) предоставляет следующие члены.
