...
# ImportedOperation - класс  
  
---  
  
Операция "Внешняя модель"

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DImportedOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ImportedOperation](M_TFlex_Model_Model3D_ImportedOperation__ctor.md) | Конструктор для операции "Внешняя модель" |
...
|  | [FileName](P_TFlex_Model_Model3D_ImportedOperation_FileName.md) | Имя файла внешней модели |
...
|  | [GroupType](P_TFlex_Model_Model3D_ImportedOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [MaterialsFromSource](P_TFlex_Model_Model3D_ImportedOperation_MaterialsFromSource.md) | Значение свойства "С учётом материалов" |
...
|  | [PathName](P_TFlex_Model_Model3D_ImportedOperation_PathName.md) | Путь к файлу внешней модели |
|  | [SaveGeometry](P_TFlex_Model_Model3D_ImportedOperation_SaveGeometry.md) | Значение свойства "Сохранять геометрию" |
|  | [SourceLCS](P_TFlex_Model_Model3D_ImportedOperation_SourceLCS.md) | Исходная система коодинат |
|  | [SourcePath](P_TFlex_Model_Model3D_ImportedOperation_SourcePath.md) | Путь к файлу-источнику, из которого выгружена в обменный файл внешняя модель |
...
|  | [TargetLCS](P_TFlex_Model_Model3D_ImportedOperation_TargetLCS.md) | Целевая система коодинат |
...
|  | [Create(Document, BasePoint3D, BasePoint3D, BasePoint3D)](M_TFlex_Model_Model3D_ImportedOperation_Create_1.md) | Конструктор для операции "Внешняя модель" |
|  | [CreateBSplineSurfaceConstrained](M_TFlex_Model_Model3D_ImportedOperation_CreateBSplineSurfaceConstrained.md) |  |
...
|  | [CreateSew](M_TFlex_Model_Model3D_ImportedOperation_CreateSew.md) |  |
...
|  | [OpenSource](M_TFlex_Model_Model3D_ImportedOperation_OpenSource.md) | Открыть файл-источник |
