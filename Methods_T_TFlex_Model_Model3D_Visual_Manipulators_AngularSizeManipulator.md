...
# AngularSizeManipulator - методы  
    
Тип [AngularSizeManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_AngularSizeManipulator_Dispose.md) | (Переопределяет [ManipulatorDispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_Manipulator_Dispose_1.md)) |
