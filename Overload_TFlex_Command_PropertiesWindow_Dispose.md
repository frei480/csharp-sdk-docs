...
|  | [Dispose(Boolean)](M_TFlex_Command_PropertiesWindow_Dispose_1.md) | Освобождает неуправляемые ресурсы, используемые объектом [PropertiesWindow](T_TFlex_Command_PropertiesWindow.md), а при необходимости освобождает также управляемые ресурсы |
