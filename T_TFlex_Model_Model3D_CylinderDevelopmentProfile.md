...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CylinderDevelopmentProfile](M_TFlex_Model_Model3D_CylinderDevelopmentProfile__ctor.md) | Конструктор для создания развёртки грани на цилиндрической поверхности |
...
|  | [Face](P_TFlex_Model_Model3D_CylinderDevelopmentProfile_Face.md) | Разворачиваемая грань |
...
|  | [PointOnFace](P_TFlex_Model_Model3D_CylinderDevelopmentProfile_PointOnFace.md) | Точка на грани |
|  | [SectionCurve](P_TFlex_Model_Model3D_CylinderDevelopmentProfile_SectionCurve.md) | Кривая, вдоль которой разрезается замкнутая грань |
|  | [SectionIsolineAngle](P_TFlex_Model_Model3D_CylinderDevelopmentProfile_SectionIsolineAngle.md) | Угол, определяющий изопараметрическую прямую, вдоль которой разрезается замкнутая грань |
|  | [SectionIsolinePoint](P_TFlex_Model_Model3D_CylinderDevelopmentProfile_SectionIsolinePoint.md) | Точка, через которую проходит изопараметрическая прямая, вдоль которой разрезается замкнутая грань |
