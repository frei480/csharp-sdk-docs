...
# SpecialBoxManipulator - методы  
  
---  
  
Тип [SpecialBoxManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_SpecialBoxManipulator.md) предоставляет следующие члены.
