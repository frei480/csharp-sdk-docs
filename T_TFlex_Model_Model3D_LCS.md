...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LCS](M_TFlex_Model_Model3D_LCS__ctor.md) | Инициализирует новый экземпляр класса LCS |
...
|  | [Comment](P_TFlex_Model_Model3D_LCS_Comment.md) | Комментарий |
|  | [ConnectorParameters](P_TFlex_Model_Model3D_LCS_ConnectorParameters.md) |  |
...
|  | [Geometry](P_TFlex_Model_Model3D_LCS_Geometry.md) | Геометрические данные системы координат |
|  | [GroupType](P_TFlex_Model_Model3D_LCS_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Info](P_TFlex_Model_Model3D_LCS_Info.md) |  |
...
|  | [UseForFragmentFixing](P_TFlex_Model_Model3D_LCS_UseForFragmentFixing.md) | Значение свойства "Использовать для привязки фрагмента" |
...
|  | [ChangeConnectorParameters](M_TFlex_Model_Model3D_LCS_ChangeConnectorParameters.md) |  |
...
|  | [IsConnector](M_TFlex_Model_Model3D_LCS_IsConnector.md) |  |
...
|  | [TestCompatibility(LCS, LCS)](M_TFlex_Model_Model3D_LCS_TestCompatibility.md) | Проверить совместимость типов, объект и объект |
|  | [TestCompatibility(LCS, Path3D)](M_TFlex_Model_Model3D_LCS_TestCompatibility_1.md) | Проверить совместимость типов, объект и трасса |
