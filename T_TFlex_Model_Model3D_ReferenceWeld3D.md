...
# ReferenceWeld3D - класс  
    
Класс для представления ссылочного 3D-сварного шва

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DWeld3D](T_TFlex_Model_Model3D_Weld3D.md) TFlex.Model.Model3DReferenceWeld3D
...
|  | [GroupType](P_TFlex_Model_Model3D_Weld3D_GroupType.md) | Тип объекта(Унаследован от [Weld3D](T_TFlex_Model_Model3D_Weld3D.md)) |
...
|  | [Length](P_TFlex_Model_Model3D_Weld3D_Length.md) | Длина сварного шва(Унаследован от [Weld3D](T_TFlex_Model_Model3D_Weld3D.md)) |
...
|  | [OriginalLayerName](P_TFlex_Model_Model3D_ReferenceWeld3D_OriginalLayerName.md) | Имя слоя, на котором объект лежит в документе фрагмента |
|  | [OriginalName](P_TFlex_Model_Model3D_ReferenceWeld3D_OriginalName.md) | Имя объекта в документе фрагмента |
|  | [Owner](P_TFlex_Model_Model3D_ReferenceWeld3D_Owner.md) | Владелец ссылочного объекта |
...
|  | [Weld2D](P_TFlex_Model_Model3D_Weld3D_Weld2D.md) | 2D-сварной шов, связанный с этим 3D-швом(Унаследован от [Weld3D](T_TFlex_Model_Model3D_Weld3D.md)) |
|  | [WeldType](P_TFlex_Model_Model3D_Weld3D_WeldType.md) | Тип сварного шва(Унаследован от [Weld3D](T_TFlex_Model_Model3D_Weld3D.md)) |
