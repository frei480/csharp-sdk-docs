...
|  | Имя | Описание |
| --- | --- | --- |
|  | [RelationPoint](M_TFlex_Model_Model3D_RelationPoint__ctor.md) | Конструктор для создания узла по наименьшему расстоянию между элементами |
...
|  | [FirstElement](P_TFlex_Model_Model3D_RelationPoint_FirstElement.md) | **Устарело.** Первый элемент, на котором ищется ближайшая точка |
...
|  | [Ratio](P_TFlex_Model_Model3D_RelationPoint_Ratio.md) | Коэффициент |
|  | [SecondElement](P_TFlex_Model_Model3D_RelationPoint_SecondElement.md) | **Устарело.** Второй элемент, относительно которого ищется ближайшая точка |
...
|  | [AddElement(Object3D)](M_TFlex_Model_Model3D_RelationPoint_AddElement_1.md) | Добавить элемент |
...
|  | [GetElement](M_TFlex_Model_Model3D_RelationPoint_GetElement.md) | Получить элемент |
|  | [GetElementCount](M_TFlex_Model_Model3D_RelationPoint_GetElementCount.md) | Получить количество элементов |
...
|  | [RemoveElement](M_TFlex_Model_Model3D_RelationPoint_RemoveElement.md) | Удалить элемент |
