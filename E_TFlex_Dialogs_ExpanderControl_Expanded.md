...
# ExpanderControlExpanded - событие  
...
```csharp
public event EventHandler<BaseEventArgs> Expanded
```
```vb
Public Event Expanded As EventHandler(Of BaseEventArgs)
```
```cpp
public:
 event EventHandler<BaseEventArgs^>^ Expanded {
