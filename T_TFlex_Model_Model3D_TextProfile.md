...
|  | Имя | Описание |
| --- | --- | --- |
|  | [TextProfile](M_TFlex_Model_Model3D_TextProfile__ctor.md) | Конструктор для создания профиля по тексту и рабочей поверхности |
...
|  | [OnText](P_TFlex_Model_Model3D_TextProfile_OnText.md) | 2D узел, задающий перемещение узла контура в 3D узел |
...
|  | [Target](P_TFlex_Model_Model3D_TextProfile_Target.md) | 3D узел для привязки плоскости контура |
|  | [Text](P_TFlex_Model_Model3D_TextProfile_Text.md) | Текст, задающий форму профиля |
...
|  | [WorkSurface](P_TFlex_Model_Model3D_TextProfile_WorkSurface.md) | Рабочая поверхность, задающую положение профиля |
