...
|  | [CircularArrayOperation(Document, ArrayOperationType)](M_TFlex_Model_Model3D_CircularArrayOperation__ctor_1.md) | Конструктор для операции "Круговой массив" |
...
|  | [Axis](P_TFlex_Model_Model3D_CircularArrayOperation_Axis.md) | Ось кругового массива |
...
|  | [GroupType](P_TFlex_Model_Model3D_CircularArrayOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [OffsetByRadius](P_TFlex_Model_Model3D_CircularArrayOperation_OffsetByRadius.md) | Использование перемещения по радиусу или оси при построении двумерного кругового массива |
|  | [OffsetLength](P_TFlex_Model_Model3D_CircularArrayOperation_OffsetLength.md) | Длина перемещения кругового массива |
|  | [OffsetLengthFromVector](P_TFlex_Model_Model3D_CircularArrayOperation_OffsetLengthFromVector.md) | Свойство "получать длину перемещения кругового массива с вектора направления" |
|  | [OffsetStep](P_TFlex_Model_Model3D_CircularArrayOperation_OffsetStep.md) | Шаг перемещения кругового массива |
|  | [OffsetStepFromVector](P_TFlex_Model_Model3D_CircularArrayOperation_OffsetStepFromVector.md) | Свойство "получать шаг перемещения кругового массива с вектора направления" |
|  | [OffsetType](P_TFlex_Model_Model3D_CircularArrayOperation_OffsetType.md) | Тип использования значений для перемещения |
...
|  | [ParallelTransfer](P_TFlex_Model_Model3D_CircularArrayOperation_ParallelTransfer.md) | Свойство "Параллельный перенос" |
...
|  | [RotateAngle](P_TFlex_Model_Model3D_CircularArrayOperation_RotateAngle.md) | Общий угол кругового массива |
|  | [RotateAngleFromVector](P_TFlex_Model_Model3D_CircularArrayOperation_RotateAngleFromVector.md) | Свойство "получать общий угол кругового массива с точек, задающих начальную и конечную точку вращения" |
|  | [RotateBeginPoint](P_TFlex_Model_Model3D_CircularArrayOperation_RotateBeginPoint.md) | Начальная точка вращения |
|  | [RotateEndPoint](P_TFlex_Model_Model3D_CircularArrayOperation_RotateEndPoint.md) | Конечная точка вращения |
|  | [RotatePoint1](P_TFlex_Model_Model3D_CircularArrayOperation_RotatePoint1.md) | Первая точка, задающая ось кругового массива |
|  | [RotatePoint2](P_TFlex_Model_Model3D_CircularArrayOperation_RotatePoint2.md) | Вторая точка, задающая ось кругового массива |
|  | [RotateStep](P_TFlex_Model_Model3D_CircularArrayOperation_RotateStep.md) | Угловой шаг кругового массива |
|  | [RotateStepFromVector](P_TFlex_Model_Model3D_CircularArrayOperation_RotateStepFromVector.md) | Свойство "получать угловой шаг кругового массива с точек, задающих начальную и конечную точку вращения" |
|  | [RotateType](P_TFlex_Model_Model3D_CircularArrayOperation_RotateType.md) | Тип использования значений для вращения |
