...
Параметры для поверхностей

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model3D.GeometryUV
...
```
```cpp
public value class UV
```


Тип UV предоставляет следующие члены.
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [U](F_TFlex_Model_Model3D_Geometry_UV_U.md) | Параметр U |
|  | [V](F_TFlex_Model_Model3D_Geometry_UV_V.md) | Параметр V |
