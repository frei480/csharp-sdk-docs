...
|  | [SubType](P_TFlex_Model_Model2D_CircularDimension_SubType.md) | Подтип размера(Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [SetDiametral](M_TFlex_Model_Model2D_CircularDimension_SetDiametral.md) | Установка диаметрального размера |
|  | [SetDiametralDimensionType(DiametralDimensionType)](M_TFlex_Model_Model2D_CircularDimension_SetDiametralDimensionType.md) | Установка размера, как диаметрального |
...
|  | [SetOffsets](M_TFlex_Model_Model2D_CircularDimension_SetOffsets.md) | Установка положения размера на окружности |
|  | [SetRadial](M_TFlex_Model_Model2D_CircularDimension_SetRadial.md) | Установка радиального размера |
|  | [SetRadialDimensionType(RadialDimensionType)](M_TFlex_Model_Model2D_CircularDimension_SetRadialDimensionType.md) | Установка размера, как радиального |
...
|  | [SetShortenedRadial](M_TFlex_Model_Model2D_CircularDimension_SetShortenedRadial.md) | Установка радиального размера с изломом размерной линии |
