...
|  | Имя | Описание |
| --- | --- | --- |
|  | [GroupControl](M_TFlex_Dialogs_GroupControl__ctor.md) | Инициализирует новый экземпляр класса GroupControl |
|  | [GroupControl(String)](M_TFlex_Dialogs_GroupControl__ctor_1.md) | Инициализирует новый экземпляр класса GroupControl |
|  | [GroupControl(String, GroupControlOrientation)](M_TFlex_Dialogs_GroupControl__ctor_2.md) | Инициализирует новый экземпляр класса GroupControl |
...
|  | [Orientation](P_TFlex_Dialogs_GroupControl_Orientation.md) | Устанавливает ориентацию группы |
