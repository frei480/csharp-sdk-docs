...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LCSPoint](M_TFlex_Model_Model3D_LCSPoint__ctor.md) | Конструктор для создания точки по координатам относительно системы координат |
...
|  | [LCS](P_TFlex_Model_Model3D_LCSPoint_LCS.md) | Система координат, относительно которой строится 3D узел |
...
|  | [X](P_TFlex_Model_Model3D_LCSPoint_X.md) | X - координата узла относительно ЛСК |
|  | [Y](P_TFlex_Model_Model3D_LCSPoint_Y.md) | Y - координата узла относительно ЛСК |
|  | [Z](P_TFlex_Model_Model3D_LCSPoint_Z.md) | Z - координата узла относительно ЛСК |
