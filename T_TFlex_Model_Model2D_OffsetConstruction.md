...
# OffsetConstruction - класс  
  
---  
  
Линия построения - эквидистанта

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DConstruction](T_TFlex_Model_Model2D_Construction.md) TFlex.Model.Model2DOffsetConstruction
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OffsetConstruction](M_TFlex_Model_Model2D_OffsetConstruction__ctor.md) | Конструктор по умолчанию |
...
|  | [GeometryType](P_TFlex_Model_Model2D_OffsetConstruction_GeometryType.md) | Тип геометрии линии построения(Переопределяет [ConstructionGeometryType](P_TFlex_Model_Model2D_Construction_GeometryType.md)) |
...
|  | [Offset](P_TFlex_Model_Model2D_OffsetConstruction_Offset.md) | Смещение эквидистанты |
|  | [OffsetNode](P_TFlex_Model_Model2D_OffsetConstruction_OffsetNode.md) | Узел, задающий смещение |
...
|  | [Source](P_TFlex_Model_Model2D_OffsetConstruction_Source.md) | Исходная линия построения |
|  | [SubType](P_TFlex_Model_Model2D_OffsetConstruction_SubType.md) | Подтип линии построения(Переопределяет [ConstructionSubType](P_TFlex_Model_Model2D_Construction_SubType.md)) |
