...
```csharp
public class WinFormsWindow : NativeWindow
```
```vb
Public Class WinFormsWindow
	Inherits NativeWindow
```
```cpp
public ref class WinFormsWindow : public NativeWindow
```


Тип WinFormsWindow предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [WinFormsWindow](M_TFlex_Dialogs_WinFormsWindow__ctor.md) | Инициализирует новый экземпляр класса WinFormsWindow |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Control](P_TFlex_Dialogs_WinFormsWindow_Control.md) |  |
