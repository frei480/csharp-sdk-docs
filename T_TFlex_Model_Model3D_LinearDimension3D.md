...
|  | Имя | Описание |
| --- | --- | --- |
|  | [LinearDimension3D](M_TFlex_Model_Model3D_LinearDimension3D__ctor.md) | Конструктор по умолчанию |
...
|  | [IsExternal](P_TFlex_Model_Model3D_LinearDimension3D_IsExternal.md) | Управление параметром "Внешний" 3D-размера |
...
|  | [SubType](P_TFlex_Model_Model3D_LinearDimension3D_SubType.md) | (Переопределяет [DimensionSubType](P_TFlex_Model_Model2D_Dimension_SubType.md)) |
...
|  | [CreateBaseDimensions](M_TFlex_Model_Model3D_LinearDimension3D_CreateBaseDimensions.md) |  |
|  | [CreateObject](M_TFlex_Model_Model2D_Object2D_CreateObject.md) | (Унаследован от [Object2D](T_TFlex_Model_Model2D_Object2D.md)) |
|  | [CreateProjected](M_TFlex_Model_Model3D_LinearDimension3D_CreateProjected.md) | Создание проекции размера |
...
|  | [SetElements](M_TFlex_Model_Model3D_LinearDimension3D_SetElements.md) | Установка привязок размера к 3D элементам |
...
|  | [SetLeaderNote](M_TFlex_Model_Model3D_LinearDimension3D_SetLeaderNote.md) | Установка привязок размера по относительным смещениям |
|  | [SetOffsets](M_TFlex_Model_Model3D_LinearDimension3D_SetOffsets.md) | Установка привязок размера по относительным смещениям |
|  | [SetOrientationPlane](M_TFlex_Model_Model3D_LinearDimension3D_SetOrientationPlane.md) | Установка плоскости ориентации 3D размера |
