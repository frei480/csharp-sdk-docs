...
|  | Имя | Описание |
| --- | --- | --- |
|  | [IntersectionPath](M_TFlex_Model_Model3D_IntersectionPath__ctor.md) | Конструктор для создания пути на пересечении |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AsSurface](P_TFlex_Model_Model3D_IntersectionPath_AsSurface.md) | Как поверхность |
...
|  | [ExtendPath](P_TFlex_Model_Model3D_IntersectionPath_ExtendPath.md) | Продлевать 3D путь |
...
|  | [MergeAdjacent](P_TFlex_Model_Model3D_IntersectionPath_MergeAdjacent.md) | Объединять смежные участки |
...
|  | [SolutionIndex](P_TFlex_Model_Model3D_IntersectionPath_SolutionIndex.md) | Индекс решения |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddSecondElement](M_TFlex_Model_Model3D_IntersectionPath_AddSecondElement.md) | Добавить второй элемент |
...
|  | [CountSecondElements](M_TFlex_Model_Model3D_IntersectionPath_CountSecondElements.md) | Количество вторых элементов |
...
|  | [GetFirstElement](M_TFlex_Model_Model3D_IntersectionPath_GetFirstElement.md) | Получить первый элемент |
...
|  | [GetSecondElement](M_TFlex_Model_Model3D_IntersectionPath_GetSecondElement.md) | Получить второй элемент |
...
|  | [RemoveFirstElement](M_TFlex_Model_Model3D_IntersectionPath_RemoveFirstElement.md) | Удалить первый элемент |
|  | [RemoveSecondElement](M_TFlex_Model_Model3D_IntersectionPath_RemoveSecondElement.md) | Удалить второй элемент |
...
|  | [SetFirstElement](M_TFlex_Model_Model3D_IntersectionPath_SetFirstElement.md) | Задать первый элемент |
