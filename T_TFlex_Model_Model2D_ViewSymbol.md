...
Базовый класс обозначения вида, разреза или сечения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) TFlex.Model.Model2DViewSymbol [TFlex.Model.Model2DArrowViewSymbol](T_TFlex_Model_Model2D_ArrowViewSymbol.md) [TFlex.Model.Model2DSectionViewSymbol](T_TFlex_Model_Model2D_SectionViewSymbol.md) [TFlex.Model.Model2DSimpleViewSymbol](T_TFlex_Model_Model2D_SimpleViewSymbol.md)
...
|  | [Color](P_TFlex_Model_Model2D_ViewSymbol_Color.md) | Цвет объекта |
...
|  | [FontStyle](P_TFlex_Model_Model2D_ViewSymbol_FontStyle.md) | Стиль шрифта текста для получения или установки его параметров |
|  | [GroupType](P_TFlex_Model_Model2D_ViewSymbol_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_ViewSymbol_Layer.md) | Слой, на котором размещается объект |
|  | [Level](P_TFlex_Model_Model2D_ViewSymbol_Level.md) | Уровень объекта |
...
|  | [Page](P_TFlex_Model_Model2D_ViewSymbol_Page.md) | Страница, на которой размещается элемент(Переопределяет [Object2DPage](P_TFlex_Model_Model2D_Object2D_Page.md)) |
...
|  | [Priority](P_TFlex_Model_Model2D_ViewSymbol_Priority.md) | Приоритет объекта |
