...
Класс ортографической камеры

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DCamera](T_TFlex_Model_Model3D_Camera.md) TFlex.Model.Model3DOrthographicCamera
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OrthographicCamera](M_TFlex_Model_Model3D_OrthographicCamera__ctor.md) | Конструктор для ортографической камеры |
...
|  | [Height](P_TFlex_Model_Model3D_OrthographicCamera_Height.md) | Высота камеры |
