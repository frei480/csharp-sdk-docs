...
Прямоугольный трубопровод

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) [TFlex.Model.Model3DBasePipe](T_TFlex_Model_Model3D_BasePipe.md) TFlex.Model.Model3DRectanglePipe
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [RectanglePipe](M_TFlex_Model_Model3D_RectanglePipe__ctor.md) | Создать трубопровод с прямоугольным сечением в документе |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model3D_BasePipe_Accuracy.md) | Точность геометрии(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [BaseProfileProps](P_TFlex_Model_Model3D_BasePipe_BaseProfileProps.md) | (Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [BeginBorder](P_TFlex_Model_Model3D_BasePipe_BeginBorder.md) | Начальная граница трубопровода(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [BeginPart](P_TFlex_Model_Model3D_BasePipe_BeginPart.md) | Специальное "окончание" трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [CountCuttingItem](P_TFlex_Model_Model3D_BasePipe_CountCuttingItem.md) | Количество операций "врезки"(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [EndBorder](P_TFlex_Model_Model3D_BasePipe_EndBorder.md) | Конечная граница трубопровода(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [EndPart](P_TFlex_Model_Model3D_BasePipe_EndPart.md) | Специальное "окончание" трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_BasePipe_GroupType.md) | (Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [IsRevers](P_TFlex_Model_Model3D_BasePipe_IsRevers.md) | Возвращает true, если направление трубы (от начальной к конечной границе) не совпадает с направлением пути(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [IsSetBeginPart](P_TFlex_Model_Model3D_BasePipe_IsSetBeginPart.md) | Наличие специального "окончания" трубы, как фрагмента(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [IsSetEndPart](P_TFlex_Model_Model3D_BasePipe_IsSetEndPart.md) | Наличие специального "окончания" трубы, как фрагмента(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [IsSetMidPart](P_TFlex_Model_Model3D_BasePipe_IsSetMidPart.md) | Наличие специальной "середины" трубы, как адаптивный фрагмент(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [MidPart](P_TFlex_Model_Model3D_BasePipe_MidPart.md) | Специальная "середина" трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [NotCreateSolids](P_TFlex_Model_Model3D_BasePipe_NotCreateSolids.md) | Не создавать твёрдотельную геометрию(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [Orientation](P_TFlex_Model_Model3D_RectanglePipe_Orientation.md) | Ориентация профиля |
...
|  | [Path](P_TFlex_Model_Model3D_BasePipe_Path.md) | Путь, используется вместо Wires(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [PipeSegments](P_TFlex_Model_Model3D_BasePipe_PipeSegments.md) | **Устарело.** Возвращает информацию об участках трубопровода(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [ProfileProps](P_TFlex_Model_Model3D_RectanglePipe_ProfileProps.md) | Получить параметры профиля трубопровода |
|  | [Simplify](P_TFlex_Model_Model3D_BasePipe_Simplify.md) | Параметр упрощения геометрии(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [Wires](P_TFlex_Model_Model3D_BasePipe_Wires.md) | Путь трубопровода(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddCuttingItem](M_TFlex_Model_Model3D_BasePipe_AddCuttingItem.md) | Добавляет операцию для создание "врезки"(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [Complete](M_TFlex_Model_Model3D_BasePipe_Complete.md) | (Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [GetBeginPartVariables](M_TFlex_Model_Model3D_BasePipe_GetBeginPartVariables.md) | Получить переменные начала трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [GetCuttingItem](M_TFlex_Model_Model3D_BasePipe_GetCuttingItem.md) | Возвращает операцию "врезки" по индексу(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [GetEndPartVariables](M_TFlex_Model_Model3D_BasePipe_GetEndPartVariables.md) | Получить переменные конца трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [GetMidPartVariables](M_TFlex_Model_Model3D_BasePipe_GetMidPartVariables.md) | Получить переменные середины трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [getProfileProperties](M_TFlex_Model_Model3D_RectanglePipe_getProfileProperties.md) | (Переопределяет [BasePipegetProfileProperties](M_TFlex_Model_Model3D_BasePipe_getProfileProperties.md)) |
...
|  | [OnCancelChanges](M_TFlex_Model_Model3D_BasePipe_OnCancelChanges.md) | (Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [OnEndChanges](M_TFlex_Model_Model3D_BasePipe_OnEndChanges.md) | (Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [RemoveAllCuttingItem](M_TFlex_Model_Model3D_BasePipe_RemoveAllCuttingItem.md) | Удаляет все операции "врезки"(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [RemoveCuttingItem(Int32)](M_TFlex_Model_Model3D_BasePipe_RemoveCuttingItem.md) | Удаляет операцию "врезки" по индексу(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [RemoveCuttingItem(Operation)](M_TFlex_Model_Model3D_BasePipe_RemoveCuttingItem_1.md) | Удаляет операцию "врезки"(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
...
|  | [TryCopyPipeStandardFrom](M_TFlex_Model_Model3D_BasePipe_TryCopyPipeStandardFrom.md) | Попробовать скопировать стандарт из другой трубы(Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
|  | [UpdateEnds](M_TFlex_Model_Model3D_BasePipe_UpdateEnds.md) | (Унаследован от [BasePipe](T_TFlex_Model_Model3D_BasePipe.md)) |
