...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DControl](T_TFlex_Model_Model2D_Control.md) [TFlex.Model.Model2DStaticTextControl](T_TFlex_Model_Model2D_StaticTextControl.md) TFlex.Model.Model2DPushButton
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PushButton](M_TFlex_Model_Model2D_PushButton__ctor.md) | Инициализирует новый экземпляр класса PushButton |
...
|  | [Caption](P_TFlex_Model_Model2D_StaticTextControl_Caption.md) | Заголовок(Унаследован от [StaticTextControl](T_TFlex_Model_Model2D_StaticTextControl.md)) |
|  | [ControlType](P_TFlex_Model_Model2D_StaticTextControl_ControlType.md) | Тип элемента управления(Унаследован от [StaticTextControl](T_TFlex_Model_Model2D_StaticTextControl.md)) |
...
|  | [GroupType](P_TFlex_Model_Model2D_Control_GroupType.md) | Идентификатор типа объекта(Унаследован от [Control](T_TFlex_Model_Model2D_Control.md)) |
...
|  | [Layer](P_TFlex_Model_Model2D_Control_Layer.md) | (Унаследован от [Control](T_TFlex_Model_Model2D_Control.md)) |
...
|  | [Rectangle](P_TFlex_Model_Model2D_Control_Rectangle.md) | Прямоугольник элемента управления(Унаследован от [Control](T_TFlex_Model_Model2D_Control.md)) |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddActivatePageAction](M_TFlex_Model_Model2D_PushButton_AddActivatePageAction.md) | Активировать страницу |
|  | [AddEditFragmentVariablesAction](M_TFlex_Model_Model2D_PushButton_AddEditFragmentVariablesAction.md) | Изменить переменные фрагмента |
|  | [AddMaximizeImageAction](M_TFlex_Model_Model2D_PushButton_AddMaximizeImageAction.md) | Максимизировать изображение |
|  | [AddOpenFileAction](M_TFlex_Model_Model2D_PushButton_AddOpenFileAction.md) | Открыть файл |
|  | [AddRegenerate3DAction](M_TFlex_Model_Model2D_PushButton_AddRegenerate3DAction.md) | Обновить 3D |
|  | [AddRunMacroAction](M_TFlex_Model_Model2D_PushButton_AddRunMacroAction.md) | Запустить макрос |
|  | [AddRunPluginCommandAction](M_TFlex_Model_Model2D_PushButton_AddRunPluginCommandAction.md) | Запустить плагин |
|  | [AddSetVariableValueAction](M_TFlex_Model_Model2D_PushButton_AddSetVariableValueAction.md) | Установить значение переменной |
|  | [AddShowDialogAction](M_TFlex_Model_Model2D_PushButton_AddShowDialogAction.md) | Показать диалог |
...
|  | [EditActions](M_TFlex_Model_Model2D_PushButton_EditActions.md) | Редактировать действия |
...
|  | [RemoveAction](M_TFlex_Model_Model2D_PushButton_RemoveAction.md) | Удалить действие |
