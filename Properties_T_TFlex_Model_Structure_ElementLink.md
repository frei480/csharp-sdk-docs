...
# ElementLink - свойства  
  
---  
  
Тип [ElementLink](T_TFlex_Model_Structure_ElementLink.md) предоставляет следующие члены.
...
|  | [GroupType](P_TFlex_Model_Structure_ElementLink_GroupType.md) | Идентификатор типа объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [IsValidLink](P_TFlex_Model_Structure_ElementLink_IsValidLink.md) |  |
...
|  | [LeftObject](P_TFlex_Model_Structure_ElementLink_LeftObject.md) |  |
|  | [LinkDescriptor](P_TFlex_Model_Structure_ElementLink_LinkDescriptor.md) |  |
...
|  | [Order](P_TFlex_Model_Structure_ElementLink_Order.md) |  |
...
|  | [RightObject](P_TFlex_Model_Structure_ElementLink_RightObject.md) |  |
|  | [UID](P_TFlex_Model_Structure_ElementLink_UID.md) |  |
