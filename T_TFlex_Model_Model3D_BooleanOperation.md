...
# BooleanOperation - класс  
    
Булева операция

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DBooleanOperation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [BooleanOperation](M_TFlex_Model_Model3D_BooleanOperation__ctor.md) | Конструктор для создания булевых операций |
...
|  | [EdgeFitting](P_TFlex_Model_Model3D_BooleanOperation_EdgeFitting.md) | Способ обработки новых рёбер |
|  | [EdgeRadius](P_TFlex_Model_Model3D_BooleanOperation_EdgeRadius.md) | Получить радиус сглаживания или смщения для фаски на новом ребре |
...
|  | [FirstOperands](P_TFlex_Model_Model3D_BooleanOperation_FirstOperands.md) | Множество первых операндов |
...
|  | [Function](P_TFlex_Model_Model3D_BooleanOperation_Function.md) | Тип булевой операции |
...
|  | [GroupType](P_TFlex_Model_Model3D_BooleanOperation_GroupType.md) | (Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [KeepFacesMaterial](P_TFlex_Model_Model3D_BooleanOperation_KeepFacesMaterial.md) | Параметр "Сохранять материал граней" |
...
|  | [OperandParts](P_TFlex_Model_Model3D_BooleanOperation_OperandParts.md) | Множество первых операндов |
...
|  | [SecondOperands](P_TFlex_Model_Model3D_BooleanOperation_SecondOperands.md) | Множество вторых операндов |
...
|  | [UsePatterning](P_TFlex_Model_Model3D_BooleanOperation_UsePatterning.md) | Параметр "копирование по образцу" |
