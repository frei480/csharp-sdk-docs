...
# DimensionsChainElement - структура  
  
---  
  
Элемент размерной цепи

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model3DDimensionsChainElement
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [DimensionsChainElement](M_TFlex_Model_Model3D_DimensionsChainElement__ctor.md) | Конструктор |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Element](P_TFlex_Model_Model3D_DimensionsChainElement_Element.md) | 3D объект |
|  | [ElementType](P_TFlex_Model_Model3D_DimensionsChainElement_ElementType.md) | Тип 3D объекта |
