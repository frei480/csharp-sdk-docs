...
Тип [Body](T_TFlex_Model_Model3D_Geometry_Body.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_Body_Dispose.md) | (Переопределяет [BaseBodyDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseBody_Dispose_1.md)) |
