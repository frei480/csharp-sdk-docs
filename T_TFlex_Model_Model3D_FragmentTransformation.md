...
# FragmentTransformation - класс  
    
Класс преобразования перемещения из одной системы координат в другую

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) [TFlex.Model.Model3DMoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md) TFlex.Model.Model3DFragmentTransformation
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FragmentTransformation](M_TFlex_Model_Model3D_FragmentTransformation__ctor.md) | Конструктор для создания нового преобразования перемещения из одной системы координат в другую |
...
|  | [LCS](P_TFlex_Model_Model3D_FragmentTransformation_LCS.md) | Система координат, относительно которой производится преобразование(Переопределяет [MoveRotateTransformationLCS](P_TFlex_Model_Model3D_MoveRotateTransformation_LCS.md)) |
...
|  | [Name](P_TFlex_Model_Model3D_Transformation_Name.md) | Имя преобразования(Унаследован от [Transformation](T_TFlex_Model_Model3D_Transformation.md)) |
...
|  | [Offset_X](P_TFlex_Model_Model3D_MoveRotateTransformation_Offset_X.md) | Значение свойства перемещения вдоль оси X(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
|  | [Offset_Y](P_TFlex_Model_Model3D_MoveRotateTransformation_Offset_Y.md) | Значение свойства перемещения вдоль оси Y(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
|  | [Offset_Z](P_TFlex_Model_Model3D_MoveRotateTransformation_Offset_Z.md) | Значение свойства перемещения вдоль оси Z(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
|  | [OnlyForExplode](P_TFlex_Model_Model3D_Transformation_OnlyForExplode.md) | Значение свойства "Только для разборки"(Унаследован от [Transformation](T_TFlex_Model_Model3D_Transformation.md)) |
|  | [OriginType](P_TFlex_Model_Model3D_FragmentTransformation_OriginType.md) | Тип поиска системы координат, относительно которой производится преобразование(Переопределяет [MoveRotateTransformationOriginType](P_TFlex_Model_Model3D_MoveRotateTransformation_OriginType.md)) |
...
|  | [RotationsCount](P_TFlex_Model_Model3D_MoveRotateTransformation_RotationsCount.md) | Количество поворотов(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
|  | [Scale](P_TFlex_Model_Model3D_MoveRotateTransformation_Scale.md) | Значение свойства масштабирования(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
|  | [SourceLCS](P_TFlex_Model_Model3D_FragmentTransformation_SourceLCS.md) | Исходная система координат |
|  | [Suppressed](P_TFlex_Model_Model3D_Transformation_Suppressed.md) | Значение свойства исключения преобразования(Унаследован от [Transformation](T_TFlex_Model_Model3D_Transformation.md)) |
|  | [TargetLCS](P_TFlex_Model_Model3D_FragmentTransformation_TargetLCS.md) | Целевая система координат |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddRotation](M_TFlex_Model_Model3D_MoveRotateTransformation_AddRotation.md) | Добавить поворот вокруг оси(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
...
|  | [GetRotation](M_TFlex_Model_Model3D_MoveRotateTransformation_GetRotation.md) | Получить параметры поворота по индексу(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
...
|  | [GetTransformationMatrix](M_TFlex_Model_Model3D_Transformation_GetTransformationMatrix.md) | Получаем карту преобразования(Унаследован от [Transformation](T_TFlex_Model_Model3D_Transformation.md)) |
...
|  | [MoveRotation](M_TFlex_Model_Model3D_MoveRotateTransformation_MoveRotation.md) | Переместить вращение вниз или вверх(Унаследован от [MoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md)) |
