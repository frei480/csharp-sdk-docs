...
# RotateGenerator - класс  
    
Генератор вращения

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryBaseGenerator](T_TFlex_Model_Model3D_Geometry_BaseGenerator.md) [TFlex.Model.Model3D.GeometryBodyGenerator](T_TFlex_Model_Model3D_Geometry_BodyGenerator.md) TFlex.Model.Model3D.GeometryRotateGenerator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [RotateGenerator](M_TFlex_Model_Model3D_Geometry_RotateGenerator__ctor.md) | Конструктор для задания вращения |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_RotateGenerator_Run.md) | Функция генерации вращения(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
