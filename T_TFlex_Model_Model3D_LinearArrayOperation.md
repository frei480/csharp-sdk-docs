...
|  | [LinearArrayOperation(Document, ArrayOperationType)](M_TFlex_Model_Model3D_LinearArrayOperation__ctor_1.md) | Конструктор для операции "Линейный массив" |
...
|  | [Constructions](P_TFlex_Model_Model3D_ArrayOperation_Constructions.md) | Коллекция копируемых элементов построения(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
...
|  | [Direction1](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1.md) | Первое направление линейного массива |
|  | [Direction1Length](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1Length.md) | Длина по первому направлению линейного массива |
|  | [Direction1LengthFromVector](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1LengthFromVector.md) | Свойство "получать длину по первому направлению линейного массива с вектора направления" |
|  | [Direction1Number](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1Number.md) | Количество копий по первому направлению линейного массива |
|  | [Direction1Point1](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1Point1.md) | Первая точка, задающая первое направление линейного массива |
|  | [Direction1Point2](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1Point2.md) | Вторая точка задающая первое направление линейного массива |
|  | [Direction1Step](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1Step.md) | Шаг по первому направлению линейного массива |
|  | [Direction1StepFromVector](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1StepFromVector.md) | Cвойство "получать шаг по первому направлению линейного массива с вектора направления" |
|  | [Direction1Type](P_TFlex_Model_Model3D_LinearArrayOperation_Direction1Type.md) | Тип использования значений(длина,шаг,количество копий) для первого направления |
|  | [Direction2](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2.md) | Второе направление линейного массива |
|  | [Direction2Length](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2Length.md) | Длина по второму направлению линейного массива |
|  | [Direction2LengthFromVector](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2LengthFromVector.md) | Свойство "получать длину по второму направлению линейного массива с вектора направления" |
|  | [Direction2Number](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2Number.md) | Количество копий по второму направлению линейного массива |
|  | [Direction2Point1](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2Point1.md) | Первая точка, задающая второе направление линейного массива |
|  | [Direction2Point2](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2Point2.md) | Вторая точка, задающая второе направление линейного массива |
|  | [Direction2Step](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2Step.md) | Шаг по второму направлению линейного массива |
|  | [Direction2StepFromVector](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2StepFromVector.md) | Свойство "получать шаг по второму направлению линейного массива с вектора направления" |
|  | [Direction2Type](P_TFlex_Model_Model3D_LinearArrayOperation_Direction2Type.md) | Тип использования значений для второго направления |
...
|  | [Edges](P_TFlex_Model_Model3D_ArrayOperation_Edges.md) | Коллекция рёбер, используемых для выбора копируемых граней(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
...
|  | [Exclusions](P_TFlex_Model_Model3D_ArrayOperation_Exclusions.md) | Коллекция исключений(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
|  | [Faces](P_TFlex_Model_Model3D_ArrayOperation_Faces.md) | Коллекция копируемых граней(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_LinearArrayOperation_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [IncludeBase](P_TFlex_Model_Model3D_ArrayOperation_IncludeBase.md) | Значение свойства "Включать исходную операцию"(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
|  | [IncludeInBom](P_TFlex_Model_Model3D_ArrayOperation_IncludeInBom.md) | Включать в спецификацию(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
...
|  | [Loops](P_TFlex_Model_Model3D_ArrayOperation_Loops.md) | Коллекция циклов, используемых для выбора копируемых граней(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
...
|  | [ObjectsType](P_TFlex_Model_Model3D_ArrayOperation_ObjectsType.md) | Тип копируемых элементов(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
|  | [Operations](P_TFlex_Model_Model3D_ArrayOperation_Operations.md) | Коллекция копируемых операций(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
...
|  | [Restrictions](P_TFlex_Model_Model3D_ArrayOperation_Restrictions.md) | Ограничения(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
|  | [Separated](P_TFlex_Model_Model3D_ArrayOperation_Separated.md) | Значение свойства "Разделять на тела"(Унаследован от [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md)) |
