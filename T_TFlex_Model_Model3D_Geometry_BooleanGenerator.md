...
# BooleanGenerator - класс  
    
Генератор булевой операции

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryBaseGenerator](T_TFlex_Model_Model3D_Geometry_BaseGenerator.md) [TFlex.Model.Model3D.GeometryBodyGenerator](T_TFlex_Model_Model3D_Geometry_BodyGenerator.md) TFlex.Model.Model3D.GeometryBooleanGenerator
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [BooleanGenerator](M_TFlex_Model_Model3D_Geometry_BooleanGenerator__ctor.md) | Конструктор для задания вытлакивания по направлению на заданные длины в прямом и обратном направлении |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_BooleanGenerator_Run.md) | Функция генерации выталкивания(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
