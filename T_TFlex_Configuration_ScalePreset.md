...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationScalePreset
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ScalePreset](M_TFlex_Configuration_ScalePreset__ctor.md) | Инициализирует новый экземпляр класса ScalePreset |
|  | [ScalePreset(IntPtr, Boolean)](M_TFlex_Configuration_ScalePreset__ctor_1.md) | Инициализирует новый экземпляр класса ScalePreset |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Name](P_TFlex_Configuration_ScalePreset_Name.md) |  |
|  | [Value](P_TFlex_Configuration_ScalePreset_Value.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_ScalePreset_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_ScalePreset_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_ScalePreset_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
