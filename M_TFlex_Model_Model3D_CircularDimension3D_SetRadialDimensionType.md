...
# CircularDimension3DSetRadialDimensionType(RadialDimensionType) - метод  
...
[SetRadialDimensionType - перегрузка](Overload_TFlex_Model_Model3D_CircularDimension3D_SetRadialDimensionType.md)
