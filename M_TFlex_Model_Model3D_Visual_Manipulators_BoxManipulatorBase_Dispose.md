...
# BoxManipulatorBaseDispose(Boolean) - метод  
    
Освобождает неуправляемые ресурсы, используемые объектом [BoxManipulatorBase](T_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase.md), а при необходимости освобождает также управляемые ресурсы
...
[Dispose - перегрузка](Overload_TFlex_Model_Model3D_Visual_Manipulators_BoxManipulatorBase_Dispose.md)
