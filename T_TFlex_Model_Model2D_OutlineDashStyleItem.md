...
# OutlineDashStyleItem - структура  
    
Штрих

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [SystemValueType](https://learn.microsoft.com/dotnet/api/system.valuetype) TFlex.Model.Model2DOutlineDashStyleItem
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [InvisibleLength](F_TFlex_Model_Model2D_OutlineDashStyleItem_InvisibleLength.md) |  |
|  | [VisibleLength](F_TFlex_Model_Model2D_OutlineDashStyleItem_VisibleLength.md) |  |
