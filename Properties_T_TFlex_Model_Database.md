...
|  | [GroupType](P_TFlex_Model_Database_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Name](P_TFlex_Model_Database_Name.md) | Имя базы данных(Переопределяет [ModelObjectName](P_TFlex_Model_ModelObject_Name.md)) |
...
|  | [SubType](P_TFlex_Model_Database_SubType.md) | Тип базы данных |
...
[Database - ](T_TFlex_Model_Database.md)
