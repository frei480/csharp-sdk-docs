...
# SegmentOutline - класс  
    
Простой отрезок

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DSegmentOutline
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SegmentOutline](M_TFlex_Model_Model2D_SegmentOutline__ctor.md) | Конструктор |
...
|  | [EndNode](P_TFlex_Model_Model2D_SegmentOutline_EndNode.md) | Конечная точка |
|  | [EndPoint](P_TFlex_Model_Model2D_SegmentOutline_EndPoint.md) | Конечная точка |
...
|  | [StartNode](P_TFlex_Model_Model2D_SegmentOutline_StartNode.md) | Начальная точка |
|  | [StartPoint](P_TFlex_Model_Model2D_SegmentOutline_StartPoint.md) | Начальная точка |
