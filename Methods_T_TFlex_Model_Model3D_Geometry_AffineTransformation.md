...
# AffineTransformation - методы  
  
---  
  
Тип [AffineTransformation](T_TFlex_Model_Model3D_Geometry_AffineTransformation.md) предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Dispose](M_TFlex_Model_Model3D_Geometry_AffineTransformation_Dispose.md) |  |
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_AffineTransformation_Dispose_1.md) |  |
