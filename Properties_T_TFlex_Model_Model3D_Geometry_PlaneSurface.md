...
# PlaneSurface - свойства  
  
---  
  
Тип [PlaneSurface](T_TFlex_Model_Model3D_Geometry_PlaneSurface.md) предоставляет следующие члены.
...
|  | [Plane](P_TFlex_Model_Model3D_Geometry_PlaneSurface_Plane.md) | Описание плоскости |
