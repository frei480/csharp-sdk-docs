...
# DOCsReferenceDatabase - класс  
    
Класс для создания базы данных по ссылке(справочник T-FLEX DOCs)

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.ModelDatabase](T_TFlex_Model_Database.md) TFlex.ModelDOCsReferenceDatabase
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [DOCsReferenceDatabase](M_TFlex_Model_DOCsReferenceDatabase__ctor.md) | Конструктор для создания базы данных по ссылке(справочник T-FLEX DOCs) |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Description](P_TFlex_Model_DOCsReferenceDatabase_Description.md) | Описание справочника |
...
|  | [SubType](P_TFlex_Model_DOCsReferenceDatabase_SubType.md) | Подтип базы данных(Переопределяет [DatabaseSubType](P_TFlex_Model_Database_SubType.md)) |
|  | [Title](P_TFlex_Model_DOCsReferenceDatabase_Title.md) | Название справочника |
|  | [UpdateMode](P_TFlex_Model_DOCsReferenceDatabase_UpdateMode.md) | Режим обновления |
