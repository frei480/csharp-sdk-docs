...
|  | Имя | Описание |
| --- | --- | --- |
|  | [PerpendicularToPathWorkplane(Document)](M_TFlex_Model_Model3D_PerpendicularToPathWorkplane__ctor.md) | Конструктор для создания рабочей плоскости |
|  | [PerpendicularToPathWorkplane(Document, Page)](M_TFlex_Model_Model3D_PerpendicularToPathWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [Location](P_TFlex_Model_Model3D_PerpendicularToPathWorkplane_Location.md) | Точка, задающая начало координат рабочей плоскости(Переопределяет [Model3DWorkplaneLocation](P_TFlex_Model_Model3D_Model3DWorkplane_Location.md)) |
...
|  | [Path](P_TFlex_Model_Model3D_PerpendicularToPathWorkplane_Path.md) | Путь, перпендикулярно которому проходит рабочая плоскость |
|  | [PointOnWorkplane](P_TFlex_Model_Model3D_PerpendicularToPathWorkplane_PointOnWorkplane.md) | Точка, задающая положение рабочей плоскости |
