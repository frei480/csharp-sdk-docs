...
# ArrayOperation - свойства  
  
---  
  
Тип [ArrayOperation](T_TFlex_Model_Model3D_ArrayOperation.md) предоставляет следующие члены.
...
|  | [Constructions](P_TFlex_Model_Model3D_ArrayOperation_Constructions.md) | Коллекция копируемых элементов построения |
...
|  | [Edges](P_TFlex_Model_Model3D_ArrayOperation_Edges.md) | Коллекция рёбер, используемых для выбора копируемых граней |
...
|  | [Exclusions](P_TFlex_Model_Model3D_ArrayOperation_Exclusions.md) | Коллекция исключений |
|  | [Faces](P_TFlex_Model_Model3D_ArrayOperation_Faces.md) | Коллекция копируемых граней |
...
|  | [IncludeBase](P_TFlex_Model_Model3D_ArrayOperation_IncludeBase.md) | Значение свойства "Включать исходную операцию" |
|  | [IncludeInBom](P_TFlex_Model_Model3D_ArrayOperation_IncludeInBom.md) | Включать в спецификацию |
...
|  | [Loops](P_TFlex_Model_Model3D_ArrayOperation_Loops.md) | Коллекция циклов, используемых для выбора копируемых граней |
...
|  | [ObjectsType](P_TFlex_Model_Model3D_ArrayOperation_ObjectsType.md) | Тип копируемых элементов |
|  | [Operations](P_TFlex_Model_Model3D_ArrayOperation_Operations.md) | Коллекция копируемых операций |
...
|  | [Restrictions](P_TFlex_Model_Model3D_ArrayOperation_Restrictions.md) | Ограничения |
|  | [Separated](P_TFlex_Model_Model3D_ArrayOperation_Separated.md) | Значение свойства "Разделять на тела" |
...
[ArrayOperation - ](T_TFlex_Model_Model3D_ArrayOperation.md)
