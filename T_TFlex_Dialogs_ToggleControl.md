...
Элемент управления, отображаемый как чекбокс или залипающая кнопка

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.DialogsUiObject](T_TFlex_Dialogs_UiObject.md) [TFlex.DialogsBaseControl](T_TFlex_Dialogs_BaseControl.md) TFlex.DialogsToggleControl
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ToggleControl](M_TFlex_Dialogs_ToggleControl__ctor.md) | Инициализирует новый экземпляр класса ToggleControl |
|  | [ToggleControl(String)](M_TFlex_Dialogs_ToggleControl__ctor_1.md) | Инициализирует новый экземпляр класса ToggleControl |
|  | [ToggleControl(String, String)](M_TFlex_Dialogs_ToggleControl__ctor_2.md) | Инициализирует новый экземпляр класса ToggleControl |
|  | [ToggleControl(String, ToggleControlType)](M_TFlex_Dialogs_ToggleControl__ctor_6.md) | Инициализирует новый экземпляр класса ToggleControl |
|  | [ToggleControl(String, String, ToggleControlType)](M_TFlex_Dialogs_ToggleControl__ctor_4.md) | Инициализирует новый экземпляр класса ToggleControl |
|  | [ToggleControl(String, Icon, ToggleControlType)](M_TFlex_Dialogs_ToggleControl__ctor_5.md) | Инициализирует новый экземпляр класса ToggleControl |
|  | [ToggleControl(String, String, Icon, ToggleControlType)](M_TFlex_Dialogs_ToggleControl__ctor_3.md) | Инициализирует новый экземпляр класса ToggleControl |
...
|  | [CheckState](P_TFlex_Dialogs_ToggleControl_CheckState.md) | Текущее значение |
...
|  | [Icon](P_TFlex_Dialogs_ToggleControl_Icon.md) | Отображаемая иконка |
...
|  | [IsChecked](P_TFlex_Dialogs_ToggleControl_IsChecked.md) | Текущее значение |
...
|  | [IsThreeState](P_TFlex_Dialogs_ToggleControl_IsThreeState.md) | Разрешать пользователю выбрать третье (неопределённое) состояние |
...
|  | [Text](P_TFlex_Dialogs_ToggleControl_Text.md) | Отображаемый текст |
|  | [Type](P_TFlex_Dialogs_ToggleControl_Type.md) | Режим отображения |
...
|  | [Checked](E_TFlex_Dialogs_ToggleControl_Checked.md) | Событие смены состояния на Отмечено |
|  | [CheckedChanged](E_TFlex_Dialogs_ToggleControl_CheckedChanged.md) | Событие смены состояния |
...
|  | [Indeterminate](E_TFlex_Dialogs_ToggleControl_Indeterminate.md) | Событие смены состояния на Неопределённое |
...
|  | [Unchecked](E_TFlex_Dialogs_ToggleControl_Unchecked.md) | Событие смены состояния на Неотмечено |
