...
# NamedFragmentNode - класс  
    
Класс узла, построенного на основе именованного узла фрагмента

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DNode](T_TFlex_Model_Model2D_Node.md) TFlex.Model.Model2DNamedFragmentNode
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [NamedFragmentNode](M_TFlex_Model_Model2D_NamedFragmentNode__ctor.md) | Конструктор |
...
|  | [Fragment](P_TFlex_Model_Model2D_NamedFragmentNode_Fragment.md) | Фрагмент, на основе которого создан узел |
...
|  | [SourceNodeName](P_TFlex_Model_Model2D_NamedFragmentNode_SourceNodeName.md) | Имя узла во фрагменте, на основе которого создан узел |
|  | [SubType](P_TFlex_Model_Model2D_NamedFragmentNode_SubType.md) | Подтип способа построения узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
