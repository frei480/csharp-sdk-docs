...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SketchProfile](M_TFlex_Model_Model3D_SketchProfile__ctor.md) | Конструктор для создания профиля по эскизу |
...
|  | [Color](P_TFlex_Model_Model3D_SketchProfile_Color.md) | Цвет линий изображения, по которым строится эскиз |
...
|  | [OnHatch](P_TFlex_Model_Model3D_SketchProfile_OnHatch.md) | 2D узел, задающий перемещение узла контура в 3D узел |
|  | [Outlines](P_TFlex_Model_Model3D_SketchProfile_Outlines.md) | Линии изображения, по которым строится эскиз |
...
|  | [Target](P_TFlex_Model_Model3D_SketchProfile_Target.md) | 3D узел для привязки плоскости контура |
...
|  | [WorkSurface](P_TFlex_Model_Model3D_SketchProfile_WorkSurface.md) | Рабочая поверхность, с которой берётся эскиз |
