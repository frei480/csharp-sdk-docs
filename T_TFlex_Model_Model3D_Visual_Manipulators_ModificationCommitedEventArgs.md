...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ModificationCommitedEventArgs](M_TFlex_Model_Model3D_Visual_Manipulators_ModificationCommitedEventArgs__ctor.md) | Инициализирует новый экземпляр класса ModificationCommitedEventArgs |
