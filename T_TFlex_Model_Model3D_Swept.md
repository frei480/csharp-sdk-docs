...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) [TFlex.Model.Model3DSweep](T_TFlex_Model_Model3D_Sweep.md) TFlex.Model.Model3DSwept
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Swept](M_TFlex_Model_Model3D_Swept__ctor.md) | Конструктор для создания операции по траектории |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Accuracy](P_TFlex_Model_Model3D_Swept_Accuracy.md) | Точность геометрии |
...
|  | [BottomFitting](P_TFlex_Model_Model3D_Sweep_BottomFitting.md) | Способ обработки рёбер на нижней грани(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [BottomRadius](P_TFlex_Model_Model3D_Sweep_BottomRadius.md) | Радиус сглаживания или смещения для фаски на нижнем ребре(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
...
|  | [GapFillType](P_TFlex_Model_Model3D_Sweep_GapFillType.md) | Способ обработки разрывов(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_Swept_GroupType.md) | (Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
|  | [GuidePath](P_TFlex_Model_Model3D_Swept_GuidePath.md) | Составной путь, задающий движение |
...
|  | [Orientation](P_TFlex_Model_Model3D_Swept_Orientation.md) | Ориентация контура |
...
|  | [Profile](P_TFlex_Model_Model3D_Sweep_Profile.md) | Множество образующих контуров(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [ReferencePoint](P_TFlex_Model_Model3D_Swept_ReferencePoint.md) | Точка для задания поворота контура |
|  | [Reverse](P_TFlex_Model_Model3D_Sweep_Reverse.md) | Параметр реверсирования направления(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [ScaleLaw](P_TFlex_Model_Model3D_Swept_ScaleLaw.md) | Табличная функция, задающая зависимость масштаба от положения на пути в процентах |
|  | [ScaleLawType](P_TFlex_Model_Model3D_Swept_ScaleLawType.md) | Способ определения направления при задании закона масштабирования составным путём |
|  | [ScalePath](P_TFlex_Model_Model3D_Swept_ScalePath.md) | Составной путь, задающий закон масштабирования |
|  | [ScalePoint](P_TFlex_Model_Model3D_Swept_ScalePoint.md) | Точка масштабирования |
|  | [Scaling](P_TFlex_Model_Model3D_Swept_Scaling.md) | Тип масштабирования |
|  | [SecondPoint](P_TFlex_Model_Model3D_Swept_SecondPoint.md) | Вторая точка для привязки контура |
|  | [SideBlending](P_TFlex_Model_Model3D_Sweep_SideBlending.md) | Сглаживание боковых рёбер(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [SideFitting](P_TFlex_Model_Model3D_Sweep_SideFitting.md) | Способ обработки боковых рёбер(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [Simplify](P_TFlex_Model_Model3D_Swept_Simplify.md) | Параметр упрощения геометрии |
|  | [StartPoint](P_TFlex_Model_Model3D_Swept_StartPoint.md) | Точка для размещения контура в начало траектории |
...
|  | [Synchronize](P_TFlex_Model_Model3D_Swept_Synchronize.md) | Синхронизация начала пути с положением контура |
|  | [Thickness1](P_TFlex_Model_Model3D_Sweep_Thickness1.md) | Первое значение толщины стенок(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [Thickness2](P_TFlex_Model_Model3D_Sweep_Thickness2.md) | Второе значение толщины стенок(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [ThicknessType](P_TFlex_Model_Model3D_Sweep_ThicknessType.md) | Тип тонкостенного элемента(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
|  | [TopFitting](P_TFlex_Model_Model3D_Sweep_TopFitting.md) | Способ обработки рёбер на верхней грани(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
...
|  | [TopRadius](P_TFlex_Model_Model3D_Sweep_TopRadius.md) | Радиус сглаживания или смещения для фаски на верхнем ребре(Унаследован от [Sweep](T_TFlex_Model_Model3D_Sweep.md)) |
...
|  | [TwistLaw](P_TFlex_Model_Model3D_Swept_TwistLaw.md) | Табличная функция, задающая зависимость угла кручения от положения на пути в процентах |
|  | [TwistLawType](P_TFlex_Model_Model3D_Swept_TwistLawType.md) | Способ определения направления при задании закона кручения составным путём |
|  | [TwistPath](P_TFlex_Model_Model3D_Swept_TwistPath.md) | Составной путь, задающий закон кручения |
|  | [TwistSheet](P_TFlex_Model_Model3D_Swept_TwistSheet.md) | Составной лист, задающий закон вращения |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CancelBinding](M_TFlex_Model_Model3D_Swept_CancelBinding.md) | Отмена привязки контура к пути по точкам |
