...
```csharp
public abstract class Model2DWorkplane : Workplane
```
```vb
Public MustInherit Class Model2DWorkplane
	Inherits Workplane
```
```cpp
public ref class Model2DWorkplane abstract : public Workplane
```


Тип Model2DWorkplane предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Model2DWorkplane(Document)](M_TFlex_Model_Model3D_Model2DWorkplane__ctor.md) | Конструктор для создания новой рабочей плоскости |
|  | [Model2DWorkplane(Document, Page)](M_TFlex_Model_Model3D_Model2DWorkplane__ctor_1.md) | Конструктор для создания новой рабочей плоскости |
...
|  | [BaseNode](P_TFlex_Model_Model3D_Model2DWorkplane_BaseNode.md) | Точка привязки |
...
|  | [BoundQuadrant](P_TFlex_Model_Model3D_Model2DWorkplane_BoundQuadrant.md) | Квадрант границы рабочей плоскости, если границы задаются одним узлом и границами листа |
...
|  | [FirstBoundCorner](P_TFlex_Model_Model3D_Model2DWorkplane_FirstBoundCorner.md) | Первый угол границы |
...
|  | [SecondBoundCorner](P_TFlex_Model_Model3D_Model2DWorkplane_SecondBoundCorner.md) | Второй угол границы |
...
|  | [TargetNode](P_TFlex_Model_Model3D_Model2DWorkplane_TargetNode.md) | Связь с 3D-узлом |
