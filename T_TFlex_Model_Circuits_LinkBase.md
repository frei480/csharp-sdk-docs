...
|  | [CanDraw](P_TFlex_Model_Circuits_LinkBase_CanDraw.md) | Управление отрисовкой |
...
|  | [Splices](P_TFlex_Model_Circuits_LinkBase_Splices.md) |  |
|  | [TextOffset](P_TFlex_Model_Circuits_LinkBase_TextOffset.md) |  |
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddDesignation(String, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_AddDesignation.md) |  |
|  | [AddDesignation(String, String, DesignationType, String)](M_TFlex_Model_Circuits_LinkBase_AddDesignation_1.md) |  |
|  | [AddDesignation(String, FixingVector, Double, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_AddDesignation_2.md) |  |
|  | [AddWireConnectionInfo](M_TFlex_Model_Circuits_LinkBase_AddWireConnectionInfo.md) | Информация о соединениях |
...
|  | [GetAllLinkedObjects](M_TFlex_Model_Circuits_LinkBase_GetAllLinkedObjects.md) | Все коннекторы |
|  | [GetAllWireConnectionInfos](M_TFlex_Model_Circuits_LinkBase_GetAllWireConnectionInfos.md) |  |
...
|  | [GetDesignations](M_TFlex_Model_Circuits_LinkBase_GetDesignations.md) |  |
...
|  | [GetFontOptions](M_TFlex_Model_Circuits_LinkBase_GetFontOptions.md) |  |
|  | [GetGroups](M_TFlex_Model_Circuits_LinkBase_GetGroups.md) | Групповые линии связи |
...
|  | [GetLinkPoint](M_TFlex_Model_Circuits_LinkBase_GetLinkPoint.md) |  |
...
|  | [GetPathBoundRect](M_TFlex_Model_Circuits_LinkBase_GetPathBoundRect.md) |  |
...
|  | [GetTexts(Boolean, FixingVector, DesignationType)](M_TFlex_Model_Circuits_LinkBase_GetTexts_1.md) |  |
|  | [GetType](https://learn.microsoft.com/dotnet/api/system.object.gettype) | Gets the [Type](https://learn.microsoft.com/dotnet/api/system.type) of the current instance.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [GetWireConnectionInfo(Element, Boolean)](M_TFlex_Model_Circuits_LinkBase_GetWireConnectionInfo_1.md) |  |
|  | [GetWireConnectionInfo(Int32, Boolean)](M_TFlex_Model_Circuits_LinkBase_GetWireConnectionInfo.md) |  |
|  | [HasDesignation(DesignationType)](M_TFlex_Model_Circuits_LinkBase_HasDesignation.md) | Обозначения |
|  | [HasDesignation(FixingVector, DesignationType)](M_TFlex_Model_Circuits_LinkBase_HasDesignation_1.md) |  |
|  | [HasDesignations](M_TFlex_Model_Circuits_LinkBase_HasDesignations.md) |  |
...
|  | [MarkPath(Graphics, Point, Point)](M_TFlex_Model_Circuits_LinkBase_MarkPath.md) |  |
|  | [MarkPath(Graphics, FixingVector, FixingVector)](M_TFlex_Model_Circuits_LinkBase_MarkPath_1.md) | Подсветить связь между коннекторами |
...
|  | [RebaseDesignation](M_TFlex_Model_Circuits_LinkBase_RebaseDesignation.md) |  |
...
|  | [Remove](M_TFlex_Model_Circuits_LinkBase_Remove.md) | Отсоединение коннектора от линии связи |
|  | [RemoveChainDesignations](M_TFlex_Model_Circuits_LinkBase_RemoveChainDesignations.md) |  |
|  | [RemoveDesignation(DesignationType)](M_TFlex_Model_Circuits_LinkBase_RemoveDesignation.md) |  |
|  | [RemoveDesignation(FixingVector, DesignationType)](M_TFlex_Model_Circuits_LinkBase_RemoveDesignation_1.md) |  |
|  | [RemoveDesignations](M_TFlex_Model_Circuits_LinkBase_RemoveDesignations.md) |  |
...
|  | [ReplaceDesignation(String, String, String, String)](M_TFlex_Model_Circuits_LinkBase_ReplaceDesignation_1.md) |  |
|  | [SetDesignation(String, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_SetDesignation.md) |  |
|  | [SetDesignation(String, MultilineText, String)](M_TFlex_Model_Circuits_LinkBase_SetDesignation_2.md) |  |
|  | [SetDesignation(String, FixingVector, Double, String, DesignationType)](M_TFlex_Model_Circuits_LinkBase_SetDesignation_1.md) |  |
...
|  | [SetFontOptions](M_TFlex_Model_Circuits_LinkBase_SetFontOptions.md) |  |
...
|  | [SetTextHorizontalAlignment](M_TFlex_Model_Circuits_LinkBase_SetTextHorizontalAlignment.md) | Надписи |
|  | [SetTextVerticalAlignment](M_TFlex_Model_Circuits_LinkBase_SetTextVerticalAlignment.md) |  |
|  | [ShowDesignations](M_TFlex_Model_Circuits_LinkBase_ShowDesignations.md) |  |
