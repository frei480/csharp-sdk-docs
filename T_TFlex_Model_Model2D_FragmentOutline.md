...
# FragmentOutline - класс  
  
---  
  
Класс линии изображения, поднятой с фрагмента

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DFragmentOutline
...
|  | [FragmentPath](P_TFlex_Model_Model2D_FragmentOutline_FragmentPath.md) | Исходный объект - путь к исходному элементу |
...
|  | [SubType](P_TFlex_Model_Model2D_FragmentOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
...
|  | [Create](M_TFlex_Model_Model2D_FragmentOutline_Create.md) | Создание элемента в указанном документе, соответствующего заданному элементу, находящегося на вложенном фрагменте |
