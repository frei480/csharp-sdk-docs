...
# WireSetManipulator - методы  
    
Тип [WireSetManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_WireSetManipulator.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_WireSetManipulator_Dispose.md) | (Переопределяет [ManipulatorDispose(Boolean)](M_TFlex_Model_Model3D_Visual_Manipulators_Manipulator_Dispose_1.md)) |
