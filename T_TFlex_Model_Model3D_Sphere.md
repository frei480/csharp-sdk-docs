...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Sphere](M_TFlex_Model_Model3D_Sphere__ctor.md) | Конструктор для создания Сферы |
...
|  | [Diameter](P_TFlex_Model_Model3D_Sphere_Diameter.md) | Диаметр |
