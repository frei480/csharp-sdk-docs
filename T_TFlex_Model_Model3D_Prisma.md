...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Prisma](M_TFlex_Model_Model3D_Prisma__ctor.md) | Конструктор для создания Призмы |
...
|  | [Diameter](P_TFlex_Model_Model3D_Prisma_Diameter.md) | Диаметр |
...
|  | [Height](P_TFlex_Model_Model3D_Prisma_Height.md) | Высота |
...
|  | [InnerDiameter](P_TFlex_Model_Model3D_Prisma_InnerDiameter.md) | Внутренний диаметр |
...
|  | [Side](P_TFlex_Model_Model3D_Prisma_Side.md) | Стороны |
