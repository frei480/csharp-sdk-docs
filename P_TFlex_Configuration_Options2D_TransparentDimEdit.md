...
# Options2DTransparentDimEdit - свойство  
  
---  
**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool TransparentDimEdit { get; set; }
```
```vb
Public Property TransparentDimEdit As Boolean
	Get
	Set
```
```cpp
public:
property bool TransparentDimEdit {
	bool get ();
	void set (bool value);
}
```
