...
# PointOnPathManipulator - конструктор  
  
---  
  
Инициализирует новый экземпляр класса [PointOnPathManipulator](T_TFlex_Model_Model3D_Visual_Manipulators_PointOnPathManipulator.md)
