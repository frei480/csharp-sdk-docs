...
# SelectionContainerExtensionsSelectSubFragment(SelectionContainer, Fragment3D, FragmentIdChain) - метод  
...
A_1 [Fragment3D](T_TFlex_Model_Model3D_Fragment3D.md)
    
A_2 [FragmentIdChain](T_TFlex_Model_FragmentIdChain.md)
