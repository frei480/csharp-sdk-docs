...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ThickenExtrusion](M_TFlex_Model_Model3D_ThickenExtrusion__ctor.md) | Конструктор для создания выталкивания |
...
|  | [BackwardLength](P_TFlex_Model_Model3D_ThickenExtrusion_BackwardLength.md) | Длина выталкивания в обратном направлении |
|  | [BackwardTaper](P_TFlex_Model_Model3D_Extrusion_BackwardTaper.md) | Получить параметр построения уклона в обратном направлении(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
|  | [BackwardTaperAngle](P_TFlex_Model_Model3D_Extrusion_BackwardTaperAngle.md) | Угол уклона в обратном направлении(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
|  | [Bedplate](P_TFlex_Model_Model3D_ThickenExtrusion_Bedplate.md) | Параметр построения донышка |
|  | [BedplateThickness](P_TFlex_Model_Model3D_ThickenExtrusion_BedplateThickness.md) | Получить толщину донышка |
...
|  | [Cover](P_TFlex_Model_Model3D_ThickenExtrusion_Cover.md) | Параметр построения крышки |
|  | [CoverThickness](P_TFlex_Model_Model3D_ThickenExtrusion_CoverThickness.md) | Толщина крышки |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_Extrusion_FirstPoint.md) | Первая точка, задающая направление выталкивания(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
...
|  | [ForwardLength](P_TFlex_Model_Model3D_ThickenExtrusion_ForwardLength.md) | Длина выталкивания в прямом направлении |
|  | [ForwardTaper](P_TFlex_Model_Model3D_Extrusion_ForwardTaper.md) | Параметр построения уклона в прямом направлении(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
|  | [ForwardTaperAngle](P_TFlex_Model_Model3D_Extrusion_ForwardTaperAngle.md) | Получить угол уклона в прямом направлении(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
...
|  | [GroupType](P_TFlex_Model_Model3D_Extrusion_GroupType.md) | Получить тип объекта(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
...
|  | [LengthType](P_TFlex_Model_Model3D_ThickenExtrusion_LengthType.md) | Способ определения длины выталкивания в прямом и обратном направлениях |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_Extrusion_SecondPoint.md) | Вторая точка, задающая направление выталкивания(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
...
|  | [Vector](P_TFlex_Model_Model3D_Extrusion_Vector.md) | Направление выталкивания(Унаследован от [Extrusion](T_TFlex_Model_Model3D_Extrusion.md)) |
