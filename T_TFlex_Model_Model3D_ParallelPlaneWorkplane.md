...
|  | [ParallelPlaneWorkplane(Document, Page)](M_TFlex_Model_Model3D_ParallelPlaneWorkplane__ctor_1.md) | Конструктор для создания рабочей плоскости |
...
|  | [BasePlane](P_TFlex_Model_Model3D_ParallelPlaneWorkplane_BasePlane.md) | Плоскость, задающая положение рабочей плоскости |
...
|  | [EdgeTangentToWorkplane](P_TFlex_Model_Model3D_ParallelPlaneWorkplane_EdgeTangentToWorkplane.md) | Ребро, которого касается рабочая плоскость |
...
|  | [FaceTangentToWorkplane](P_TFlex_Model_Model3D_ParallelPlaneWorkplane_FaceTangentToWorkplane.md) | Поверхность, которой касается рабочая плоскость |
...
|  | [Offset](P_TFlex_Model_Model3D_ParallelPlaneWorkplane_Offset.md) | Смещение |
...
|  | [PointOnWorkplane](P_TFlex_Model_Model3D_ParallelPlaneWorkplane_PointOnWorkplane.md) | Точка, задающую положение рабочей плоскости |
