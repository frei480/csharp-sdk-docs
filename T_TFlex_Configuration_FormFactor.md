...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationFormFactor
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [FormFactor](M_TFlex_Configuration_FormFactor__ctor.md) | Инициализирует новый экземпляр класса FormFactor |
|  | [FormFactor(IntPtr, Boolean)](M_TFlex_Configuration_FormFactor__ctor_1.md) | Инициализирует новый экземпляр класса FormFactor |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [FormFactorName](P_TFlex_Configuration_FormFactor_FormFactorName.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_FormFactor_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_FormFactor_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_FormFactor_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
