...
# ReferenceDatabase - класс  
    
Класс для создания базы данных по ссылке(файл)

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.ModelDatabase](T_TFlex_Model_Database.md) TFlex.ModelReferenceDatabase
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ReferenceDatabase](M_TFlex_Model_ReferenceDatabase__ctor.md) | Конструктор для создания базы данных по ссылке(файл) |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [Delimiter](P_TFlex_Model_ReferenceDatabase_Delimiter.md) | Тип разделителя |
...
|  | [FileLink](P_TFlex_Model_ReferenceDatabase_FileLink.md) | Путь к файлу базы данных по ссылке |
...
|  | [SubType](P_TFlex_Model_ReferenceDatabase_SubType.md) | Подтип базы данных(Переопределяет [DatabaseSubType](P_TFlex_Model_Database_SubType.md)) |
|  | [TableName](P_TFlex_Model_ReferenceDatabase_TableName.md) | Имя таблицы базы данных по ссылке |
|  | [UpdateMode](P_TFlex_Model_ReferenceDatabase_UpdateMode.md) | Режим обновления |
|  | [UseDosEncoding](P_TFlex_Model_ReferenceDatabase_UseDosEncoding.md) | Кодировка DOS |
...
|  | [ConvertToInternal](M_TFlex_Model_ReferenceDatabase_ConvertToInternal.md) | Конвертировать базу данных во внутреннюю базу данных |
...
|  | [GetColumnComment](M_TFlex_Model_ReferenceDatabase_GetColumnComment.md) | Получить комментарий столбца |
|  | [GetColumnCount](M_TFlex_Model_ReferenceDatabase_GetColumnCount.md) | Получить количество столбцов |
|  | [GetColumnName](M_TFlex_Model_ReferenceDatabase_GetColumnName.md) | Получить имя столбца |
...
|  | [GetIntValue](M_TFlex_Model_ReferenceDatabase_GetIntValue.md) | Получить целое значение в таблице |
...
|  | [GetRealValue](M_TFlex_Model_ReferenceDatabase_GetRealValue.md) | Получить вещественное значение в таблице |
|  | [GetRecordCount](M_TFlex_Model_ReferenceDatabase_GetRecordCount.md) | Получить количество строк |
...
|  | [GetTextValue](M_TFlex_Model_ReferenceDatabase_GetTextValue.md) | Получить текстовое значение в таблице |
