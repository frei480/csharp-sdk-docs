...
# Transformation - класс  
  
---  
  
Базовый класс для всех 3D преобразований

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.Model3DTransformation Подробнее
...
|  | [Name](P_TFlex_Model_Model3D_Transformation_Name.md) | Имя преобразования(Переопределяет [ModelObjectName](P_TFlex_Model_ModelObject_Name.md)) |
...
|  | [OnlyForExplode](P_TFlex_Model_Model3D_Transformation_OnlyForExplode.md) | Значение свойства "Только для разборки" |
...
|  | [Suppressed](P_TFlex_Model_Model3D_Transformation_Suppressed.md) | Значение свойства исключения преобразования |
...
|  | [Create](M_TFlex_Model_Model3D_Transformation_Create.md) |  |
...
|  | [GetTransformationMatrix](M_TFlex_Model_Model3D_Transformation_GetTransformationMatrix.md) | Получаем карту преобразования |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.Model.Model3DTransformation [TFlex.Model.Model3DImportedTransformation](T_TFlex_Model_Model3D_ImportedTransformation.md) [TFlex.Model.Model3DMoveRotateTransformation](T_TFlex_Model_Model3D_MoveRotateTransformation.md) [TFlex.Model.Model3DReflectTransformation](T_TFlex_Model_Model3D_ReflectTransformation.md) [TFlex.Model.Model3DScaleTransformation](T_TFlex_Model_Model3D_ScaleTransformation.md) [TFlex.Model.Model3DUnknownTransformation](T_TFlex_Model_Model3D_UnknownTransformation.md) [TFlex.Model.Model3DVectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md)