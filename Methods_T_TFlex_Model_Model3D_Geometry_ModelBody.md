...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_ModelBody_Dispose.md) | (Переопределяет [BaseBodyDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseBody_Dispose_1.md)) |
