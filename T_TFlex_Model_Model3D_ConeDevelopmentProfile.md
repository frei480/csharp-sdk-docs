...
|  | Имя | Описание |
| --- | --- | --- |
|  | [ConeDevelopmentProfile](M_TFlex_Model_Model3D_ConeDevelopmentProfile__ctor.md) | Конструктор для создания развёртки грани на конической поверхности |
...
|  | [Face](P_TFlex_Model_Model3D_ConeDevelopmentProfile_Face.md) | Разворачиваемая грань |
...
|  | [PointOnFace](P_TFlex_Model_Model3D_ConeDevelopmentProfile_PointOnFace.md) | Точка на грани |
|  | [SectionIsolinePoint](P_TFlex_Model_Model3D_ConeDevelopmentProfile_SectionIsolinePoint.md) | Точка, через которую проходит изопараметрическая прямая, вдоль которой разрезается замкнтуая грань |
