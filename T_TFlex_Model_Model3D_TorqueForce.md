...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DRestraint](T_TFlex_Model_Model3D_Restraint.md) TFlex.Model.Model3DTorqueForce
...
|  | [Torque](P_TFlex_Model_Model3D_TorqueForce_Torque.md) | Крутящий момент |
|  | [Type](P_TFlex_Model_Model3D_TorqueForce_Type.md) | Тип нагрузки(Переопределяет [RestraintType](P_TFlex_Model_Model3D_Restraint_Type.md)) |
