...
# GeometryModification - конструктор  
    
Инициализирует новый экземпляр класса [GeometryModification](T_TFlex_Model_Model3D_Visual_Manipulators_GeometryModification.md)
