...
# SizeDoubleStep - класс  
    
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ConfigurationSettingsGroup](T_TFlex_Configuration_SettingsGroup.md) TFlex.ConfigurationSizeDoubleStep
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SizeDoubleStep](M_TFlex_Configuration_SizeDoubleStep__ctor.md) | Инициализирует новый экземпляр класса SizeDoubleStep |
|  | [SizeDoubleStep(IntPtr, Boolean)](M_TFlex_Configuration_SizeDoubleStep__ctor_1.md) | Инициализирует новый экземпляр класса SizeDoubleStep |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [X](P_TFlex_Configuration_SizeDoubleStep_X.md) |  |
|  | [Y](P_TFlex_Configuration_SizeDoubleStep_Y.md) |  |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Assign](M_TFlex_Configuration_SizeDoubleStep_Assign.md) |  |
|  | [AssignBaseOptions](M_TFlex_Configuration_SizeDoubleStep_AssignBaseOptions.md) | (Переопределяет [SettingsGroupAssignBaseOptions(SettingsGroup)](M_TFlex_Configuration_SettingsGroup_AssignBaseOptions.md)) |
...
|  | [Copy](M_TFlex_Configuration_SizeDoubleStep_Copy.md) | (Переопределяет [SettingsGroupCopy](M_TFlex_Configuration_SettingsGroup_Copy.md)) |
...
|  | [ToString](M_TFlex_Configuration_SizeDoubleStep_ToString.md) | (Переопределяет [ObjectToString](https://learn.microsoft.com/dotnet/api/system.object.tostring)) |
