...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DStudy](T_TFlex_Model_Model3D_Study.md) TFlex.Model.Model3DDynamicStudy
...
|  | [Frame](P_TFlex_Model_Model3D_DynamicStudy_Frame.md) | Текущий кадр моделирования |
...
|  | [RestraintCount](P_TFlex_Model_Model3D_DynamicStudy_RestraintCount.md) | Количество нагружений |
|  | [SensorCount](P_TFlex_Model_Model3D_DynamicStudy_SensorCount.md) | Количество датчиков |
|  | [Time](P_TFlex_Model_Model3D_DynamicStudy_Time.md) | Текущее время моделирования |
...
|  | [GetRestraint](M_TFlex_Model_Model3D_DynamicStudy_GetRestraint.md) | Получить нагружение по номеру |
|  | [GetSensor](M_TFlex_Model_Model3D_DynamicStudy_GetSensor.md) | Получить датчик по номеру |
...
|  | [RunSolve](M_TFlex_Model_Model3D_Study_RunSolve.md) | Запустить рассчитать задачу(Унаследован от [Study](T_TFlex_Model_Model3D_Study.md)) |
...
|  | [Solve](M_TFlex_Model_Model3D_DynamicStudy_Solve.md) | Рассчитать задачу(Переопределяет [StudySolve](M_TFlex_Model_Model3D_Study_Solve.md)) |
|  | [Solve(DynamicStudySolveCallback)](M_TFlex_Model_Model3D_DynamicStudy_Solve_1.md) | Рассчитать задачу с возможностью досрочной остановки расчёта |
