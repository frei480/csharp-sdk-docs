...
# SketcherOptionsSketcherShowConstraintIndex - свойство  
  
---  
**Пространство имён:** [TFlex.Configuration](N_TFlex_Configuration.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public bool SketcherShowConstraintIndex { get; set; }
```
```vb
Public Property SketcherShowConstraintIndex As Boolean
	Get
	Set
```
```cpp
public:
property bool SketcherShowConstraintIndex {
	bool get ();
	void set (bool value);
}
```
