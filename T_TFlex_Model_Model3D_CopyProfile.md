...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CopyProfile](M_TFlex_Model_Model3D_CopyProfile__ctor.md) | Конструктор для создания копии профиля |
...
|  | [SourceLCS](P_TFlex_Model_Model3D_CopyProfile_SourceLCS.md) | Исходная локальная система координат |
|  | [SourceProfile](P_TFlex_Model_Model3D_CopyProfile_SourceProfile.md) | Копируемый профиль |
|  | [TargetLCS](P_TFlex_Model_Model3D_CopyProfile_TargetLCS.md) | Целевая локальная система координат |
