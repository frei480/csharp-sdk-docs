...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.GeometryGeometry](T_TFlex_Model_Model3D_Geometry_Geometry.md) [TFlex.Model.Model3D.GeometryBaseBox](T_TFlex_Model_Model3D_Geometry_BaseBox.md) TFlex.Model.Model3D.GeometryBox
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Box(BaseBox)](M_TFlex_Model_Model3D_Geometry_Box__ctor.md) | Конструктор для создания границы как копии другой границы |
|  | [Box(BasePoint3D, BasePoint3D)](M_TFlex_Model_Model3D_Geometry_Box__ctor_1.md) | Конструтор для создания границы по двум точкам |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Maximum](P_TFlex_Model_Model3D_Geometry_Box_Maximum.md) | Получить точку максимальных границ(Переопределяет [BaseBoxMaximum](P_TFlex_Model_Model3D_Geometry_BaseBox_Maximum.md)) |
|  | [Minimum](P_TFlex_Model_Model3D_Geometry_Box_Minimum.md) | Получить точку минимальных границ(Переопределяет [BaseBoxMinimum](P_TFlex_Model_Model3D_Geometry_BaseBox_Minimum.md)) |
...
|  | [Update](M_TFlex_Model_Model3D_Geometry_BaseBox_Update.md) | Обновить геометрию для каждого конкретного порождённого типа(Унаследован от [BaseBox](T_TFlex_Model_Model3D_Geometry_BaseBox.md)) |
