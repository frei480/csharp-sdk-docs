...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DFixingVector](T_TFlex_Model_Model2D_FixingVector.md) TFlex.Model.Model2DLcs2D
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Lcs2D](M_TFlex_Model_Model2D_Lcs2D__ctor.md) | Конструктор по умолчанию |
