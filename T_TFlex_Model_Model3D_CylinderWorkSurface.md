...
# CylinderWorkSurface - класс  
  
---  
  
Цилиндрическая рабочая поверхность

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DWorkSurface](T_TFlex_Model_Model3D_WorkSurface.md) [TFlex.Model.Model3DSpatialWorkSurface](T_TFlex_Model_Model3D_SpatialWorkSurface.md) TFlex.Model.Model3DCylinderWorkSurface
...
|  | [CylinderWorkSurface(Document, Page)](M_TFlex_Model_Model3D_CylinderWorkSurface__ctor_1.md) | Конструктор для создания цилиндрической поверхности |
...
|  | [Param](P_TFlex_Model_Model3D_CylinderWorkSurface_Param.md) | Тип параметризации по U |
...
|  | [Radius](P_TFlex_Model_Model3D_CylinderWorkSurface_Radius.md) | Радиус цилиндра |
