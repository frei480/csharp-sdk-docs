...
Объект "Линия связи с разрывом"

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.CircuitsLinkBase](T_TFlex_Model_Circuits_LinkBase.md) [TFlex.Model.CircuitsLink](T_TFlex_Model_Circuits_Link.md) TFlex.Model.CircuitsBus
...
|  | [GroupType](P_TFlex_Model_Circuits_Bus_GroupType.md) | (Переопределяет [LinkGroupType](P_TFlex_Model_Circuits_Link_GroupType.md)) |
...
|  | [AddWireConnectionInfo](M_TFlex_Model_Circuits_Link_AddWireConnectionInfo.md) | (Унаследован от [Link](T_TFlex_Model_Circuits_Link.md)) |
...
|  | [GetAllLinkedObjects](M_TFlex_Model_Circuits_Bus_GetAllLinkedObjects.md) | (Переопределяет [LinkGetAllLinkedObjects](M_TFlex_Model_Circuits_Link_GetAllLinkedObjects.md)) |
|  | [GetAllWireConnectionInfos](M_TFlex_Model_Circuits_Link_GetAllWireConnectionInfos.md) | (Унаследован от [Link](T_TFlex_Model_Circuits_Link.md)) |
...
|  | [GetBusConnectors](M_TFlex_Model_Circuits_Bus_GetBusConnectors.md) |  |
...
|  | [GetWireConnectionInfo(Element, Boolean)](M_TFlex_Model_Circuits_Link_GetWireConnectionInfo_1.md) | (Унаследован от [Link](T_TFlex_Model_Circuits_Link.md)) |
|  | [GetWireConnectionInfo(Int32, Boolean)](M_TFlex_Model_Circuits_Link_GetWireConnectionInfo.md) | (Унаследован от [Link](T_TFlex_Model_Circuits_Link.md)) |
