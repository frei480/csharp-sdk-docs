...
|  | [FragmentPath](P_TFlex_Model_Model2D_FragmentNode_FragmentPath.md) | Объект, задающий путь к исходному элементу |
...
|  | [SubType](P_TFlex_Model_Model2D_FragmentNode_SubType.md) | Подтип узла(Переопределяет [NodeSubType](P_TFlex_Model_Model2D_Node_SubType.md)) |
...
|  | [Create](M_TFlex_Model_Model2D_FragmentNode_Create.md) | Создание узла в указанном документе, соответствующего заданному узлу элемента, находящегося на вложенном фрагменте |
