...
# LinkBaseGetTexts(Boolean, FixingVector, DesignationType) - метод  
  **Пространство имён:** [TFlex.Model.Circuits](N_TFlex_Model_Circuits.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public abstract IEnumerable<Tuple<MultilineText, string>> GetTexts(
	bool edit,
	FixingVector point,
...
[GetTexts - перегрузка](Overload_TFlex_Model_Circuits_LinkBase_GetTexts.md)
