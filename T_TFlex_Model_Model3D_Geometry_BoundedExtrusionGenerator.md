...
|  | Имя | Описание |
| --- | --- | --- |
|  | [BoundedExtrusionGenerator](M_TFlex_Model_Model3D_Geometry_BoundedExtrusionGenerator__ctor.md) | Конструктор для задания выталкивания от границы до границы |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Disjoint](P_TFlex_Model_Model3D_Geometry_BoundedExtrusionGenerator_Disjoint.md) | Результирующее тело может иметь несвязанные разбиения |
|  | [End](P_TFlex_Model_Model3D_Geometry_BoundedExtrusionGenerator_End.md) | Вторая граница выталкивания |
...
|  | [Start](P_TFlex_Model_Model3D_Geometry_BoundedExtrusionGenerator_Start.md) | Первая граница выталкивания |
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BoundedExtrusionGenerator_Dispose.md) | Освобождает неуправляемые ресурсы, используемые объектом BoundedExtrusionGenerator, а при необходимости освобождает также управляемые ресурсы(Переопределяет [BaseGeneratorDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Dispose_1.md)) |
...
|  | [Run](M_TFlex_Model_Model3D_Geometry_BoundedExtrusionGenerator_Run.md) | Функция генерации выталкивания от границы до границы(Переопределяет [BaseGeneratorRun](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Run.md)) |
