...
# ScaleVectorTransformation - класс  
    
Класс преобразования масштабирования вдоль вектора

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DTransformation](T_TFlex_Model_Model3D_Transformation.md) [TFlex.Model.Model3DVectorTransformation](T_TFlex_Model_Model3D_VectorTransformation.md) TFlex.Model.Model3DScaleVectorTransformation

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class ScaleVectorTransformation : VectorTransformation
```
```vb
Public Class ScaleVectorTransformation
	Inherits VectorTransformation
```
```cpp
public ref class ScaleVectorTransformation : public VectorTransformation
```


Тип ScaleVectorTransformation предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [ScaleVectorTransformation](M_TFlex_Model_Model3D_ScaleVectorTransformation__ctor.md) | Конструктор для создания нового преобразования масштабирования вдоль вектора |
...
|  | [Scale](P_TFlex_Model_Model3D_ScaleVectorTransformation_Scale.md) | Значение масштаба |
