...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SectionPath](M_TFlex_Model_Model3D_SectionPath__ctor.md) | Конструктор для создания пути на пересечении тела и поверхности |
...
|  | [IntBody](P_TFlex_Model_Model3D_SectionPath_IntBody.md) | Тело |
|  | [IntPlane](P_TFlex_Model_Model3D_SectionPath_IntPlane.md) | Поверхность |
|  | [IntSurface](P_TFlex_Model_Model3D_SectionPath_IntSurface.md) | **Устарело.** Поверхность |
