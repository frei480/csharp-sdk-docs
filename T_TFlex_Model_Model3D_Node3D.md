...
Базовый класс для всех типов 3D узлов

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DNode3D Подробнее

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class Node3D : Construction3D
```
```vb
Public Class Node3D
...
```
```cpp
public ref class Node3D : public Construction3D
```


Тип Node3D предоставляет следующие члены.
...
|  | [Geometry](P_TFlex_Model_Model3D_Node3D_Geometry.md) | Получить геометрические данные точки |
|  | [GroupType](P_TFlex_Model_Model3D_Node3D_GroupType.md) | Получить тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) TFlex.Model.Model3DNode3D [TFlex.Model.Model3DCoordinateNode3D](T_TFlex_Model_Model3D_CoordinateNode3D.md) [TFlex.Model.Model3DGeometryNode3D](T_TFlex_Model_Model3D_GeometryNode3D.md) [TFlex.Model.Model3DIntersectionNode3D](T_TFlex_Model_Model3D_IntersectionNode3D.md) [TFlex.Model.Model3DLCSPoint](T_TFlex_Model_Model3D_LCSPoint.md) [TFlex.Model.Model3DMassCenterNode3D](T_TFlex_Model_Model3D_MassCenterNode3D.md) [TFlex.Model.Model3DOnFaceOffsetPoint](T_TFlex_Model_Model3D_OnFaceOffsetPoint.md) [TFlex.Model.Model3DOnSurfacePoint](T_TFlex_Model_Model3D_OnSurfacePoint.md) [TFlex.Model.Model3DOnWirePoint](T_TFlex_Model_Model3D_OnWirePoint.md) [TFlex.Model.Model3DReferenceNode3D](T_TFlex_Model_Model3D_ReferenceNode3D.md) [TFlex.Model.Model3DRelationPoint](T_TFlex_Model_Model3D_RelationPoint.md) [TFlex.Model.Model3DThreePlanesPoint](T_TFlex_Model_Model3D_ThreePlanesPoint.md) [TFlex.Model.Model3DTwoPathesIntersectionPoint](T_TFlex_Model_Model3D_TwoPathesIntersectionPoint.md) [TFlex.Model.Model3DWorkplaneNode3D](T_TFlex_Model_Model3D_WorkplaneNode3D.md)