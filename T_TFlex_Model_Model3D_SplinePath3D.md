...
|  | Имя | Описание |
| --- | --- | --- |
|  | [SplinePath3D](M_TFlex_Model_Model3D_SplinePath3D__ctor.md) | Конструктор для создания пути по точкам |
...
|  | [Periodic](P_TFlex_Model_Model3D_SplinePath3D_Periodic.md) | Свойство периодичности сплайна |
|  | [Points](P_TFlex_Model_Model3D_SplinePath3D_Points.md) | Множество контрольных точек |
...
|  | [Dispose](M_TFlex_Model_Model3D_SplinePath3D_Dispose.md) | Выполняет определяемые приложением задачи, связанные с удалением, высвобождением или сбросом неуправляемых ресурсов |
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_SplinePath3D_Dispose_1.md) | Освобождает неуправляемые ресурсы, используемые объектом SplinePath3D, а при необходимости освобождает также управляемые ресурсы |
