...
# LoftGenerator - методы  
    
Тип [LoftGenerator](T_TFlex_Model_Model3D_Geometry_LoftGenerator.md) предоставляет следующие члены.
...
|  | [Dispose(Boolean)](M_TFlex_Model_Model3D_Geometry_LoftGenerator_Dispose.md) | (Переопределяет [BaseGeneratorDispose(Boolean)](M_TFlex_Model_Model3D_Geometry_BaseGenerator_Dispose_1.md)) |
