...
Базовый класс для всех типов рабочих плоскостей

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DWorkSurface](T_TFlex_Model_Model3D_WorkSurface.md) TFlex.Model.Model3DWorkplane [TFlex.Model.Model3DCopyWorkplane](T_TFlex_Model_Model3D_CopyWorkplane.md) [TFlex.Model.Model3DModel2DWorkplane](T_TFlex_Model_Model3D_Model2DWorkplane.md) [TFlex.Model.Model3DModel3DWorkplane](T_TFlex_Model_Model3D_Model3DWorkplane.md) [TFlex.Model.Model3DReferenceWorkplane](T_TFlex_Model_Model3D_ReferenceWorkplane.md)
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Workplane(Document)](M_TFlex_Model_Model3D_Workplane__ctor.md) | Конструктор для создания новой рабочей плоскости |
|  | [Workplane(Document, Page)](M_TFlex_Model_Model3D_Workplane__ctor_1.md) | Конструктор для создания новой рабочей плоскости |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [AddOffset](P_TFlex_Model_Model3D_Workplane_AddOffset.md) | Смещение рабочей плоскости вдоль нормали |
...
|  | [Bottom](P_TFlex_Model_Model3D_Workplane_Bottom.md) | Нижняя Y-координата границ бумаги |
...
|  | [Geometry](P_TFlex_Model_Model3D_Workplane_Geometry.md) | Получить геометрические данные рабочей плоскости |
|  | [GroupType](P_TFlex_Model_Model3D_Workplane_GroupType.md) | Получить тип объекта(Переопределяет [WorkSurfaceGroupType](P_TFlex_Model_Model3D_WorkSurface_GroupType.md)) |
...
|  | [Left](P_TFlex_Model_Model3D_Workplane_Left.md) | Левая X-координата границ бумаги |
...
|  | [Right](P_TFlex_Model_Model3D_Workplane_Right.md) | Правая X-координата границ бумаги |
|  | [ShowElements2DInView3D](P_TFlex_Model_Model3D_Workplane_ShowElements2DInView3D.md) | Показать 2D элементы на 3D виде |
...
|  | [Top](P_TFlex_Model_Model3D_Workplane_Top.md) | Верхняя Y-координата границ бумаги |
...
|  | [Project](M_TFlex_Model_Model3D_Workplane_Project.md) | Проекция точки на рабочую плоскость |
