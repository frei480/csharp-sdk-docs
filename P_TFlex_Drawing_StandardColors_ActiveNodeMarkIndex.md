...
# StandardColorsActiveNodeMarkIndex - свойство  
...
```csharp
public static int ActiveNodeMarkIndex { get; }
```
```vb
Public Shared ReadOnly Property ActiveNodeMarkIndex As Integer
	Get
```
```cpp
public:
static property int ActiveNodeMarkIndex {
	int get ();
}
```
