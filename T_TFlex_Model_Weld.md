...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) TFlex.ModelWeld
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Weld](M_TFlex_Model_Weld__ctor.md) | Конструктор |
...
|  | [GroupType](P_TFlex_Model_Weld_GroupType.md) | Тип объекта(Переопределяет [ModelObjectGroupType](P_TFlex_Model_ModelObject_GroupType.md)) |
...
|  | [Length](P_TFlex_Model_Weld_Length.md) | Длина сварного шва |
...
|  | [WeldType](P_TFlex_Model_Weld_WeldType.md) | Тип сварного шва |
