...
Манипулятор для изменения угловых данных

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.Model.Model3D.VisualDragger](T_TFlex_Model_Model3D_Visual_Dragger.md) TFlex.Model.Model3D.VisualCircleDragger
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [CircleDragger](M_TFlex_Model_Model3D_Visual_CircleDragger__ctor.md) | Конструктор по умолчанию |
...
|  | [Axis](P_TFlex_Model_Model3D_Visual_CircleDragger_Axis.md) | Ось вращения |
...
|  | [Step](P_TFlex_Model_Model3D_Visual_CircleDragger_Step.md) | (Переопределяет [DraggerStep](P_TFlex_Model_Model3D_Visual_Dragger_Step.md)) |
...
|  | [Value](P_TFlex_Model_Model3D_Visual_CircleDragger_Value.md) | Текущее значение(Переопределяет [DraggerValue](P_TFlex_Model_Model3D_Visual_Dragger_Value.md)) |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Activate](M_TFlex_Model_Model3D_Visual_CircleDragger_Activate.md) | Переопределённый метод класса Dragger(Переопределяет [DraggerActivate(View3D, Int32, Int32, Single)](M_TFlex_Model_Model3D_Visual_Dragger_Activate.md)) |
...
|  | [Release](M_TFlex_Model_Model3D_Visual_CircleDragger_Release.md) | Переопределённый метод класса Dragger(Переопределяет [DraggerRelease](M_TFlex_Model_Model3D_Visual_Dragger_Release.md)) |
|  | [ToString](https://learn.microsoft.com/dotnet/api/system.object.tostring) | Returns a string that represents the current object.(Унаследован от [Object](https://learn.microsoft.com/dotnet/api/system.object)) |
|  | [UpdatePosition](M_TFlex_Model_Model3D_Visual_CircleDragger_UpdatePosition.md) | Переопределённый метод класса Dragger(Переопределяет [DraggerUpdatePosition(View3D, Int32, Int32)](M_TFlex_Model_Model3D_Visual_Dragger_UpdatePosition.md)) |
...
Манипулятор позволяет изменять данные с помощью вращения декораций вокруг заданной оси. 
...
[LineDragger](T_TFlex_Model_Model3D_Visual_LineDragger.md)
