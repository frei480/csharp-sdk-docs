...
|  | [Path2DSection(Document, Page)](M_TFlex_Model_Model3D_Path2DSection__ctor_1.md) | Конструктор для создания сечения по 2D пути |
...
|  | [Path2D](P_TFlex_Model_Model3D_Path2DSection_Path2D.md) | 2D путь |
