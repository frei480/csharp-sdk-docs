...
Путь по набору проволочных моделей

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DConstruction3D](T_TFlex_Model_Model3D_Construction3D.md) [TFlex.Model.Model3DPath3D](T_TFlex_Model_Model3D_Path3D.md) TFlex.Model.Model3DPath3DPath

**Пространство имён:** [TFlex.Model.Model3D](N_TFlex_Model_Model3D.md)**Сборка:** TFlexAPI3D (в TFlexAPI3D.dll) Версия: 17.1.20.0

```csharp
public class Path3DPath : Path3D
```
```vb
Public Class Path3DPath
	Inherits Path3D
```
```cpp
public ref class Path3DPath : public Path3D
```


Тип Path3DPath предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [Path3DPath](M_TFlex_Model_Model3D_Path3DPath__ctor.md) | Конструктор для создания пути по набору проволочных моделей |
...
|  | [StartPoint](P_TFlex_Model_Model3D_Path3DPath_StartPoint.md) | Точка начала составного пути |
...
|  | [Wires](P_TFlex_Model_Model3D_Path3DPath_Wires.md) | Множество проволочных моделей |
...
В настоящей версии в качестве проволочных моделей можно выбирать только 3D пути. В остальных случаях путь строится не будет
