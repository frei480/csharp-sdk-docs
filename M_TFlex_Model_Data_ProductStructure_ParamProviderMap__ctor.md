...
# ParamProviderMap - конструктор  
    
Инициализирует новый экземпляр класса [ParamProviderMap](T_TFlex_Model_Data_ProductStructure_ParamProviderMap.md)
