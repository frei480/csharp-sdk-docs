...
|  | [NonStandardProjection(Document, Page)](M_TFlex_Model_Model3D_NonStandardProjection__ctor_1.md) | Конструктор для создания новой проекции |
...
|  | [Center](P_TFlex_Model_Model3D_NonStandardProjection_Center.md) | Проекция позиционируется по центру ограничивающиего прямоугольника |
...
|  | [ViewPlane](P_TFlex_Model_Model3D_NonStandardProjection_ViewPlane.md) | Топологический элемент для определения направления проецирования. Поддерживаются два типа элементов грани и вершины. Элемент для опеределения направления проецирования. |
|  | [ViewTiePoint3D](P_TFlex_Model_Model3D_NonStandardProjection_ViewTiePoint3D.md) | Привязка проекции к 3d точке |
...
|  | [CreateLegacy(Document, Page)](M_TFlex_Model_Model3D_NonStandardProjection_CreateLegacy_1.md) |  |
...
|  | [SetViewPoint](M_TFlex_Model_Model3D_NonStandardProjection_SetViewPoint.md) | Установить координаты точки проецирования |
