...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Cylinder](M_TFlex_Model_Model3D_Cylinder__ctor.md) | Конструктор для создания Цилиндра |
...
|  | [Diameter](P_TFlex_Model_Model3D_Cylinder_Diameter.md) | Диаметр |
...
|  | [Height](P_TFlex_Model_Model3D_Cylinder_Height.md) | Высота |
