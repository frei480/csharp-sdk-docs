...
# TwoPointCircleOutline - класс  
    
Линия изображения - окружность, проходящая через два узла с заданным радиусом

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DTwoPointCircleOutline

**Пространство имён:** [TFlex.Model.Model2D](N_TFlex_Model_Model2D.md)**Сборка:** TFlexAPI (в TFlexAPI.dll) Версия: 17.1.20.0

```csharp
public class TwoPointCircleOutline : Outline
```
```vb
Public Class TwoPointCircleOutline
	Inherits Outline
```
```cpp
public ref class TwoPointCircleOutline : public Outline
```


Тип TwoPointCircleOutline предоставляет следующие члены.

|  | Имя | Описание |
| --- | --- | --- |
|  | [TwoPointCircleOutline](M_TFlex_Model_Model2D_TwoPointCircleOutline__ctor.md) | Конструктор |
...
|  | [FirstNode](P_TFlex_Model_Model2D_TwoPointCircleOutline_FirstNode.md) | Первый узел |
...
|  | [Radius](P_TFlex_Model_Model2D_TwoPointCircleOutline_Radius.md) | Радиус окружности |
|  | [SecondNode](P_TFlex_Model_Model2D_TwoPointCircleOutline_SecondNode.md) | Второй узел |
...
|  | [SubType](P_TFlex_Model_Model2D_TwoPointCircleOutline_SubType.md) | Подтип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
