...
[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model3DObject3D](T_TFlex_Model_Model3D_Object3D.md) [TFlex.Model.Model3DOperation](T_TFlex_Model_Model3D_Operation.md) TFlex.Model.Model3DThread
...
|  | Имя | Описание |
| --- | --- | --- |
|  | [Thread](M_TFlex_Model_Model3D_Thread__ctor.md) | Конструктор резьбы |
...
|  | [Diameter](P_TFlex_Model_Model3D_Thread_Diameter.md) | Диаметер резьбы |
...
|  | [EndLimitDirection](P_TFlex_Model_Model3D_Thread_EndLimitDirection.md) | Геометрическое направление задающее ограничение конца резьбы |
|  | [EndLimitMeasure](P_TFlex_Model_Model3D_Thread_EndLimitMeasure.md) | Единицы измерения ограничения конца резьбы |
|  | [EndLimitPlane](P_TFlex_Model_Model3D_Thread_EndLimitPlane.md) | Плоскость задающая ограничение конца резьбы |
|  | [EndLimitPoint](P_TFlex_Model_Model3D_Thread_EndLimitPoint.md) | Точка задающая ограничение конца резьбы |
|  | [EndLimitType](P_TFlex_Model_Model3D_Thread_EndLimitType.md) | Ограничение конца резьбы |
|  | [EndLimitValue](P_TFlex_Model_Model3D_Thread_EndLimitValue.md) | Значение задающее ограничение конца резьбы |
|  | [Faces](P_TFlex_Model_Model3D_Thread_Faces.md) | Массив граней |
...
|  | [GroupType](P_TFlex_Model_Model3D_Thread_GroupType.md) | Получить тип объекта(Переопределяет [OperationGroupType](P_TFlex_Model_Model3D_Operation_GroupType.md)) |
...
|  | [Spec](P_TFlex_Model_Model3D_Thread_Spec.md) | Спецификация резьбы |
|  | [Standard](P_TFlex_Model_Model3D_Thread_Standard.md) | Стандарт резьбы |
|  | [Standards](P_TFlex_Model_Model3D_Thread_Standards.md) | Коллекция стандартов резьбы |
|  | [StartLimitDirection](P_TFlex_Model_Model3D_Thread_StartLimitDirection.md) | Геометрическое направление задающее ограничение начала резьбы |
|  | [StartLimitMeasure](P_TFlex_Model_Model3D_Thread_StartLimitMeasure.md) | Единицы измерения ограничения начала резьбы |
|  | [StartLimitPlane](P_TFlex_Model_Model3D_Thread_StartLimitPlane.md) | Плоскость задающая ограничение начала резьбы |
|  | [StartLimitPoint](P_TFlex_Model_Model3D_Thread_StartLimitPoint.md) | Точка задающая ограничение начала резьбы |
|  | [StartLimitType](P_TFlex_Model_Model3D_Thread_StartLimitType.md) | Ограничение начала резьбы |
|  | [StartLimitValue](P_TFlex_Model_Model3D_Thread_StartLimitValue.md) | Значение задающее ограничение начала резьбы |
|  | [Step](P_TFlex_Model_Model3D_Thread_Step.md) | Шаг резьбы |
