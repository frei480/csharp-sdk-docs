...
# ConstraintCreateAlignHorizontal - метод  
...
```csharp
public static Constraint CreateAlignHorizontal(
	Document iDoc,
	Object2D iObject1,
...
```
```vb
Public Shared Function CreateAlignHorizontal ( 
	iDoc As Document,
...
```cpp
public:
static Constraint^ CreateAlignHorizontal(
	Document^ iDoc, 
	Object2D^ iObject1, 
	ConstraintPointType iPoint1, 
	Object2D^ iObject2, 
