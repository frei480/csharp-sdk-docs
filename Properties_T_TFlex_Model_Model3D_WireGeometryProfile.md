...
# WireGeometryProfile - свойства  
    
Тип [WireGeometryProfile](T_TFlex_Model_Model3D_WireGeometryProfile.md) предоставляет следующие члены.
...
|  | [Edges](P_TFlex_Model_Model3D_WireGeometryProfile_Edges.md) | Множество рёбер |
...
|  | [Path](P_TFlex_Model_Model3D_WireGeometryProfile_Path.md) | 3D путь |
...
[WireGeometryProfile - ](T_TFlex_Model_Model3D_WireGeometryProfile.md)
