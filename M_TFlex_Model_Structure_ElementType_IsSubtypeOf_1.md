...
# ElementTypeIsSubtypeOf(String) - метод  
...
typeSystemName [String](https://learn.microsoft.com/dotnet/api/system.string)
...
[IsSubtypeOf - перегрузка](Overload_TFlex_Model_Structure_ElementType_IsSubtypeOf.md)
