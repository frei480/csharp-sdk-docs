...
|  | Имя | Описание |
| --- | --- | --- |
|  | [OutlinePath](M_TFlex_Model_Model3D_OutlinePath__ctor.md) | Конструктор для создания линии очерка |
...
|  | [Direction](P_TFlex_Model_Model3D_OutlinePath_Direction.md) | Направление очерка |
...
|  | [FirstPoint](P_TFlex_Model_Model3D_OutlinePath_FirstPoint.md) | Первая точка, задающая направление очерка |
...
|  | [Operation](P_TFlex_Model_Model3D_OutlinePath_Operation.md) | Тело, для которого задаётся очерк |
...
|  | [SecondPoint](P_TFlex_Model_Model3D_OutlinePath_SecondPoint.md) | Вторая точка, задающая направление очерка |
...
|  | [VerticalFaces](P_TFlex_Model_Model3D_OutlinePath_VerticalFaces.md) | Параметр обработки вертикальных граней |
...
|  | [ChangeOutline](M_TFlex_Model_Model3D_OutlinePath_ChangeOutline.md) | Выбрать другую линию очерка |
...
|  | [Complete](M_TFlex_Model_Model3D_OutlinePath_Complete.md) | (Переопределяет [ModelObjectComplete](M_TFlex_Model_ModelObject_Complete.md)) |
