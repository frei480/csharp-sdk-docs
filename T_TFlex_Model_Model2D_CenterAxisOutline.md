...
# CenterAxisOutline - класс  
  
---  
  
Линия изображения - ось окружности или эллипса

[SystemObject](https://learn.microsoft.com/dotnet/api/system.object) [TFlex.ModelModelObject](T_TFlex_Model_ModelObject.md) [TFlex.Model.Model2DObject2D](T_TFlex_Model_Model2D_Object2D.md) [TFlex.Model.Model2DOutline](T_TFlex_Model_Model2D_Outline.md) TFlex.Model.Model2DCenterAxisOutline
...
|  | [CenterAxisOutline(Document, Outline, CenterAxisOutlineCenterAxisType, Construction, Outline, Outline, Node, Node)](M_TFlex_Model_Model2D_CenterAxisOutline__ctor_1.md) | Конструктор для создания оси от центра, заданного окружностью построения |
|  | [CenterAxisOutline(Document, Outline, CenterAxisOutlineCenterAxisType, Node, Outline, Outline, Node, Node)](M_TFlex_Model_Model2D_CenterAxisOutline__ctor_2.md) | Конструктор для создания оси от центра в узле |
|  | [CenterAxisOutline(Document, Outline, CenterAxisOutlineCenterAxisType, Outline, Outline, Outline, Node, Node)](M_TFlex_Model_Model2D_CenterAxisOutline__ctor_3.md) | Конструктор для создания оси от центра, заданного дугой или окружностью изображения |
  
|  | Имя | Описание |
| --- | --- | --- |
|  | [Attributes](P_TFlex_Model_ModelObject_Attributes.md) | **Устарело.**(Унаследован от [ModelObject](T_TFlex_Model_ModelObject.md)) |
|  | [AxisType](P_TFlex_Model_Model2D_CenterAxisOutline_AxisType.md) | Тип оси |
...
|  | [CenterConstruction](P_TFlex_Model_Model2D_CenterAxisOutline_CenterConstruction.md) | Линия построения, определяющая центр |
|  | [CenterNode](P_TFlex_Model_Model2D_CenterAxisOutline_CenterNode.md) | Центральный узел |
|  | [CenterOutline](P_TFlex_Model_Model2D_CenterAxisOutline_CenterOutline.md) | Линия изображения, определяющая центр |
...
|  | [Limit1Node](P_TFlex_Model_Model2D_CenterAxisOutline_Limit1Node.md) | Первый ограничивающий узел |
|  | [Limit1Outline](P_TFlex_Model_Model2D_CenterAxisOutline_Limit1Outline.md) | Первая ограничивающая линия изображения |
|  | [Limit2Node](P_TFlex_Model_Model2D_CenterAxisOutline_Limit2Node.md) | Второй ограничивающий узел |
|  | [Limit2Outline](P_TFlex_Model_Model2D_CenterAxisOutline_Limit2Outline.md) | Вторая ограничивающая линия изображения |
...
|  | [SourceOutline](P_TFlex_Model_Model2D_CenterAxisOutline_SourceOutline.md) | Исходная линия изображения |
...
|  | [SubType](P_TFlex_Model_Model2D_CenterAxisOutline_SubType.md) | Тип линии изображения(Переопределяет [OutlineSubType](P_TFlex_Model_Model2D_Outline_SubType.md)) |
